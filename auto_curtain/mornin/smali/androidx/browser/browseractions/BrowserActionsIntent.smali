...
.method synthetic constructor <init>(Landroid/content/Intent;Landroidx/browser/browseractions/BrowserActionsIntent$1;)V
    ...
    .line 49
    invoke-direct/range {p0 .. p1}, Landroidx/browser/browseractions/BrowserActionsIntent;-><init>(Landroid/content/Intent;)V
...
.method public static getCreatorPackageName(Landroid/content/Intent;)Ljava/lang/String;
    ...
    .line 422
    invoke-virtual/range {p0 .. p0}, Landroid/app/PendingIntent;->getCreatorPackage()Ljava/lang/String;
    ...
    .line 424
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/app/PendingIntent;->getTargetPackage()Ljava/lang/String;
...
.method public static launchIntent(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 312
    invoke-static/range {p0 .. p0}, Landroidx/browser/browseractions/BrowserActionsIntent;->getBrowserActionsIntentHandlers(Landroid/content/Context;)Ljava/util/List;
...
.method static launchIntent(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V
    ...
    :cond_4
    :goto_2
    invoke-static/range {p0 .. p1}, Landroidx/browser/browseractions/BrowserActionsIntent;->openFallbackBrowserActionsMenu(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public static openBrowserAction(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroidx/browser/browseractions/BrowserActionsIntent$Builder;->build()Landroidx/browser/browseractions/BrowserActionsIntent;

    move-result-object p1

    .line 279
    invoke-virtual/range {p1 .. p1}, Landroidx/browser/browseractions/BrowserActionsIntent;->getIntent()Landroid/content/Intent;
...
.method public static openBrowserAction(Landroid/content/Context;Landroid/net/Uri;ILjava/util/ArrayList;Landroid/app/PendingIntent;)V
    ...
    .line 298
    invoke-virtual/range {p1 .. p1}, Landroidx/browser/browseractions/BrowserActionsIntent$Builder;->build()Landroidx/browser/browseractions/BrowserActionsIntent;
...
.method private static openFallbackBrowserActionsMenu(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 360
    invoke-static/range {p1 .. p1}, Landroidx/browser/browseractions/BrowserActionsIntent;->parseBrowserActionItems(Ljava/util/ArrayList;)Ljava/util/List;
...
.method private static openFallbackBrowserActionsMenu(Landroid/content/Context;Landroid/net/Uri;ILjava/util/List;)V
    ...
    .line 382
    invoke-virtual/range {p2 .. p2}, Landroidx/browser/browseractions/BrowserActionsFallbackMenuUi;->displayMenu()V
    ...
    invoke-interface/range {p0 .. p0}, Landroidx/browser/browseractions/BrowserActionsIntent$BrowserActionsFallDialogListener;->onDialogShown()V
