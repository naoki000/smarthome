...
.method public constructor <init>()V
    ...
    .line 38
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/app/FragmentTransitionImpl;-><init>()V
...
.method private static hasSimpleTarget(Landroid/support/transition/Transition;)Z
    ...
    .line 122
    invoke-virtual/range {p0 .. p0}, Landroid/support/transition/Transition;->getTargetIds()Ljava/util/List;

    move-result-object v0

    invoke-static/range {v0 .. v0}, Landroid/support/transition/FragmentTransitionSupport;->isNullOrEmpty(Ljava/util/List;)Z
    ...
    .line 123
    invoke-virtual/range {p0 .. p0}, Landroid/support/transition/Transition;->getTargetNames()Ljava/util/List;
    ...
    .line 124
    invoke-virtual/range {p0 .. p0}, Landroid/support/transition/Transition;->getTargetTypes()Ljava/util/List;

    move-result-object p0

    invoke-static/range {p0 .. p0}, Landroid/support/transition/FragmentTransitionSupport;->isNullOrEmpty(Ljava/util/List;)Z
...
.method public addTargets(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .line 104
    invoke-virtual/range {p1 .. p1}, Landroid/support/transition/TransitionSet;->getTransitionCount()I
    ...
    .line 109
    :cond_1
    invoke-static/range {p1 .. p1}, Landroid/support/transition/FragmentTransitionSupport;->hasSimpleTarget(Landroid/support/transition/Transition;)Z
    ...
    .line 110
    invoke-virtual/range {p1 .. p1}, Landroid/support/transition/Transition;->getTargets()Ljava/util/List;
...
.method public cloneTransition(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/transition/Transition;->clone()Landroid/support/transition/Transition;
...
.method public mergeTransitionsInSequence(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/transition/TransitionSet;-><init>()V
    ...
    invoke-direct/range {p2 .. p2}, Landroid/support/transition/TransitionSet;-><init>()V
...
.method public setSharedElementTargets(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    .line 68
    invoke-virtual/range {p1 .. p1}, Landroid/support/transition/TransitionSet;->getTargets()Ljava/util/List;
