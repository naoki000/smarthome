...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 202
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/LinearLayoutCompat;->draw(Landroid/graphics/Canvas;)V
    ...
    .line 212
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->getRight()I

    move-result v4

    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->getLeft()I
    ...
    .line 213
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->getBottom()I

    move-result v5

    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->getTop()I
    ...
    .line 218
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->getPaddingLeft()I

    move-result v1

    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->getPaddingTop()I

    move-result v6

    .line 219
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->getPaddingRight()I

    move-result v7

    sub-int/2addr v4, v7

    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->getPaddingBottom()I
...
.method public drawableHotspotChanged(FF)V
    ...
    .line 234
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/LinearLayoutCompat;->drawableHotspotChanged(FF)V
...
.method protected drawableStateChanged()V
    ...
    .line 135
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/LinearLayoutCompat;->drawableStateChanged()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->getDrawableState()[I
...
.method public jumpDrawablesToCurrentState()V
    ...
    .line 127
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/LinearLayoutCompat;->jumpDrawablesToCurrentState()V
...
.method protected onSizeChanged(IIII)V
    ...
    .line 196
    invoke-super/range {p0 .. p4}, Landroid/support/v7/widget/LinearLayoutCompat;->onSizeChanged(IIII)V
...
.method public setForeground(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_3
    :goto_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->requestLayout()V

    .line 173
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/ForegroundLinearLayout;->invalidate()V
...
.method protected verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 121
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/LinearLayoutCompat;->verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
