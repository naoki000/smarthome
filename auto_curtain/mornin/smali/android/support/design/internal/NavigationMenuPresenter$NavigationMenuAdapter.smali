...
.method constructor <init>(Landroid/support/design/internal/NavigationMenuPresenter;)V
    ...
    .line 367
    invoke-direct/range {p0 .. p0}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->prepareMenuItems()V
...
.method private prepareMenuItems()V
    ...
    invoke-direct/range {v3 .. v3}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuHeaderItem;-><init>()V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/view/menu/MenuBuilder;->getVisibleItems()Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v8 .. v8}, Landroid/support/v7/view/menu/MenuBuilder;->getVisibleItems()Ljava/util/ArrayList;
    ...
    .line 481
    invoke-virtual/range {v8 .. v8}, Landroid/support/v7/view/menu/MenuItemImpl;->isChecked()Z
    ...
    .line 484
    :cond_1
    invoke-virtual/range {v8 .. v8}, Landroid/support/v7/view/menu/MenuItemImpl;->isCheckable()Z
    ...
    .line 487
    :cond_2
    invoke-virtual/range {v8 .. v8}, Landroid/support/v7/view/menu/MenuItemImpl;->hasSubMenu()Z
    ...
    .line 488
    invoke-virtual/range {v8 .. v8}, Landroid/support/v7/view/menu/MenuItemImpl;->getSubMenu()Landroid/view/SubMenu;

    move-result-object v9

    .line 489
    invoke-interface/range {v9 .. v9}, Landroid/view/SubMenu;->hasVisibleItems()Z
    ...
    .line 496
    invoke-interface/range {v9 .. v9}, Landroid/view/SubMenu;->size()I
    ...
    .line 498
    invoke-virtual/range {v14 .. v14}, Landroid/support/v7/view/menu/MenuItemImpl;->isVisible()Z
    ...
    .line 499
    invoke-virtual/range {v14 .. v14}, Landroid/support/v7/view/menu/MenuItemImpl;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 502
    :cond_4
    invoke-virtual/range {v14 .. v14}, Landroid/support/v7/view/menu/MenuItemImpl;->isCheckable()Z
    ...
    .line 516
    :cond_9
    invoke-virtual/range {v8 .. v8}, Landroid/support/v7/view/menu/MenuItemImpl;->getGroupId()I
    ...
    .line 519
    invoke-virtual/range {v8 .. v8}, Landroid/support/v7/view/menu/MenuItemImpl;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public createInstanceState()Landroid/os/Bundle;
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 567
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/view/menu/MenuItemImpl;->getActionView()Landroid/view/View;
    ...
    invoke-direct/range {v6 .. v6}, Landroid/support/design/internal/ParcelableSparseArray;-><init>()V

    .line 570
    invoke-virtual {v5, v6}, Landroid/view/View;->saveHierarchyState(Landroid/util/SparseArray;)V

    .line 571
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/view/menu/MenuItemImpl;->getItemId()I
...
.method public getItemViewType(I)I
    ...
    .line 389
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroid/support/v7/view/menu/MenuItemImpl;
...
.method public onBindViewHolder(Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;I)V
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuSeparatorItem;->getPaddingTop()I

    move-result v0

    .line 442
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuSeparatorItem;->getPaddingBottom()I
    ...
    .line 435
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroid/support/v7/view/menu/MenuItemImpl;

    move-result-object p2

    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/view/menu/MenuItemImpl;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable$ConstantState;->newDrawable()Landroid/graphics/drawable/Drawable;
...
.method public bridge synthetic onBindViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual/range {p0 .. p2}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->onBindViewHolder(Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;I)V
...
.method public bridge synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 352
    invoke-virtual/range {p0 .. p2}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->onCreateViewHolder(Landroid/view/ViewGroup;I)Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;
...
.method public onViewRecycled(Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/internal/NavigationMenuItemView;->recycle()V
...
.method public bridge synthetic onViewRecycled(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->onViewRecycled(Landroid/support/design/internal/NavigationMenuPresenter$ViewHolder;)V
...
.method public restoreInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuTextItem;->getMenuItem()Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 609
    :cond_4
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuItemImpl;->getActionView()Landroid/view/View;
...
.method public setCheckedItem(Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->isCheckable()Z
...
.method public update()V
    ...
    .line 461
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/NavigationMenuPresenter$NavigationMenuAdapter;->notifyDataSetChanged()V
