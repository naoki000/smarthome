...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 94
    invoke-direct/range {p0 .. p3}, Landroid/support/design/internal/ForegroundLinearLayout;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private adjustAppearance()V
    ...
    .line 132
    invoke-direct/range {p0 .. p0}, Landroid/support/design/internal/NavigationMenuItemView;->shouldExpandActionArea()Z
...
.method private createDefaultBackground()Landroid/graphics/drawable/StateListDrawable;
    ...
    .line 170
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/NavigationMenuItemView;->getContext()Landroid/content/Context;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/graphics/drawable/StateListDrawable;-><init>()V
...
.method private setActionView(Landroid/view/View;)V
    ...
    .line 161
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewStub;->inflate()Landroid/view/View;
...
.method private shouldExpandActionArea()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuItemImpl;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 127
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuItemImpl;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 128
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuItemImpl;->getActionView()Landroid/view/View;
...
.method public initialize(Landroid/support/v7/view/menu/MenuItemImpl;I)V
    ...
    .line 108
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->isVisible()Z
    ...
    .line 110
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/NavigationMenuItemView;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 111
    invoke-direct/range {p0 .. p0}, Landroid/support/design/internal/NavigationMenuItemView;->createDefaultBackground()Landroid/graphics/drawable/StateListDrawable;
    ...
    .line 115
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->isChecked()Z
    ...
    .line 117
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 118
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 120
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->getContentDescription()Ljava/lang/CharSequence;
    ...
    .line 121
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->getTooltipText()Ljava/lang/CharSequence;
    ...
    .line 122
    invoke-direct/range {p0 .. p0}, Landroid/support/design/internal/NavigationMenuItemView;->adjustAppearance()V
...
.method protected onCreateDrawableState(I)[I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuItemImpl;->isCheckable()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuItemImpl;->isChecked()Z
...
.method public setCheckable(Z)V
    ...
    .line 192
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/NavigationMenuItemView;->refreshDrawableState()V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_0
    invoke-static/range {p1 .. p1}, Landroid/support/v4/graphics/drawable/DrawableCompat;->wrap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 221
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/internal/NavigationMenuItemView;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/content/Context;->getTheme()Landroid/content/res/Resources$Theme;
