...
.method public constructor <init>()V
    ...
    .line 817
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/HeaderBehavior;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 820
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/HeaderBehavior;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private animateOffsetTo(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;IF)V
    ...
    .line 905
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->getHeight()I
...
.method private animateOffsetWithDuration(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;II)V
    ...
    invoke-direct/range {v1 .. v1}, Landroid/animation/ValueAnimator;-><init>()V
...
.method private static getAppBarChildOnOffset(Landroid/support/design/widget/AppBarLayout;I)Landroid/view/View;
    ...
    .line 1261
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/AppBarLayout;->getChildCount()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getBottom()I
...
.method private getChildIndexOnOffset(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    .line 942
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/AppBarLayout;->getChildCount()I
...
.method private interpolateOffset(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    .line 1166
    invoke-virtual/range {v5 .. v5}, Landroid/support/design/widget/AppBarLayout$LayoutParams;->getScrollInterpolator()Landroid/view/animation/Interpolator;

    move-result-object v6

    .line 1168
    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->getTop()I

    move-result v7

    if-lt v0, v7, :cond_2

    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->getBottom()I
    ...
    .line 1171
    invoke-virtual/range {v5 .. v5}, Landroid/support/design/widget/AppBarLayout$LayoutParams;->getScrollFlags()I
    ...
    .line 1174
    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->getHeight()I
    ...
    .line 1180
    invoke-static/range {v4 .. v4}, Landroid/support/v4/view/ViewCompat;->getMinimumHeight(Landroid/view/View;)I
    ...
    .line 1184
    :cond_0
    invoke-static/range {v4 .. v4}, Landroid/support/v4/view/ViewCompat;->getFitsSystemWindows(Landroid/view/View;)Z
    ...
    .line 1185
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/AppBarLayout;->getTopInset()I
...
.method private shouldJumpElevationState(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Z
    ...
    .line 1245
    invoke-virtual/range {p1 .. p2}, Landroid/support/design/widget/CoordinatorLayout;->getDependents(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/AppBarLayout$ScrollingViewBehavior;->getOverlayTop()I
...
.method private snapToChildIfNeeded(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    .line 957
    invoke-virtual/range {v3 .. v3}, Landroid/support/design/widget/AppBarLayout$LayoutParams;->getScrollFlags()I
    ...
    .line 971
    invoke-static/range {v2 .. v2}, Landroid/support/v4/view/ViewCompat;->getMinimumHeight(Landroid/view/View;)I
...
.method private updateAppBarLayoutDrawableState(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;IIZ)V
    ...
    .line 1210
    invoke-static/range {p2 .. p3}, Landroid/support/design/widget/AppBarLayout$Behavior;->getAppBarChildOnOffset(Landroid/support/design/widget/AppBarLayout;I)Landroid/view/View;
    ...
    .line 1213
    invoke-virtual/range {v1 .. v1}, Landroid/support/design/widget/AppBarLayout$LayoutParams;->getScrollFlags()I
    ...
    .line 1234
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/AppBarLayout$Behavior;->shouldJumpElevationState(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Z
    ...
    .line 1237
    :cond_2
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->jumpDrawablesToCurrentState()V
...
.method bridge synthetic canDragView(Landroid/view/View;)Z
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/widget/AppBarLayout$Behavior;->canDragView(Landroid/support/design/widget/AppBarLayout;)Z
...
.method public bridge synthetic getLeftAndRightOffset()I
    ...
    .line 787
    invoke-super/range {p0 .. p0}, Landroid/support/design/widget/HeaderBehavior;->getLeftAndRightOffset()I
...
.method getMaxDragOffset(Landroid/support/design/widget/AppBarLayout;)I
    ...
    .line 1102
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/AppBarLayout;->getDownNestedScrollRange()I
...
.method bridge synthetic getMaxDragOffset(Landroid/view/View;)I
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/widget/AppBarLayout$Behavior;->getMaxDragOffset(Landroid/support/design/widget/AppBarLayout;)I
...
.method getScrollRangeForDragFling(Landroid/support/design/widget/AppBarLayout;)I
    ...
    .line 1107
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/AppBarLayout;->getTotalScrollRange()I
...
.method bridge synthetic getScrollRangeForDragFling(Landroid/view/View;)I
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/widget/AppBarLayout$Behavior;->getScrollRangeForDragFling(Landroid/support/design/widget/AppBarLayout;)I
...
.method public bridge synthetic getTopAndBottomOffset()I
    ...
    .line 787
    invoke-super/range {p0 .. p0}, Landroid/support/design/widget/HeaderBehavior;->getTopAndBottomOffset()I
...
.method getTopBottomOffsetForScrollingSibling()I
    ...
    .line 1272
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/AppBarLayout$Behavior;->getTopAndBottomOffset()I
...
.method onFlingFinished(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    .line 1097
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/AppBarLayout$Behavior;->snapToChildIfNeeded(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
...
.method bridge synthetic onFlingFinished(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)V
    ...
    invoke-virtual/range {p0 .. p2}, Landroid/support/design/widget/AppBarLayout$Behavior;->onFlingFinished(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
...
.method public onLayoutChild(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)Z
    ...
    .line 1021
    invoke-super/range {p0 .. p3}, Landroid/support/design/widget/HeaderBehavior;->onLayoutChild(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z

    move-result p3

    .line 1027
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->getPendingAction()I
    ...
    .line 1040
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->getUpNestedPreScrollRange()I
    ...
    :cond_6
    :goto_2
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->resetPendingAction()V
...
.method public bridge synthetic onLayoutChild(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-virtual/range {p0 .. p3}, Landroid/support/design/widget/AppBarLayout$Behavior;->onLayoutChild(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)Z
...
.method public onMeasureChild(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;IIII)Z
    ...
    .line 1002
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
...
.method public onNestedPreScroll(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;II[II)V
    ...
    .line 851
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->getDownNestedPreScrollRange()I
...
.method public onNestedScroll(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;IIIII)V
    ...
    .line 871
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->getDownNestedScrollRange()I
...
.method public onRestoreInstanceState(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/os/Parcelable;)V
    ...
    .line 1304
    invoke-virtual/range {p3 .. p3}, Landroid/support/design/widget/AppBarLayout$Behavior$SavedState;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 1309
    :cond_0
    invoke-super/range {p0 .. p3}, Landroid/support/design/widget/HeaderBehavior;->onRestoreInstanceState(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/os/Parcelable;)V
...
.method public bridge synthetic onRestoreInstanceState(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    invoke-virtual/range {p0 .. p3}, Landroid/support/design/widget/AppBarLayout$Behavior;->onRestoreInstanceState(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/os/Parcelable;)V
...
.method public onSaveInstanceState(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
    ...
    .line 1277
    invoke-super/range {p0 .. p2}, Landroid/support/design/widget/HeaderBehavior;->onSaveInstanceState(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
...
.method public bridge synthetic onSaveInstanceState(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-virtual/range {p0 .. p2}, Landroid/support/design/widget/AppBarLayout$Behavior;->onSaveInstanceState(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
...
.method public onStartNestedScroll(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;Landroid/view/View;II)Z
    ...
    .line 829
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->hasScrollableChildren()Z
...
.method public bridge synthetic onStopNestedScroll(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual/range {p0 .. p4}, Landroid/support/design/widget/AppBarLayout$Behavior;->onStopNestedScroll(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/view/View;I)V
...
.method setHeaderTopBottomOffset(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;III)I
    ...
    .line 1119
    invoke-static/range {p3 .. p5}, Landroid/support/v4/math/MathUtils;->clamp(III)I
    ...
    .line 1121
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->hasChildWithInterpolator()Z
    ...
    .line 1137
    invoke-virtual/range {p1 .. p2}, Landroid/support/design/widget/CoordinatorLayout;->dispatchDependentViewsChanged(Landroid/view/View;)V
...
.method public bridge synthetic setLeftAndRightOffset(I)Z
    ...
    .line 787
    invoke-super/range {p0 .. p1}, Landroid/support/design/widget/HeaderBehavior;->setLeftAndRightOffset(I)Z
...
.method public bridge synthetic setTopAndBottomOffset(I)Z
    ...
    .line 787
    invoke-super/range {p0 .. p1}, Landroid/support/design/widget/HeaderBehavior;->setTopAndBottomOffset(I)Z
