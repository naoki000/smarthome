...
.method private animateScrim(I)V
    ...
    .line 607
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->ensureToolbar()V
...
.method private ensureToolbar()V
    ...
    .line 356
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->getChildCount()I
    ...
    .line 366
    :cond_4
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->updateDummyView()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->getWidth()I
...
.method protected drawableStateChanged()V
    ...
    .line 739
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->getDrawableState()[I
    ...
    .line 755
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->invalidate()V
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 105
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->generateDefaultLayoutParams()Landroid/support/design/widget/CollapsingToolbarLayout$LayoutParams;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 105
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/widget/CollapsingToolbarLayout;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 105
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/widget/CollapsingToolbarLayout;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/widget/FrameLayout$LayoutParams;
...
.method public getCollapsedTitleGravity()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CollapsingTextHelper;->getCollapsedTextGravity()I
...
.method public getCollapsedTitleTypeface()Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CollapsingTextHelper;->getCollapsedTypeface()Landroid/graphics/Typeface;
...
.method public getExpandedTitleGravity()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CollapsingTextHelper;->getExpandedTextGravity()I
...
.method public getExpandedTitleTypeface()Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CollapsingTextHelper;->getExpandedTypeface()Landroid/graphics/Typeface;
...
.method final getMaxOffsetForPinChild(Landroid/view/View;)I
    ...
    .line 1259
    invoke-static/range {p1 .. p1}, Landroid/support/design/widget/CollapsingToolbarLayout;->getViewOffsetHelper(Landroid/view/View;)Landroid/support/design/widget/ViewOffsetHelper;
    ...
    .line 1261
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->getHeight()I

    move-result v2

    .line 1262
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/ViewOffsetHelper;->getLayoutTop()I
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CollapsingTextHelper;->getText()Ljava/lang/CharSequence;
...
.method protected onAttachedToWindow()V
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v4/view/ViewCompat;->getFitsSystemWindows(Landroid/view/View;)Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 262
    :cond_0
    invoke-super/range {p0 .. p0}, Landroid/widget/FrameLayout;->onDetachedFromWindow()V
...
.method protected onLayout(ZIIII)V
    ...
    .line 433
    invoke-static/range {v3 .. v3}, Landroid/support/v4/view/ViewCompat;->getFitsSystemWindows(Landroid/view/View;)Z
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewCompat;->isAttachedToWindow(Landroid/view/View;)Z
    ...
    .line 460
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/Toolbar;->getTitleMarginEnd()I
    ...
    .line 461
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/Toolbar;->getTitleMarginStart()I
    ...
    .line 462
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/Toolbar;->getTitleMarginTop()I
    ...
    .line 464
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/widget/Toolbar;->getTitleMarginStart()I
    ...
    .line 465
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/widget/Toolbar;->getTitleMarginEnd()I
    ...
    .line 466
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/Toolbar;->getTitleMarginBottom()I
    ...
    invoke-static/range {p2 .. p2}, Landroid/support/design/widget/CollapsingToolbarLayout;->getViewOffsetHelper(Landroid/view/View;)Landroid/support/design/widget/ViewOffsetHelper;

    move-result-object p2

    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/ViewOffsetHelper;->onViewLayout()V
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/Toolbar;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/design/widget/CollapsingToolbarLayout;->getHeightWithMargins(Landroid/view/View;)I
    ...
    :cond_e
    :goto_a
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->updateScrimVisibility()V
...
.method protected onMeasure(II)V
    ...
    .line 419
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->getMeasuredHeight()I
...
.method onWindowInsetChanged(Landroid/support/v4/view/WindowInsetsCompat;)Landroid/support/v4/view/WindowInsetsCompat;
    ...
    .line 276
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->requestLayout()V

    .line 281
    :cond_1
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/view/WindowInsetsCompat;->consumeSystemWindowInsets()Landroid/support/v4/view/WindowInsetsCompat;
...
.method setScrimAlpha(I)V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/ViewCompat;->postInvalidateOnAnimation(Landroid/view/View;)V
...
.method public setScrimsShown(Z)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->isInEditMode()Z
...
.method public setStatusBarScrim(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->getVisibility()I
...
.method public setVisibility(I)V
    ...
    .line 766
    invoke-super/range {p0 .. p1}, Landroid/widget/FrameLayout;->setVisibility(I)V
...
.method final updateScrimVisibility()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingToolbarLayout;->getScrimVisibleHeightTrigger()I
...
.method protected verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 761
    invoke-super/range {p0 .. p1}, Landroid/widget/FrameLayout;->verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
