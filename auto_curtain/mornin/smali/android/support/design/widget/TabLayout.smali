...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 365
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getResources()Landroid/content/res/Resources;
    ...
    .line 370
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->applyModeAndGravity()V
...
.method private addTabFromItemView(Landroid/support/design/widget/TabItem;)V
    ...
    .line 488
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->newTab()Landroid/support/design/widget/TabLayout$Tab;
    ...
    .line 498
    :cond_2
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/TabItem;->getContentDescription()Ljava/lang/CharSequence;
...
.method private addTabView(Landroid/support/design/widget/TabLayout$Tab;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/TabLayout$Tab;->getPosition()I

    move-result p1

    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->createLayoutParamsForTabs()Landroid/widget/LinearLayout$LayoutParams;
...
.method private animateToTab(I)V
    ...
    .line 1076
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getWindowToken()Landroid/os/IBinder;
    ...
    .line 1077
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$SlidingTabStrip;->childrenNeedLayout()Z
    ...
    .line 1084
    :cond_1
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getScrollX()I
    ...
    .line 1088
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->ensureScrollAnimator()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/ValueAnimator;->start()V
...
.method private calculateScrollXForTab(IF)I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/TabLayout$SlidingTabStrip;->getChildCount()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getWidth()I
...
.method private configureTab(Landroid/support/design/widget/TabLayout$Tab;I)V
    ...
    .line 941
    invoke-virtual/range {p1 .. p2}, Landroid/support/design/widget/TabLayout$Tab;->setPosition(I)V
...
.method private createTabView(Landroid/support/design/widget/TabLayout$Tab;)Landroid/support/design/widget/TabLayout$TabView;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getContext()Landroid/content/Context;
    ...
    .line 936
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getTabMinWidth()I
...
.method private getDefaultHeight()I
    ...
    .line 2065
    invoke-virtual/range {v3 .. v3}, Landroid/support/design/widget/TabLayout$Tab;->getIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v4

    if-eqz v4, :cond_0

    invoke-virtual/range {v3 .. v3}, Landroid/support/design/widget/TabLayout$Tab;->getText()Ljava/lang/CharSequence;
...
.method private getScrollPosition()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$SlidingTabStrip;->getIndicatorPosition()F
...
.method private getTabScrollRange()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$SlidingTabStrip;->getWidth()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getPaddingLeft()I
    ...
    .line 881
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getPaddingRight()I
...
.method private removeTabViewAt(I)V
    ...
    .line 1065
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$TabView;->reset()V
    ...
    .line 1068
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->requestLayout()V
...
.method private setSelectedTabView(I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$SlidingTabStrip;->getChildCount()I
...
.method private setupWithViewPager(Landroid/support/v4/view/ViewPager;ZZ)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$TabLayoutOnPageChangeListener;->reset()V
    ...
    .line 810
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/view/ViewPager;->getAdapter()Landroid/support/v4/view/PagerAdapter;
    ...
    .line 825
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/view/ViewPager;->getCurrentItem()I
...
.method private updateAllTabs()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/TabLayout$Tab;->updateView()V
...
.method public addTab(Landroid/support/design/widget/TabLayout$Tab;IZ)V
    ...
    .line 479
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/TabLayout;->configureTab(Landroid/support/design/widget/TabLayout$Tab;I)V

    .line 480
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/TabLayout;->addTabView(Landroid/support/design/widget/TabLayout$Tab;)V

    if-eqz p3, :cond_0

    .line 483
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/TabLayout$Tab;->select()V
...
.method public addView(Landroid/view/View;)V
    ...
    .line 957
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/TabLayout;->addViewInternal(Landroid/view/View;)V
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 148
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/widget/TabLayout;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 2088
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->generateDefaultLayoutParams()Landroid/widget/FrameLayout$LayoutParams;
...
.method public getSelectedTabPosition()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$Tab;->getPosition()I
...
.method public getTabAt(I)Landroid/support/design/widget/TabLayout$Tab;
    ...
    .line 587
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getTabCount()I
...
.method public newTab()Landroid/support/design/widget/TabLayout$Tab;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$Tab;-><init>()V
...
.method protected onAttachedToWindow()V
    ...
    .line 854
    invoke-super/range {p0 .. p0}, Landroid/widget/HorizontalScrollView;->onAttachedToWindow()V
    ...
    .line 859
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getParent()Landroid/view/ViewParent;
...
.method protected onDetachedFromWindow()V
    ...
    .line 870
    invoke-super/range {p0 .. p0}, Landroid/widget/HorizontalScrollView;->onDetachedFromWindow()V
...
.method protected onMeasure(II)V
    ...
    .line 1008
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getDefaultHeight()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getPaddingTop()I

    move-result v1

    add-int/2addr v0, v1

    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getPaddingBottom()I
    ...
    .line 1032
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getChildCount()I
    ...
    .line 1046
    :pswitch_0
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getMeasuredWidth()I

    move-result v2

    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getMeasuredWidth()I
...
.method populateFromPagerAdapter()V
    ...
    .line 905
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->removeAllTabs()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/ViewPager;->getCurrentItem()I

    move-result v0

    .line 916
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getSelectedTabPosition()I
...
.method public removeAllTabs()V
    ...
    .line 651
    invoke-virtual/range {v1 .. v1}, Landroid/support/design/widget/TabLayout$Tab;->reset()V
...
.method public removeTabAt(I)V
    ...
    .line 621
    :goto_0
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/TabLayout;->removeTabViewAt(I)V
    ...
    .line 625
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/TabLayout$Tab;->reset()V
...
.method selectTab(Landroid/support/design/widget/TabLayout$Tab;Z)V
    ...
    .line 1136
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/TabLayout;->dispatchTabReselected(Landroid/support/design/widget/TabLayout$Tab;)V
    ...
    .line 1158
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/TabLayout;->dispatchTabSelected(Landroid/support/design/widget/TabLayout$Tab;)V
...
.method public setOnTabSelectedListener(Landroid/support/design/widget/TabLayout$OnTabSelectedListener;)V
    ...
    .line 519
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/widget/TabLayout;->addOnTabSelectedListener(Landroid/support/design/widget/TabLayout$OnTabSelectedListener;)V
...
.method setPagerAdapter(Landroid/support/v4/view/PagerAdapter;Z)V
    ...
    .line 901
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->populateFromPagerAdapter()V
...
.method setScrollPosition(IFZZ)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/design/widget/TabLayout$SlidingTabStrip;->getChildCount()I
    ...
    invoke-virtual/range {p4 .. p4}, Landroid/animation/ValueAnimator;->isRunning()Z
    ...
    invoke-virtual/range {p4 .. p4}, Landroid/animation/ValueAnimator;->cancel()V

    .line 425
    :cond_2
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/TabLayout;->calculateScrollXForTab(IF)I
...
.method public setTabTextColors(II)V
    ...
    .line 741
    invoke-static/range {p1 .. p2}, Landroid/support/design/widget/TabLayout;->createColorStateList(II)Landroid/content/res/ColorStateList;
...
.method public setTabTextColors(Landroid/content/res/ColorStateList;)V
    ...
    .line 722
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->updateAllTabs()V
...
.method public shouldDelayChildPressedState()Z
    ...
    .line 849
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TabLayout;->getTabScrollRange()I
...
.method updateTabViews(Z)V
    ...
    .line 1228
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->requestLayout()V
