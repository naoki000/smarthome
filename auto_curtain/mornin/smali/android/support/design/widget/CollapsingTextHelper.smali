...
.method public constructor <init>(Landroid/view/View;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/graphics/RectF;-><init>()V
...
.method private areTypefacesDifferent(Landroid/graphics/Typeface;Landroid/graphics/Typeface;)Z
    ...
    .line 546
    invoke-virtual/range {p1 .. p2}, Landroid/graphics/Typeface;->equals(Ljava/lang/Object;)Z
...
.method private calculateBaseOffsets()V
    ...
    .line 400
    invoke-interface/range {v5 .. v5}, Ljava/lang/CharSequence;->length()I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/text/TextPaint;->descent()F

    move-result v5

    iget-object v9, p0, Landroid/support/design/widget/CollapsingTextHelper;->mTextPaint:Landroid/text/TextPaint;

    invoke-virtual/range {v9 .. v9}, Landroid/text/TextPaint;->ascent()F
    ...
    invoke-virtual/range {v9 .. v9}, Landroid/text/TextPaint;->descent()F
    ...
    invoke-virtual/range {v9 .. v9}, Landroid/graphics/Rect;->centerY()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/Rect;->centerX()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/text/TextPaint;->descent()F

    move-result v3

    iget-object v4, p0, Landroid/support/design/widget/CollapsingTextHelper;->mTextPaint:Landroid/text/TextPaint;

    invoke-virtual/range {v4 .. v4}, Landroid/text/TextPaint;->ascent()F
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/text/TextPaint;->descent()F
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/Rect;->centerY()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/graphics/Rect;->centerX()I
    ...
    .line 463
    :goto_4
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CollapsingTextHelper;->clearTexture()V
...
.method private calculateOffsets(F)V
    ...
    .line 349
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/CollapsingTextHelper;->interpolateBounds(F)V
    ...
    .line 362
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CollapsingTextHelper;->getCurrentExpandedTextColor()I

    move-result v1

    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CollapsingTextHelper;->getCurrentCollapsedTextColor()I
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewCompat;->postInvalidateOnAnimation(Landroid/view/View;)V
...
.method private calculateUsingTextSize(F)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/graphics/Rect;->width()I
...
.method private clearTexture()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Bitmap;->recycle()V
...
.method private ensureExpandedTexture()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Rect;->isEmpty()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/text/TextPaint;->ascent()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/text/TextPaint;->descent()F
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/text/TextPaint;->descent()F
...
.method private setInterpolatedTextSize(F)V
    ...
    .line 532
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/CollapsingTextHelper;->calculateUsingTextSize(F)V
    ...
    .line 539
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CollapsingTextHelper;->ensureExpandedTexture()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/text/TextPaint;->ascent()F
...
.method public recalculate()V
    ...
    .line 651
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CollapsingTextHelper;->calculateBaseOffsets()V

    .line 652
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CollapsingTextHelper;->calculateCurrentOffsets()V
...
.method setCollapsedBounds(IIII)V
    ...
    .line 170
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingTextHelper;->onBoundsChanged()V
...
.method setCollapsedTextAppearance(I)V
    ...
    .line 224
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/CollapsingTextHelper;->readFontFamilyTypeface(I)Landroid/graphics/Typeface;
    ...
    .line 227
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingTextHelper;->recalculate()V
...
.method final setState([I)Z
    ...
    .line 319
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CollapsingTextHelper;->isStateful()Z
