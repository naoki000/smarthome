...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/design/widget/CoordinatorLayout$ViewElevationComparator;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Ljava/lang/ThreadLocal;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/widget/DirectedAcyclicGraph;-><init>()V
    ...
    .line 226
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->setupForInsets()V
...
.method private static acquireTempRect()Landroid/graphics/Rect;
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v4/util/Pools$Pool;->acquire()Ljava/lang/Object;
...
.method private dispatchApplyWindowInsetsToBehaviors(Landroid/support/v4/view/WindowInsetsCompat;)Landroid/support/v4/view/WindowInsetsCompat;
    ...
    .line 831
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/view/WindowInsetsCompat;->isConsumed()Z
    ...
    .line 837
    invoke-static/range {v2 .. v2}, Landroid/support/v4/view/ViewCompat;->getFitsSystemWindows(Landroid/view/View;)Z
    ...
    .line 839
    invoke-virtual/range {v3 .. v3}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method private getDesiredAnchoredChildRectWithoutConstraints(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/support/design/widget/CoordinatorLayout$LayoutParams;II)V
    ...
    .line 969
    invoke-static/range {p1 .. p1}, Landroid/support/design/widget/CoordinatorLayout;->resolveAnchoredChildGravity(I)I
    ...
    .line 971
    invoke-static/range {p5 .. p5}, Landroid/support/design/widget/CoordinatorLayout;->resolveGravity(I)I
...
.method private layoutChild(Landroid/view/View;I)V
    ...
    .line 1179
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewCompat;->getFitsSystemWindows(Landroid/view/View;)Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/view/WindowInsetsCompat;->getSystemWindowInsetLeft()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/view/WindowInsetsCompat;->getSystemWindowInsetTop()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/view/WindowInsetsCompat;->getSystemWindowInsetRight()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/view/WindowInsetsCompat;->getSystemWindowInsetBottom()I
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/design/widget/CoordinatorLayout;->resolveGravity(I)I
    ...
    .line 1193
    invoke-static/range {v7 .. v7}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V

    .line 1194
    invoke-static/range {v8 .. v8}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V
...
.method private layoutChildWithAnchor(Landroid/view/View;Landroid/view/View;I)V
    ...
    .line 1091
    invoke-static/range {v0 .. v0}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V

    .line 1092
    invoke-static/range {v1 .. v1}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V
...
.method private layoutChildWithKeyline(Landroid/view/View;II)V
    ...
    .line 1110
    invoke-static/range {v1 .. v1}, Landroid/support/design/widget/CoordinatorLayout;->resolveKeylineGravity(I)I
...
.method private offsetChildByInset(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    .line 1379
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewCompat;->isLaidOut(Landroid/view/View;)Z
    ...
    .line 1390
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    .line 1399
    invoke-virtual/range {v2 .. v2}, Landroid/graphics/Rect;->toShortString()Ljava/lang/String;
    ...
    .line 1400
    invoke-virtual/range {v3 .. v3}, Landroid/graphics/Rect;->toShortString()Ljava/lang/String;
    ...
    .line 1407
    :goto_0
    invoke-static/range {v3 .. v3}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V

    .line 1409
    invoke-virtual/range {v2 .. v2}, Landroid/graphics/Rect;->isEmpty()Z
    ...
    .line 1411
    invoke-static/range {v2 .. v2}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V
...
.method private performIntercept(Landroid/view/MotionEvent;I)Z
    ...
    .line 446
    invoke-virtual/range {v10 .. v10}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 447
    invoke-virtual/range {v11 .. v11}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    .line 486
    :cond_3
    invoke-virtual/range {v11 .. v11}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->didBlockInteraction()Z
    ...
    :cond_6
    :goto_4
    invoke-interface/range {v3 .. v3}, Ljava/util/List;->clear()V
...
.method private prepareChildren()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/DirectedAcyclicGraph;->clear()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/widget/DirectedAcyclicGraph;->getSortedList()Ljava/util/ArrayList;
    ...
    invoke-static/range {v0 .. v0}, Ljava/util/Collections;->reverse(Ljava/util/List;)V
...
.method private static releaseTempRect(Landroid/graphics/Rect;)V
    ...
    .line 163
    invoke-virtual/range {p0 .. p0}, Landroid/graphics/Rect;->setEmpty()V
...
.method private resetTouchBehaviors(Z)V
    ...
    .line 388
    invoke-virtual/range {v4 .. v4}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    .line 398
    :goto_1
    invoke-virtual/range {v5 .. v5}, Landroid/view/MotionEvent;->recycle()V
    ...
    .line 405
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->resetTouchBehaviorTracking()V
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
...
.method public doViewsOverlap(Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 1695
    invoke-static/range {p1 .. p1}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-direct/range {v2 .. v2}, Landroid/graphics/Paint;-><init>()V
    ...
    .line 1241
    invoke-virtual/range {p2 .. p2}, Landroid/view/View;->isOpaque()Z
...
.method protected drawableStateChanged()V
    ...
    .line 305
    invoke-super/range {p0 .. p0}, Landroid/view/ViewGroup;->drawableStateChanged()V

    .line 307
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->getDrawableState()[I
    ...
    .line 311
    invoke-virtual/range {v1 .. v1}, Landroid/graphics/drawable/Drawable;->isStateful()Z
    ...
    .line 316
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->invalidate()V
...
.method ensurePreDrawListener()V
    ...
    .line 1560
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->addPreDrawListener()V

    goto :goto_2

    .line 1562
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->removePreDrawListener()V
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 112
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->generateDefaultLayoutParams()Landroid/support/design/widget/CoordinatorLayout$LayoutParams;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/design/widget/CoordinatorLayout$LayoutParams;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->getContext()Landroid/content/Context;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 112
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/widget/CoordinatorLayout;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/design/widget/CoordinatorLayout$LayoutParams;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 112
    invoke-virtual/range {p0 .. p1}, Landroid/support/design/widget/CoordinatorLayout;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/design/widget/CoordinatorLayout$LayoutParams;
...
.method getChildRect(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    :cond_2
    :goto_1
    invoke-virtual/range {p3 .. p3}, Landroid/graphics/Rect;->setEmpty()V
...
.method final getDependencySortedChildren()Ljava/util/List;
    ...
    invoke-static/range {v0 .. v0}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;
...
.method getDescendantRect(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 711
    invoke-static/range {p0 .. p2}, Landroid/support/v4/widget/ViewGroupUtils;->getDescendantRect(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method getLastChildRect(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 942
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getLastChildRect()Landroid/graphics/Rect;
...
.method public getNestedScrollAxes()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/NestedScrollingParentHelper;->getNestedScrollAxes()I
...
.method getResolvedLayoutParams(Landroid/view/View;)Landroid/support/design/widget/CoordinatorLayout$LayoutParams;
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/design/widget/CoordinatorLayout$AttachedBehavior;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    .line 654
    :try_start_0
    invoke-interface/range {v1 .. v1}, Landroid/support/design/widget/CoordinatorLayout$DefaultBehavior;->value()Ljava/lang/Class;
...
.method offsetChildToAnchor(Landroid/view/View;I)V
    ...
    .line 1645
    invoke-virtual/range {v10 .. v10}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    .line 1651
    :cond_4
    invoke-static/range {v11 .. v11}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V

    .line 1652
    invoke-static/range {v12 .. v12}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V

    .line 1653
    invoke-static/range {v13 .. v13}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V
...
.method public onAttachedToWindow()V
    ...
    .line 249
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ViewCompat;->requestApplyInsets(Landroid/view/View;)V
...
.method final onChildViewsChanged(I)V
    ...
    .line 1282
    invoke-virtual/range {v9 .. v9}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1283
    invoke-virtual/range {v9 .. v9}, Landroid/view/View;->getVisibility()I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/graphics/Rect;->isEmpty()Z
    ...
    .line 1339
    invoke-virtual/range {v13 .. v13}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1340
    invoke-virtual/range {v14 .. v14}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    .line 1343
    invoke-virtual/range {v14 .. v14}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getChangedAfterNestedScroll()Z
    ...
    .line 1346
    invoke-virtual/range {v14 .. v14}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->resetChangedAfterNestedScroll()V
    ...
    .line 1373
    :cond_f
    invoke-static/range {v4 .. v4}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V

    .line 1374
    invoke-static/range {v5 .. v5}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V

    .line 1375
    invoke-static/range {v6 .. v6}, Landroid/support/design/widget/CoordinatorLayout;->releaseTempRect(Landroid/graphics/Rect;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/WindowInsetsCompat;->getSystemWindowInsetTop()I
...
.method protected onLayout(ZIIII)V
    ...
    .line 892
    invoke-virtual/range {p5 .. p5}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method public onLayoutChild(Landroid/view/View;I)V
    ...
    .line 867
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->checkAnchorChanged()Z
    ...
    .line 876
    :cond_1
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/CoordinatorLayout;->layoutChild(Landroid/view/View;I)V
...
.method protected onMeasure(II)V
    ...
    .line 781
    invoke-static/range {v11 .. v11}, Landroid/support/design/widget/CoordinatorLayout;->resolveKeylineGravity(I)I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/WindowInsetsCompat;->getSystemWindowInsetLeft()I
    ...
    .line 800
    invoke-virtual/range {v11 .. v11}, Landroid/support/v4/view/WindowInsetsCompat;->getSystemWindowInsetBottom()I
    ...
    .line 808
    :goto_4
    invoke-virtual/range {v1 .. v1}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    .line 1900
    invoke-virtual/range {v6 .. v6}, Landroid/view/View;->getVisibility()I
    ...
    .line 1905
    :cond_0
    invoke-virtual/range {v6 .. v6}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
...
.method public onNestedPreScroll(Landroid/view/View;II[II)V
    ...
    .line 1861
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getVisibility()I
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;II)V
    ...
    .line 1769
    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1774
    :cond_0
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 3143
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/CoordinatorLayout$SavedState;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 3149
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getId()I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/util/SparseArray;-><init>()V
    ...
    .line 3169
    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->getId()I
    ...
    .line 3171
    invoke-virtual/range {v6 .. v6}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method public onStartNestedScroll(Landroid/view/View;Landroid/view/View;II)Z
    ...
    .line 1743
    invoke-virtual/range {v13 .. v13}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method public onStopNestedScroll(Landroid/view/View;I)V
    ...
    .line 1804
    invoke-virtual/range {v3 .. v3}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->resetChangedAfterNestedScroll()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 560
    invoke-virtual/range {v8 .. v8}, Landroid/view/MotionEvent;->recycle()V
...
.method public requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    .line 3195
    :cond_0
    invoke-super/range {p0 .. p3}, Landroid/view/ViewGroup;->requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
...
.method public setFitsSystemWindows(Z)V
    ...
    .line 914
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->setFitsSystemWindows(Z)V
...
.method public setStatusBarBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/drawable/Drawable;->isStateful()Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->getVisibility()I
...
.method public setVisibility(I)V
    ...
    .line 327
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->setVisibility(I)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/graphics/drawable/Drawable;->isVisible()Z
...
.method final setWindowInsets(Landroid/support/v4/view/WindowInsetsCompat;)Landroid/support/v4/view/WindowInsetsCompat;
    ...
    .line 359
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/view/WindowInsetsCompat;->getSystemWindowInsetTop()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 363
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/CoordinatorLayout;->dispatchApplyWindowInsetsToBehaviors(Landroid/support/v4/view/WindowInsetsCompat;)Landroid/support/v4/view/WindowInsetsCompat;

    move-result-object p1

    .line 364
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout;->requestLayout()V
...
.method protected verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 322
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
