...
.method public constructor <init>()V
    ...
    .line 595
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout$Behavior;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 600
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/CoordinatorLayout$Behavior;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private static isBottomSheet(Landroid/view/View;)Z
    ...
    .line 658
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
...
.method private offsetIfNeeded(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;)V
    ...
    .line 777
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/FloatingActionButton;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 781
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/FloatingActionButton;->getRight()I

    move-result v2

    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/CoordinatorLayout;->getWidth()I
    ...
    .line 784
    :cond_0
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/FloatingActionButton;->getLeft()I
    ...
    .line 788
    :goto_0
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/FloatingActionButton;->getBottom()I
    ...
    .line 791
    :cond_2
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/FloatingActionButton;->getTop()I
...
.method private shouldUpdateVisibility(Landroid/view/View;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 675
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->getAnchorId()I
    ...
    .line 682
    :cond_1
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/FloatingActionButton;->getUserSetVisibility()I
...
.method private updateFabVisibilityForAppBarLayout(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/AppBarLayout;->getMinimumHeightForVisibleOverlappingContent()I
...
.method private updateFabVisibilityForBottomSheet(Landroid/view/View;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 716
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/FloatingActionButton$Behavior;->shouldUpdateVisibility(Landroid/view/View;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/FloatingActionButton;->getHeight()I
...
.method public bridge synthetic getInsetDodgeRect(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;)Z
    ...
    invoke-virtual/range {p0 .. p3}, Landroid/support/design/widget/FloatingActionButton$Behavior;->getInsetDodgeRect(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;Landroid/graphics/Rect;)Z
...
.method public onDependentViewChanged(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;Landroid/view/View;)Z
    ...
    .line 648
    :cond_0
    invoke-static/range {p3 .. p3}, Landroid/support/design/widget/FloatingActionButton$Behavior;->isBottomSheet(Landroid/view/View;)Z
...
.method public bridge synthetic onDependentViewChanged(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual/range {p0 .. p3}, Landroid/support/design/widget/FloatingActionButton$Behavior;->onDependentViewChanged(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;Landroid/view/View;)Z
...
.method public onLayoutChild(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;I)Z
    ...
    .line 741
    :cond_0
    invoke-static/range {v3 .. v3}, Landroid/support/design/widget/FloatingActionButton$Behavior;->isBottomSheet(Landroid/view/View;)Z
    ...
    :cond_2
    :goto_1
    invoke-virtual/range {p1 .. p3}, Landroid/support/design/widget/CoordinatorLayout;->onLayoutChild(Landroid/view/View;I)V

    .line 750
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/FloatingActionButton$Behavior;->offsetIfNeeded(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;)V
...
.method public bridge synthetic onLayoutChild(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-virtual/range {p0 .. p3}, Landroid/support/design/widget/FloatingActionButton$Behavior;->onLayoutChild(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;I)Z
