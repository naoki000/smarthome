...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ShadowViewDelegate;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/support/design/widget/StateListAnimator;-><init>()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/VisibilityAwareImageButton;->getRotation()F
...
.method private shouldAnimateVisibilityChange()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->isInEditMode()Z
...
.method private updateFromViewRotation()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->getLayerType()I
...
.method createBorderDrawable(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/CircularBorderDrawable;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->getContext()Landroid/content/Context;

    move-result-object v0

    .line 347
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonImpl;->newCircularDrawable()Landroid/support/design/widget/CircularBorderDrawable;
...
.method createShapeDrawable()Landroid/graphics/drawable/GradientDrawable;
    ...
    .line 383
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonImpl;->newGradientDrawableForShape()Landroid/graphics/drawable/GradientDrawable;
...
.method hide(Landroid/support/design/widget/FloatingActionButtonImpl$InternalVisibilityChangedListener;Z)V
    ...
    .line 205
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonImpl;->isOrWillBeHidden()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->animate()Landroid/view/ViewPropertyAnimator;
    ...
    .line 212
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonImpl;->shouldAnimateVisibilityChange()Z
    ...
    .line 252
    invoke-interface/range {p1 .. p1}, Landroid/support/design/widget/FloatingActionButtonImpl$InternalVisibilityChangedListener;->onHidden()V
...
.method isOrWillBeHidden()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->getVisibility()I
...
.method jumpDrawableToCurrentState()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/StateListAnimator;->jumpToCurrentState()V
...
.method newCircularDrawable()Landroid/support/design/widget/CircularBorderDrawable;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/design/widget/CircularBorderDrawable;-><init>()V
...
.method newGradientDrawableForShape()Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/graphics/drawable/GradientDrawable;-><init>()V
...
.method onAttachedToWindow()V
    ...
    .line 328
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonImpl;->requirePreDrawListener()Z
    ...
    .line 329
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonImpl;->ensurePreDrawListener()V

    .line 330
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->mView:Landroid/support/design/widget/VisibilityAwareImageButton;

    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->getViewTreeObserver()Landroid/view/ViewTreeObserver;
...
.method onPreDraw()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->getRotation()F
    ...
    .line 366
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonImpl;->updateFromViewRotation()V
...
.method setBackgroundDrawable(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    .line 114
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonImpl;->createShapeDrawable()Landroid/graphics/drawable/GradientDrawable;
    ...
    .line 125
    invoke-static/range {p2 .. p2}, Landroid/support/v4/graphics/drawable/DrawableCompat;->wrap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static/range {p3 .. p3}, Landroid/support/design/widget/FloatingActionButtonImpl;->createColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    .line 140
    invoke-virtual/range {p2 .. p2}, Landroid/support/design/widget/VisibilityAwareImageButton;->getContext()Landroid/content/Context;
    ...
    .line 142
    invoke-interface/range {p2 .. p2}, Landroid/support/design/widget/ShadowViewDelegate;->getRadius()F
...
.method setRippleColor(I)V
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/design/widget/FloatingActionButtonImpl;->createColorStateList(I)Landroid/content/res/ColorStateList;
...
.method show(Landroid/support/design/widget/FloatingActionButtonImpl$InternalVisibilityChangedListener;Z)V
    ...
    .line 258
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonImpl;->isOrWillBeShown()Z
    ...
    .line 301
    invoke-interface/range {p1 .. p1}, Landroid/support/design/widget/FloatingActionButtonImpl$InternalVisibilityChangedListener;->onShown()V
