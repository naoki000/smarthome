...
.method public constructor <init>()V
    ...
    .line 80
    invoke-direct/range {p0 .. p0}, Landroid/support/constraint/solver/LinearSystem;->releaseRows()V

    .line 81
    new-instance v0, Landroid/support/constraint/solver/Cache;

    invoke-direct/range {v0 .. v0}, Landroid/support/constraint/solver/Cache;-><init>()V
...
.method private acquireSolverVariable(Landroid/support/constraint/solver/SolverVariable$Type;Ljava/lang/String;)Landroid/support/constraint/solver/SolverVariable;
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/constraint/solver/Pools$Pool;->acquire()Ljava/lang/Object;
    ...
    .line 310
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/support/constraint/solver/SolverVariable;->reset()V
...
.method public static createRowGreaterThan(Landroid/support/constraint/solver/LinearSystem;Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/SolverVariable;IZ)Landroid/support/constraint/solver/ArrayRow;
    ...
    .line 1235
    invoke-virtual/range {p0 .. p0}, Landroid/support/constraint/solver/LinearSystem;->createSlackVariable()Landroid/support/constraint/solver/SolverVariable;
...
.method private createVariable(Ljava/lang/String;Landroid/support/constraint/solver/SolverVariable$Type;)Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 267
    invoke-direct/range {p0 .. p0}, Landroid/support/constraint/solver/LinearSystem;->increaseTableSize()V
...
.method private displayRows()V
    ...
    .line 852
    invoke-direct/range {p0 .. p0}, Landroid/support/constraint/solver/LinearSystem;->displaySolverVariables()V
...
.method public addCenterPoint(Landroid/support/constraint/solver/widgets/ConstraintWidget;Landroid/support/constraint/solver/widgets/ConstraintWidget;FI)V
    ...
    .line 1333
    invoke-static/range {v13 .. v14}, Ljava/lang/Math;->sin(D)D
    ...
    .line 1337
    invoke-static/range {v13 .. v14}, Ljava/lang/Math;->cos(D)D
...
.method public addConstraint(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .line 480
    invoke-direct/range {p0 .. p1}, Landroid/support/constraint/solver/LinearSystem;->updateRowFromVariables(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .line 487
    :cond_4
    invoke-virtual/range {p1 .. p1}, Landroid/support/constraint/solver/ArrayRow;->ensurePositiveConstant()V
    ...
    .line 496
    invoke-virtual/range {p0 .. p0}, Landroid/support/constraint/solver/LinearSystem;->createExtraVariable()Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 498
    invoke-direct/range {p0 .. p1}, Landroid/support/constraint/solver/LinearSystem;->addRow(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .line 523
    :cond_9
    invoke-virtual/range {p1 .. p1}, Landroid/support/constraint/solver/ArrayRow;->hasKeyVariable()Z
...
.method public createObjectVariable(Ljava/lang/Object;)Landroid/support/constraint/solver/SolverVariable;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->getSolverVariable()Landroid/support/constraint/solver/SolverVariable;
...
.method public createRow()Landroid/support/constraint/solver/ArrayRow;
    ...
    .line 204
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/support/constraint/solver/ArrayRow;->reset()V
...
.method displayReadableRows()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/constraint/solver/ArrayRow;->toReadableString()Ljava/lang/String;
...
.method displaySystemInformations()V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/constraint/solver/ArrayRow;->sizeInBytes()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/constraint/solver/ArrayRow;->sizeInBytes()I
...
.method public getMemoryUsed()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/constraint/solver/ArrayRow;->sizeInBytes()I
...
.method getVariable(Ljava/lang/String;Landroid/support/constraint/solver/SolverVariable$Type;)Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 364
    invoke-direct/range {p0 .. p2}, Landroid/support/constraint/solver/LinearSystem;->createVariable(Ljava/lang/String;Landroid/support/constraint/solver/SolverVariable$Type;)Landroid/support/constraint/solver/SolverVariable;
...
.method public minimize()V
    ...
    .line 401
    :cond_5
    invoke-direct/range {p0 .. p0}, Landroid/support/constraint/solver/LinearSystem;->computeValues()V
...
.method minimizeGoal(Landroid/support/constraint/solver/LinearSystem$Row;)V
    ...
    .line 430
    invoke-direct/range {p0 .. p1}, Landroid/support/constraint/solver/LinearSystem;->enforceBFS(Landroid/support/constraint/solver/LinearSystem$Row;)I
...
.method public reset()V
    ...
    .line 145
    invoke-virtual/range {v2 .. v2}, Landroid/support/constraint/solver/SolverVariable;->reset()V
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/util/HashMap;->clear()V
    ...
    invoke-interface/range {v1 .. v1}, Landroid/support/constraint/solver/LinearSystem$Row;->clear()V
