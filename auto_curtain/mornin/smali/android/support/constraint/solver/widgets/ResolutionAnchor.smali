...
.method public constructor <init>(Landroid/support/constraint/solver/widgets/ConstraintAnchor;)V
    ...
    .line 50
    invoke-direct/range {p0 .. p0}, Landroid/support/constraint/solver/widgets/ResolutionNode;-><init>()V
...
.method addResolvedValue(Landroid/support/constraint/solver/LinearSystem;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->getSolverVariable()Landroid/support/constraint/solver/SolverVariable;
...
.method public remove(Landroid/support/constraint/solver/widgets/ResolutionDimension;)V
    ...
    :cond_1
    :goto_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve()V
...
.method public reset()V
    ...
    .line 226
    invoke-super/range {p0 .. p0}, Landroid/support/constraint/solver/widgets/ResolutionNode;->reset()V
...
.method public resolve()V
    ...
    .line 139
    :goto_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->didResolve()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getHeight()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->getWidth()I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->getTarget()Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    invoke-virtual/range {v6 .. v6}, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->getTarget()Landroid/support/constraint/solver/widgets/ConstraintAnchor;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->didResolve()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->resolve()V
...
.method public resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
    ...
    .line 82
    invoke-virtual/range {p0 .. p0}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->invalidate()V
