...
.method public static clearAnimationCallbacks(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/graphics/drawable/AnimatedVectorDrawable;->clearAnimationCallbacks()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat;->clearAnimationCallbacks()V
...
.method private static registerPlatformCallback(Landroid/graphics/drawable/AnimatedVectorDrawable;Landroid/support/graphics/drawable/Animatable2Compat$AnimationCallback;)V
    ...
    .line 806
    invoke-virtual/range {p1 .. p1}, Landroid/support/graphics/drawable/Animatable2Compat$AnimationCallback;->getPlatformCallback()Landroid/graphics/drawable/Animatable2$AnimationCallback;
...
.method private setupAnimatorsForTarget(Ljava/lang/String;Landroid/animation/Animator;)V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$AnimatedVectorDrawableCompatState;->access$000(Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$AnimatedVectorDrawableCompatState;)Ljava/util/ArrayList;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v4/util/ArrayMap;-><init>()V
...
.method private setupColorAnimator(Landroid/animation/Animator;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/AnimatorSet;->getChildAnimations()Ljava/util/ArrayList;
    ...
    .line 657
    invoke-virtual/range {p1 .. p1}, Landroid/animation/ObjectAnimator;->getPropertyName()Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/animation/ArgbEvaluator;-><init>()V
...
.method public clearAnimationCallbacks()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/AnimatedVectorDrawable;->clearAnimationCallbacks()V

    return-void

    .line 847
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat;->removeAnimatorSetListener()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/animation/AnimatorSet;->isStarted()Z
    ...
    .line 286
    invoke-virtual/range {p0 .. p0}, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat;->invalidateSelf()V
...
.method public getAlpha()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->getAlpha()I
...
.method public getIntrinsicHeight()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->getIntrinsicHeight()I
...
.method public getIntrinsicWidth()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->getIntrinsicWidth()I
...
.method public getOpacity()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->getOpacity()I
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/graphics/drawable/AnimatedVectorDrawableCompat$AnimatedVectorDrawableCompatState;->setupAnimatorSet()V
...
.method public isAutoMirrored()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->isAutoMirrored()Z
...
.method public isRunning()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/AnimatedVectorDrawable;->isRunning()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/AnimatorSet;->isRunning()Z
...
.method public isStateful()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->isStateful()Z
...
.method public start()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/AnimatedVectorDrawable;->start()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/AnimatorSet;->isStarted()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/AnimatorSet;->start()V
...
.method public stop()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/AnimatedVectorDrawable;->stop()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/AnimatorSet;->end()V
