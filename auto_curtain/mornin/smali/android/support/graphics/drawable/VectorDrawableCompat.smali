...
.method constructor <init>()V
    ...
    .line 243
    invoke-direct/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/graphics/drawable/VectorDrawableCompat$VectorDrawableCompatState;-><init>()V
...
.method public static create(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/graphics/drawable/VectorDrawableCompat;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/graphics/drawable/VectorDrawableCompat;-><init>()V

    .line 555
    invoke-static/range {p0 .. p2}, Landroid/support/v4/content/res/ResourcesCompat;->getDrawable(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method private inflateInternal(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-direct/range {v2 .. v2}, Ljava/util/ArrayDeque;-><init>()V
    ...
    .line 740
    invoke-virtual/range {v2 .. v2}, Ljava/util/ArrayDeque;->peek()Ljava/lang/Object;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/support/graphics/drawable/VectorDrawableCompat$VFullPath;-><init>()V
    ...
    .line 745
    invoke-virtual/range {v3 .. v3}, Landroid/support/graphics/drawable/VectorDrawableCompat$VFullPath;->getPathName()Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/support/graphics/drawable/VectorDrawableCompat$VClipPath;-><init>()V
    ...
    .line 754
    invoke-virtual/range {v3 .. v3}, Landroid/support/graphics/drawable/VectorDrawableCompat$VClipPath;->getPathName()Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/support/graphics/drawable/VectorDrawableCompat$VGroup;-><init>()V
    ...
    .line 763
    invoke-virtual/range {v3 .. v3}, Landroid/support/graphics/drawable/VectorDrawableCompat$VGroup;->getGroupName()Ljava/lang/String;
    ...
    .line 772
    invoke-virtual/range {v2 .. v2}, Ljava/util/ArrayDeque;->pop()Ljava/lang/Object;
...
.method private needMirroring()Z
    ...
    .line 815
    invoke-virtual/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->isAutoMirrored()Z
...
.method private printGroupTree(Landroid/support/graphics/drawable/VectorDrawableCompat$VGroup;I)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/graphics/drawable/VectorDrawableCompat$VGroup;->getGroupName()Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/graphics/drawable/VectorDrawableCompat$VGroup;->getLocalMatrix()Landroid/graphics/Matrix;

    move-result-object v2

    invoke-virtual/range {v2 .. v2}, Landroid/graphics/Matrix;->toString()Ljava/lang/String;
...
.method private updateStateFromTypedArray(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 711
    invoke-virtual/range {v1 .. v1}, Landroid/support/graphics/drawable/VectorDrawableCompat$VPathRenderer;->getAlpha()F
...
.method public bridge synthetic applyTheme(Landroid/content/res/Resources$Theme;)V
    ...
    .line 199
    invoke-super/range {p0 .. p1}, Landroid/support/graphics/drawable/VectorDrawableCommon;->applyTheme(Landroid/content/res/Resources$Theme;)V
...
.method public canApplyTheme()Z
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/graphics/drawable/DrawableCompat;->canApplyTheme(Landroid/graphics/drawable/Drawable;)Z
...
.method public bridge synthetic clearColorFilter()V
    ...
    .line 199
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->clearColorFilter()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static/range {v3 .. v3}, Ljava/lang/Math;->abs(F)F
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/Rect;->width()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/Rect;->height()I
    ...
    .line 328
    invoke-direct/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->needMirroring()Z
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/graphics/Rect;->width()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/graphics/drawable/VectorDrawableCompat$VectorDrawableCompatState;->canReuseCache()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/graphics/drawable/VectorDrawableCompat$VectorDrawableCompatState;->updateCacheStates()V
...
.method public getAlpha()I
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/graphics/drawable/DrawableCompat;->getAlpha(Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/graphics/drawable/VectorDrawableCompat$VPathRenderer;->getRootAlpha()I
...
.method public getChangingConfigurations()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable;->getChangingConfigurations()I
    ...
    .line 835
    :cond_0
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->getChangingConfigurations()I

    move-result v0

    iget-object v1, p0, Landroid/support/graphics/drawable/VectorDrawableCompat;->mVectorState:Landroid/support/graphics/drawable/VectorDrawableCompat$VectorDrawableCompatState;

    invoke-virtual/range {v1 .. v1}, Landroid/support/graphics/drawable/VectorDrawableCompat$VectorDrawableCompatState;->getChangingConfigurations()I
...
.method public bridge synthetic getColorFilter()Landroid/graphics/ColorFilter;
    ...
    .line 199
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->getColorFilter()Landroid/graphics/ColorFilter;
...
.method public getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->getChangingConfigurations()I
...
.method public bridge synthetic getCurrent()Landroid/graphics/drawable/Drawable;
    ...
    .line 199
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->getCurrent()Landroid/graphics/drawable/Drawable;
...
.method public getIntrinsicHeight()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I
...
.method public getIntrinsicWidth()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable;->getIntrinsicWidth()I
...
.method public bridge synthetic getMinimumHeight()I
    ...
    .line 199
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->getMinimumHeight()I
...
.method public bridge synthetic getMinimumWidth()I
    ...
    .line 199
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->getMinimumWidth()I
...
.method public getOpacity()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable;->getOpacity()I
...
.method public bridge synthetic getPadding(Landroid/graphics/Rect;)Z
    ...
    .line 199
    invoke-super/range {p0 .. p1}, Landroid/support/graphics/drawable/VectorDrawableCommon;->getPadding(Landroid/graphics/Rect;)Z
...
.method public bridge synthetic getState()[I
    ...
    .line 199
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->getState()[I
...
.method public bridge synthetic getTransparentRegion()Landroid/graphics/Region;
    ...
    .line 199
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->getTransparentRegion()Landroid/graphics/Region;
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/graphics/drawable/VectorDrawableCompat$VPathRenderer;-><init>()V
    ...
    .line 631
    invoke-direct/range {p0 .. p4}, Landroid/support/graphics/drawable/VectorDrawableCompat;->inflateInternal(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
...
.method public invalidateSelf()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable;->invalidateSelf()V

    return-void

    .line 844
    :cond_0
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->invalidateSelf()V
...
.method public isAutoMirrored()Z
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/graphics/drawable/DrawableCompat;->isAutoMirrored(Landroid/graphics/drawable/Drawable;)Z
...
.method public isStateful()Z
    ...
    .line 446
    :cond_0
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->isStateful()Z
    ...
    .line 447
    invoke-virtual/range {v0 .. v0}, Landroid/content/res/ColorStateList;->isStateful()Z
...
.method public bridge synthetic jumpToCurrentState()V
    ...
    .line 199
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->jumpToCurrentState()V
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    invoke-super/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCommon;->mutate()Landroid/graphics/drawable/Drawable;
...
.method protected onStateChange([I)Z
    ...
    .line 459
    invoke-virtual/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->invalidateSelf()V
...
.method public scheduleSelf(Ljava/lang/Runnable;J)V
    ...
    .line 853
    :cond_0
    invoke-super/range {p0 .. p3}, Landroid/support/graphics/drawable/VectorDrawableCommon;->scheduleSelf(Ljava/lang/Runnable;J)V
...
.method public bridge synthetic setChangingConfigurations(I)V
    ...
    .line 199
    invoke-super/range {p0 .. p1}, Landroid/support/graphics/drawable/VectorDrawableCommon;->setChangingConfigurations(I)V
...
.method public bridge synthetic setColorFilter(ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 199
    invoke-super/range {p0 .. p2}, Landroid/support/graphics/drawable/VectorDrawableCommon;->setColorFilter(ILandroid/graphics/PorterDuff$Mode;)V
...
.method public bridge synthetic setFilterBitmap(Z)V
    ...
    .line 199
    invoke-super/range {p0 .. p1}, Landroid/support/graphics/drawable/VectorDrawableCommon;->setFilterBitmap(Z)V
...
.method public bridge synthetic setHotspot(FF)V
    ...
    .line 199
    invoke-super/range {p0 .. p2}, Landroid/support/graphics/drawable/VectorDrawableCommon;->setHotspot(FF)V
...
.method public bridge synthetic setHotspotBounds(IIII)V
    ...
    .line 199
    invoke-super/range {p0 .. p4}, Landroid/support/graphics/drawable/VectorDrawableCommon;->setHotspotBounds(IIII)V
...
.method public bridge synthetic setState([I)Z
    ...
    .line 199
    invoke-super/range {p0 .. p1}, Landroid/support/graphics/drawable/VectorDrawableCommon;->setState([I)Z
...
.method public setVisible(ZZ)Z
    ...
    .line 861
    :cond_0
    invoke-super/range {p0 .. p2}, Landroid/support/graphics/drawable/VectorDrawableCommon;->setVisible(ZZ)Z
...
.method public unscheduleSelf(Ljava/lang/Runnable;)V
    ...
    .line 870
    :cond_0
    invoke-super/range {p0 .. p1}, Landroid/support/graphics/drawable/VectorDrawableCommon;->unscheduleSelf(Ljava/lang/Runnable;)V
...
.method updateTintFilter(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 396
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->getState()[I
