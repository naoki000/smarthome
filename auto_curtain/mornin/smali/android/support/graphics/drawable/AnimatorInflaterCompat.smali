...
.method private static createAnimatorFromXml(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/animation/AnimatorSet;IF)Landroid/animation/Animator;
    ...
    invoke-direct/range {v15 .. v15}, Landroid/animation/AnimatorSet;-><init>()V
    ...
    invoke-direct/range {v13 .. v13}, Ljava/util/ArrayList;-><init>()V
    ...
    .line 561
    invoke-virtual/range {v13 .. v13}, Ljava/util/ArrayList;->iterator()Ljava/util/Iterator;
...
.method private static createNewKeyframe(Landroid/animation/Keyframe;F)Landroid/animation/Keyframe;
    ...
    .line 778
    invoke-virtual/range {p0 .. p0}, Landroid/animation/Keyframe;->getType()Ljava/lang/Class;
    ...
    .line 779
    invoke-static/range {p1 .. p1}, Landroid/animation/Keyframe;->ofFloat(F)Landroid/animation/Keyframe;
    ...
    .line 781
    invoke-static/range {p1 .. p1}, Landroid/animation/Keyframe;->ofInt(F)Landroid/animation/Keyframe;
    ...
    .line 782
    :cond_1
    invoke-static/range {p1 .. p1}, Landroid/animation/Keyframe;->ofObject(F)Landroid/animation/Keyframe;
...
.method private static distributeKeyframes([Landroid/animation/Keyframe;FII)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/animation/Keyframe;->getFraction()F
...
.method private static dumpKeyframes([Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static/range {v4 .. v4}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;
    ...
    .line 681
    invoke-virtual/range {v1 .. v1}, Landroid/animation/Keyframe;->hasValue()Z

    move-result v4

    if-eqz v4, :cond_2

    invoke-virtual/range {v1 .. v1}, Landroid/animation/Keyframe;->getValue()Ljava/lang/Object;
...
.method private static getPVH(Landroid/content/res/TypedArray;IIILjava/lang/String;)Landroid/animation/PropertyValuesHolder;
    ...
    .line 215
    invoke-static/range {v0 .. v0}, Landroid/support/graphics/drawable/AnimatorInflaterCompat;->isColorType(I)Z
    ...
    invoke-static/range {v4 .. v4}, Landroid/support/graphics/drawable/AnimatorInflaterCompat;->isColorType(I)Z
    ...
    .line 231
    invoke-static/range {p1 .. p1}, Landroid/support/v4/graphics/PathParser;->createNodesFromPathData(Ljava/lang/String;)[Landroid/support/v4/graphics/PathParser$PathDataNode;

    move-result-object p2

    .line 233
    invoke-static/range {p0 .. p0}, Landroid/support/v4/graphics/PathParser;->createNodesFromPathData(Ljava/lang/String;)[Landroid/support/v4/graphics/PathParser$PathDataNode;
...
.method private static inferValueTypeFromValues(Landroid/content/res/TypedArray;II)I
    ...
    .line 654
    invoke-virtual/range {p0 .. p1}, Landroid/content/res/TypedArray;->peekValue(I)Landroid/util/TypedValue;
    ...
    .line 663
    invoke-static/range {p1 .. p1}, Landroid/support/graphics/drawable/AnimatorInflaterCompat;->isColorType(I)Z
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/graphics/drawable/AnimatorInflaterCompat;->isColorType(I)Z
...
.method public static loadAnimator(Landroid/content/Context;I)Landroid/animation/Animator;
    ...
    .line 100
    invoke-static/range {p0 .. p1}, Landroid/animation/AnimatorInflater;->loadAnimator(Landroid/content/Context;I)Landroid/animation/Animator;
...
.method public static loadAnimator(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;IF)Landroid/animation/Animator;
    ...
    .line 146
    invoke-interface/range {v1 .. v1}, Landroid/content/res/XmlResourceParser;->close()V
    ...
    .line 146
    invoke-interface/range {v0 .. v0}, Landroid/content/res/XmlResourceParser;->close()V
...
.method private static loadAnimator(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Landroid/animation/ValueAnimator;FLorg/xmlpull/v1/XmlPullParser;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct/range {p4 .. p4}, Landroid/animation/ValueAnimator;-><init>()V
...
.method private static loadKeyframe(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;ILorg/xmlpull/v1/XmlPullParser;)Landroid/animation/Keyframe;
    ...
    invoke-static/range {p4 .. p4}, Landroid/support/graphics/drawable/AnimatorInflaterCompat;->isColorType(I)Z
    ...
    .line 853
    invoke-static/range {p2 .. p2}, Landroid/animation/Keyframe;->ofFloat(F)Landroid/animation/Keyframe;
    ...
    .line 854
    :cond_5
    invoke-static/range {p2 .. p2}, Landroid/animation/Keyframe;->ofInt(F)Landroid/animation/Keyframe;
...
.method private static loadObjectAnimator(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;FLorg/xmlpull/v1/XmlPullParser;)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct/range {v7 .. v7}, Landroid/animation/ObjectAnimator;-><init>()V
...
.method private static loadPvh(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Landroid/animation/PropertyValuesHolder;
    ...
    .line 724
    invoke-virtual/range {p3 .. p3}, Landroid/animation/Keyframe;->getFraction()F
    ...
    :cond_6
    :goto_1
    invoke-virtual/range {p2 .. p2}, Landroid/animation/Keyframe;->getFraction()F
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/animation/Keyframe;->getFraction()F
    ...
    .line 763
    invoke-virtual/range {p5 .. p5}, Landroid/animation/Keyframe;->getFraction()F
...
.method private static loadValues(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)[Landroid/animation/PropertyValuesHolder;
    ...
    .line 612
    :cond_3
    invoke-virtual/range {v14 .. v14}, Landroid/content/res/TypedArray;->recycle()V
...
.method private static setupObjectAnimator(Landroid/animation/ValueAnimator;Landroid/content/res/TypedArray;IFLorg/xmlpull/v1/XmlPullParser;)V
    ...
    :cond_2
    :goto_0
    invoke-static/range {v0 .. v0}, Landroid/support/v4/graphics/PathParser;->createPathFromPathData(Ljava/lang/String;)Landroid/graphics/Path;
...
.method private static setupPathMotion(Landroid/graphics/Path;Landroid/animation/ObjectAnimator;FLjava/lang/String;Ljava/lang/String;)V
    ...
    .line 442
    :cond_0
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/PathMeasure;->getLength()F
    ...
    .line 446
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/PathMeasure;->nextContour()Z
    ...
    invoke-virtual/range {v5 .. v5}, Ljava/lang/Float;->floatValue()F
