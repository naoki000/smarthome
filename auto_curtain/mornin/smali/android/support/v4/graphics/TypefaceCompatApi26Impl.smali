...
.method static constructor <clinit>()V
    ...
    .line 94
    invoke-virtual/range {v11 .. v11}, Ljava/lang/Object;->getClass()Ljava/lang/Class;
...
.method public constructor <init>()V
    ...
    .line 53
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/graphics/TypefaceCompatApi21Impl;-><init>()V
...
.method public createFromFontFamilyFilesResourceEntry(Landroid/content/Context;Landroid/support/v4/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 217
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;->getFileName()Ljava/lang/String;
    ...
    .line 218
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;->getWeight()I

    move-result v4

    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;->isItalic()Z
    ...
    .line 219
    invoke-static/range {p3 .. p3}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->abortCreation(Ljava/lang/Object;)V
    ...
    .line 223
    :cond_2
    invoke-static/range {p3 .. p3}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->freeze(Ljava/lang/Object;)Z
    ...
    .line 226
    :cond_3
    invoke-static/range {p3 .. p3}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->createFromFamiliesWithDefault(Ljava/lang/Object;)Landroid/graphics/Typeface;
...
.method public createFromFontInfo(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
    ...
    .line 242
    :try_start_0
    invoke-virtual/range {p3 .. p3}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getUri()Landroid/net/Uri;
    ...
    .line 247
    invoke-virtual/range {p3 .. p3}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getWeight()I
    ...
    .line 248
    invoke-virtual/range {p3 .. p3}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->isItalic()Z
    ...
    .line 249
    invoke-virtual/range {p2 .. p2}, Landroid/graphics/Typeface$Builder;->build()Landroid/graphics/Typeface;
    ...
    .line 259
    invoke-virtual/range {v5 .. v5}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getUri()Landroid/net/Uri;
    ...
    .line 264
    :cond_7
    invoke-virtual/range {v5 .. v5}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getTtcIndex()I

    move-result v4

    invoke-virtual/range {v5 .. v5}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getWeight()I

    move-result v7

    invoke-virtual/range {v5 .. v5}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->isItalic()Z
    ...
    .line 266
    invoke-static/range {p2 .. p2}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->abortCreation(Ljava/lang/Object;)V
    ...
    .line 275
    :cond_a
    invoke-static/range {p2 .. p2}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->freeze(Ljava/lang/Object;)Z
    ...
    .line 278
    :cond_b
    invoke-static/range {p2 .. p2}, Landroid/support/v4/graphics/TypefaceCompatApi26Impl;->createFromFamiliesWithDefault(Ljava/lang/Object;)Landroid/graphics/Typeface;
