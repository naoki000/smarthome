...
.method constructor <init>()V
    ...
    .line 50
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/graphics/TypefaceCompatBaseImpl;-><init>()V
...
.method public createFromFontFamilyFilesResourceEntry(Landroid/content/Context;Landroid/support/v4/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    .line 158
    invoke-virtual/range {v3 .. v3}, Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;->getResourceId()I
    ...
    .line 163
    :cond_0
    invoke-virtual/range {v3 .. v3}, Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;->getWeight()I

    move-result v6

    invoke-virtual/range {v3 .. v3}, Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;->isItalic()Z
    ...
    .line 167
    :cond_2
    invoke-static/range {p4 .. p4}, Landroid/support/v4/graphics/TypefaceCompatApi24Impl;->createFromFamiliesWithDefault(Ljava/lang/Object;)Landroid/graphics/Typeface;
...
.method public createFromFontInfo(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v4/util/SimpleArrayMap;-><init>()V
    ...
    .line 137
    invoke-virtual/range {v4 .. v4}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getUri()Landroid/net/Uri;
    ...
    .line 143
    :cond_0
    invoke-virtual/range {v4 .. v4}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getTtcIndex()I

    move-result v5

    invoke-virtual/range {v4 .. v4}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getWeight()I

    move-result v7

    .line 144
    invoke-virtual/range {v4 .. v4}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->isItalic()Z
    ...
    .line 148
    :cond_2
    invoke-static/range {v0 .. v0}, Landroid/support/v4/graphics/TypefaceCompatApi24Impl;->createFromFamiliesWithDefault(Ljava/lang/Object;)Landroid/graphics/Typeface;
