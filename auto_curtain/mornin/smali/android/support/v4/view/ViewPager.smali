...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/view/ViewPager$1;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/view/ViewPager$2;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/view/ViewPager$ViewPositionComparator;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/support/v4/view/ViewPager$ItemInfo;-><init>()V
    ...
    .line 386
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->initViewPager()V
...
.method private calculatePageOffsets(Landroid/support/v4/view/ViewPager$ItemInfo;ILandroid/support/v4/view/ViewPager$ItemInfo;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/PagerAdapter;->getCount()I
...
.method private completeScroll(Z)V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/widget/Scroller;->isFinished()Z
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/widget/Scroller;->abortAnimation()V
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/widget/Scroller;->getCurrX()I
    ...
    invoke-virtual/range {v6 .. v6}, Landroid/widget/Scroller;->getCurrY()I
...
.method private endDrag()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/view/VelocityTracker;->recycle()V
...
.method private infoForCurrentScrollPosition()Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    invoke-virtual/range {v10 .. v10}, Ljava/util/ArrayList;->size()I
...
.method private performDrag(F)Z
    ...
    invoke-virtual/range {v8 .. v8}, Landroid/support/v4/view/PagerAdapter;->getCount()I
...
.method private recomputeScrollPosition(IIII)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/Scroller;->isFinished()Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->getCurrentItem()I
...
.method private scrollToItem(IZIZ)V
    ...
    .line 670
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/view/ViewPager;->infoForPosition(I)Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    .line 680
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/view/ViewPager;->dispatchOnPageSelected(I)V
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 2901
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->getDescendantFocusability()I
    ...
    .line 2923
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->isFocusable()Z
    ...
    .line 2927
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->isInTouchMode()Z

    move-result p2

    if-eqz p2, :cond_4

    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->isFocusableInTouchMode()Z
...
.method addNewItem(II)Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/view/ViewPager$ItemInfo;-><init>()V
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    .line 2946
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getVisibility()I
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewPager;->isDecorView(Landroid/view/View;)Z
...
.method public arrowScroll(I)Z
    ...
    .line 2793
    :cond_1
    invoke-interface/range {v4 .. v4}, Landroid/view/ViewParent;->getParent()Landroid/view/ViewParent;
    ...
    invoke-virtual/range {v5 .. v5}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;
    ...
    .line 2804
    invoke-interface/range {v0 .. v0}, Landroid/view/ViewParent;->getParent()Landroid/view/ViewParent;
    ...
    .line 2824
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->pageLeft()Z
    ...
    .line 2834
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->pageRight()Z
...
.method public beginFakeDrag()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/VelocityTracker;->clear()V
    ...
    .line 2536
    invoke-virtual/range {v1 .. v1}, Landroid/view/MotionEvent;->recycle()V
...
.method protected canScroll(Landroid/view/View;ZIII)Z
    ...
    .line 2717
    invoke-virtual/range {v1 .. v1}, Landroid/view/ViewGroup;->getChildCount()I
    ...
    .line 2723
    invoke-virtual/range {v7 .. v7}, Landroid/view/View;->getLeft()I

    move-result v8

    if-lt v6, v8, :cond_0

    invoke-virtual/range {v7 .. v7}, Landroid/view/View;->getRight()I
    ...
    .line 2724
    invoke-virtual/range {v7 .. v7}, Landroid/view/View;->getTop()I

    move-result v9

    if-lt v8, v9, :cond_0

    invoke-virtual/range {v7 .. v7}, Landroid/view/View;->getBottom()I
...
.method public computeScroll()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/Scroller;->isFinished()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/Scroller;->computeScrollOffset()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/widget/Scroller;->getCurrX()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/widget/Scroller;->getCurrY()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/Scroller;->abortAnimation()V
...
.method dataSetChanged()V
    ...
    invoke-virtual/range {v7 .. v7}, Ljava/util/ArrayList;->size()I
    ...
    .line 1081
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->requestLayout()V
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/view/ViewPager;->executeKeyEvent(Landroid/view/KeyEvent;)Z
...
.method public dispatchPopulateAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    .line 2992
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->dispatchPopulateAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 2423
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->getOverScrollMode()I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/EdgeEffect;->finish()V
    ...
    .line 2429
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->getHeight()I
...
.method protected drawableStateChanged()V
    ...
    .line 911
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable;->isStateful()Z
    ...
    .line 912
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->getDrawableState()[I
...
.method public executeKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 2768
    :cond_2
    invoke-virtual/range {p1 .. p1}, Landroid/view/KeyEvent;->hasNoModifiers()Z
...
.method public fakeDragBy(F)V
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v4/view/PagerAdapter;->getCount()I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/view/ViewPager$LayoutParams;-><init>()V
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->getContext()Landroid/content/Context;
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 3018
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
...
.method initViewPager()V
    ...
    .line 400
    invoke-static/range {v1 .. v1}, Landroid/view/ViewConfiguration;->get(Landroid/content/Context;)Landroid/view/ViewConfiguration;
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/content/res/Resources;->getDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    .line 403
    invoke-virtual/range {v2 .. v2}, Landroid/view/ViewConfiguration;->getScaledPagingTouchSlop()I
    ...
    .line 405
    invoke-virtual/range {v2 .. v2}, Landroid/view/ViewConfiguration;->getScaledMaximumFlingVelocity()I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual/range {v8 .. v8}, Ljava/util/ArrayList;->size()I
    ...
    invoke-static/range {v7 .. v7}, Ljava/lang/Math;->round(F)I
    ...
    .line 2493
    invoke-static/range {v15 .. v15}, Ljava/lang/Math;->round(F)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2068
    invoke-static/range {v1 .. v1}, Ljava/lang/Math;->abs(F)F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/Scroller;->computeScrollOffset()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/Scroller;->getCurrX()I
...
.method protected onLayout(ZIIII)V
    ...
    .line 1691
    invoke-virtual/range {v13 .. v13}, Landroid/view/View;->getVisibility()I
    ...
    .line 1711
    invoke-virtual/range {v13 .. v13}, Landroid/view/View;->getMeasuredWidth()I
    ...
    .line 1728
    invoke-virtual/range {v13 .. v13}, Landroid/view/View;->getMeasuredHeight()I
    ...
    .line 1770
    :cond_8
    invoke-virtual/range {v6 .. v6}, Landroid/view/View;->getMeasuredWidth()I
    ...
    .line 1771
    invoke-virtual/range {v6 .. v6}, Landroid/view/View;->getMeasuredHeight()I
...
.method protected onMeasure(II)V
    ...
    .line 1603
    invoke-virtual/range {v9 .. v9}, Landroid/view/View;->getMeasuredHeight()I
    ...
    .line 1605
    invoke-virtual/range {v9 .. v9}, Landroid/view/View;->getMeasuredWidth()I
    ...
    .line 1623
    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->getVisibility()I
...
.method protected onPageScrolled(IFI)V
    ...
    .line 1878
    :cond_2
    invoke-virtual/range {v8 .. v8}, Landroid/view/View;->getWidth()I
    ...
    .line 1891
    invoke-virtual/range {v8 .. v8}, Landroid/view/View;->getLeft()I
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    .line 2976
    invoke-virtual/range {v5 .. v5}, Landroid/view/View;->getVisibility()I
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1452
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/view/ViewPager$SavedState;->getSuperState()Landroid/os/Parcelable;
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/PagerAdapter;->saveState()Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static/range {v4 .. v4}, Ljava/lang/Math;->abs(F)F
    ...
    invoke-static/range {v5 .. v5}, Ljava/lang/Math;->abs(F)F
...
.method pageRight()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/view/PagerAdapter;->getCount()I
...
.method populate(I)V
    ...
    invoke-virtual/range {v6 .. v6}, Landroid/support/v4/view/PagerAdapter;->getCount()I
...
.method public removeView(Landroid/view/View;)V
    ...
    .line 1499
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/view/ViewPager;->removeViewInLayout(Landroid/view/View;)V
...
.method public setAdapter(Landroid/support/v4/view/PagerAdapter;)V
    ...
    .line 509
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->removeNonDecorViews()V
...
.method setCurrentItemInternal(IZZI)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/view/PagerAdapter;->getCount()I
...
.method public setPageMarginDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 888
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/view/ViewPager;->refreshDrawableState()V
...
.method setScrollState(I)V
    ...
    .line 491
    :cond_2
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/view/ViewPager;->dispatchOnScrollStateChanged(I)V
...
.method smoothScrollTo(III)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/Scroller;->getCurrX()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/Scroller;->getStartX()I
