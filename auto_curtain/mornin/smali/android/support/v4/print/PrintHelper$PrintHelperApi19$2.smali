...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19$2;->doInBackground([Ljava/lang/Void;)Ljava/lang/Throwable;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    .line 475
    invoke-virtual/range {v3 .. v3}, Landroid/print/PrintAttributes;->getColorMode()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/os/CancellationSignal;->isCanceled()Z
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/graphics/pdf/PdfDocument$Page;->getInfo()Landroid/graphics/pdf/PdfDocument$PageInfo;

    move-result-object v4

    invoke-virtual/range {v4 .. v4}, Landroid/graphics/pdf/PdfDocument$PageInfo;->getContentRect()Landroid/graphics/Rect;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/graphics/pdf/PdfDocument$Page;->getInfo()Landroid/graphics/pdf/PdfDocument$PageInfo;

    move-result-object v6

    invoke-virtual/range {v6 .. v6}, Landroid/graphics/pdf/PdfDocument$PageInfo;->getContentRect()Landroid/graphics/Rect;
    ...
    .line 495
    invoke-virtual/range {v4 .. v4}, Landroid/print/pdf/PrintedPdfDocument;->close()V
    ...
    .line 510
    invoke-virtual/range {v3 .. v3}, Landroid/graphics/pdf/PdfDocument$Page;->getCanvas()Landroid/graphics/Canvas;
    ...
    .line 528
    :try_start_2
    invoke-virtual/range {p1 .. p1}, Landroid/print/pdf/PrintedPdfDocument;->close()V
    ...
    .line 539
    invoke-virtual/range {v1 .. v1}, Landroid/graphics/Bitmap;->recycle()V
    :try_end_4
    ...
    .line 525
    invoke-virtual/range {v3 .. v3}, Landroid/os/ParcelFileDescriptor;->getFileDescriptor()Ljava/io/FileDescriptor;
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19$2;->onPostExecute(Ljava/lang/Throwable;)V
...
.method protected onPostExecute(Ljava/lang/Throwable;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/os/CancellationSignal;->isCanceled()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/print/PrintDocumentAdapter$WriteResultCallback;->onWriteCancelled()V
