...
.method static synthetic access$100(Landroid/support/v4/print/PrintHelper$PrintHelperApi19;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    .line 199
    invoke-direct/range {p0 .. p2}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19;->convertBitmapForColorMode(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method static synthetic access$200(Landroid/support/v4/print/PrintHelper$PrintHelperApi19;IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    .line 199
    invoke-direct/range {p0 .. p4}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19;->getMatrix(IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;
...
.method static synthetic access$400(Landroid/support/v4/print/PrintHelper$PrintHelperApi19;Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    .line 199
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19;->loadConstrainedBitmap(Landroid/net/Uri;)Landroid/graphics/Bitmap;
...
.method static synthetic access$600(Landroid/graphics/Bitmap;)Z
    ...
    .line 199
    invoke-static/range {p0 .. p0}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19;->isPortrait(Landroid/graphics/Bitmap;)Z
...
.method private convertBitmapForColorMode(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-direct/range {v2 .. v2}, Landroid/graphics/ColorMatrix;-><init>()V
...
.method private loadConstrainedBitmap(Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    invoke-direct/range {v2 .. v2}, Landroid/graphics/BitmapFactory$Options;-><init>()V
...
.method private writeBitmap(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    .line 459
    :cond_0
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19;->copyAttributes(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$Builder;
...
.method protected copyAttributes(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$Builder;
    ...
    .line 329
    invoke-virtual/range {p1 .. p1}, Landroid/print/PrintAttributes;->getMediaSize()Landroid/print/PrintAttributes$MediaSize;
    ...
    .line 330
    invoke-virtual/range {p1 .. p1}, Landroid/print/PrintAttributes;->getResolution()Landroid/print/PrintAttributes$Resolution;
    ...
    .line 331
    invoke-virtual/range {p1 .. p1}, Landroid/print/PrintAttributes;->getMinMargins()Landroid/print/PrintAttributes$Margins;
    ...
    .line 333
    invoke-virtual/range {p1 .. p1}, Landroid/print/PrintAttributes;->getColorMode()I
...
.method public printBitmap(Ljava/lang/String;Landroid/graphics/Bitmap;Landroid/support/v4/print/PrintHelper$OnPrintFinishCallback;)V
    ...
    .line 358
    invoke-static/range {p2 .. p2}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19;->isPortrait(Landroid/graphics/Bitmap;)Z
    ...
    invoke-direct/range {v1 .. v1}, Landroid/print/PrintAttributes$Builder;-><init>()V
...
.method public printBitmap(Ljava/lang/String;Landroid/net/Uri;Landroid/support/v4/print/PrintHelper$OnPrintFinishCallback;)V
    ...
    invoke-direct/range {p3 .. p3}, Landroid/print/PrintAttributes$Builder;-><init>()V
    ...
    :cond_2
    :goto_1
    invoke-virtual/range {p3 .. p3}, Landroid/print/PrintAttributes$Builder;->build()Landroid/print/PrintAttributes;
