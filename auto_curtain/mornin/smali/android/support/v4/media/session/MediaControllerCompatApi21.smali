...
.method public static getExtras(Ljava/lang/Object;)Landroid/os/Bundle;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getExtras()Landroid/os/Bundle;
...
.method public static getFlags(Ljava/lang/Object;)J
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getFlags()J
...
.method public static getMediaController(Landroid/app/Activity;)Ljava/lang/Object;
    ...
    .line 63
    invoke-virtual/range {p0 .. p0}, Landroid/app/Activity;->getMediaController()Landroid/media/session/MediaController;
...
.method public static getMetadata(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getMetadata()Landroid/media/MediaMetadata;
...
.method public static getPackageName(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getPackageName()Ljava/lang/String;
...
.method public static getPlaybackInfo(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getPlaybackInfo()Landroid/media/session/MediaController$PlaybackInfo;
...
.method public static getPlaybackState(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getPlaybackState()Landroid/media/session/PlaybackState;
...
.method public static getQueue(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getQueue()Ljava/util/List;
...
.method public static getQueueTitle(Ljava/lang/Object;)Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getQueueTitle()Ljava/lang/CharSequence;
...
.method public static getRatingType(Ljava/lang/Object;)I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getRatingType()I
...
.method public static getSessionActivity(Ljava/lang/Object;)Landroid/app/PendingIntent;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getSessionActivity()Landroid/app/PendingIntent;
...
.method public static getSessionToken(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getSessionToken()Landroid/media/session/MediaSession$Token;
...
.method public static getTransportControls(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/media/session/MediaController;->getTransportControls()Landroid/media/session/MediaController$TransportControls;
