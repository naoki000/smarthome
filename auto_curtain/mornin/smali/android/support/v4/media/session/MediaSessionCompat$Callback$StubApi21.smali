...
.method public onCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->access$100(Landroid/support/v4/media/session/MediaSessionCompat$Callback;)Ljava/lang/ref/WeakReference;
    ...
    .line 1210
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi21;->getSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 1212
    :cond_0
    invoke-interface/range {p1 .. p1}, Landroid/support/v4/media/session/IMediaSession;->asBinder()Landroid/os/IBinder;
    ...
    .line 1233
    invoke-static/range {p1 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi21;->access$200(Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi21;)Ljava/util/List;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->getDescription()Landroid/support/v4/media/MediaDescriptionCompat;
...
.method public onCustomAction(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onPrepare()V
...
.method public onSetRating(Ljava/lang/Object;)V
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/media/RatingCompat;->fromRating(Ljava/lang/Object;)Landroid/support/v4/media/RatingCompat;
