...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/os/RemoteCallbackList;-><init>()V
...
.method private sendCaptioningEnabled(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/os/RemoteCallbackList;->beginBroadcast()I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/os/RemoteCallbackList;->finishBroadcast()V
...
.method private sendSessionDestroyed()V
    ...
    .line 2317
    :try_start_0
    invoke-interface/range {v1 .. v1}, Landroid/support/v4/media/session/IMediaControllerCallback;->onSessionDestroyed()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/os/RemoteCallbackList;->finishBroadcast()V

    .line 2322
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mControllerCallbacks:Landroid/os/RemoteCallbackList;

    invoke-virtual/range {v0 .. v0}, Landroid/os/RemoteCallbackList;->kill()V
...
.method buildRccMetadata(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    ...
    .line 2083
    invoke-virtual/range {v2 .. v2}, Landroid/graphics/Bitmap;->getConfig()Landroid/graphics/Bitmap$Config;
...
.method public release()V
    ...
    .line 1953
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->update()Z

    .line 1954
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->sendSessionDestroyed()V
...
.method public sendSessionEvent(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 1946
    invoke-direct/range {p0 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->sendEvent(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public setCaptioningEnabled(Z)V
    ...
    .line 2198
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->sendCaptioningEnabled(Z)V
...
.method public setExtras(Landroid/os/Bundle;)V
    ...
    .line 2221
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->sendExtras(Landroid/os/Bundle;)V
...
.method public setMetadata(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/MediaMetadataCompat$Builder;->build()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    .line 2070
    :cond_2
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/media/MediaMetadataCompat;->getBundle()Landroid/os/Bundle;
    ...
    .line 2071
    invoke-virtual/range {p1 .. p1}, Landroid/media/RemoteControlClient$MetadataEditor;->apply()V
...
.method public setPlaybackState(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 1967
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->sendState(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 1977
    :cond_1
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->setRccState(Landroid/support/v4/media/session/PlaybackStateCompat;)V
...
.method public setPlaybackToRemote(Landroid/support/v4/media/VolumeProviderCompat;)V
    ...
    .line 1920
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/media/VolumeProviderCompat;->getVolumeControl()I

    move-result v4

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroid/support/v4/media/VolumeProviderCompat;

    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/media/VolumeProviderCompat;->getMaxVolume()I
    ...
    .line 1921
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/media/VolumeProviderCompat;->getCurrentVolume()I
...
.method public setQueue(Ljava/util/List;)V
    ...
    .line 2165
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->sendQueue(Ljava/util/List;)V
...
.method public setQueueTitle(Ljava/lang/CharSequence;)V
    ...
    .line 2171
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->sendQueueTitle(Ljava/lang/CharSequence;)V
...
.method public setRepeatMode(I)V
    ...
    .line 2206
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->sendRepeatMode(I)V
...
.method public setShuffleMode(I)V
    ...
    .line 2214
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->sendShuffleMode(I)V
