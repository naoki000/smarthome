...
.method private addChildrenForAccessibility(Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;Landroid/view/ViewGroup;)V
    ...
    .line 2332
    invoke-static/range {v2 .. v2}, Landroid/support/v4/widget/DrawerLayout;->includeChildForAccessibility(Landroid/view/View;)Z
...
.method private copyNodeInfoNoChildren(Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;)V
    ...
    .line 2353
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isVisibleToUser()Z
    ...
    .line 2354
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->getPackageName()Ljava/lang/CharSequence;
    ...
    .line 2355
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->getClassName()Ljava/lang/CharSequence;
    ...
    .line 2356
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->getContentDescription()Ljava/lang/CharSequence;
    ...
    .line 2358
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isEnabled()Z
    ...
    .line 2359
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isClickable()Z
    ...
    .line 2360
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isFocusable()Z
    ...
    .line 2361
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isFocused()Z
    ...
    .line 2362
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isAccessibilityFocused()Z
    ...
    .line 2363
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isSelected()Z
    ...
    .line 2364
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isLongClickable()Z
    ...
    .line 2366
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->getActions()I
...
.method public dispatchPopulateAccessibilityEvent(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/widget/DrawerLayout;->findVisibleDrawer()Landroid/view/View;
    ...
    .line 2316
    :cond_1
    invoke-super/range {p0 .. p2}, Landroid/support/v4/view/AccessibilityDelegateCompat;->dispatchPopulateAccessibilityEvent(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;)V
    ...
    .line 2267
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewCompat;->getParentForAccessibility(Landroid/view/View;)Landroid/view/ViewParent;
    ...
    .line 2272
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->recycle()V
...
.method public onRequestSendAccessibilityEvent(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-static/range {p2 .. p2}, Landroid/support/v4/widget/DrawerLayout;->includeChildForAccessibility(Landroid/view/View;)Z
    ...
    :cond_1
    :goto_0
    invoke-super/range {p0 .. p3}, Landroid/support/v4/view/AccessibilityDelegateCompat;->onRequestSendAccessibilityEvent(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
