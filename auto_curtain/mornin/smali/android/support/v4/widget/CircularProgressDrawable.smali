...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/view/animation/LinearInterpolator;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/view/animation/FastOutSlowInInterpolator;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;-><init>()V
    ...
    .line 142
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/widget/CircularProgressDrawable;->setupAnimators()V
...
.method static synthetic access$000(Landroid/support/v4/widget/CircularProgressDrawable;FLandroid/support/v4/widget/CircularProgressDrawable$Ring;)V
    ...
    .line 65
    invoke-direct/range {p0 .. p2}, Landroid/support/v4/widget/CircularProgressDrawable;->updateRingColor(FLandroid/support/v4/widget/CircularProgressDrawable$Ring;)V
...
.method static synthetic access$100(Landroid/support/v4/widget/CircularProgressDrawable;FLandroid/support/v4/widget/CircularProgressDrawable$Ring;Z)V
    ...
    .line 65
    invoke-direct/range {p0 .. p3}, Landroid/support/v4/widget/CircularProgressDrawable;->applyTransformation(FLandroid/support/v4/widget/CircularProgressDrawable$Ring;Z)V
...
.method private applyFinishTranslation(FLandroid/support/v4/widget/CircularProgressDrawable$Ring;)V
    ...
    .line 513
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getStartingRotation()F
    ...
    invoke-static/range {v0 .. v1}, Ljava/lang/Math;->floor(D)D
    ...
    .line 515
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getStartingStartTrim()F

    move-result v1

    .line 516
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getStartingEndTrim()F
...
.method private applyTransformation(FLandroid/support/v4/widget/CircularProgressDrawable$Ring;Z)V
    ...
    .line 530
    invoke-direct/range {p0 .. p2}, Landroid/support/v4/widget/CircularProgressDrawable;->applyFinishTranslation(FLandroid/support/v4/widget/CircularProgressDrawable$Ring;)V
...
.method private setupAnimators()V
    ...
    invoke-static/range {v1 .. v1}, Landroid/animation/ValueAnimator;->ofFloat([F)Landroid/animation/ValueAnimator;
...
.method private updateRingColor(FLandroid/support/v4/widget/CircularProgressDrawable$Ring;)V
    ...
    .line 497
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getStartingColor()I

    move-result v0

    .line 498
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getNextColor()I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 396
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/CircularProgressDrawable;->getBounds()Landroid/graphics/Rect;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Rect;->exactCenterX()F

    move-result v2

    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Rect;->exactCenterY()F
...
.method public getAlpha()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getAlpha()I
...
.method public getArrowEnabled()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getShowArrow()Z
...
.method public getArrowHeight()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getArrowHeight()F
...
.method public getArrowScale()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getArrowScale()F
...
.method public getArrowWidth()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getArrowWidth()F
...
.method public getBackgroundColor()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getBackgroundColor()I
...
.method public getCenterRadius()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getCenterRadius()F
...
.method public getColorSchemeColors()[I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getColors()[I
...
.method public getEndTrim()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getEndTrim()F
...
.method public getProgressRotation()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getRotation()F
...
.method public getStartTrim()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getStartTrim()F
...
.method public getStrokeCap()Landroid/graphics/Paint$Cap;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getStrokeCap()Landroid/graphics/Paint$Cap;
...
.method public getStrokeWidth()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getStrokeWidth()F
...
.method public isRunning()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/Animator;->isRunning()Z
...
.method public setAlpha(I)V
    ...
    .line 406
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/CircularProgressDrawable;->invalidateSelf()V
...
.method public start()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->storeOriginals()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getStartTrim()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->resetOriginals()V
