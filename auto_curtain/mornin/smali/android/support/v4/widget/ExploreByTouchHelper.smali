...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/widget/ExploreByTouchHelper$1;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/widget/ExploreByTouchHelper$2;-><init>()V
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    .line 145
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewCompat;->getImportantForAccessibility(Landroid/view/View;)I
...
.method private clearAccessibilityFocus(I)Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/view/View;->invalidate()V
...
.method private createEvent(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    .line 638
    invoke-direct/range {p0 .. p2}, Landroid/support/v4/widget/ExploreByTouchHelper;->createEventForChild(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method private createEventForChild(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    .line 674
    invoke-static/range {p2 .. p2}, Landroid/view/accessibility/AccessibilityEvent;->obtain(I)Landroid/view/accessibility/AccessibilityEvent;

    move-result-object p2

    .line 675
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/widget/ExploreByTouchHelper;->obtainAccessibilityNodeInfo(I)Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->getText()Ljava/lang/CharSequence;
    ...
    .line 679
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->getContentDescription()Ljava/lang/CharSequence;
    ...
    .line 680
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isScrollable()Z
    ...
    .line 681
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isPassword()Z
    ...
    .line 682
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isEnabled()Z
    ...
    .line 683
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isChecked()Z
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/view/accessibility/AccessibilityEvent;->getContentDescription()Ljava/lang/CharSequence;
    ...
    :cond_1
    :goto_0
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->getClassName()Ljava/lang/CharSequence;
...
.method private createEventForHost(I)Landroid/view/accessibility/AccessibilityEvent;
    ...
    .line 650
    invoke-static/range {p1 .. p1}, Landroid/view/accessibility/AccessibilityEvent;->obtain(I)Landroid/view/accessibility/AccessibilityEvent;
...
.method private createNodeForChild(I)Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;
    ...
    .line 813
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->getActions()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getContext()Landroid/content/Context;
    ...
    .line 840
    :cond_4
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->isFocusable()Z
    ...
    .line 868
    :cond_6
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->recycle()V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/view/View;->getScrollX()I
    ...
    .line 872
    invoke-virtual/range {v5 .. v5}, Landroid/view/View;->getScrollY()I
    ...
    .line 877
    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->getScrollY()I
...
.method private createNodeForHost()Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->obtain(Landroid/view/View;)Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;
    ...
    .line 738
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;->getChildCount()I
    ...
    invoke-virtual/range {v5 .. v5}, Ljava/lang/Integer;->intValue()I
...
.method private getAllNodes()Landroid/support/v4/util/SparseArrayCompat;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v4/util/SparseArrayCompat;-><init>()V
...
.method private moveFocus(ILandroid/graphics/Rect;)Z
    ...
    .line 380
    invoke-static/range {p2 .. p2}, Landroid/support/v4/view/ViewCompat;->getLayoutDirection(Landroid/view/View;)I
    ...
    invoke-direct/range {v4 .. v4}, Landroid/graphics/Rect;-><init>()V
...
.method private performActionForChild(IILandroid/os/Bundle;)Z
    ...
    .line 915
    invoke-virtual/range {p0 .. p3}, Landroid/support/v4/widget/ExploreByTouchHelper;->onPerformActionForVirtualView(IILandroid/os/Bundle;)Z
    ...
    .line 913
    :pswitch_0
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/widget/ExploreByTouchHelper;->clearKeyboardFocusForVirtualView(I)Z
    ...
    .line 911
    :pswitch_1
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/widget/ExploreByTouchHelper;->requestKeyboardFocusForVirtualView(I)Z
    ...
    .line 909
    :cond_0
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/widget/ExploreByTouchHelper;->clearAccessibilityFocus(I)Z
    ...
    .line 907
    :cond_1
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/widget/ExploreByTouchHelper;->requestAccessibilityFocus(I)Z
...
.method private requestAccessibilityFocus(I)Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/view/accessibility/AccessibilityManager;->isTouchExplorationEnabled()Z
...
.method public final dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 224
    invoke-static/range {v0 .. v0}, Landroid/support/v4/widget/ExploreByTouchHelper;->keyToDirection(I)I
    ...
    .line 239
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/widget/ExploreByTouchHelper;->clickKeyboardFocusedVirtualView()Z
...
.method public getFocusedVirtualView()I
    ...
    .line 586
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/ExploreByTouchHelper;->getAccessibilityFocusedVirtualViewId()I
...
.method obtainAccessibilityNodeInfo(I)Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;
    ...
    .line 717
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/widget/ExploreByTouchHelper;->createNodeForHost()Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;
    ...
    .line 720
    :cond_0
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/widget/ExploreByTouchHelper;->createNodeForChild(I)Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;
...
.method performAction(IILandroid/os/Bundle;)Z
    ...
    .line 896
    invoke-direct/range {p0 .. p3}, Landroid/support/v4/widget/ExploreByTouchHelper;->performActionForChild(IILandroid/os/Bundle;)Z
...
.method public final sendEventForVirtualView(II)Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/accessibility/AccessibilityManager;->isEnabled()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getParent()Landroid/view/ViewParent;
    ...
    .line 511
    :cond_1
    invoke-direct/range {p0 .. p2}, Landroid/support/v4/widget/ExploreByTouchHelper;->createEvent(II)Landroid/view/accessibility/AccessibilityEvent;
