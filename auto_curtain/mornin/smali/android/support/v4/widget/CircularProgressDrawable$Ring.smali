...
.method draw(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    .line 709
    invoke-virtual/range {v6 .. v6}, Landroid/graphics/RectF;->centerX()F

    move-result v1

    invoke-virtual/range {v6 .. v6}, Landroid/graphics/RectF;->centerY()F

    move-result v3

    invoke-virtual/range {v6 .. v6}, Landroid/graphics/RectF;->width()F
...
.method drawTriangle(Landroid/graphics/Canvas;FFLandroid/graphics/RectF;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Path;->close()V
...
.method getNextColor()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/CircularProgressDrawable$Ring;->getNextColorIndex()I
...
.method getStrokeCap()Landroid/graphics/Paint$Cap;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Paint;->getStrokeCap()Landroid/graphics/Paint$Cap;
