...
.method constructor <init>()V
    ...
    .line 2089
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompat$Style;-><init>()V
...
.method public static extractMessagingStyleFromNotification(Landroid/app/Notification;)Landroid/support/v4/app/NotificationCompat$MessagingStyle;
    ...
    .line 2181
    invoke-static/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompat;->getExtras(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v4/app/NotificationCompat$MessagingStyle;-><init>()V
...
.method private findLatestIncomingMessage()Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;
    ...
    .line 2257
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getSender()Ljava/lang/CharSequence;
...
.method private hasMessagesWithoutSender()Z
    ...
    .line 2271
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getSender()Ljava/lang/CharSequence;
...
.method private makeMessageLine(Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;)Ljava/lang/CharSequence;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/text/SpannableStringBuilder;-><init>()V
    ...
    .line 2283
    :goto_1
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getSender()Ljava/lang/CharSequence;
    ...
    invoke-static/range {v5 .. v5}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/app/NotificationCompat$Builder;->getColor()I
    ...
    .line 2294
    invoke-virtual/range {v1 .. v1}, Landroid/text/SpannableStringBuilder;->length()I
    ...
    .line 2297
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getText()Ljava/lang/CharSequence;
...
.method public addCompatExtras(Landroid/os/Bundle;)V
    ...
    .line 2309
    invoke-super/range {p0 .. p1}, Landroid/support/v4/app/NotificationCompat$Style;->addCompatExtras(Landroid/os/Bundle;)V
    ...
    .line 2317
    invoke-static/range {v1 .. v1}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getBundleArrayForMessages(Ljava/util/List;)[Landroid/os/Bundle;
...
.method public apply(Landroid/support/v4/app/NotificationBuilderWithBuilderAccessor;)V
    ...
    .line 2208
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getText()Ljava/lang/CharSequence;

    move-result-object v4

    .line 2209
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getTimestamp()J
    ...
    .line 2211
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getDataMimeType()Ljava/lang/String;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getDataUri()Landroid/net/Uri;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getSender()Ljava/lang/CharSequence;
    ...
    .line 2229
    :cond_5
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getText()Ljava/lang/CharSequence;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/text/SpannableStringBuilder;-><init>()V
    ...
    :cond_9
    invoke-virtual/range {v5 .. v5}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getText()Ljava/lang/CharSequence;
...
.method protected restoreFromCompatExtras(Landroid/os/Bundle;)V
    ...
    .line 2332
    invoke-static/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$MessagingStyle$Message;->getMessagesFromBundleArray([Landroid/os/Parcelable;)Ljava/util/List;
