...
.method constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/os/HandlerThread;->start()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;
...
.method private handleQueueTask(Landroid/support/v4/app/NotificationManagerCompat$Task;)V
    ...
    .line 356
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->updateListenerMap()V
...
.method private handleServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 366
    invoke-static/range {p2 .. p2}, Landroid/support/v4/app/INotificationSideChannel$Stub;->asInterface(Landroid/os/IBinder;)Landroid/support/v4/app/INotificationSideChannel;
...
.method private processListenerQueue(Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V
    ...
    .line 517
    invoke-virtual/range {v3 .. v3}, Ljava/util/ArrayDeque;->size()I
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/ArrayDeque;->isEmpty()Z
    ...
    .line 522
    :cond_1
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->ensureServiceBound(Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/ArrayDeque;->peek()Ljava/lang/Object;
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/ArrayDeque;->remove()Ljava/lang/Object;
    :try_end_0
    ...
    .line 551
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->scheduleListenerRetry(Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V
...
.method private scheduleListenerRetry(Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/util/ArrayDeque;->size()I
    ...
    invoke-virtual/range {p1 .. p1}, Ljava/util/ArrayDeque;->clear()V
...
.method private updateListenerMap()V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/app/NotificationManagerCompat;->getEnabledListenerPackages(Landroid/content/Context;)Ljava/util/Set;
