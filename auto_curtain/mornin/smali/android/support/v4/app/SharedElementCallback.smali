...
.method public onCaptureSharedElementSnapshot(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;)Landroid/os/Parcelable;
    ...
    .line 173
    invoke-static/range {v1 .. v1}, Landroid/support/v4/app/SharedElementCallback;->createDrawableBitmap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    .line 178
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageView;->getScaleType()Landroid/widget/ImageView$ScaleType;

    move-result-object p3

    invoke-virtual/range {p3 .. p3}, Landroid/widget/ImageView$ScaleType;->toString()Ljava/lang/String;
    ...
    .line 180
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageView;->getImageMatrix()Landroid/graphics/Matrix;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/graphics/Matrix;-><init>()V
...
.method public onCreateSnapshotView(Landroid/content/Context;Landroid/os/Parcelable;)Landroid/view/View;
    ...
    invoke-static/range {p1 .. p1}, Landroid/widget/ImageView$ScaleType;->valueOf(Ljava/lang/String;)Landroid/widget/ImageView$ScaleType;
    ...
    .line 269
    invoke-virtual/range {v1 .. v1}, Landroid/widget/ImageView;->getScaleType()Landroid/widget/ImageView$ScaleType;
...
.method public onSharedElementsArrived(Ljava/util/List;Ljava/util/List;Landroid/support/v4/app/SharedElementCallback$OnSharedElementsReadyListener;)V
    ...
    .line 301
    invoke-interface/range {p3 .. p3}, Landroid/support/v4/app/SharedElementCallback$OnSharedElementsReadyListener;->onSharedElementsReady()V
