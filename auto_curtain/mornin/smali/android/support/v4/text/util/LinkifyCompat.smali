...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/text/util/LinkifyCompat$1;-><init>()V
...
.method public static addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;)V
    ...
    .line 208
    invoke-static/range {p0 .. p2}, Landroid/text/util/Linkify;->addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;)V
...
.method public static addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
    ...
    .line 232
    invoke-static/range {p0 .. p4}, Landroid/text/util/Linkify;->addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
...
.method public static addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
    ...
    invoke-static/range {v0 .. v0}, Landroid/text/SpannableString;->valueOf(Ljava/lang/CharSequence;)Landroid/text/SpannableString;
    ...
    .line 268
    invoke-static/range {p0 .. p0}, Landroid/support/v4/text/util/LinkifyCompat;->addLinkMovementMethod(Landroid/widget/TextView;)V
...
.method public static addLinks(Landroid/text/Spannable;I)Z
    ...
    .line 101
    invoke-static/range {p0 .. p1}, Landroid/text/util/Linkify;->addLinks(Landroid/text/Spannable;I)Z
...
.method public static addLinks(Landroid/text/Spannable;Ljava/util/regex/Pattern;Ljava/lang/String;)Z
    ...
    .line 284
    invoke-static/range {p0 .. p2}, Landroid/text/util/Linkify;->addLinks(Landroid/text/Spannable;Ljava/util/regex/Pattern;Ljava/lang/String;)Z
...
.method public static addLinks(Landroid/text/Spannable;Ljava/util/regex/Pattern;Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)Z
    ...
    .line 308
    invoke-static/range {p0 .. p4}, Landroid/text/util/Linkify;->addLinks(Landroid/text/Spannable;Ljava/util/regex/Pattern;Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)Z
...
.method public static addLinks(Landroid/widget/TextView;I)Z
    ...
    .line 165
    invoke-static/range {p0 .. p1}, Landroid/text/util/Linkify;->addLinks(Landroid/widget/TextView;I)Z
    ...
    .line 181
    :cond_3
    invoke-static/range {v1 .. v1}, Landroid/text/SpannableString;->valueOf(Ljava/lang/CharSequence;)Landroid/text/SpannableString;
...
.method private static gatherLinks(Ljava/util/ArrayList;Landroid/text/Spannable;Ljava/util/regex/Pattern;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
    ...
    :cond_0
    :goto_0
    invoke-virtual/range {p2 .. p2}, Ljava/util/regex/Matcher;->find()Z
    ...
    invoke-direct/range {v2 .. v2}, Landroid/support/v4/text/util/LinkifyCompat$LinkSpec;-><init>()V
...
.method private static gatherMapLinks(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    ...
    :goto_0
    :try_start_0
    invoke-static/range {p1 .. p1}, Landroid/webkit/WebView;->findAddress(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/support/v4/text/util/LinkifyCompat$LinkSpec;-><init>()V
