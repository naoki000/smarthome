...
.method static synthetic access$000(Landroid/support/v4/provider/SelfDestructiveThread;Ljava/lang/Runnable;)V
    ...
    .line 42
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/provider/SelfDestructiveThread;->onInvokeRunnable(Ljava/lang/Runnable;)V
...
.method static synthetic access$100(Landroid/support/v4/provider/SelfDestructiveThread;)V
    ...
    .line 42
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/provider/SelfDestructiveThread;->onDestruction()V
...
.method private onDestruction()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/os/HandlerThread;->quit()Z
...
.method private post(Ljava/lang/Runnable;)V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;
...
.method public postAndWait(Ljava/util/concurrent/Callable;I)Ljava/lang/Object;
    ...
    invoke-direct/range {v7 .. v7}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    .line 166
    invoke-virtual/range {v7 .. v7}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;
    ...
    invoke-direct/range {v9 .. v9}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V
    ...
    .line 188
    invoke-virtual/range {v7 .. v7}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    .line 190
    :try_start_0
    invoke-virtual/range {v10 .. v10}, Ljava/util/concurrent/atomic/AtomicBoolean;->get()Z
    ...
    .line 191
    invoke-virtual/range {v9 .. v9}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;
    ...
    .line 208
    invoke-virtual/range {v7 .. v7}, Ljava/util/concurrent/locks/ReentrantLock;->unlock()V
