...
.method private performMenuItemShortcut(ILandroid/view/KeyEvent;)Z
    ...
    invoke-static/range {p1 .. p1}, Landroid/view/KeyEvent;->metaStateHasNoModifiers(I)Z
    ...
    invoke-static/range {p1 .. p1}, Landroid/view/KeyEvent;->isModifierKey(I)Z
...
.method public addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 154
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatActivity;->getDelegate()Landroid/support/v7/app/AppCompatDelegate;
...
.method public closeOptionsMenu()V
    ...
    .line 587
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/ActionBar;->closeOptionsMenu()Z
    ...
    .line 588
    :cond_0
    invoke-super/range {p0 .. p0}, Landroid/support/v4/app/FragmentActivity;->closeOptionsMenu()V
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 534
    :cond_0
    invoke-super/range {p0 .. p1}, Landroid/support/v4/app/FragmentActivity;->dispatchKeyEvent(Landroid/view/KeyEvent;)Z
...
.method public getDrawerToggleDelegate()Landroid/support/v7/app/ActionBarDrawerToggle$Delegate;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AppCompatDelegate;->getDrawerToggleDelegate()Landroid/support/v7/app/ActionBarDrawerToggle$Delegate;
...
.method public getMenuInflater()Landroid/view/MenuInflater;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AppCompatDelegate;->getMenuInflater()Landroid/view/MenuInflater;
...
.method public getResources()Landroid/content/res/Resources;
    ...
    invoke-super/range {p0 .. p0}, Landroid/support/v4/app/FragmentActivity;->getResources()Landroid/content/res/Resources;
...
.method public getSupportActionBar()Landroid/support/v7/app/ActionBar;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AppCompatDelegate;->getSupportActionBar()Landroid/support/v7/app/ActionBar;
...
.method public getSupportParentActivityIntent()Landroid/content/Intent;
    ...
    .line 430
    invoke-static/range {p0 .. p0}, Landroid/support/v4/app/NavUtils;->getParentActivityIntent(Landroid/app/Activity;)Landroid/content/Intent;
...
.method public invalidateOptionsMenu()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AppCompatDelegate;->invalidateOptionsMenu()V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 159
    invoke-super/range {p0 .. p1}, Landroid/support/v4/app/FragmentActivity;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public onContentChanged()V
    ...
    .line 469
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatActivity;->onSupportContentChanged()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 73
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AppCompatDelegate;->applyDayNight()Z
    ...
    .line 79
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatActivity;->getTheme()Landroid/content/res/Resources$Theme;
...
.method protected onDestroy()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AppCompatDelegate;->onDestroy()V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 568
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/app/AppCompatActivity;->performMenuItemShortcut(ILandroid/view/KeyEvent;)Z
    ...
    .line 571
    :cond_0
    invoke-super/range {p0 .. p2}, Landroid/support/v4/app/FragmentActivity;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    .line 195
    invoke-super/range {p0 .. p2}, Landroid/support/v4/app/FragmentActivity;->onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    .line 201
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/app/ActionBar;->getDisplayOptions()I
    ...
    .line 202
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatActivity;->onSupportNavigateUp()Z
...
.method public onMenuOpened(ILandroid/view/Menu;)Z
    ...
    .line 493
    invoke-super/range {p0 .. p2}, Landroid/support/v4/app/FragmentActivity;->onMenuOpened(ILandroid/view/Menu;)Z
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    .line 504
    invoke-super/range {p0 .. p2}, Landroid/support/v4/app/FragmentActivity;->onPanelClosed(ILandroid/view/Menu;)V
...
.method protected onPostCreate(Landroid/os/Bundle;)V
    ...
    .line 96
    invoke-super/range {p0 .. p1}, Landroid/support/v4/app/FragmentActivity;->onPostCreate(Landroid/os/Bundle;)V
...
.method protected onPostResume()V
    ...
    .line 171
    invoke-super/range {p0 .. p0}, Landroid/support/v4/app/FragmentActivity;->onPostResume()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AppCompatDelegate;->onPostResume()V
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    .line 509
    invoke-super/range {p0 .. p1}, Landroid/support/v4/app/FragmentActivity;->onSaveInstanceState(Landroid/os/Bundle;)V
...
.method protected onStart()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AppCompatDelegate;->onStart()V
...
.method protected onStop()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AppCompatDelegate;->onStop()V
...
.method public onSupportNavigateUp()Z
    ...
    .line 392
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatActivity;->getSupportParentActivityIntent()Landroid/content/Intent;
    ...
    .line 399
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/app/TaskStackBuilder;->startActivities()V

    .line 402
    :try_start_0
    invoke-static/range {p0 .. p0}, Landroid/support/v4/app/ActivityCompat;->finishAffinity(Landroid/app/Activity;)V
    :try_end_0
    ...
    .line 406
    :catch_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatActivity;->finish()V
...
.method protected onTitleChanged(Ljava/lang/CharSequence;I)V
    ...
    .line 215
    invoke-super/range {p0 .. p2}, Landroid/support/v4/app/FragmentActivity;->onTitleChanged(Ljava/lang/CharSequence;I)V
...
.method public openOptionsMenu()V
    ...
    .line 578
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/ActionBar;->openOptionsMenu()Z
    ...
    .line 579
    :cond_0
    invoke-super/range {p0 .. p0}, Landroid/support/v4/app/FragmentActivity;->openOptionsMenu()V
...
.method public setTheme(I)V
    ...
    .line 89
    invoke-super/range {p0 .. p1}, Landroid/support/v4/app/FragmentActivity;->setTheme(I)V
...
.method public supportNavigateUpTo(Landroid/content/Intent;)V
    ...
    .line 463
    invoke-static/range {p0 .. p1}, Landroid/support/v4/app/NavUtils;->navigateUpTo(Landroid/app/Activity;Landroid/content/Intent;)V
...
.method public supportShouldUpRecreateTask(Landroid/content/Intent;)Z
    ...
    .line 447
    invoke-static/range {p0 .. p1}, Landroid/support/v4/app/NavUtils;->shouldUpRecreateTask(Landroid/app/Activity;Landroid/content/Intent;)Z
