...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/AppCompatCallback;)V
    ...
    .line 149
    invoke-direct/range {p0 .. p3}, Landroid/support/v7/app/AppCompatDelegateImplBase;-><init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/AppCompatCallback;)V
...
.method private applyFixedSizeWindow()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/Window;->getDecorView()Landroid/view/View;

    move-result-object v1

    .line 537
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getPaddingLeft()I

    move-result v2

    .line 538
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getPaddingTop()I

    move-result v3

    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getPaddingRight()I

    move-result v4

    .line 539
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getPaddingBottom()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ContentFrameLayout;->getMinWidthMajor()Landroid/util/TypedValue;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ContentFrameLayout;->getMinWidthMinor()Landroid/util/TypedValue;
    ...
    .line 547
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ContentFrameLayout;->getFixedWidthMajor()Landroid/util/TypedValue;
    ...
    .line 551
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ContentFrameLayout;->getFixedWidthMinor()Landroid/util/TypedValue;
    ...
    .line 555
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ContentFrameLayout;->getFixedHeightMajor()Landroid/util/TypedValue;
    ...
    .line 559
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ContentFrameLayout;->getFixedHeightMinor()Landroid/util/TypedValue;
    ...
    .line 561
    :cond_3
    invoke-virtual/range {v1 .. v1}, Landroid/content/res/TypedArray;->recycle()V

    .line 563
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ContentFrameLayout;->requestLayout()V
...
.method private createSubDecor()Landroid/view/ViewGroup;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/view/Window;->getDecorView()Landroid/view/View;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/content/Context;->getTheme()Landroid/content/res/Resources$Theme;
    ...
    .line 405
    :goto_1
    invoke-static/range {v1 .. v1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;
    ...
    .line 484
    :cond_d
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/ViewUtils;->makeOptionalFitsSystemWindows(Landroid/view/View;)V
    ...
    .line 493
    :goto_4
    invoke-virtual/range {v3 .. v3}, Landroid/view/ViewGroup;->getChildCount()I
...
.method private ensureSubDecor()V
    ...
    .line 323
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->createSubDecor()Landroid/view/ViewGroup;
    ...
    .line 326
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 331
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->applyFixedSizeWindow()V
...
.method private initializePanelDecor(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;)Z
    ...
    .line 1212
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->getActionBarThemedContext()Landroid/content/Context;
...
.method private initializePanelMenu(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;)Z
    ...
    invoke-direct/range {v1 .. v1}, Landroid/util/TypedValue;-><init>()V
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/content/res/Resources;->newTheme()Landroid/content/res/Resources$Theme;
...
.method private onKeyUpPanel(ILandroid/view/KeyEvent;)Z
    ...
    .line 1499
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/DecorContentParent;->canShowOverflowMenu()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/view/ViewConfiguration;->hasPermanentMenuKey()Z
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/DecorContentParent;->isOverflowMenuShowing()Z
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/DecorContentParent;->showOverflowMenu()Z
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/DecorContentParent;->hideOverflowMenu()Z
...
.method private openPanel(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/view/View;->getParent()Landroid/view/ViewParent;
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/view/View;->hasFocus()Z
...
.method private preparePanel(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    invoke-interface/range {v4 .. v4}, Landroid/support/v7/widget/DecorContentParent;->setMenuPrepared()V
    ...
    .line 1357
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->peekSupportActionBar()Landroid/support/v7/app/ActionBar;
    ...
    .line 1362
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/app/AppCompatDelegateImplV9;->initializePanelMenu(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;)Z
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/view/menu/MenuBuilder;->stopDispatchingItemsChanged()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->startDispatchingItemsChanged()V
    ...
    .line 1415
    :goto_2
    invoke-static/range {p2 .. p2}, Landroid/view/KeyCharacterMap;->load(I)Landroid/view/KeyCharacterMap;

    move-result-object p2

    .line 1417
    invoke-virtual/range {p2 .. p2}, Landroid/view/KeyCharacterMap;->getKeyboardType()I
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/view/menu/MenuBuilder;->startDispatchingItemsChanged()V
...
.method private reopenMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .line 1221
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/DecorContentParent;->isOverflowMenuShowPending()Z
    ...
    invoke-interface/range {v2 .. v2}, Landroid/support/v7/widget/DecorContentParent;->isOverflowMenuShowing()Z
    ...
    invoke-interface/range {p2 .. p2}, Landroid/support/v7/widget/DecorContentParent;->hideOverflowMenu()Z
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/view/Window;->getDecorView()Landroid/view/View;
...
.method private shouldInheritContext(Landroid/view/ViewParent;)Z
    ...
    .line 1056
    invoke-static/range {v2 .. v2}, Landroid/support/v4/view/ViewCompat;->isAttachedToWindow(Landroid/view/View;)Z
    ...
    .line 1063
    :cond_2
    invoke-interface/range {p1 .. p1}, Landroid/view/ViewParent;->getParent()Landroid/view/ViewParent;
...
.method public addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 302
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->ensureSubDecor()V
    ...
    invoke-interface/range {p1 .. p1}, Landroid/view/Window$Callback;->onContentChanged()V
...
.method checkCloseActionMenu(Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorContentParent;->dismissPopups()V
...
.method closePanel(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;Z)V
    ...
    .line 1450
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorContentParent;->isOverflowMenuShowing()Z
...
.method public createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/app/AppCompatViewInflater;-><init>()V
...
.method dismissPopups()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/PopupWindow;->isShowing()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/PopupWindow;->dismiss()V
    :try_end_0
    ...
    .line 1780
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->endOnGoingFadeAnimation()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuBuilder;->close()V
...
.method doInvalidatePanelMenu(I)V
    ...
    .line 1641
    invoke-virtual/range {v2 .. v2}, Landroid/os/Bundle;->size()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuBuilder;->stopDispatchingItemsChanged()V

    .line 1646
    iget-object v2, v1, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->menu:Landroid/support/v7/view/menu/MenuBuilder;

    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuBuilder;->clear()V
...
.method endOnGoingFadeAnimation()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/ViewPropertyAnimatorCompat;->cancel()V
...
.method public hasWindowFeature(I)Z
    ...
    .line 610
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/app/AppCompatDelegateImplV9;->sanitizeWindowFeatureId(I)I
...
.method public installViewFactory()V
    ...
    .line 1070
    invoke-virtual/range {v0 .. v0}, Landroid/view/LayoutInflater;->getFactory()Landroid/view/LayoutInflater$Factory;
    ...
    .line 1073
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/view/LayoutInflater;->getFactory2()Landroid/view/LayoutInflater$Factory2;
...
.method public invalidateOptionsMenu()V
    ...
    .line 715
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->getSupportActionBar()Landroid/support/v7/app/ActionBar;
    ...
    .line 716
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/ActionBar;->invalidateOptionsMenu()Z
...
.method onBackPressed()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/ActionMode;->finish()V
    ...
    .line 895
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/ActionBar;->collapseActionView()Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 254
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->applyDayNight()Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/app/NavUtils;->getParentActivityName(Landroid/app/Activity;)Ljava/lang/String;
...
.method public final onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 1086
    invoke-virtual/range {p0 .. p4}, Landroid/support/v7/app/AppCompatDelegateImplV9;->callActivityOnCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 1092
    :cond_0
    invoke-virtual/range {p0 .. p4}, Landroid/support/v7/app/AppCompatDelegateImplV9;->createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
...
.method public onDestroy()V
    ...
    .line 314
    :cond_0
    invoke-super/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplBase;->onDestroy()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/ActionBar;->onDestroy()V
...
.method onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    .line 975
    :cond_3
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->onBackPressed()Z
...
.method public onMenuItemSelected(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
    ...
    .line 672
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->getRootMenu()Landroid/support/v7/view/menu/MenuBuilder;
...
.method public requestWindowFeature(I)Z
    ...
    .line 584
    :sswitch_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->throwFeatureRequestIfSubDecorInstalled()V
...
.method public setSupportActionBar(Landroid/support/v7/widget/Toolbar;)V
    ...
    .line 217
    invoke-virtual/range {v1 .. v1}, Landroid/app/Activity;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/ToolbarActionBar;->getWrappedWindowCallback()Landroid/view/Window$Callback;
    ...
    .line 226
    :goto_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->invalidateOptionsMenu()V
...
.method final shouldAnimateActionModeView()Z
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/ViewCompat;->isLaidOut(Landroid/view/View;)Z
...
.method startSupportActionModeFromWindow(Landroid/support/v7/view/ActionMode$Callback;)Landroid/support/v7/view/ActionMode;
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/content/Context;->getTheme()Landroid/content/res/Resources$Theme;
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/content/res/Resources;->newTheme()Landroid/content/res/Resources$Theme;
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/content/res/Resources;->getDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    invoke-static/range {v4 .. v4}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;
    ...
    .line 814
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ViewStubCompat;->inflate()Landroid/view/View;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarContextView;->killMode()V
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/ActionBarContextView;->getContext()Landroid/content/Context;
    ...
    .line 824
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/ActionMode;->getMenu()Landroid/view/Menu;
    ...
    .line 825
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/ActionMode;->invalidate()V
    ...
    .line 829
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/AppCompatDelegateImplV9;->shouldAnimateActionModeView()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ActionBarContextView;->getParent()Landroid/view/ViewParent;
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewCompat;->requestApplyInsets(Landroid/view/View;)V
...
.method updateStatusGuard(I)I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarContextView;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/ActionBarContextView;->isShown()Z
