...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/view/animation/AccelerateInterpolator;-><init>()V
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    .line 190
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/app/WindowDecorActionBar;->init(Landroid/view/View;)V
...
.method private cleanupTabs()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ScrollingTabContainerView;->removeAllTabs()V
...
.method private configureTab(Landroid/support/v7/app/ActionBar$Tab;I)V
    ...
    .line 544
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/app/WindowDecorActionBar$TabImpl;->getCallback()Landroid/support/v7/app/ActionBar$TabListener;
...
.method private ensureTabsExist()V
    ...
    .line 297
    :cond_1
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->getNavigationMode()I
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v4/view/ViewCompat;->requestApplyInsets(Landroid/view/View;)V
...
.method private getDecorToolbar(Landroid/view/View;)Landroid/support/v7/widget/DecorToolbar;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/Toolbar;->getWrapper()Landroid/support/v7/widget/DecorToolbar;
...
.method private init(Landroid/view/View;)V
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/DecorToolbar;->getContext()Landroid/content/Context;
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/DecorToolbar;->getDisplayOptions()I
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v7/view/ActionBarPolicy;->get(Landroid/content/Context;)Landroid/support/v7/view/ActionBarPolicy;

    move-result-object v2

    .line 219
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/ActionBarPolicy;->enableHomeButtonByDefault()Z
    ...
    .line 220
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/ActionBarPolicy;->hasEmbeddedTabs()Z
...
.method private setHasEmbeddedTabs(Z)V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/ViewCompat;->requestApplyInsets(Landroid/view/View;)V
...
.method private updateVisibility(Z)V
    ...
    .line 776
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/app/WindowDecorActionBar;->doShow(Z)V
    ...
    .line 781
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/app/WindowDecorActionBar;->doHide(Z)V
...
.method public addTab(Landroid/support/v7/app/ActionBar$Tab;IZ)V
    ...
    .line 581
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->ensureTabsExist()V
    ...
    .line 583
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/app/WindowDecorActionBar;->configureTab(Landroid/support/v7/app/ActionBar$Tab;I)V

    if-eqz p3, :cond_0

    .line 585
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/app/WindowDecorActionBar;->selectTab(Landroid/support/v7/app/ActionBar$Tab;)V
...
.method public animateToMode(Z)V
    ...
    .line 875
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->showForActionMode()V

    goto :goto_0

    .line 877
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->hideForActionMode()V

    .line 880
    :goto_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->shouldAnimateContextView()Z
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;-><init>()V
    ...
    .line 899
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->start()V
...
.method public collapseActionView()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->collapseActionView()V
...
.method public doHide(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->cancel()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;-><init>()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/ActionBarContainer;->getHeight()I
    ...
    .line 860
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->start()V
...
.method public doShow(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarContainer;->getHeight()I
    ...
    invoke-direct/range {p1 .. p1}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;-><init>()V

    .line 803
    iget-object v2, p0, Landroid/support/v7/app/WindowDecorActionBar;->mContainerView:Landroid/support/v7/widget/ActionBarContainer;

    invoke-static/range {v2 .. v2}, Landroid/support/v4/view/ViewCompat;->animate(Landroid/view/View;)Landroid/support/v4/view/ViewPropertyAnimatorCompat;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/ViewCompat;->animate(Landroid/view/View;)Landroid/support/v4/view/ViewPropertyAnimatorCompat;
    ...
    .line 821
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->start()V
...
.method public getCustomView()Landroid/view/View;
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->getCustomView()Landroid/view/View;
...
.method public getElevation()F
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/ViewCompat;->getElevation(Landroid/view/View;)F
...
.method public getHideOffset()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->getActionBarHideOffset()I
...
.method public getNavigationItemCount()I
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->getDropdownItemCount()I
...
.method public getSelectedNavigationIndex()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/WindowDecorActionBar$TabImpl;->getPosition()I
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->getDropdownSelectedPosition()I
...
.method public getSubtitle()Ljava/lang/CharSequence;
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->getSubtitle()Ljava/lang/CharSequence;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->getTitle()Ljava/lang/CharSequence;
...
.method public hasIcon()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->hasIcon()Z
...
.method public hasLogo()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->hasLogo()Z
...
.method public isHideOnContentScrollEnabled()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->isHideOnContentScrollEnabled()Z
...
.method public isShowing()Z
    ...
    .line 868
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->getHeight()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->getHideOffset()I
...
.method public isTitleTruncated()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->isTitleTruncated()Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v7/view/ActionBarPolicy;->get(Landroid/content/Context;)Landroid/support/v7/view/ActionBarPolicy;

    move-result-object p1

    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/ActionBarPolicy;->hasEmbeddedTabs()Z
...
.method public onKeyShortcut(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/WindowDecorActionBar$ActionModeImpl;->getMenu()Landroid/view/Menu;
    ...
    .line 1406
    :goto_0
    invoke-static/range {v2 .. v2}, Landroid/view/KeyCharacterMap;->load(I)Landroid/view/KeyCharacterMap;

    move-result-object v2

    .line 1408
    invoke-virtual/range {v2 .. v2}, Landroid/view/KeyCharacterMap;->getKeyboardType()I
...
.method public removeAllTabs()V
    ...
    .line 424
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->cleanupTabs()V
...
.method public removeTab(Landroid/support/v7/app/ActionBar$Tab;)V
    ...
    .line 596
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/app/ActionBar$Tab;->getPosition()I
...
.method public requestFocus()Z
    ...
    .line 451
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewGroup;->hasFocus()Z
    ...
    .line 452
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewGroup;->requestFocus()Z
...
.method public selectTab(Landroid/support/v7/app/ActionBar$Tab;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewGroup;->isInEditMode()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/app/FragmentTransaction;->disallowAddToBackStack()Landroid/support/v4/app/FragmentTransaction;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/app/WindowDecorActionBar$TabImpl;->getCallback()Landroid/support/v7/app/ActionBar$TabListener;
    ...
    .line 656
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/app/FragmentTransaction;->isEmpty()Z
...
.method public setCustomView(I)V
    ...
    .line 363
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->getThemedContext()Landroid/content/Context;
...
.method public setDefaultDisplayHomeAsUpEnabled(Z)V
    ...
    .line 1395
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/app/WindowDecorActionBar;->setDisplayHomeAsUpEnabled(Z)V
...
.method public setHideOffset(I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->isInOverlayMode()Z
...
.method public setNavigationMode(I)V
    ...
    .line 1333
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/app/WindowDecorActionBar;->getSelectedNavigationIndex()I
...
.method public setShowHideAnimationEnabled(Z)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->cancel()V
...
.method public startActionMode(Landroid/support/v7/view/ActionMode$Callback;)Landroid/support/v7/view/ActionMode;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/WindowDecorActionBar$ActionModeImpl;->finish()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/ActionBarContextView;->getContext()Landroid/content/Context;
    ...
    .line 529
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/WindowDecorActionBar$ActionModeImpl;->dispatchOnCreate()Z
    ...
    .line 533
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/WindowDecorActionBar$ActionModeImpl;->invalidate()V
