...
.method private tryShow()Z
    ...
    .line 144
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/StandardMenuPopup;->isShowing()Z
    ...
    .line 160
    :goto_0
    invoke-virtual/range {v0 .. v0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/StandardMenuPopup;->getEpicenterBounds()Landroid/graphics/Rect;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/MenuPopupWindow;->show()V

    .line 178
    iget-object v0, p0, Landroid/support/v7/view/menu/StandardMenuPopup;->mPopup:Landroid/support/v7/widget/MenuPopupWindow;

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/MenuPopupWindow;->getListView()Landroid/widget/ListView;
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/view/menu/MenuBuilder;->getHeaderTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/view/menu/MenuBuilder;->getHeaderTitle()Ljava/lang/CharSequence;
...
.method public onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .line 290
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/StandardMenuPopup;->dismiss()V
...
.method public onDismiss()V
    ...
    invoke-interface/range {v0 .. v0}, Landroid/widget/PopupWindow$OnDismissListener;->onDismiss()V
...
.method public onSubMenuSelected(Landroid/support/v7/view/menu/SubMenuBuilder;)Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/MenuPopupWindow;->getHorizontalOffset()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/MenuPopupWindow;->getVerticalOffset()I
...
.method public show()V
    ...
    .line 203
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/view/menu/StandardMenuPopup;->tryShow()Z
...
.method public updateMenuView(Z)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuAdapter;->notifyDataSetChanged()V
