...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 71
    invoke-direct/range {p0 .. p3}, Landroid/support/v7/widget/AppCompatTextView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 73
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->shouldAllowTextWithIcon()Z
...
.method private updateTextButtonVisibility()V
    ...
    .line 189
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuItemImpl;->showsTextAsAction()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuItemImpl;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuItemImpl;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuItemImpl;->getTooltipText()Ljava/lang/CharSequence;
...
.method public hasText()Z
    ...
    .line 236
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->getText()Ljava/lang/CharSequence;
...
.method public initialize(Landroid/support/v7/view/menu/MenuItemImpl;I)V
    ...
    .line 127
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->getItemId()I
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 91
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatTextView;->onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 94
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->updateTextButtonVisibility()V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->getPaddingTop()I

    move-result v2

    .line 271
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->getPaddingRight()I

    move-result v3

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->getPaddingBottom()I
    ...
    .line 278
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->getMeasuredWidth()I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuItemImpl;->hasSubMenu()Z
    ...
    .line 144
    :cond_0
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatTextView;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setExpandedFormat(Z)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->actionFormatChanged()V
...
.method public setPadding(IIII)V
    ...
    .line 113
    invoke-super/range {p0 .. p4}, Landroid/support/v7/widget/AppCompatTextView;->setPadding(IIII)V
