...
.method public dismiss()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/app/AlertDialog;->dismiss()V
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/ListMenuPresenter;->getAdapter()Landroid/widget/ListAdapter;
...
.method public onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .line 151
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuDialogHelper;->dismiss()V
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    .line 112
    invoke-virtual/range {v0 .. v0}, Landroid/view/View;->getKeyDispatcherState()Landroid/view/KeyEvent$DispatcherState;
...
.method public show(Landroid/os/IBinder;)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/app/AlertDialog$Builder;->getContext()Landroid/content/Context;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/ListMenuPresenter;->getAdapter()Landroid/widget/ListAdapter;
    ...
    .line 65
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuBuilder;->getHeaderView()Landroid/view/View;
    ...
    .line 71
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuBuilder;->getHeaderIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuBuilder;->getHeaderTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/view/Window;->getAttributes()Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/app/AlertDialog;->show()V
