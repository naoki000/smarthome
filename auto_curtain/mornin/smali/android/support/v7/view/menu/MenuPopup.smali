...
.method protected static measureIndividualMenuWidth(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I
    ...
    .line 148
    invoke-interface/range {p0 .. p0}, Landroid/widget/ListAdapter;->getCount()I
...
.method protected static shouldPreserveIconSpacing(Landroid/support/v7/view/menu/MenuBuilder;)Z
    ...
    .line 206
    invoke-interface/range {v3 .. v3}, Landroid/view/MenuItem;->isVisible()Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-interface/range {v3 .. v3}, Landroid/view/MenuItem;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method protected static toMenuAdapter(Landroid/widget/ListAdapter;)Landroid/support/v7/view/menu/MenuAdapter;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/widget/HeaderViewListAdapter;->getWrappedAdapter()Landroid/widget/ListAdapter;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 123
    invoke-static/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuPopup;->toMenuAdapter(Landroid/widget/ListAdapter;)Landroid/support/v7/view/menu/MenuAdapter;
    ...
    .line 130
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuPopup;->closeMenuOnSubMenuOpened()Z
