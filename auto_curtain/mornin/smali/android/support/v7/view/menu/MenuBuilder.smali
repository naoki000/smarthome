...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v0 .. v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V
...
.method private dispatchPresenterUpdate(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/concurrent/CopyOnWriteArrayList;->isEmpty()Z
    ...
    .line 285
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->stopDispatchingItemsChanged()V
    ...
    .line 294
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->startDispatchingItemsChanged()V
...
.method private dispatchRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    .line 352
    :cond_2
    invoke-interface/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuPresenter;->getId()I
...
.method private dispatchSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/util/concurrent/CopyOnWriteArrayList;->iterator()Ljava/util/Iterator;
    ...
    .line 325
    invoke-virtual/range {v2 .. v2}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;
    ...
    .line 329
    :cond_2
    invoke-interface/range {v3 .. v3}, Landroid/support/v7/view/menu/MenuPresenter;->getId()I
    ...
    .line 331
    invoke-interface/range {v3 .. v3}, Landroid/support/v7/view/menu/MenuPresenter;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method private static findInsertIndex(Ljava/util/ArrayList;I)I
    ...
    .line 837
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/view/menu/MenuItemImpl;->getOrdering()I
...
.method private setHeaderInternal(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    .line 1210
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->getResources()Landroid/content/res/Resources;
    ...
    .line 1226
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->getContext()Landroid/content/Context;
...
.method public add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    .line 475
    invoke-virtual/range {p0 .. p4}, Landroid/support/v7/view/menu/MenuBuilder;->addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
...
.method protected addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    .line 440
    invoke-static/range {p3 .. p3}, Landroid/support/v7/view/menu/MenuBuilder;->getOrdering(I)I
...
.method public clearAll()V
    ...
    .line 583
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->clear()V

    .line 584
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->clearHeader()V
...
.method public findGroupIndex(II)I
    ...
    .line 717
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->size()I
    ...
    .line 726
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/view/menu/MenuItemImpl;->getGroupId()I
...
.method public findItem(I)Landroid/view/MenuItem;
    ...
    .line 685
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuItemImpl;->getItemId()I
    ...
    .line 687
    :cond_0
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuItemImpl;->hasSubMenu()Z
    ...
    .line 688
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuItemImpl;->getSubMenu()Landroid/view/SubMenu;
...
.method findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/view/KeyCharacterMap$KeyData;-><init>()V
    ...
    .line 942
    invoke-virtual/range {v7 .. v7}, Landroid/support/v7/view/menu/MenuItemImpl;->getAlphabeticShortcut()C
    ...
    .line 943
    :cond_2
    invoke-virtual/range {v7 .. v7}, Landroid/support/v7/view/menu/MenuItemImpl;->getNumericShortcut()C
...
.method findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    invoke-direct/range {v2 .. v2}, Landroid/view/KeyCharacterMap$KeyData;-><init>()V
    ...
    .line 884
    invoke-virtual/range {v7 .. v7}, Landroid/support/v7/view/menu/MenuItemImpl;->hasSubMenu()Z
    ...
    .line 885
    invoke-virtual/range {v7 .. v7}, Landroid/support/v7/view/menu/MenuItemImpl;->getSubMenu()Landroid/view/SubMenu;
    ...
    .line 890
    invoke-virtual/range {v7 .. v7}, Landroid/support/v7/view/menu/MenuItemImpl;->getAlphabeticModifiers()I
    ...
    :cond_3
    invoke-virtual/range {v7 .. v7}, Landroid/support/v7/view/menu/MenuItemImpl;->getNumericModifiers()I
    ...
    .line 898
    :cond_5
    invoke-virtual/range {v7 .. v7}, Landroid/support/v7/view/menu/MenuItemImpl;->isEnabled()Z
...
.method public flagActionItems()V
    ...
    .line 1151
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->getVisibleItems()Ljava/util/ArrayList;
    ...
    .line 1160
    invoke-virtual/range {v4 .. v4}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;
    ...
    .line 1164
    :cond_1
    invoke-interface/range {v5 .. v5}, Landroid/support/v7/view/menu/MenuPresenter;->flagActionItems()Z
    ...
    .line 1174
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/view/menu/MenuItemImpl;->isActionButton()Z
...
.method public getActionItems()Ljava/util/ArrayList;
    ...
    .line 1191
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->flagActionItems()V
...
.method public getVisibleItems()Ljava/util/ArrayList;
    ...
    .line 1115
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/view/menu/MenuItemImpl;->isVisible()Z
...
.method public hasVisibleItems()Z
    ...
    .line 672
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/view/menu/MenuItemImpl;->isVisible()Z
...
.method public isShortcutKey(ILandroid/view/KeyEvent;)Z
    ...
    .line 746
    invoke-virtual/range {p0 .. p2}, Landroid/support/v7/view/menu/MenuBuilder;->findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Landroid/support/v7/view/menu/MenuItemImpl;
...
.method public onItemsChanged(Z)V
    ...
    .line 1051
    :cond_0
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->dispatchPresenterUpdate(Z)V
...
.method public performIdentifierAction(II)Z
    ...
    .line 959
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->findItem(I)Landroid/view/MenuItem;
...
.method public performItemAction(Landroid/view/MenuItem;Landroid/support/v7/view/menu/MenuPresenter;I)Z
    ...
    .line 969
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->isEnabled()Z
    ...
    .line 973
    :cond_0
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->invoke()Z

    move-result v1

    .line 975
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->getSupportActionProvider()Landroid/support/v4/view/ActionProvider;
    ...
    .line 976
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/view/ActionProvider;->hasSubMenu()Z
    ...
    .line 977
    :goto_0
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->hasCollapsibleActionView()Z
    ...
    .line 978
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->expandActionView()Z
    ...
    .line 982
    :cond_2
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->hasSubMenu()Z
    ...
    .line 992
    :cond_6
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->getSubMenu()Landroid/view/SubMenu;
...
.method public removeGroup(I)V
    ...
    .line 544
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->findGroupIndex(I)I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/view/menu/MenuItemImpl;->getGroupId()I
...
.method public removeItem(I)V
    ...
    .line 539
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->findItemIndex(I)I
...
.method public restoreActionViewStates(Landroid/os/Bundle;)V
    ...
    .line 404
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->getActionViewStatesKey()Ljava/lang/String;
    ...
    .line 409
    invoke-interface/range {v3 .. v3}, Landroid/view/MenuItem;->getActionView()Landroid/view/View;
    ...
    .line 413
    :cond_1
    invoke-interface/range {v3 .. v3}, Landroid/view/MenuItem;->hasSubMenu()Z
    ...
    .line 414
    invoke-interface/range {v3 .. v3}, Landroid/view/MenuItem;->getSubMenu()Landroid/view/SubMenu;
    ...
    .line 423
    invoke-interface/range {p1 .. p1}, Landroid/view/MenuItem;->expandActionView()Z
...
.method public restorePresenterStates(Landroid/os/Bundle;)V
    ...
    .line 368
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->dispatchRestoreInstanceState(Landroid/os/Bundle;)V
...
.method public saveActionViewStates(Landroid/os/Bundle;)V
    ...
    .line 383
    invoke-interface/range {v3 .. v3}, Landroid/view/MenuItem;->isActionViewExpanded()Z
    ...
    .line 384
    invoke-interface/range {v3 .. v3}, Landroid/view/MenuItem;->getItemId()I
...
.method public savePresenterStates(Landroid/os/Bundle;)V
    ...
    .line 364
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->dispatchSaveInstanceState(Landroid/os/Bundle;)V
...
.method setExclusiveItemChecked(Landroid/view/MenuItem;)V
    ...
    .line 608
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/view/menu/MenuItemImpl;->getGroupId()I
    ...
    .line 609
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/view/menu/MenuItemImpl;->isExclusiveCheckable()Z
    ...
    .line 610
    :cond_0
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/view/menu/MenuItemImpl;->isCheckable()Z
...
.method public setGroupCheckable(IZZ)V
    ...
    .line 625
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/MenuItemImpl;->getGroupId()I
...
.method public setShortcutsVisible(Z)V
    ...
    .line 796
    :cond_0
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->setShortcutsVisibleInner(Z)V
