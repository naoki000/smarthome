...
.method declared-synchronized next()Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;->access$000(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
...
.method declared-synchronized removeMessages(I)V
    ...
    .line 265
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;->recycle()V
    ...
    .line 269
    invoke-static/range {v0 .. v0}, Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;->access$000(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
    ...
    .line 274
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;->recycle()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
