...
.method private applyFrameworkTintUsingColorFilter(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/TintInfo;-><init>()V
    ...
    .line 199
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/TintInfo;->clear()V

    .line 201
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mView:Landroid/widget/ImageView;

    invoke-static/range {v1 .. v1}, Landroid/support/v4/widget/ImageViewCompat;->getImageTintList(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v4/widget/ImageViewCompat;->getImageTintMode(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/ImageView;->getDrawableState()[I
...
.method applySupportImageTint()V
    ...
    .line 142
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatImageHelper;->shouldApplyFrameworkTintUsingColorFilter()Z
    ...
    .line 151
    invoke-virtual/range {v2 .. v2}, Landroid/widget/ImageView;->getDrawableState()[I
...
.method hasOverlappingRendering()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageView;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method public loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageView;->getContext()Landroid/content/Context;
    ...
    .line 66
    invoke-static/range {p2 .. p2}, Landroid/support/v7/widget/DrawableUtils;->fixDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setImageResource(I)V
    ...
    .line 87
    invoke-static/range {p1 .. p1}, Landroid/support/v7/widget/DrawableUtils;->fixDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 94
    :goto_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatImageHelper;->applySupportImageTint()V
