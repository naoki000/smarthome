...
.method private createStaticLayoutForMeasuring(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    .line 720
    invoke-virtual/range {p3 .. p3}, Landroid/widget/TextView;->getLineSpacingMultiplier()F
    ...
    .line 726
    invoke-virtual/range {p1 .. p1}, Landroid/text/StaticLayout$Builder;->build()Landroid/text/StaticLayout;
...
.method private createStaticLayoutForMeasuringPre23(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/TextView;->getLineSpacingMultiplier()F
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getLineSpacingExtra()F
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/widget/TextView;->getIncludeFontPadding()Z
    ...
    .line 745
    invoke-static/range {v2 .. v2}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/lang/Float;->floatValue()F
...
.method private setRawTextSize(F)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/TextView;->getPaint()Landroid/text/TextPaint;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/text/TextPaint;->getTextSize()F
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/TextView;->isInLayout()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/TextView;->requestLayout()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/TextView;->forceLayout()V

    .line 631
    :goto_2
    iget-object p1, p0, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->mTextView:Landroid/widget/TextView;

    invoke-virtual/range {p1 .. p1}, Landroid/widget/TextView;->invalidate()V
...
.method private setupAutoSizeText()Z
    ...
    .line 509
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->supportsAutoSizeText()Z
    ...
    .line 518
    invoke-static/range {v5 .. v5}, Ljava/lang/Math;->round(F)I
...
.method private setupAutoSizeUniformPresetSizes(Landroid/content/res/TypedArray;)V
    ...
    .line 420
    invoke-virtual/range {p1 .. p1}, Landroid/content/res/TypedArray;->length()I
    ...
    .line 428
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->setupAutoSizeUniformPresetSizesConfiguration()Z
...
.method private suggestedSizeFitsInSpace(ILandroid/graphics/RectF;)Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getTransformationMethod()Landroid/text/method/TransformationMethod;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getMaxLines()I
    ...
    invoke-direct/range {v2 .. v2}, Landroid/text/TextPaint;-><init>()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/text/TextPaint;->reset()V
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/widget/TextView;->getPaint()Landroid/text/TextPaint;
...
.method autoSizeText()V
    ...
    .line 546
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->isAutoSizeEnabled()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getTotalPaddingLeft()I
    ...
    .line 560
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getTotalPaddingRight()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getHeight()I

    move-result v1

    iget-object v3, p0, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->mTextView:Landroid/widget/TextView;

    invoke-virtual/range {v3 .. v3}, Landroid/widget/TextView;->getCompoundPaddingBottom()I
    ...
    .line 562
    invoke-virtual/range {v3 .. v3}, Landroid/widget/TextView;->getCompoundPaddingTop()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/RectF;->setEmpty()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getTextSize()F
...
.method loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    .line 174
    :cond_8
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->setupAutoSizeText()Z
...
.method setAutoSizeTextTypeUniformWithConfiguration(IIII)V
    ...
    .line 277
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->autoSizeText()V
...
.method setAutoSizeTextTypeWithDefaults(I)V
    ...
    .line 200
    :pswitch_1
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatTextViewAutoSizeHelper;->clearAutoSizeConfiguration()V
