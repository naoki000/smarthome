...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 83
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/LinearLayoutManager;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/util/SparseIntArray;-><init>()V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/support/v7/widget/GridLayoutManager$DefaultSpanSizeLookup;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 71
    invoke-direct/range {p0 .. p4}, Landroid/support/v7/widget/LinearLayoutManager;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/util/SparseIntArray;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/GridLayoutManager$DefaultSpanSizeLookup;-><init>()V
    ...
    .line 72
    invoke-static/range {p1 .. p4}, Landroid/support/v7/widget/GridLayoutManager;->getProperties(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/support/v7/widget/RecyclerView$LayoutManager$Properties;
...
.method private cachePreLayoutSpanMapping()V
    ...
    .line 192
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->getViewLayoutPosition()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->getSpanSize()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->getSpanIndex()I
...
.method private clearPreLayoutSpanMappingCache()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/util/SparseIntArray;->clear()V
...
.method private measureChild(Landroid/view/View;IZ)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->getHeightMode()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->getWidthMode()I
...
.method private measureChildWithDecorationsAndMargin(Landroid/view/View;IIZ)V
    ...
    .line 760
    invoke-virtual/range {p1 .. p3}, Landroid/view/View;->measure(II)V
...
.method private updateMeasurements()V
    ...
    .line 275
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->getOrientation()I
    ...
    .line 276
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->getWidth()I

    move-result v0

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->getPaddingRight()I
    ...
    .line 278
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->getHeight()I

    move-result v0

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->getPaddingBottom()I
...
.method findReferenceChild(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;III)Landroid/view/View;
    ...
    .line 416
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->ensureLayoutState()V
...
.method layoutChunk(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Landroid/support/v7/widget/LinearLayoutManager$LayoutState;Landroid/support/v7/widget/LinearLayoutManager$LayoutChunkResult;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/OrientationHelper;->getModeInOther()I
    ...
    .line 693
    invoke-virtual/range {v9 .. v9}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->isItemRemoved()Z

    move-result v0

    if-nez v0, :cond_1a

    invoke-virtual/range {v9 .. v9}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->isItemChanged()Z
    ...
    invoke-virtual/range {v7 .. v7}, Landroid/view/View;->hasFocusable()Z
...
.method onAnchorReady(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Landroid/support/v7/widget/LinearLayoutManager$AnchorInfo;I)V
    ...
    .line 354
    invoke-super/range {p0 .. p4}, Landroid/support/v7/widget/LinearLayoutManager;->onAnchorReady(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Landroid/support/v7/widget/LinearLayoutManager$AnchorInfo;I)V
    ...
    .line 357
    invoke-direct/range {p0 .. p4}, Landroid/support/v7/widget/GridLayoutManager;->ensureAnchorIsInCorrectSpan(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Landroid/support/v7/widget/LinearLayoutManager$AnchorInfo;I)V

    .line 359
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->ensureViewSet()V
...
.method public onInitializeAccessibilityNodeInfoForItem(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Landroid/view/View;Landroid/support/v4/view/accessibility/AccessibilityNodeInfoCompat;)V
    ...
    .line 151
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->getViewLayoutPosition()I
    ...
    .line 154
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->getSpanIndex()I

    move-result p2

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/GridLayoutManager$LayoutParams;->getSpanSize()I
...
.method public onItemsAdded(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/GridLayoutManager$SpanSizeLookup;->invalidateSpanIndexCache()V
...
.method public onLayoutChildren(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)V
    ...
    .line 168
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->cachePreLayoutSpanMapping()V

    .line 170
    :cond_0
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/LinearLayoutManager;->onLayoutChildren(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)V

    .line 174
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->clearPreLayoutSpanMappingCache()V
...
.method public onLayoutCompleted(Landroid/support/v7/widget/RecyclerView$State;)V
    ...
    .line 179
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/LinearLayoutManager;->onLayoutCompleted(Landroid/support/v7/widget/RecyclerView$State;)V
...
.method public scrollHorizontallyBy(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
    ...
    .line 373
    invoke-super/range {p0 .. p3}, Landroid/support/v7/widget/LinearLayoutManager;->scrollHorizontallyBy(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
...
.method public scrollVerticallyBy(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
    ...
    .line 381
    invoke-super/range {p0 .. p3}, Landroid/support/v7/widget/LinearLayoutManager;->scrollVerticallyBy(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
...
.method public setMeasuredDimension(Landroid/graphics/Rect;II)V
    ...
    .line 286
    invoke-super/range {p0 .. p3}, Landroid/support/v7/widget/LinearLayoutManager;->setMeasuredDimension(Landroid/graphics/Rect;II)V
    ...
    .line 293
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->getMinimumHeight()I
    ...
    .line 295
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->getMinimumWidth()I
...
.method public setSpanCount(I)V
    ...
    .line 819
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->requestLayout()V
