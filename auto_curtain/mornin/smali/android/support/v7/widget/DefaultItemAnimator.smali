...
.method public constructor <init>()V
    ...
    .line 38
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SimpleItemAnimator;-><init>()V
...
.method private animateRemoveImpl(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 200
    invoke-virtual/range {v0 .. v0}, Landroid/view/View;->animate()Landroid/view/ViewPropertyAnimator;
...
.method private resetAnimation(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/ValueAnimator;->getInterpolator()Landroid/animation/TimeInterpolator;
...
.method animateAddImpl(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/DefaultItemAnimator;->getAddDuration()J
...
.method animateChangeImpl(Landroid/support/v7/widget/DefaultItemAnimator$ChangeInfo;)V
    ...
    .line 374
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewPropertyAnimator;->start()V

    :cond_2
    if-eqz v1, :cond_3

    .line 377
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->animate()Landroid/view/ViewPropertyAnimator;
...
.method animateMoveImpl(Landroid/support/v7/widget/RecyclerView$ViewHolder;IIII)V
    ...
    .line 282
    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->animate()Landroid/view/ViewPropertyAnimator;
...
.method public canReuseUpdatedViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;Ljava/util/List;)Z
    ...
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/SimpleItemAnimator;->canReuseUpdatedViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;Ljava/util/List;)Z
...
.method cancelAll(Ljava/util/List;)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/ViewPropertyAnimator;->cancel()V
...
.method dispatchFinishedWhenDone()V
    ...
    .line 550
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/DefaultItemAnimator;->isRunning()Z
    ...
    .line 551
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/DefaultItemAnimator;->dispatchAnimationsFinished()V
...
.method public endAnimation(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 453
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/DefaultItemAnimator;->dispatchRemoveFinished(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 457
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/DefaultItemAnimator;->dispatchAddFinished(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 463
    invoke-virtual/range {v4 .. v4}, Ljava/util/ArrayList;->isEmpty()Z
    ...
    .line 488
    invoke-virtual/range {v2 .. v2}, Ljava/util/ArrayList;->isEmpty()Z
    ...
    .line 518
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/DefaultItemAnimator;->dispatchFinishedWhenDone()V
...
.method public endAnimations()V
    ...
    .line 600
    invoke-virtual/range {v3 .. v3}, Ljava/util/ArrayList;->isEmpty()Z
...
.method public runPendingAnimations()V
    ...
    invoke-virtual/range {v4 .. v4}, Ljava/util/ArrayList;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual/range {v4 .. v4}, Ljava/util/ArrayList;->clear()V
    ...
    invoke-virtual/range {v6 .. v6}, Ljava/util/ArrayList;->clear()V
    ...
    .line 136
    :cond_2
    invoke-interface/range {v6 .. v6}, Ljava/lang/Runnable;->run()V
    ...
    invoke-virtual/range {v5 .. v5}, Ljava/util/ArrayList;->clear()V
    ...
    .line 186
    :cond_6
    invoke-interface/range {v5 .. v5}, Ljava/lang/Runnable;->run()V
