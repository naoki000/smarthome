...
.method private attachAccessibilityDelegateOnBind(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView;->isAccessibilityEnabled()Z
    ...
    .line 5935
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/ViewCompat;->getImportantForAccessibility(Landroid/view/View;)I
    ...
    .line 5940
    :cond_0
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/ViewCompat;->hasAccessibilityDelegate(Landroid/view/View;)Z
    ...
    .line 5943
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerViewAccessibilityDelegate;->getItemDelegate()Landroid/support/v4/view/AccessibilityDelegateCompat;
...
.method private invalidateDisplayListInt(Landroid/view/ViewGroup;Z)V
    ...
    .line 5965
    :cond_2
    invoke-virtual/range {p1 .. p1}, Landroid/view/ViewGroup;->getVisibility()I
...
.method private tryBindViewHolderByDeadline(Landroid/support/v7/widget/RecyclerView$ViewHolder;IIJ)Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView;->getNanoTime()J
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/RecyclerView;->getNanoTime()J
    ...
    .line 5650
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView$Recycler;->attachAccessibilityDelegateOnBind(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
...
.method addViewHolderToRecycledViewPool(Landroid/support/v7/widget/RecyclerView$ViewHolder;Z)V
    ...
    .line 6144
    invoke-static/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView;->clearNestedRecyclerViewIfNotNested(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 6150
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView$Recycler;->dispatchViewRecycled(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
...
.method public bindViewToPosition(Landroid/view/View;I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$Adapter;->getItemCount()I
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/RecyclerView;->generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/RecyclerView;->exceptionLabel()Ljava/lang/String;
    ...
    .line 5677
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView;->exceptionLabel()Ljava/lang/String;
...
.method public clear()V
    ...
    .line 5557
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView$Recycler;->recycleAndClearCachedViews()V
...
.method clearOldPositions()V
    ...
    .line 6524
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->clearOldPosition()V
...
.method public convertPreLayoutPositionToPostLayout(I)I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$State;->getItemCount()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$State;->isPreLayout()Z
...
.method getChangedScrapViewForPosition(I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 6239
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->wasReturnedFromScrap()Z

    move-result v6

    if-nez v6, :cond_1

    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getLayoutPosition()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$Adapter;->hasStableIds()Z
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$Adapter;->getItemCount()I
    ...
    .line 6251
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->wasReturnedFromScrap()Z
...
.method getRecycledViewPool()Landroid/support/v7/widget/RecyclerView$RecycledViewPool;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$RecycledViewPool;-><init>()V
...
.method getScrapOrCachedViewForId(JIZ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->wasReturnedFromScrap()Z
    ...
    .line 6327
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getItemViewType()I
    ...
    .line 6359
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getItemId()J
    ...
    .line 6360
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getItemViewType()I
...
.method getScrapOrHiddenOrCachedHolderForPosition(IZ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 6274
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->wasReturnedFromScrap()Z
    ...
    .line 6307
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isInvalid()Z

    move-result v3

    if-nez v3, :cond_6

    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getLayoutPosition()I
...
.method onAdapterChanged(Landroid/support/v7/widget/RecyclerView$Adapter;Landroid/support/v7/widget/RecyclerView$Adapter;Z)V
    ...
    .line 6389
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView$Recycler;->clear()V
...
.method quickRecycleScrapView(Landroid/view/View;)V
    ...
    .line 6165
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->clearReturnedFromScrapFlag()V
...
.method recycleAndClearCachedViews()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;->clearPrefetchPositions()V
...
.method public recycleView(Landroid/view/View;)V
    ...
    .line 5992
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isScrap()Z
    ...
    .line 5993
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->unScrap()V

    goto :goto_0

    .line 5994
    :cond_1
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->wasReturnedFromScrap()Z
    ...
    .line 5995
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->clearReturnedFromScrapFlag()V
...
.method recycleViewHolderInternal(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 6049
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isScrap()Z
    ...
    .line 6069
    invoke-static/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->access$900(Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
    ...
    .line 6079
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isRecyclable()Z
    ...
    .line 6065
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView;->exceptionLabel()Ljava/lang/String;
...
.method scrapView(Landroid/view/View;)V
    ...
    :cond_2
    :goto_0
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isInvalid()Z
...
.method setRecycledViewPool(Landroid/support/v7/widget/RecyclerView$RecycledViewPool;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$RecycledViewPool;->detach()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView;->getAdapter()Landroid/support/v7/widget/RecyclerView$Adapter;
...
.method public setViewCacheSize(I)V
    ...
    .line 5567
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView$Recycler;->updateViewCacheSize()V
...
.method tryGetViewHolderForPositionByDeadline(IZJ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 5798
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isScrap()Z
    ...
    .line 5800
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->unScrap()V
    ...
    .line 5802
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->clearReturnedFromScrapFlag()V
    ...
    invoke-virtual/range {v9 .. v9}, Landroid/support/v7/widget/RecyclerView$Adapter;->getItemCount()I
    ...
    invoke-virtual/range {v10 .. v10}, Landroid/support/v7/widget/RecyclerView$Adapter;->hasStableIds()Z
    ...
    .line 5845
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView;->exceptionLabel()Ljava/lang/String;
    ...
    .line 5856
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->resetInternal()V
    ...
    invoke-static/range {v5 .. v5}, Landroid/support/v7/widget/RecyclerView;->findNestedRecyclerView(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/RecyclerView;->getNanoTime()J
    ...
    .line 5817
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$State;->getItemCount()I
    ...
    .line 5894
    invoke-static/range {v10 .. v10}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->buildAdapterChangeFlagsForAnimations(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    .line 5897
    invoke-virtual/range {v10 .. v10}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getUnmodifiedPayloads()Ljava/util/List;
    ...
    invoke-virtual/range {v10 .. v10}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isBound()Z
    ...
    invoke-virtual/range {v10 .. v10}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->needsUpdate()Z

    move-result v0

    if-nez v0, :cond_13

    invoke-virtual/range {v10 .. v10}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isInvalid()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView;->generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
...
.method unscrapView(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 6205
    invoke-static/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->access$1100(Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
