...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 1844
    invoke-direct/range {p0 .. p3}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 1845
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getThreshold()I
...
.method static synthetic access$000(Landroid/support/v7/widget/SearchView$SearchAutoComplete;Z)V
    ...
    .line 1822
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->setImeVisibility(Z)V
...
.method static synthetic access$100(Landroid/support/v7/widget/SearchView$SearchAutoComplete;)Z
    ...
    .line 1822
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->isEmpty()Z
...
.method static synthetic access$200(Landroid/support/v7/widget/SearchView$SearchAutoComplete;)V
    ...
    .line 1822
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->showSoftInputIfNecessary()V
...
.method private getSearchViewTextMinWidthDp()I
    ...
    .line 1958
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getResources()Landroid/content/res/Resources;
...
.method private isEmpty()Z
    ...
    .line 1870
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getText()Landroid/text/Editable;
...
.method private setImeVisibility(Z)V
    ...
    .line 1996
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getContext()Landroid/content/Context;
    ...
    .line 2000
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getWindowToken()Landroid/os/IBinder;
...
.method public enoughToFilter()Z
    ...
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->enoughToFilter()Z
...
.method public onCreateInputConnection(Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    .line 1977
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->onCreateInputConnection(Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
...
.method protected onFinishInflate()V
    ...
    .line 1850
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->onFinishInflate()V
    ...
    .line 1853
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getSearchViewTextMinWidthDp()I
...
.method protected onFocusChanged(ZILandroid/graphics/Rect;)V
    ...
    .line 1915
    invoke-super/range {p0 .. p3}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->onFocusChanged(ZILandroid/graphics/Rect;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/SearchView;->onTextFocusChanged()V
...
.method public onKeyPreIme(ILandroid/view/KeyEvent;)Z
    ...
    .line 1934
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getKeyDispatcherState()Landroid/view/KeyEvent$DispatcherState;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/SearchView;->clearFocus()V
    ...
    .line 1951
    :cond_3
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->onKeyPreIme(ILandroid/view/KeyEvent;)Z
...
.method public onWindowFocusChanged(Z)V
    ...
    .line 1897
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->onWindowFocusChanged(Z)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/SearchView;->hasFocus()Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getVisibility()I
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/SearchView;->isLandscapeMode(Landroid/content/Context;)Z
...
.method public setThreshold(I)V
    ...
    .line 1862
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatAutoCompleteTextView;->setThreshold(I)V
