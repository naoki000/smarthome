...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 234
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActivityChooserView;->getContext()Landroid/content/Context;
...
.method public dismissPopup()Z
    ...
    .line 409
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActivityChooserView;->isShowingPopup()Z
    ...
    .line 410
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/ListPopupWindow;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ListPopupWindow;->dismiss()V

    .line 411
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActivityChooserView;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    .line 412
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewTreeObserver;->isAlive()Z
...
.method public getDataModel()Landroid/support/v7/widget/ActivityChooserModel;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;->getDataModel()Landroid/support/v7/widget/ActivityChooserModel;
...
.method public isShowingPopup()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ListPopupWindow;->isShowing()Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 450
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActivityChooserView;->dismissPopup()Z
...
.method protected onMeasure(II)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/FrameLayout;->getVisibility()I
...
.method public setActivityChooserModel(Landroid/support/v7/widget/ActivityChooserModel;)V
    ...
    .line 301
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActivityChooserView;->showPopup()Z
...
.method showPopupUnchecked(I)V
    ...
    .line 371
    invoke-virtual/range {v0 .. v0}, Landroid/widget/FrameLayout;->getVisibility()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;->getActivityCount()I
    ...
    .line 385
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ListPopupWindow;->isShowing()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;->measureContentWidth()I
    ...
    .line 393
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ListPopupWindow;->show()V
    ...
    .line 397
    :cond_4
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ListPopupWindow;->getListView()Landroid/widget/ListView;
...
.method updateAppearance()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;->getCount()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;->getActivityCount()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;->getHistorySize()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActivityChooserView$ActivityChooserViewAdapter;->getDefaultActivity()Landroid/content/pm/ResolveInfo;
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;
