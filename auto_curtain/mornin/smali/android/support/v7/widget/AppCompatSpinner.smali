...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    .line 242
    invoke-virtual/range {p5 .. p5}, Landroid/support/v7/widget/TintTypedArray;->recycle()V
    ...
    .line 270
    :cond_7
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/TintTypedArray;->recycle()V
...
.method compatMeasureContentWidth(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    .line 550
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner;->getMeasuredWidth()I
    ...
    .line 552
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner;->getMeasuredHeight()I
    ...
    .line 556
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner;->getSelectedItemPosition()I
...
.method protected drawableStateChanged()V
    ...
    .line 535
    invoke-super/range {p0 .. p0}, Landroid/widget/Spinner;->drawableStateChanged()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatBackgroundHelper;->applySupportBackgroundTint()V
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->getHorizontalOffset()I
    ...
    .line 360
    invoke-super/range {p0 .. p0}, Landroid/widget/Spinner;->getDropDownHorizontalOffset()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->getVerticalOffset()I
    ...
    .line 335
    invoke-super/range {p0 .. p0}, Landroid/widget/Spinner;->getDropDownVerticalOffset()I
...
.method public getDropDownWidth()I
    ...
    .line 379
    invoke-super/range {p0 .. p0}, Landroid/widget/Spinner;->getDropDownWidth()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 316
    invoke-super/range {p0 .. p0}, Landroid/widget/Spinner;->getPopupBackground()Landroid/graphics/drawable/Drawable;
...
.method public getPopupContext()Landroid/content/Context;
    ...
    .line 292
    invoke-super/range {p0 .. p0}, Landroid/widget/Spinner;->getPopupContext()Landroid/content/Context;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->getHintText()Ljava/lang/CharSequence;
    ...
    :cond_0
    invoke-super/range {p0 .. p0}, Landroid/widget/Spinner;->getPrompt()Ljava/lang/CharSequence;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .line 501
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatBackgroundHelper;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 530
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatBackgroundHelper;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method protected onDetachedFromWindow()V
    ...
    .line 403
    invoke-super/range {p0 .. p0}, Landroid/widget/Spinner;->onDetachedFromWindow()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->isShowing()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->dismiss()V
...
.method protected onMeasure(II)V
    ...
    .line 420
    invoke-super/range {p0 .. p2}, Landroid/widget/Spinner;->onMeasure(II)V
    ...
    .line 425
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner;->getAdapter()Landroid/widget/SpinnerAdapter;

    move-result-object v0

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 415
    :cond_0
    invoke-super/range {p0 .. p1}, Landroid/widget/Spinner;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public performClick()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->show()V
    ...
    .line 442
    :cond_1
    invoke-super/range {p0 .. p0}, Landroid/widget/Spinner;->performClick()Z
...
.method public bridge synthetic setAdapter(Landroid/widget/Adapter;)V
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatSpinner;->setAdapter(Landroid/widget/SpinnerAdapter;)V
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 393
    :cond_0
    invoke-super/range {p0 .. p1}, Landroid/widget/Spinner;->setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner;->getContext()Landroid/content/Context;
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 469
    invoke-super/range {p0 .. p1}, Landroid/widget/Spinner;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setBackgroundResource(I)V
    ...
    .line 461
    invoke-super/range {p0 .. p1}, Landroid/widget/Spinner;->setBackgroundResource(I)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    .line 345
    invoke-super/range {p0 .. p1}, Landroid/widget/Spinner;->setDropDownHorizontalOffset(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    .line 326
    invoke-super/range {p0 .. p1}, Landroid/widget/Spinner;->setDropDownVerticalOffset(I)V
...
.method public setDropDownWidth(I)V
    ...
    .line 370
    invoke-super/range {p0 .. p1}, Landroid/widget/Spinner;->setDropDownWidth(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 302
    invoke-super/range {p0 .. p1}, Landroid/widget/Spinner;->setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setPopupBackgroundResource(I)V
    ...
    .line 308
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner;->getPopupContext()Landroid/content/Context;
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    .line 450
    :cond_0
    invoke-super/range {p0 .. p1}, Landroid/widget/Spinner;->setPrompt(Ljava/lang/CharSequence;)V
