...
.method private addSystemView(Landroid/view/View;Z)V
    ...
    .line 1392
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->generateDefaultLayoutParams()Landroid/support/v7/widget/Toolbar$LayoutParams;
...
.method private ensureContentInsets()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/RtlSpacingHelper;-><init>()V
...
.method private ensureMenu()V
    ...
    .line 1032
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->ensureMenuView()V

    .line 1033
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->mMenuView:Landroid/support/v7/widget/ActionMenuView;

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->peekMenu()Landroid/support/v7/view/menu/MenuBuilder;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->getMenu()Landroid/view/Menu;
...
.method private getHorizontalMargins(Landroid/view/View;)I
    ...
    .line 2066
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/MarginLayoutParamsCompat;->getMarginStart(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v0

    .line 2067
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/MarginLayoutParamsCompat;->getMarginEnd(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private getViewListMeasuredWidth(Ljava/util/List;[I)I
    ...
    .line 1928
    invoke-virtual/range {v5 .. v5}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1935
    invoke-virtual/range {v5 .. v5}, Landroid/view/View;->getMeasuredWidth()I
...
.method public canShowOverflowMenu()Z
    ...
    .line 506
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->getVisibility()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->isOverflowReserved()Z
...
.method public collapseActionView()V
    ...
    .line 717
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuItemImpl;->collapseActionView()Z
...
.method public dismissPopupMenus()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->dismissPopupMenus()V
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 141
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/Toolbar;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/v7/widget/Toolbar$LayoutParams;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 141
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/Toolbar;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/Toolbar$LayoutParams;
...
.method public getContentInsetEnd()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RtlSpacingHelper;->getEnd()I
...
.method public getContentInsetLeft()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RtlSpacingHelper;->getLeft()I
...
.method public getContentInsetRight()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RtlSpacingHelper;->getRight()I
...
.method public getContentInsetStart()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RtlSpacingHelper;->getStart()I
...
.method public getCurrentContentInsetEnd()I
    ...
    .line 1322
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuBuilder;->hasVisibleItems()Z
...
.method public getCurrentContentInsetStart()I
    ...
    .line 1305
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->getNavigationIcon()Landroid/graphics/drawable/Drawable;
...
.method public getLogoDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageView;->getContentDescription()Ljava/lang/CharSequence;
...
.method public getMenu()Landroid/view/Menu;
    ...
    .line 1006
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->ensureMenu()V
...
.method public getNavigationContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageButton;->getContentDescription()Ljava/lang/CharSequence;
...
.method public getNavigationIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageButton;->getDrawable()Landroid/graphics/drawable/Drawable;
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->getOverflowIcon()Landroid/graphics/drawable/Drawable;
...
.method public hideOverflowMenu()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->hideOverflowMenu()Z
...
.method public inflateMenu(I)V
    ...
    .line 1070
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->getMenuInflater()Landroid/view/MenuInflater;

    move-result-object v0

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->getMenu()Landroid/view/Menu;
...
.method public isOverflowMenuShowPending()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->isOverflowMenuShowPending()Z
...
.method public isOverflowMenuShowing()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->isOverflowMenuShowing()Z
...
.method public isTitleTruncated()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/TextView;->getLayout()Landroid/text/Layout;
    ...
    .line 601
    :cond_1
    invoke-virtual/range {v0 .. v0}, Landroid/text/Layout;->getLineCount()I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1491
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->onHoverEvent(Landroid/view/MotionEvent;)Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual/range {v15 .. v15}, Landroid/widget/TextView;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual/range {v7 .. v7}, Landroid/widget/TextView;->getMeasuredHeight()I
    ...
    invoke-virtual/range {v7 .. v7}, Landroid/widget/TextView;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/widget/TextView;->getMeasuredHeight()I
    ...
    invoke-virtual/range {v15 .. v15}, Landroid/widget/TextView;->getMeasuredWidth()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/widget/TextView;->getMeasuredWidth()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/widget/TextView;->getMeasuredHeight()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/widget/TextView;->getMeasuredWidth()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/widget/TextView;->getMeasuredWidth()I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/widget/TextView;->getMeasuredHeight()I
...
.method protected onMeasure(II)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageButton;->getMeasuredWidth()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/ImageButton;->getMeasuredHeight()I
    ...
    .line 1595
    invoke-virtual/range {v2 .. v2}, Landroid/widget/ImageButton;->getMeasuredState()I
    ...
    .line 1606
    invoke-virtual/range {v1 .. v1}, Landroid/widget/ImageButton;->getMeasuredState()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->getMeasuredWidth()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/ActionMenuView;->getMeasuredHeight()I
    ...
    .line 1621
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/ActionMenuView;->getMeasuredState()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageView;->getMeasuredHeight()I
    ...
    .line 1643
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageView;->getMeasuredState()I
    ...
    .line 1649
    invoke-virtual/range {v15 .. v15}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1657
    invoke-virtual/range {v15 .. v15}, Landroid/view/View;->getMeasuredHeight()I
    ...
    .line 1658
    invoke-virtual/range {v15 .. v15}, Landroid/view/View;->getMeasuredState()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getMeasuredHeight()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/widget/TextView;->getMeasuredState()I
    ...
    .line 1681
    invoke-virtual/range {v0 .. v0}, Landroid/widget/TextView;->getMeasuredState()I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1428
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/Toolbar$SavedState;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 1434
    invoke-interface/range {v0 .. v0}, Landroid/view/MenuItem;->expandActionView()Z
    ...
    .line 1439
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->postShowOverflowMenu()V
...
.method public onRtlPropertiesChanged(I)V
    ...
    .line 483
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->onRtlPropertiesChanged(I)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/view/menu/MenuItemImpl;->getItemId()I
    ...
    .line 1416
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->isOverflowMenuShowing()Z
...
.method public setCollapsible(Z)V
    ...
    .line 2150
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->requestLayout()V
...
.method public setLogo(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 621
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->ensureLogoView()V
...
.method public setNavigationContentDescription(Ljava/lang/CharSequence;)V
    ...
    .line 917
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->ensureNavButtonView()V
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->setSingleLine()V
...
.method public showOverflowMenu()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuView;->showOverflowMenu()Z
