...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 86
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/ActionBarPolicy;->getTabContainerHeight()I
    ...
    .line 87
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/ActionBarPolicy;->getStackedTabMaxWidth()I
    ...
    .line 89
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->createTabLayout()Landroid/support/v7/widget/LinearLayoutCompat;
...
.method private createSpinner()Landroid/widget/Spinner;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->getContext()Landroid/content/Context;
...
.method private isCollapsed()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/Spinner;->getParent()Landroid/view/ViewParent;
...
.method private performCollapse()V
    ...
    .line 153
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->isCollapsed()Z
    ...
    .line 156
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->createSpinner()Landroid/widget/Spinner;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/Spinner;->getAdapter()Landroid/widget/SpinnerAdapter;
...
.method private performExpand()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/Spinner;->getSelectedItemPosition()I
...
.method public addTab(Landroid/support/v7/app/ActionBar$Tab;IZ)V
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/widget/Spinner;->getAdapter()Landroid/widget/SpinnerAdapter;

    move-result-object p2

    check-cast p2, Landroid/support/v7/widget/ScrollingTabContainerView$TabAdapter;

    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/ScrollingTabContainerView$TabAdapter;->notifyDataSetChanged()V
    ...
    .line 334
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->requestLayout()V
...
.method public addTab(Landroid/support/v7/app/ActionBar$Tab;Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ScrollingTabContainerView$TabAdapter;->notifyDataSetChanged()V
...
.method public animateToVisibility(I)V
    ...
    .line 238
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->getVisibility()I
    ...
    .line 242
    :cond_1
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->animate()Landroid/view/ViewPropertyAnimator;
    ...
    .line 247
    invoke-virtual/range {v2 .. v2}, Landroid/view/ViewPropertyAnimator;->start()V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 224
    invoke-super/range {p0 .. p1}, Landroid/widget/HorizontalScrollView;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 371
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->getTab()Landroid/support/v7/app/ActionBar$Tab;

    move-result-object p1

    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/app/ActionBar$Tab;->select()V
...
.method public onMeasure(II)V
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/LinearLayoutCompat;->getChildCount()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/LinearLayoutCompat;->getMeasuredWidth()I
    ...
    .line 121
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->performCollapse()V

    goto :goto_4

    .line 123
    :cond_5
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->performExpand()Z
    ...
    .line 129
    :goto_4
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->getMeasuredWidth()I
...
.method public removeAllTabs()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/LinearLayoutCompat;->removeAllViews()V
...
.method public removeTabAt(I)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/Spinner;->getAdapter()Landroid/widget/SpinnerAdapter;

    move-result-object p1

    check-cast p1, Landroid/support/v7/widget/ScrollingTabContainerView$TabAdapter;

    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ScrollingTabContainerView$TabAdapter;->notifyDataSetChanged()V
...
.method public setTabSelected(I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/LinearLayoutCompat;->getChildCount()I
    ...
    .line 189
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/ScrollingTabContainerView;->animateToTab(I)V
...
.method public updateTab(I)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->update()V
