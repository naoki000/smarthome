...
.method constructor <init>(Landroid/widget/SeekBar;)V
    ...
    .line 42
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatProgressBarHelper;-><init>(Landroid/widget/ProgressBar;)V
...
.method private applyTickMarkTint()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/SeekBar;->getDrawableState()[I
...
.method drawTickMarks(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/SeekBar;->getMax()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/graphics/drawable/Drawable;->getIntrinsicWidth()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/SeekBar;->getWidth()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSeekBarHelper;->mView:Landroid/widget/SeekBar;

    invoke-virtual/range {v2 .. v2}, Landroid/widget/SeekBar;->getPaddingLeft()I
    ...
    .line 173
    invoke-virtual/range {v2 .. v2}, Landroid/widget/SeekBar;->getPaddingRight()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/widget/SeekBar;->getPaddingLeft()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/widget/SeekBar;->getHeight()I
...
.method loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    .line 48
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/AppCompatProgressBarHelper;->loadFromAttributes(Landroid/util/AttributeSet;I)V

    .line 50
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSeekBarHelper;->mView:Landroid/widget/SeekBar;

    invoke-virtual/range {v0 .. v0}, Landroid/widget/SeekBar;->getContext()Landroid/content/Context;
    ...
    .line 73
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSeekBarHelper;->applyTickMarkTint()V
...
.method setTickMark(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/SeekBar;->getDrawableState()[I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/SeekBar;->invalidate()V
