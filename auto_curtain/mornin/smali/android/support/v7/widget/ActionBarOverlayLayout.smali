...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 141
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/ActionBarOverlayLayout;->init(Landroid/content/Context;)V
...
.method private addActionBarHideOffset()V
    ...
    .line 602
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->haltActionBarHideOffsetAnimations()V
...
.method private init(Landroid/content/Context;)V
    ...
    .line 147
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->getContext()Landroid/content/Context;
...
.method private shouldHideActionBarOnFling(FF)Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/OverScroller;->getFinalY()I
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/ActionBarContainer;->getHeight()I
...
.method public canShowOverflowMenu()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->canShowOverflowMenu()Z
...
.method public dismissPopups()V
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->dismissPopupMenus()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarContainer;->getVisibility()I
    ...
    .line 453
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarContainer;->getBottom()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/ActionBarContainer;->getTranslationY()F
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->getWidth()I
    ...
    .line 456
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    .line 307
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->requestLayout()V
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 53
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->generateDefaultLayoutParams()Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 53
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/ActionBarOverlayLayout;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;
...
.method public getActionBarHideOffset()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarContainer;->getTranslationY()F
...
.method public hideOverflowMenu()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->hideOverflowMenu()Z
...
.method public initFeature(I)V
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/DecorToolbar;->initIndeterminateProgress()V
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/DecorToolbar;->initProgress()V
...
.method public isOverflowMenuShowPending()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->isOverflowMenuShowPending()Z
...
.method public isOverflowMenuShowing()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->isOverflowMenuShowing()Z
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 222
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionBarContainer;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 351
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/ActionBarContainer;->getMeasuredWidth()I
    ...
    .line 353
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/ActionBarContainer;->getMeasuredHeight()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/ActionBarContainer;->getMeasuredState()I
    ...
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/widget/ActionBarContainer;->getTabContainer()Landroid/view/View;
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/ActionBarContainer;->getVisibility()I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/ActionBarContainer;->getMeasuredHeight()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/ContentFrameLayout;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 403
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/ContentFrameLayout;->getMeasuredWidth()I
    ...
    .line 405
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/ContentFrameLayout;->getMeasuredHeight()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/ContentFrameLayout;->getMeasuredState()I
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    .line 511
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->addActionBarHideOffset()V

    goto :goto_0

    .line 513
    :cond_1
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->removeActionBarHideOffset()V
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    .line 477
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->getActionBarHideOffset()I
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/ActionBarOverlayLayout$ActionBarVisibilityCallback;->onContentScrollStarted()V
...
.method public onStartNestedScroll(Landroid/view/View;Landroid/view/View;I)Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ActionBarContainer;->getVisibility()I
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    .line 495
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->postRemoveActionBarHideOffset()V

    goto :goto_0

    .line 497
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->postAddActionBarHideOffset()V
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/ActionBarOverlayLayout$ActionBarVisibilityCallback;->onContentScrollStopped()V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    .line 230
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->onWindowSystemUiVisibilityChanged(I)V
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/ActionBarOverlayLayout$ActionBarVisibilityCallback;->hideForSystem()V
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/v7/widget/ActionBarOverlayLayout$ActionBarVisibilityCallback;->showForSystem()V
...
.method protected onWindowVisibilityChanged(I)V
    ...
    .line 254
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->onWindowVisibilityChanged(I)V
...
.method public setActionBarVisibilityCallback(Landroid/support/v7/widget/ActionBarOverlayLayout$ActionBarVisibilityCallback;)V
    ...
    .line 167
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->getWindowToken()Landroid/os/IBinder;
...
.method public setMenuPrepared()V
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->setMenuPrepared()V
...
.method public showOverflowMenu()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/DecorToolbar;->showOverflowMenu()Z
