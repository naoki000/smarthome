...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback$1;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback$2;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/helper/ItemTouchUIUtilImpl$Api21Impl;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/helper/ItemTouchUIUtilImpl$BaseImpl;-><init>()V
...
.method public chooseDropTarget(Landroid/support/v7/widget/RecyclerView$ViewHolder;Ljava/util/List;II)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual/range {v11 .. v11}, Landroid/view/View;->getRight()I
    ...
    invoke-virtual/range {v13 .. v13}, Landroid/view/View;->getRight()I
    ...
    .line 1782
    invoke-static/range {v11 .. v11}, Ljava/lang/Math;->abs(I)I
    ...
    invoke-virtual/range {v13 .. v13}, Landroid/view/View;->getLeft()I
    ...
    invoke-virtual/range {v13 .. v13}, Landroid/view/View;->getTop()I
    ...
    invoke-virtual/range {v13 .. v13}, Landroid/view/View;->getBottom()I
...
.method final getAbsoluteMovementFlags(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    .line 1568
    invoke-virtual/range {p0 .. p2}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->getMovementFlags(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
...
.method public getAnimationDuration(Landroid/support/v7/widget/RecyclerView;IFF)J
    ...
    .line 2104
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->getMoveDuration()J
    ...
    .line 2105
    :cond_2
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->getRemoveDuration()J
...
.method hasDragFlag(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
    ...
    .line 1573
    invoke-virtual/range {p0 .. p2}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->getAbsoluteMovementFlags(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
...
.method public interpolateOutOfBoundsScroll(Landroid/support/v7/widget/RecyclerView;IIIJ)I
    ...
    .line 2132
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->getMaxDragScroll(Landroid/support/v7/widget/RecyclerView;)I
    ...
    .line 2134
    invoke-static/range {v0 .. v0}, Ljava/lang/Math;->signum(F)F
...
.method onDraw(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;Ljava/util/List;IFF)V
    ...
    .line 1949
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$RecoverAnimation;->update()V
...
.method public onMoved(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;ILandroid/support/v7/widget/RecyclerView$ViewHolder;III)V
    ...
    .line 1920
    :cond_0
    invoke-virtual/range {p3 .. p3}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollHorizontally()Z
    ...
    .line 1931
    :cond_2
    invoke-virtual/range {p3 .. p3}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollVertically()Z
