...
.method public constructor <init>(Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;)V
    ...
    .line 432
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView$ItemDecoration;-><init>()V
...
.method private checkHorizontalSwipe(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView;->getWidth()I
...
.method private checkVerticalSwipe(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView;->getHeight()I
...
.method private destroyCallbacks()V
    ...
    .line 493
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/helper/ItemTouchHelper;->stopGestureDetection()V
...
.method private findSwapTargets(Landroid/support/v7/widget/RecyclerView$ViewHolder;)Ljava/util/List;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->getBoundingBoxMargin()I
    ...
    invoke-static/range {v4 .. v4}, Ljava/lang/Math;->round(F)I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/view/View;->getWidth()I
    ...
    invoke-virtual/range {v6 .. v6}, Landroid/view/View;->getHeight()I
    ...
    invoke-virtual/range {v8 .. v8}, Landroid/support/v7/widget/RecyclerView;->getLayoutManager()Landroid/support/v7/widget/RecyclerView$LayoutManager;

    move-result-object v8

    .line 793
    invoke-virtual/range {v8 .. v8}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->getChildCount()I
    ...
    .line 799
    :cond_1
    invoke-virtual/range {v12 .. v12}, Landroid/view/View;->getBottom()I

    move-result v13

    if-lt v13, v4, :cond_4

    invoke-virtual/range {v12 .. v12}, Landroid/view/View;->getTop()I
    ...
    invoke-static/range {v10 .. v10}, Ljava/lang/Math;->abs(I)I
    ...
    invoke-static/range {v12 .. v12}, Ljava/lang/Math;->abs(I)I
    ...
    invoke-interface/range {v12 .. v12}, Ljava/util/List;->size()I
...
.method private findSwipedView(Landroid/view/MotionEvent;)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 944
    :cond_3
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/helper/ItemTouchHelper;->findChildView(Landroid/view/MotionEvent;)Landroid/view/View;
...
.method private setupCallbacks()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView;->getContext()Landroid/content/Context;
    ...
    .line 476
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/helper/ItemTouchHelper;->startGestureDetection()V
...
.method private startGestureDetection()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView;->getContext()Landroid/content/Context;
...
.method private stopGestureDetection()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$ItemTouchHelperGestureListener;->doNotReactToLongPress()V
...
.method private swipeIfNecessary(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    .line 1170
    invoke-static/range {v3 .. v3}, Landroid/support/v4/view/ViewCompat;->getLayoutDirection(Landroid/view/View;)I
...
.method public attachToRecyclerView(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 457
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/helper/ItemTouchHelper;->destroyCallbacks()V
    ...
    .line 466
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/helper/ItemTouchHelper;->setupCallbacks()V
...
.method checkSelectForSwipe(ILandroid/view/MotionEvent;I)Z
    ...
    .line 956
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->isItemViewSwipeEnabled()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView;->getScrollState()I
...
.method endRecoverAnimation(Landroid/support/v7/widget/RecyclerView$ViewHolder;Z)I
    ...
    .line 896
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/helper/ItemTouchHelper$RecoverAnimation;->cancel()V
...
.method moveIfNecessary(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView;->isLayoutRequested()Z
    ...
    invoke-static/range {v1 .. v1}, Ljava/lang/Math;->abs(I)I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getHeight()I
    ...
    .line 842
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getWidth()I
    ...
    .line 856
    :cond_4
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getAdapterPosition()I
...
.method public onChildViewDetachedFromWindow(Landroid/view/View;)V
    ...
    .line 871
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/helper/ItemTouchHelper;->removeChildDrawingOrderCallbackIfNecessary(Landroid/view/View;)V
...
.method scrollIfNecessary()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView;->getLayoutManager()Landroid/support/v7/widget/RecyclerView$LayoutManager;
    ...
    invoke-direct/range {v9 .. v9}, Landroid/graphics/Rect;-><init>()V
    ...
    .line 729
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollHorizontally()Z
    ...
    invoke-virtual/range {v12 .. v12}, Landroid/support/v7/widget/RecyclerView;->getPaddingLeft()I
    ...
    .line 736
    invoke-virtual/range {v11 .. v11}, Landroid/view/View;->getWidth()I
    ...
    .line 737
    invoke-virtual/range {v11 .. v11}, Landroid/support/v7/widget/RecyclerView;->getWidth()I

    move-result v11

    iget-object v12, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mRecyclerView:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual/range {v12 .. v12}, Landroid/support/v7/widget/RecyclerView;->getPaddingRight()I
    ...
    invoke-virtual/range {v11 .. v11}, Landroid/support/v7/widget/RecyclerView;->getPaddingTop()I
    ...
    invoke-virtual/range {v9 .. v9}, Landroid/view/View;->getHeight()I
    ...
    .line 750
    invoke-virtual/range {v9 .. v9}, Landroid/support/v7/widget/RecyclerView;->getHeight()I
    ...
    invoke-virtual/range {v10 .. v10}, Landroid/support/v7/widget/RecyclerView;->getPaddingBottom()I
    ...
    .line 759
    invoke-virtual/range {v13 .. v13}, Landroid/support/v7/widget/RecyclerView;->getWidth()I
    ...
    .line 763
    invoke-virtual/range {v11 .. v11}, Landroid/view/View;->getHeight()I
    ...
    .line 764
    invoke-virtual/range {v12 .. v12}, Landroid/support/v7/widget/RecyclerView;->getHeight()I
...
.method select(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-static/range {v2 .. v2}, Ljava/lang/Math;->signum(F)F
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView;->getHeight()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView;->getWidth()I
    ...
    .line 647
    invoke-virtual/range {v14 .. v14}, Landroid/support/v7/widget/helper/ItemTouchHelper$RecoverAnimation;->start()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView;->getParent()Landroid/view/ViewParent;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->requestSimpleAnimationsInNextLayout()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView;->invalidate()V
...
.method public startDrag(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 1076
    :cond_1
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/helper/ItemTouchHelper;->obtainVelocityTracker()V
