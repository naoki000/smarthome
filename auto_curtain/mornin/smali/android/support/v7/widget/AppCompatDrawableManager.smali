...
.method private addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v4/util/LongSparseArray;-><init>()V
...
.method private addTintListToCache(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/util/SparseArrayCompat;-><init>()V
...
.method private checkVectorDrawableSetup(Landroid/content/Context;)V
    ...
    .line 754
    invoke-static/range {p1 .. p1}, Landroid/support/v7/widget/AppCompatDrawableManager;->isVectorDrawable(Landroid/graphics/drawable/Drawable;)Z
...
.method private createDrawableIfNeeded(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 233
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatDrawableManager;->createCacheKey(Landroid/util/TypedValue;)J
...
.method private createSwitchThumbColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 633
    invoke-virtual/range {v2 .. v2}, Landroid/content/res/ColorStateList;->isStateful()Z
...
.method public static get()Landroid/support/v7/widget/AppCompatDrawableManager;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatDrawableManager;-><init>()V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatDrawableManager;->installDefaultInflateDelegates(Landroid/support/v7/widget/AppCompatDrawableManager;)V
...
.method private static installDefaultInflateDelegates(Landroid/support/v7/widget/AppCompatDrawableManager;)V
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v7/widget/AppCompatDrawableManager$VdcInflateDelegate;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v7/widget/AppCompatDrawableManager$AvdcInflateDelegate;-><init>()V
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/util/ArrayMap;->isEmpty()Z
    ...
    invoke-interface/range {v6 .. v6}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;
    ...
    .line 346
    invoke-static/range {v1 .. v1}, Landroid/util/Xml;->asAttributeSet(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;

    move-result-object v6

    .line 348
    :goto_0
    invoke-interface/range {v1 .. v1}, Lorg/xmlpull/v1/XmlPullParser;->next()I
    ...
    .line 356
    invoke-interface/range {v1 .. v1}, Lorg/xmlpull/v1/XmlPullParser;->getName()Ljava/lang/String;
...
.method private static setPorterDuffColorFilter(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 739
    invoke-static/range {p0 .. p0}, Landroid/support/v7/widget/DrawableUtils;->canSafelyMutateDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 740
    invoke-virtual/range {p0 .. p0}, Landroid/graphics/drawable/Drawable;->mutate()Landroid/graphics/drawable/Drawable;
...
.method private tintDrawable(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 260
    invoke-virtual/range {p0 .. p2}, Landroid/support/v7/widget/AppCompatDrawableManager;->getTintList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 263
    invoke-static/range {p4 .. p4}, Landroid/support/v7/widget/DrawableUtils;->canSafelyMutateDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 266
    :cond_0
    invoke-static/range {p4 .. p4}, Landroid/support/v4/graphics/drawable/DrawableCompat;->wrap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 270
    invoke-static/range {p2 .. p2}, Landroid/support/v7/widget/AppCompatDrawableManager;->getTintMode(I)Landroid/graphics/PorterDuff$Mode;
...
.method static tintDrawableUsingColorFilter(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 468
    invoke-static/range {p2 .. p2}, Landroid/support/v7/widget/DrawableUtils;->canSafelyMutateDrawable(Landroid/graphics/drawable/Drawable;)Z
...
.method getDrawable(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 191
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatDrawableManager;->checkVectorDrawableSetup(Landroid/content/Context;)V

    .line 193
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/widget/AppCompatDrawableManager;->loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 195
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/widget/AppCompatDrawableManager;->createDrawableIfNeeded(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 198
    invoke-static/range {p1 .. p2}, Landroid/support/v4/content/ContextCompat;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 207
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/DrawableUtils;->fixDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method getTintList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 523
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/widget/AppCompatDrawableManager;->getTintListFromCache(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 532
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatDrawableManager;->createSwitchThumbColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 534
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatDrawableManager;->createDefaultButtonColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 536
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatDrawableManager;->createBorderlessButtonColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 538
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatDrawableManager;->createColoredButtonColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
...
.method onDrawableLoadedFromResources(Landroid/content/Context;Landroid/support/v7/widget/VectorEnabledTintResources;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 433
    invoke-virtual/range {p2 .. p3}, Landroid/support/v7/widget/VectorEnabledTintResources;->superGetDrawable(I)Landroid/graphics/drawable/Drawable;
