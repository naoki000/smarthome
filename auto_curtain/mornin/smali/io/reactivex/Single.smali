...
.method public static varargs ambArray([Lio/reactivex/SingleSource;)Lio/reactivex/Single;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/Single;->error(Ljava/util/concurrent/Callable;)Lio/reactivex/Single;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/Single;->wrap(Lio/reactivex/SingleSource;)Lio/reactivex/Single;
...
.method public static concat(Lio/reactivex/SingleSource;Lio/reactivex/SingleSource;)Lio/reactivex/Flowable;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/Single;->concat(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
...
.method public static fromFuture(Ljava/util/concurrent/Future;)Lio/reactivex/Single;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/Single;->toSingle(Lio/reactivex/Flowable;)Lio/reactivex/Single;
...
.method public static fromFuture(Ljava/util/concurrent/Future;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Single;
    ...
    .line 544
    invoke-static/range {p0 .. p4}, Lio/reactivex/Flowable;->fromFuture(Ljava/util/concurrent/Future;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Flowable;
...
.method public static fromFuture(Ljava/util/concurrent/Future;Lio/reactivex/Scheduler;)Lio/reactivex/Single;
    ...
    .line 574
    invoke-static/range {p0 .. p1}, Lio/reactivex/Flowable;->fromFuture(Ljava/util/concurrent/Future;Lio/reactivex/Scheduler;)Lio/reactivex/Flowable;
...
.method public static merge(Lio/reactivex/SingleSource;Lio/reactivex/SingleSource;)Lio/reactivex/Flowable;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/Single;->merge(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
...
.method public static mergeDelayError(Lio/reactivex/SingleSource;Lio/reactivex/SingleSource;)Lio/reactivex/Flowable;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/Single;->mergeDelayError(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
...
.method public static wrap(Lio/reactivex/SingleSource;)Lio/reactivex/Single;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/Single;)Lio/reactivex/Single;
...
.method public final ambWith(Lio/reactivex/SingleSource;)Lio/reactivex/Single;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Single;->ambArray([Lio/reactivex/SingleSource;)Lio/reactivex/Single;
...
.method public final blockingGet()Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/internal/observers/BlockingMultiObserver;-><init>()V

    .line 2485
    invoke-virtual {p0, v0}, Lio/reactivex/Single;->subscribe(Lio/reactivex/SingleObserver;)V

    .line 2486
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/internal/observers/BlockingMultiObserver;->blockingGet()Ljava/lang/Object;
...
.method public final compose(Lio/reactivex/SingleTransformer;)Lio/reactivex/Single;
    ...
    invoke-static/range {p1 .. p1}, Lio/reactivex/Single;->wrap(Lio/reactivex/SingleSource;)Lio/reactivex/Single;
...
.method public final concatWith(Lio/reactivex/SingleSource;)Lio/reactivex/Flowable;
    ...
    .line 1897
    invoke-static/range {p0 .. p1}, Lio/reactivex/Single;->concat(Lio/reactivex/SingleSource;Lio/reactivex/SingleSource;)Lio/reactivex/Flowable;
...
.method public final flatMapObservable(Lio/reactivex/functions/Function;)Lio/reactivex/Observable;
    ...
    .line 2445
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/Single;->toObservable()Lio/reactivex/Observable;
...
.method public final flatMapPublisher(Lio/reactivex/functions/Function;)Lio/reactivex/Flowable;
    ...
    .line 2371
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/Single;->toFlowable()Lio/reactivex/Flowable;
...
.method public final mergeWith(Lio/reactivex/SingleSource;)Lio/reactivex/Flowable;
    ...
    .line 2603
    invoke-static/range {p0 .. p1}, Lio/reactivex/Single;->merge(Lio/reactivex/SingleSource;Lio/reactivex/SingleSource;)Lio/reactivex/Flowable;
...
.method public final repeat()Lio/reactivex/Flowable;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Flowable;->repeat()Lio/reactivex/Flowable;
...
.method public final retry()Lio/reactivex/Single;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Flowable;->retry()Lio/reactivex/Flowable;

    move-result-object v0

    invoke-static/range {v0 .. v0}, Lio/reactivex/Single;->toSingle(Lio/reactivex/Flowable;)Lio/reactivex/Single;
...
.method public final retry(J)Lio/reactivex/Single;
    ...
    invoke-static/range {p1 .. p1}, Lio/reactivex/Single;->toSingle(Lio/reactivex/Flowable;)Lio/reactivex/Single;
...
.method public final subscribe(Lio/reactivex/SingleObserver;)V
    ...
    .line 3091
    invoke-static/range {p0 .. p1}, Lio/reactivex/plugins/RxJavaPlugins;->onSubscribe(Lio/reactivex/Single;Lio/reactivex/SingleObserver;)Lio/reactivex/SingleObserver;
...
.method public final subscribeWith(Lio/reactivex/SingleObserver;)Lio/reactivex/SingleObserver;
    ...
    .line 3140
    invoke-virtual/range {p0 .. p1}, Lio/reactivex/Single;->subscribe(Lio/reactivex/SingleObserver;)V
...
.method public final test(Z)Lio/reactivex/observers/TestObserver;
    ...
    .line 3555
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/observers/TestObserver;->cancel()V
...
.method public final toFlowable()Lio/reactivex/Flowable;
    ...
    invoke-interface/range {v0 .. v0}, Lio/reactivex/internal/fuseable/FuseToFlowable;->fuseToFlowable()Lio/reactivex/Flowable;
...
.method public final toFuture()Ljava/util/concurrent/Future;
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/internal/observers/FutureSingleObserver;-><init>()V
...
.method public final toMaybe()Lio/reactivex/Maybe;
    ...
    invoke-interface/range {v0 .. v0}, Lio/reactivex/internal/fuseable/FuseToMaybe;->fuseToMaybe()Lio/reactivex/Maybe;
...
.method public final toObservable()Lio/reactivex/Observable;
    ...
    invoke-interface/range {v0 .. v0}, Lio/reactivex/internal/fuseable/FuseToObservable;->fuseToObservable()Lio/reactivex/Observable;
...
.method public final zipWith(Lio/reactivex/SingleSource;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Single;
    ...
    .line 3514
    invoke-static/range {p0 .. p2}, Lio/reactivex/Single;->zip(Lio/reactivex/SingleSource;Lio/reactivex/SingleSource;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Single;
