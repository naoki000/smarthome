...
.method public static varargs ambArray([Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/Completable;->wrap(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
...
.method public static fromFuture(Ljava/util/concurrent/Future;)Lio/reactivex/Completable;
    ...
    .line 354
    invoke-static/range {p0 .. p0}, Lio/reactivex/internal/functions/Functions;->futureAction(Ljava/util/concurrent/Future;)Lio/reactivex/functions/Action;
...
.method public static wrap(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/Completable;)Lio/reactivex/Completable;
...
.method public final ambWith(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Completable;->ambArray([Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
...
.method public final andThen(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    .line 961
    invoke-virtual/range {p0 .. p1}, Lio/reactivex/Completable;->concatWith(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
...
.method public final andThen(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
    ...
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/Completable;->toFlowable()Lio/reactivex/Flowable;
...
.method public final andThen(Lio/reactivex/ObservableSource;)Lio/reactivex/Observable;
    ...
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/Completable;->toObservable()Lio/reactivex/Observable;
...
.method public final blockingGet()Ljava/lang/Throwable;
    ...
    .line 1039
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/internal/observers/BlockingMultiObserver;->blockingGetError()Ljava/lang/Throwable;
...
.method public final compose(Lio/reactivex/CompletableTransformer;)Lio/reactivex/Completable;
    ...
    invoke-static/range {p1 .. p1}, Lio/reactivex/Completable;->wrap(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
...
.method public final concatWith(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Completable;->concatArray([Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
...
.method public final mergeWith(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Completable;->mergeArray([Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
...
.method public final repeat()Lio/reactivex/Completable;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Completable;->fromPublisher(Lorg/reactivestreams/Publisher;)Lio/reactivex/Completable;
...
.method public final repeat(J)Lio/reactivex/Completable;
    ...
    invoke-static/range {p1 .. p1}, Lio/reactivex/Completable;->fromPublisher(Lorg/reactivestreams/Publisher;)Lio/reactivex/Completable;
...
.method public final subscribe()Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/internal/observers/EmptyCompletableObserver;-><init>()V
...
.method public final subscribe(Lio/reactivex/CompletableObserver;)V
    ...
    .line 1792
    :try_start_0
    invoke-static/range {p0 .. p1}, Lio/reactivex/plugins/RxJavaPlugins;->onSubscribe(Lio/reactivex/Completable;Lio/reactivex/CompletableObserver;)Lio/reactivex/CompletableObserver;
    ...
    .line 1800
    invoke-static/range {p1 .. p1}, Lio/reactivex/Completable;->toNpe(Ljava/lang/Throwable;)Ljava/lang/NullPointerException;
...
.method public final subscribeWith(Lio/reactivex/CompletableObserver;)Lio/reactivex/CompletableObserver;
    ...
    .line 1838
    invoke-virtual/range {p0 .. p1}, Lio/reactivex/Completable;->subscribe(Lio/reactivex/CompletableObserver;)V
