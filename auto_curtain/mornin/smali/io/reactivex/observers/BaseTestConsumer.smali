...
.method public constructor <init>()V
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/internal/util/VolatileSizeArrayList;-><init>()V
...
.method public final assertEmpty()Lio/reactivex/observers/BaseTestConsumer;
    ...
    .line 846
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/observers/BaseTestConsumer;->assertSubscribed()Lio/reactivex/observers/BaseTestConsumer;

    move-result-object v0

    .line 847
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/observers/BaseTestConsumer;->assertNoValues()Lio/reactivex/observers/BaseTestConsumer;

    move-result-object v0

    .line 848
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/observers/BaseTestConsumer;->assertNoErrors()Lio/reactivex/observers/BaseTestConsumer;

    move-result-object v0

    .line 849
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/observers/BaseTestConsumer;->assertNotComplete()Lio/reactivex/observers/BaseTestConsumer;
...
.method public final assertErrorMessage(Ljava/lang/String;)Lio/reactivex/observers/BaseTestConsumer;
    ...
    .line 708
    invoke-virtual/range {v0 .. v0}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;
...
.method public final varargs assertFailure(Lio/reactivex/functions/Predicate;[Ljava/lang/Object;)Lio/reactivex/observers/BaseTestConsumer;
    ...
    .line 797
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/observers/BaseTestConsumer;->assertNotComplete()Lio/reactivex/observers/BaseTestConsumer;
...
.method public final assertNever(Ljava/lang/Object;)Lio/reactivex/observers/BaseTestConsumer;
    ...
    invoke-static/range {p1 .. p1}, Lio/reactivex/observers/BaseTestConsumer;->valueAndClass(Ljava/lang/Object;)Ljava/lang/String;
...
.method public final varargs assertResult([Ljava/lang/Object;)Lio/reactivex/observers/BaseTestConsumer;
    ...
    .line 766
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/observers/BaseTestConsumer;->assertNoErrors()Lio/reactivex/observers/BaseTestConsumer;

    move-result-object p1

    .line 767
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/observers/BaseTestConsumer;->assertComplete()Lio/reactivex/observers/BaseTestConsumer;
...
.method public final assertValue(Ljava/lang/Object;)Lio/reactivex/observers/BaseTestConsumer;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/observers/BaseTestConsumer;->valueAndClass(Ljava/lang/Object;)Ljava/lang/String;
...
.method public final assertValueAt(ILjava/lang/Object;)Lio/reactivex/observers/BaseTestConsumer;
    ...
    invoke-static/range {p2 .. p2}, Lio/reactivex/observers/BaseTestConsumer;->valueAndClass(Ljava/lang/Object;)Ljava/lang/String;
...
.method public final assertValueSequence(Ljava/lang/Iterable;)Lio/reactivex/observers/BaseTestConsumer;
    ...
    invoke-static/range {v2 .. v2}, Lio/reactivex/observers/BaseTestConsumer;->valueAndClass(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static/range {v3 .. v3}, Lio/reactivex/observers/BaseTestConsumer;->valueAndClass(Ljava/lang/Object;)Ljava/lang/String;
...
.method public final assertValueSet(Ljava/util/Collection;)Lio/reactivex/observers/BaseTestConsumer;
    ...
    .line 579
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/observers/BaseTestConsumer;->assertNoValues()Lio/reactivex/observers/BaseTestConsumer;
    ...
    invoke-static/range {v1 .. v1}, Lio/reactivex/observers/BaseTestConsumer;->valueAndClass(Ljava/lang/Object;)Ljava/lang/String;
...
.method public final awaitCount(ILjava/lang/Runnable;J)Lio/reactivex/observers/BaseTestConsumer;
    ...
    invoke-virtual/range {v4 .. v4}, Ljava/util/concurrent/CountDownLatch;->getCount()J
...
.method public final awaitDone(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/observers/BaseTestConsumer;
    ...
    .line 831
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/observers/BaseTestConsumer;->dispose()V
    :try_end_0
...
.method public final awaitTerminalEvent()Z
    ...
    .line 671
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/observers/BaseTestConsumer;->await()Lio/reactivex/observers/BaseTestConsumer;
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/lang/Thread;->interrupt()V
...
.method public final awaitTerminalEvent(JLjava/util/concurrent/TimeUnit;)Z
    ...
    .line 688
    :try_start_0
    invoke-virtual/range {p0 .. p3}, Lio/reactivex/observers/BaseTestConsumer;->await(JLjava/util/concurrent/TimeUnit;)Z
...
.method protected final fail(Ljava/lang/String;)Ljava/lang/AssertionError;
    ...
    .line 177
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/observers/BaseTestConsumer;->isDisposed()Z
...
.method public final getEvents()Ljava/util/List;
    ...
    .line 729
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/observers/BaseTestConsumer;->values()Ljava/util/List;
    ...
    .line 731
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/observers/BaseTestConsumer;->errors()Ljava/util/List;
