...
.method public static varargs ambArray([Lio/reactivex/MaybeSource;)Lio/reactivex/Maybe;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/Maybe;->wrap(Lio/reactivex/MaybeSource;)Lio/reactivex/Maybe;
...
.method public static concat(Lio/reactivex/MaybeSource;Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Maybe;->concatArray([Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
...
.method public static merge(Lio/reactivex/MaybeSource;Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Maybe;->mergeArray([Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
...
.method public static merge(Ljava/lang/Iterable;)Lio/reactivex/Flowable;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/Maybe;->merge(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
...
.method public static mergeDelayError(Lio/reactivex/MaybeSource;Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Maybe;->mergeArrayDelayError([Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
...
.method public static wrap(Lio/reactivex/MaybeSource;)Lio/reactivex/Maybe;
    ...
    invoke-static/range {p0 .. p0}, Lio/reactivex/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/Maybe;)Lio/reactivex/Maybe;
...
.method public final ambWith(Lio/reactivex/MaybeSource;)Lio/reactivex/Maybe;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Maybe;->ambArray([Lio/reactivex/MaybeSource;)Lio/reactivex/Maybe;
...
.method public final compose(Lio/reactivex/MaybeTransformer;)Lio/reactivex/Maybe;
    ...
    invoke-static/range {p1 .. p1}, Lio/reactivex/Maybe;->wrap(Lio/reactivex/MaybeSource;)Lio/reactivex/Maybe;
...
.method public final concatWith(Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
    ...
    .line 2311
    invoke-static/range {p0 .. p1}, Lio/reactivex/Maybe;->concat(Lio/reactivex/MaybeSource;Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
...
.method public final defaultIfEmpty(Ljava/lang/Object;)Lio/reactivex/Maybe;
    ...
    .line 2382
    invoke-static/range {p1 .. p1}, Lio/reactivex/Maybe;->just(Ljava/lang/Object;)Lio/reactivex/Maybe;
...
.method public final doAfterTerminate(Lio/reactivex/functions/Action;)Lio/reactivex/Maybe;
    ...
    .line 2578
    invoke-static/range {v8 .. v8}, Lio/reactivex/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/Maybe;)Lio/reactivex/Maybe;
...
.method public final flatMapObservable(Lio/reactivex/functions/Function;)Lio/reactivex/Observable;
    ...
    .line 2939
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/Maybe;->toObservable()Lio/reactivex/Observable;
...
.method public final flatMapPublisher(Lio/reactivex/functions/Function;)Lio/reactivex/Flowable;
    ...
    .line 2965
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/Maybe;->toFlowable()Lio/reactivex/Flowable;
...
.method public final mergeWith(Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
    ...
    .line 3173
    invoke-static/range {p0 .. p1}, Lio/reactivex/Maybe;->merge(Lio/reactivex/MaybeSource;Lio/reactivex/MaybeSource;)Lio/reactivex/Flowable;
...
.method public final retry(JLio/reactivex/functions/Predicate;)Lio/reactivex/Maybe;
    ...
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/Flowable;->singleElement()Lio/reactivex/Maybe;
...
.method public final subscribe(Lio/reactivex/MaybeObserver;)V
    ...
    .line 3919
    invoke-static/range {p0 .. p1}, Lio/reactivex/plugins/RxJavaPlugins;->onSubscribe(Lio/reactivex/Maybe;Lio/reactivex/MaybeObserver;)Lio/reactivex/MaybeObserver;
...
.method public final subscribeWith(Lio/reactivex/MaybeObserver;)Lio/reactivex/MaybeObserver;
    ...
    .line 3990
    invoke-virtual/range {p0 .. p1}, Lio/reactivex/Maybe;->subscribe(Lio/reactivex/MaybeObserver;)V
...
.method public final timeout(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Maybe;
    ...
    .line 4198
    invoke-static/range {p1 .. p4}, Lio/reactivex/Maybe;->timer(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Maybe;
...
.method public final zipWith(Lio/reactivex/MaybeSource;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Maybe;
    ...
    .line 4339
    invoke-static/range {p0 .. p2}, Lio/reactivex/Maybe;->zip(Lio/reactivex/MaybeSource;Lio/reactivex/MaybeSource;Lio/reactivex/functions/BiFunction;)Lio/reactivex/Maybe;
