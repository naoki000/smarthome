...
.method constructor <init>(Lorg/reactivestreams/Subscriber;Ljava/util/concurrent/Callable;I)V
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/internal/queue/MpscLinkedQueue;-><init>()V
...
.method drainLoop()V
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/internal/disposables/DisposableHelper;->dispose(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    .line 215
    :cond_2
    invoke-virtual/range {v2 .. v2}, Lio/reactivex/processors/UnicastProcessor;->onComplete()V
    ...
    invoke-virtual/range {v5 .. v5}, Ljava/util/concurrent/atomic/AtomicLong;->decrementAndGet()J
    ...
    invoke-interface/range {v2 .. v2}, Ljava/util/concurrent/Callable;->call()Ljava/lang/Object;
    ...
    invoke-static/range {v5 .. v5}, Lio/reactivex/processors/UnicastProcessor;->create(I)Lio/reactivex/processors/UnicastProcessor;
    ...
    invoke-virtual/range {v6 .. v6}, Ljava/util/concurrent/atomic/AtomicLong;->getAndIncrement()J
    ...
    .line 241
    invoke-static/range {v0 .. v0}, Lio/reactivex/exceptions/Exceptions;->throwIfFatal(Ljava/lang/Throwable;)V
    ...
    invoke-static/range {v2 .. v2}, Lio/reactivex/internal/disposables/DisposableHelper;->dispose(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    .line 275
    :cond_a
    invoke-static/range {v6 .. v6}, Lio/reactivex/internal/util/NotificationLite;->getValue(Ljava/lang/Object;)Ljava/lang/Object;
...
.method next()V
    ...
    .line 287
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->enter()Z
    ...
    .line 288
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->drainLoop()V
...
.method public onComplete()V
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/concurrent/atomic/AtomicLong;->decrementAndGet()J
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 131
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->fastEnter()Z
...
.method public onSubscribe(Lorg/reactivestreams/Subscription;)V
    ...
    invoke-interface/range {v1 .. v1}, Ljava/util/concurrent/Callable;->call()Ljava/lang/Object;
    ...
    invoke-static/range {v2 .. v2}, Lio/reactivex/processors/UnicastProcessor;->create(I)Lio/reactivex/processors/UnicastProcessor;
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/util/concurrent/atomic/AtomicLong;->getAndIncrement()J
    ...
    .line 94
    invoke-static/range {v1 .. v1}, Lio/reactivex/exceptions/Exceptions;->throwIfFatal(Ljava/lang/Throwable;)V
...
.method public request(J)V
    ...
    .line 187
    invoke-virtual/range {p0 .. p2}, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->requested(J)V
