...
.method constructor <init>(Lorg/reactivestreams/Subscriber;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;IJZ)V
    ...
    invoke-direct/range {p1 .. p1}, Lio/reactivex/internal/disposables/SequentialDisposable;-><init>()V
    ...
    .line 310
    invoke-virtual/range {p5 .. p5}, Lio/reactivex/Scheduler;->createWorker()Lio/reactivex/Scheduler$Worker;
...
.method public dispose()V
    ...
    .line 457
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Scheduler$Worker;->dispose()V
...
.method drainLoop()V
    ...
    invoke-interface/range {v2 .. v2}, Lorg/reactivestreams/Subscription;->cancel()V

    .line 472
    invoke-interface/range {v1 .. v1}, Lio/reactivex/internal/fuseable/SimplePlainQueue;->clear()V
    ...
    .line 479
    invoke-interface/range {v1 .. v1}, Lio/reactivex/internal/fuseable/SimplePlainQueue;->poll()Ljava/lang/Object;
    ...
    .line 491
    :cond_4
    invoke-virtual/range {v3 .. v3}, Lio/reactivex/processors/UnicastProcessor;->onComplete()V
    ...
    invoke-static/range {v3 .. v3}, Lio/reactivex/processors/UnicastProcessor;->create(I)Lio/reactivex/processors/UnicastProcessor;
    ...
    invoke-interface/range {v1 .. v1}, Lorg/reactivestreams/Subscription;->cancel()V
    ...
    .line 527
    :cond_a
    invoke-static/range {v7 .. v7}, Lio/reactivex/internal/util/NotificationLite;->getValue(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 541
    iget-object v8, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->actual:Lorg/reactivestreams/Subscriber;
    ...
    invoke-virtual/range {v4 .. v4}, Lio/reactivex/internal/disposables/SequentialDisposable;->get()Ljava/lang/Object;
    ...
    .line 548
    invoke-interface/range {v4 .. v4}, Lio/reactivex/disposables/Disposable;->dispose()V
    ...
    .line 553
    invoke-interface/range {v5 .. v5}, Lio/reactivex/disposables/Disposable;->dispose()V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 376
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/processors/UnicastProcessor;->onComplete()V
    ...
    invoke-static/range {p1 .. p1}, Lio/reactivex/processors/UnicastProcessor;->create(I)Lio/reactivex/processors/UnicastProcessor;
    ...
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/internal/disposables/SequentialDisposable;->get()Ljava/lang/Object;
...
.method public onSubscribe(Lorg/reactivestreams/Subscription;)V
    ...
    invoke-static/range {v1 .. v1}, Lio/reactivex/processors/UnicastProcessor;->create(I)Lio/reactivex/processors/UnicastProcessor;
...
.method public request(J)V
    ...
    .line 445
    invoke-virtual/range {p0 .. p2}, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->requested(J)V
