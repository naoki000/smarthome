...
.method constructor <init>(I)V
    ...
    invoke-direct/range {p1 .. p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V
    ...
    invoke-interface/range {p1 .. p1}, Ljava/util/concurrent/locks/Lock;->newCondition()Ljava/util/concurrent/locks/Condition;
...
.method public dispose()V
    ...
    .line 179
    invoke-static/range {p0 .. p0}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
...
.method public hasNext()Z
    ...
    invoke-virtual/range {v1 .. v1}, Lio/reactivex/internal/queue/SpscArrayQueue;->isEmpty()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/internal/queue/SpscArrayQueue;->isEmpty()Z
    ...
    invoke-interface/range {v0 .. v0}, Ljava/util/concurrent/locks/Condition;->await()V
    :try_end_0
    ...
    invoke-interface/range {v0 .. v0}, Ljava/util/concurrent/locks/Lock;->unlock()V
    ...
    .line 97
    :try_start_1
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/BlockingFlowableIterable$BlockingFlowableIterator;->run()V
    ...
    invoke-interface/range {v1 .. v1}, Ljava/util/concurrent/locks/Lock;->unlock()V
...
.method public isDisposed()Z
    ...
    .line 184
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/BlockingFlowableIterable$BlockingFlowableIterator;->get()Ljava/lang/Object;
...
.method public next()Ljava/lang/Object;
    ...
    .line 110
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/BlockingFlowableIterable$BlockingFlowableIterator;->hasNext()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/internal/queue/SpscArrayQueue;->poll()Ljava/lang/Object;
...
.method public onComplete()V
    ...
    .line 154
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/BlockingFlowableIterable$BlockingFlowableIterator;->signalConsumer()V
...
.method public onSubscribe(Lorg/reactivestreams/Subscription;)V
    ...
    .line 128
    invoke-static/range {p0 .. p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lorg/reactivestreams/Subscription;)Z
...
.method signalConsumer()V
    ...
    invoke-interface/range {v0 .. v0}, Ljava/util/concurrent/locks/Condition;->signalAll()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
