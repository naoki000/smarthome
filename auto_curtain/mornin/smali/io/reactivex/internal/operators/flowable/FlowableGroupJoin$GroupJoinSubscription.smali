...
.method drain()V
    ...
    invoke-virtual/range {v4 .. v4}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;
    ...
    invoke-interface/range {v4 .. v4}, Ljava/util/Map;->values()Ljava/util/Collection;
    ...
    invoke-interface/range {v5 .. v5}, Ljava/util/Map;->values()Ljava/util/Collection;

    move-result-object v5

    invoke-interface/range {v5 .. v5}, Ljava/util/Collection;->iterator()Ljava/util/Iterator;
    ...
    .line 332
    invoke-virtual/range {v5 .. v5}, Lio/reactivex/processors/UnicastProcessor;->onComplete()V
...
.method errorAll(Lorg/reactivestreams/Subscriber;)V
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/internal/util/ExceptionHelper;->terminate(Ljava/util/concurrent/atomic/AtomicReference;)Ljava/lang/Throwable;
    ...
    invoke-interface/range {v1 .. v1}, Ljava/util/Map;->clear()V
...
.method fail(Ljava/lang/Throwable;Lorg/reactivestreams/Subscriber;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    ...
    .line 186
    invoke-interface/range {p3 .. p3}, Lio/reactivex/internal/fuseable/SimpleQueue;->clear()V
...
.method public innerClose(ZLio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;)V
    ...
    .line 380
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->drain()V
