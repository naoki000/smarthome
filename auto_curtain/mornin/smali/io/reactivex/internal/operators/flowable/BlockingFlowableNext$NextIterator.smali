...
.method private moveToNext()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/internal/operators/flowable/BlockingFlowableNext$NextSubscriber;->setWaiting()V
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/Flowable;->fromPublisher(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;

    move-result-object v0

    .line 87
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Flowable;->materialize()Lio/reactivex/Flowable;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/internal/operators/flowable/BlockingFlowableNext$NextSubscriber;->takeNext()Lio/reactivex/Notification;

    move-result-object v0

    .line 91
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Notification;->isOnNext()Z
    ...
    .line 93
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Notification;->getValue()Ljava/lang/Object;
    ...
    .line 99
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Notification;->isOnComplete()Z
    ...
    .line 102
    :cond_2
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Notification;->isOnError()Z
    ...
    .line 103
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Notification;->getError()Ljava/lang/Throwable;
    ...
    invoke-virtual/range {v1 .. v1}, Lio/reactivex/internal/operators/flowable/BlockingFlowableNext$NextSubscriber;->dispose()V
...
.method public hasNext()Z
    ...
    invoke-direct/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/BlockingFlowableNext$NextIterator;->moveToNext()Z
...
.method public next()Ljava/lang/Object;
    ...
    .line 120
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/BlockingFlowableNext$NextIterator;->hasNext()Z
