...
.method final collect(Ljava/util/Collection;)V
    ...
    .line 739
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/observable/ObservableReplay$BoundedReplayBuffer;->getHead()Lio/reactivex/internal/operators/observable/ObservableReplay$Node;

    move-result-object v0

    .line 741
    :goto_0
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/internal/operators/observable/ObservableReplay$Node;->get()Ljava/lang/Object;
    ...
    .line 745
    invoke-static/range {v1 .. v1}, Lio/reactivex/internal/util/NotificationLite;->isComplete(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_1

    invoke-static/range {v1 .. v1}, Lio/reactivex/internal/util/NotificationLite;->isError(Ljava/lang/Object;)Z
    ...
    .line 748
    :cond_0
    invoke-static/range {v1 .. v1}, Lio/reactivex/internal/util/NotificationLite;->getValue(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final complete()V
    ...
    .line 661
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/observable/ObservableReplay$BoundedReplayBuffer;->truncateFinal()V
...
.method public final error(Ljava/lang/Throwable;)V
    ...
    .line 650
    invoke-static/range {p1 .. p1}, Lio/reactivex/internal/util/NotificationLite;->error(Ljava/lang/Throwable;)Ljava/lang/Object;
...
.method getHead()Lio/reactivex/internal/operators/observable/ObservableReplay$Node;
    ...
    .line 763
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/observable/ObservableReplay$BoundedReplayBuffer;->get()Ljava/lang/Object;
...
.method hasCompleted()Z
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/internal/util/NotificationLite;->isComplete(Ljava/lang/Object;)Z
...
.method hasError()Z
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/internal/util/NotificationLite;->isError(Ljava/lang/Object;)Z
...
.method public final next(Ljava/lang/Object;)V
    ...
    .line 645
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/observable/ObservableReplay$BoundedReplayBuffer;->truncate()V
...
.method public final replay(Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;)V
    ...
    .line 666
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;->getAndIncrement()I
    ...
    .line 673
    :cond_1
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;->index()Ljava/lang/Object;
    ...
    :cond_2
    :goto_0
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;->isDisposed()Z
    ...
    .line 684
    :cond_3
    invoke-virtual/range {v1 .. v1}, Lio/reactivex/internal/operators/observable/ObservableReplay$Node;->get()Ljava/lang/Object;
...
.method final setFirst(Lio/reactivex/internal/operators/observable/ObservableReplay$Node;)V
    ...
    .line 637
    invoke-virtual/range {p0 .. p1}, Lio/reactivex/internal/operators/observable/ObservableReplay$BoundedReplayBuffer;->set(Ljava/lang/Object;)V
