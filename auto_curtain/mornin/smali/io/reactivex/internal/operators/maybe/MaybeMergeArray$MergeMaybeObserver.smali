...
.method constructor <init>(Lorg/reactivestreams/Subscriber;ILio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;)V
    ...
    .line 93
    invoke-direct/range {p0 .. p0}, Lio/reactivex/internal/subscriptions/BasicIntQueueSubscription;-><init>()V
    ...
    invoke-direct/range {p1 .. p1}, Lio/reactivex/internal/util/AtomicThrowable;-><init>()V
...
.method public cancel()V
    ...
    .line 146
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->getAndIncrement()I
    ...
    invoke-interface/range {v0 .. v0}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->clear()V
...
.method drain()V
    ...
    .line 295
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->drainFused()V

    goto :goto_0

    .line 297
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->drainNormal()V
...
.method drainFused()V
    ...
    .line 260
    invoke-interface/range {v1 .. v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->clear()V
    ...
    invoke-virtual/range {v4 .. v4}, Lio/reactivex/internal/util/AtomicThrowable;->get()Ljava/lang/Object;
    ...
    .line 270
    :cond_2
    invoke-interface/range {v1 .. v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->producerIndex()I
    ...
    .line 272
    :goto_0
    invoke-interface/range {v1 .. v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->isEmpty()Z
...
.method drainNormal()V
    ...
    invoke-virtual/range {v8 .. v8}, Lio/reactivex/internal/util/AtomicThrowable;->get()Ljava/lang/Object;
    ...
    invoke-virtual/range {v1 .. v1}, Lio/reactivex/internal/util/AtomicThrowable;->terminate()Ljava/lang/Throwable;
    ...
    .line 208
    :cond_3
    invoke-interface/range {v1 .. v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->consumerIndex()I
    ...
    .line 213
    :cond_4
    invoke-interface/range {v1 .. v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->poll()Ljava/lang/Object;
    ...
    invoke-virtual/range {v5 .. v5}, Lio/reactivex/internal/util/AtomicThrowable;->get()Ljava/lang/Object;
    ...
    :cond_7
    :goto_2
    invoke-interface/range {v1 .. v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->peek()Ljava/lang/Object;
    ...
    .line 235
    invoke-interface/range {v1 .. v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->drop()V
...
.method public isEmpty()Z
    ...
    invoke-interface/range {v0 .. v0}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->isEmpty()Z
...
.method public onComplete()V
    ...
    .line 177
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->drain()V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/disposables/CompositeDisposable;->dispose()V
...
.method public poll()Ljava/lang/Object;
    ...
    invoke-interface/range {v0 .. v0}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$SimpleQueueWithConsumerIndex;->poll()Ljava/lang/Object;
