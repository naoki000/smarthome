...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/schedulers/Schedulers$SingleTask;-><init>()V

    invoke-static/range {v0 .. v0}, Lio/reactivex/plugins/RxJavaPlugins;->initSingleScheduler(Ljava/util/concurrent/Callable;)Lio/reactivex/Scheduler;
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/schedulers/Schedulers$ComputationTask;-><init>()V

    invoke-static/range {v0 .. v0}, Lio/reactivex/plugins/RxJavaPlugins;->initComputationScheduler(Ljava/util/concurrent/Callable;)Lio/reactivex/Scheduler;
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/schedulers/Schedulers$IOTask;-><init>()V

    invoke-static/range {v0 .. v0}, Lio/reactivex/plugins/RxJavaPlugins;->initIoScheduler(Ljava/util/concurrent/Callable;)Lio/reactivex/Scheduler;
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/schedulers/Schedulers$NewThreadTask;-><init>()V

    invoke-static/range {v0 .. v0}, Lio/reactivex/plugins/RxJavaPlugins;->initNewThreadScheduler(Ljava/util/concurrent/Callable;)Lio/reactivex/Scheduler;
...
.method public static computation()Lio/reactivex/Scheduler;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/plugins/RxJavaPlugins;->onComputationScheduler(Lio/reactivex/Scheduler;)Lio/reactivex/Scheduler;
...
.method public static io()Lio/reactivex/Scheduler;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/plugins/RxJavaPlugins;->onIoScheduler(Lio/reactivex/Scheduler;)Lio/reactivex/Scheduler;
...
.method public static newThread()Lio/reactivex/Scheduler;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/plugins/RxJavaPlugins;->onNewThreadScheduler(Lio/reactivex/Scheduler;)Lio/reactivex/Scheduler;
...
.method public static shutdown()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Scheduler;->shutdown()V
...
.method public static single()Lio/reactivex/Scheduler;
    ...
    invoke-static/range {v0 .. v0}, Lio/reactivex/plugins/RxJavaPlugins;->onSingleScheduler(Lio/reactivex/Scheduler;)Lio/reactivex/Scheduler;
...
.method public static start()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/Scheduler;->start()V
