...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Lio/fabric/sdk/android/DefaultLogger;-><init>()V
...
.method static synthetic access$000(Ljava/util/Collection;)Ljava/util/Map;
    ...
    .line 48
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/Fabric;->getKitMap(Ljava/util/Collection;)Ljava/util/Map;
...
.method static synthetic access$100(Landroid/content/Context;)Landroid/app/Activity;
    ...
    .line 48
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/Fabric;->extractActivity(Landroid/content/Context;)Landroid/app/Activity;
...
.method private static addToKitMap(Ljava/util/Map;Ljava/util/Collection;)V
    ...
    invoke-interface/range {v0 .. v0}, Lio/fabric/sdk/android/KitGroup;->getKits()Ljava/util/Collection;
...
.method private static setFabric(Lio/fabric/sdk/android/Fabric;)V
    ...
    .line 342
    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/Fabric;->init()V
...
.method public static varargs with(Landroid/content/Context;[Lio/fabric/sdk/android/Kit;)Lio/fabric/sdk/android/Fabric;
    ...
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/Fabric$Builder;->build()Lio/fabric/sdk/android/Fabric;

    move-result-object p0

    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/Fabric;->setFabric(Lio/fabric/sdk/android/Fabric;)V
...
.method addAnnotatedDependencies(Ljava/util/Map;Lio/fabric/sdk/android/Kit;)V
    ...
    .line 463
    invoke-interface/range {v0 .. v0}, Lio/fabric/sdk/android/services/concurrency/DependsOn;->value()[Ljava/lang/Class;
    ...
    .line 465
    invoke-virtual/range {v3 .. v3}, Ljava/lang/Class;->isInterface()Z
    ...
    invoke-interface/range {v4 .. v4}, Ljava/util/Collection;->iterator()Ljava/util/Iterator;
    ...
    .line 468
    invoke-virtual/range {v5 .. v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;
...
.method public getAppInstallIdentifier()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/common/IdManager;->getAppInstallIdentifier()Ljava/lang/String;
...
.method getKitsFinderFuture(Landroid/content/Context;)Ljava/util/concurrent/Future;
    ...
    .line 615
    invoke-virtual/range {p1 .. p1}, Landroid/content/Context;->getPackageCodePath()Ljava/lang/String;
    ...
    .line 616
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/Fabric;->getExecutorService()Ljava/util/concurrent/ExecutorService;
...
.method initializeKits(Landroid/content/Context;)V
    ...
    .line 405
    invoke-virtual/range {p0 .. p1}, Lio/fabric/sdk/android/Fabric;->getKitsFinderFuture(Landroid/content/Context;)Ljava/util/concurrent/Future;

    move-result-object v0

    .line 407
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/Fabric;->getKits()Ljava/util/Collection;
    ...
    .line 410
    invoke-static/range {v0 .. v0}, Ljava/util/Collections;->sort(Ljava/util/List;)V
    ...
    .line 421
    :cond_0
    invoke-virtual/range {v2 .. v2}, Lio/fabric/sdk/android/Onboarding;->initialize()V
    ...
    .line 427
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/Fabric;->getIdentifier()Ljava/lang/String;
    ...
    .line 429
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/Fabric;->getVersion()Ljava/lang/String;
    ...
    .line 440
    invoke-virtual/range {v1 .. v1}, Lio/fabric/sdk/android/Kit;->initialize()V

    if-eqz p1, :cond_2

    .line 443
    invoke-virtual/range {v1 .. v1}, Lio/fabric/sdk/android/Kit;->getIdentifier()Ljava/lang/String;
    ...
    .line 445
    invoke-virtual/range {v1 .. v1}, Lio/fabric/sdk/android/Kit;->getVersion()Ljava/lang/String;
