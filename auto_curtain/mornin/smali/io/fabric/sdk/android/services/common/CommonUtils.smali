...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Lio/fabric/sdk/android/services/common/CommonUtils$1;-><init>()V
...
.method public static calculateFreeRamInBytes(Landroid/content/Context;)J
    ...
    invoke-direct/range {v0 .. v0}, Landroid/app/ActivityManager$MemoryInfo;-><init>()V
...
.method public static calculateUsedDiskSpaceInBytes(Ljava/lang/String;)J
    ...
    .line 388
    invoke-virtual/range {v0 .. v0}, Landroid/os/StatFs;->getBlockSize()I
    ...
    .line 389
    invoke-virtual/range {v0 .. v0}, Landroid/os/StatFs;->getBlockCount()I
    ...
    .line 390
    invoke-virtual/range {v0 .. v0}, Landroid/os/StatFs;->getAvailableBlocks()I
...
.method public static canTryConnection(Landroid/content/Context;)Z
    ...
    .line 924
    invoke-virtual/range {p0 .. p0}, Landroid/net/NetworkInfo;->isConnectedOrConnecting()Z
...
.method public static checkPermission(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 863
    invoke-virtual/range {p0 .. p1}, Landroid/content/Context;->checkCallingOrSelfPermission(Ljava/lang/String;)I
...
.method public static varargs createInstanceIdFrom([Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 352
    :cond_2
    invoke-static/range {v1 .. v1}, Ljava/util/Collections;->sort(Ljava/util/List;)V
    ...
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->sha1(Ljava/lang/String;)Ljava/lang/String;
...
.method public static extractFieldFromSystemFile(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 125
    invoke-static/range {v3 .. v3}, Ljava/util/regex/Pattern;->compile(Ljava/lang/String;)Ljava/util/regex/Pattern;
...
.method public static finishAffinity(Landroid/app/Activity;I)V
    ...
    .line 907
    :cond_1
    invoke-virtual/range {p0 .. p1}, Landroid/app/Activity;->setResult(I)V
...
.method public static flushOrLog(Ljava/io/Flushable;Ljava/lang/String;)V
    ...
    .line 710
    :try_start_0
    invoke-interface/range {p0 .. p0}, Ljava/io/Flushable;->flush()V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static getAppIconHashOrNull(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->getAppIconResourceId(Landroid/content/Context;)I
    ...
    .line 813
    :try_start_1
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->sha1(Ljava/io/InputStream;)Ljava/lang/String;

    move-result-object v1

    .line 814
    invoke-static/range {v1 .. v1}, Lio/fabric/sdk/android/services/common/CommonUtils;->isNullOrEmpty(Ljava/lang/String;)Z
...
.method public static getAppProcessInfo(Ljava/lang/String;Landroid/content/Context;)Landroid/app/ActivityManager$RunningAppProcessInfo;
    ...
    .line 251
    invoke-virtual/range {p1 .. p1}, Landroid/app/ActivityManager;->getRunningAppProcesses()Ljava/util/List;
...
.method public static getBatteryVelocity(Landroid/content/Context;Z)I
    ...
    .line 597
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->getBatteryLevel(Landroid/content/Context;)Ljava/lang/Float;
...
.method public static getCpuArchitectureInt()I
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/common/CommonUtils$Architecture;->ordinal()I
...
.method public static getDeviceState(Landroid/content/Context;)I
    ...
    .line 574
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->isEmulator(Landroid/content/Context;)Z
    ...
    .line 578
    :goto_0
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->isRooted(Landroid/content/Context;)Z
...
.method public static getResourcePackageName(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/content/Context;->getApplicationInfo()Landroid/content/pm/ApplicationInfo;
...
.method public static getResourcesIdentifier(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 517
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->getResourcePackageName(Landroid/content/Context;)Ljava/lang/String;
...
.method private static hash(Ljava/io/InputStream;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->hexify([B)Ljava/lang/String;
...
.method public static logControlled(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 447
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->isClsTrace(Landroid/content/Context;)Z
...
.method public static streamToString(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    .line 271
    invoke-virtual/range {p0 .. p0}, Ljava/util/Scanner;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual/range {p0 .. p0}, Ljava/util/Scanner;->next()Ljava/lang/String;
