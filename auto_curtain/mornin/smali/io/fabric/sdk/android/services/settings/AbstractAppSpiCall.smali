...
.method private applyMultipartDataTo(Lio/fabric/sdk/android/services/network/HttpRequest;Lio/fabric/sdk/android/services/settings/AppRequestData;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-static/range {v0 .. v0}, Lio/fabric/sdk/android/services/common/CommonUtils;->isNullOrEmpty(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/KitInfo;->getVersion()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/KitInfo;->getBuildType()Ljava/lang/String;
...
.method getKitBuildTypeKey(Lio/fabric/sdk/android/KitInfo;)Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/KitInfo;->getIdentifier()Ljava/lang/String;
...
.method public invoke(Lio/fabric/sdk/android/services/settings/AppRequestData;)Z
    ...
    .line 74
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/services/settings/AbstractAppSpiCall;->getHttpRequest()Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/services/settings/AbstractAppSpiCall;->getUrl()Ljava/lang/String;
    ...
    .line 86
    :cond_0
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/network/HttpRequest;->code()I
    ...
    .line 87
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/network/HttpRequest;->method()Ljava/lang/String;
    ...
    .line 94
    invoke-static/range {p1 .. p1}, Lio/fabric/sdk/android/services/common/ResponseParser;->parse(I)I
