...
.method constructor <init>(Lio/realm/internal/OsSharedRealm;Lio/realm/internal/Table;J)V
    ...
    invoke-direct/range {v1 .. v1}, Lio/realm/internal/ObserverPairList;-><init>()V
    ...
    .line 307
    invoke-virtual/range {p0 .. p0}, Lio/realm/internal/OsResults;->getMode()Lio/realm/internal/OsResults$Mode;
...
.method public static createForBacklinks(Lio/realm/internal/OsSharedRealm;Lio/realm/internal/UncheckedRow;Lio/realm/internal/Table;Ljava/lang/String;)Lio/realm/internal/OsResults;
    ...
    .line 280
    invoke-virtual/range {p0 .. p0}, Lio/realm/internal/OsSharedRealm;->getNativePtr()J
...
.method public static createFromQuery(Lio/realm/internal/OsSharedRealm;Lio/realm/internal/TableQuery;Lio/realm/internal/SortDescriptor;Lio/realm/internal/SortDescriptor;)Lio/realm/internal/OsResults;
    ...
    .line 290
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/TableQuery;->validateQuery()V
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/TableQuery;->getNativePtr()J
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/TableQuery;->getTable()Lio/realm/internal/Table;
...
.method public addListener(Ljava/lang/Object;Lio/realm/OrderedRealmCollectionChangeListener;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/ObserverPairList;->isEmpty()Z
...
.method public aggregateDate(Lio/realm/internal/OsResults$Aggregate;J)Ljava/util/Date;
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsResults$Aggregate;->getValue()B
...
.method public clear()V
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsResults;->nativeClear(J)V
...
.method public createSnapshot()Lio/realm/internal/OsResults;
    ...
    invoke-static/range {v3 .. v4}, Lio/realm/internal/OsResults;->nativeCreateSnapshot(J)J
...
.method public deleteFirst()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsResults;->nativeDeleteFirst(J)Z
...
.method public deleteLast()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsResults;->nativeDeleteLast(J)Z
...
.method public firstUncheckedRow()Lio/realm/internal/UncheckedRow;
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsResults;->nativeFirstRow(J)J
...
.method public getMode()Lio/realm/internal/OsResults$Mode;
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsResults;->nativeGetMode(J)B

    move-result v0

    invoke-static/range {v0 .. v0}, Lio/realm/internal/OsResults$Mode;->getByValue(B)Lio/realm/internal/OsResults$Mode;
...
.method public isValid()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsResults;->nativeIsValid(J)Z
...
.method public lastUncheckedRow()Lio/realm/internal/UncheckedRow;
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsResults;->nativeLastRow(J)J
...
.method public notifyChangeListeners(J)V
    ...
    invoke-virtual/range {p0 .. p0}, Lio/realm/internal/OsResults;->isLoaded()Z
    ...
    invoke-virtual/range {v2 .. v2}, Lio/realm/internal/OsSharedRealm;->isPartial()Z
    ...
    .line 447
    :goto_0
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsCollectionChangeSet;->isEmpty()Z
...
.method public removeAllListeners()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/ObserverPairList;->clear()V
...
.method public removeListener(Ljava/lang/Object;Lio/realm/OrderedRealmCollectionChangeListener;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/ObserverPairList;->isEmpty()Z
...
.method public size()J
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsResults;->nativeSize(J)J
...
.method public where()Lio/realm/internal/TableQuery;
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsResults;->nativeWhere(J)J
