...
.method private constructor <init>(Lio/realm/internal/NativeContext;Lio/realm/internal/Table;J)V
    ...
    .line 39
    invoke-direct/range {p0 .. p4}, Lio/realm/internal/UncheckedRow;-><init>(Lio/realm/internal/NativeContext;Lio/realm/internal/Table;J)V
...
.method private constructor <init>(Lio/realm/internal/UncheckedRow;)V
    ...
    .line 43
    invoke-direct/range {p0 .. p1}, Lio/realm/internal/UncheckedRow;-><init>(Lio/realm/internal/UncheckedRow;)V
...
.method public static get(Lio/realm/internal/NativeContext;Lio/realm/internal/Table;J)Lio/realm/internal/CheckedRow;
    ...
    .line 56
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/Table;->getNativePtr()J
...
.method public getModelList(J)Lio/realm/internal/OsList;
    ...
    .line 102
    invoke-virtual/range {p0 .. p0}, Lio/realm/internal/CheckedRow;->getTable()Lio/realm/internal/Table;
    ...
    .line 108
    invoke-super/range {p0 .. p2}, Lio/realm/internal/UncheckedRow;->getModelList(J)Lio/realm/internal/OsList;
...
.method public getValueList(JLio/realm/RealmFieldType;)Lio/realm/internal/OsList;
    ...
    .line 119
    invoke-super/range {p0 .. p3}, Lio/realm/internal/UncheckedRow;->getValueList(JLio/realm/RealmFieldType;)Lio/realm/internal/OsList;
...
.method public isNull(J)Z
    ...
    .line 81
    invoke-super/range {p0 .. p2}, Lio/realm/internal/UncheckedRow;->isNull(J)Z
...
.method public isNullLink(J)Z
    ...
    .line 71
    invoke-virtual/range {p0 .. p2}, Lio/realm/internal/CheckedRow;->getColumnType(J)Lio/realm/RealmFieldType;
    ...
    :cond_1
    :goto_0
    invoke-super/range {p0 .. p2}, Lio/realm/internal/UncheckedRow;->isNullLink(J)Z
...
.method public setNull(J)V
    ...
    .line 96
    :cond_0
    invoke-super/range {p0 .. p2}, Lio/realm/internal/UncheckedRow;->setNull(J)V
