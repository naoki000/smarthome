...
.method private constructor <init>(JLio/realm/internal/OsRealmConfig;)V
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeGetSchemaInfo(J)J
    ...
    .line 204
    invoke-virtual/range {p3 .. p3}, Lio/realm/internal/OsRealmConfig;->getContext()Lio/realm/internal/NativeContext;
    ...
    invoke-direct/range {p1 .. p1}, Lio/realm/internal/android/AndroidCapabilities;-><init>()V
...
.method private constructor <init>(Lio/realm/internal/OsRealmConfig;)V
    ...
    .line 168
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsRealmConfig;->getContext()Lio/realm/internal/NativeContext;
    ...
    .line 171
    :try_start_0
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsRealmConfig;->getNativePtr()J
    ...
    invoke-static/range {v2 .. v3}, Lio/realm/internal/OsSharedRealm;->nativeGetSchemaInfo(J)J
    ...
    .line 175
    invoke-virtual/range {v1 .. v1}, Lio/realm/internal/OsSharedRealm;->isClosed()Z
...
.method private detachIterators()V
    ...
    .line 475
    invoke-virtual/range {v1 .. v1}, Lio/realm/internal/OsResults$Iterator;->detach()V
...
.method private executePendingRowQueries()V
    ...
    .line 518
    invoke-virtual/range {v1 .. v1}, Lio/realm/internal/PendingRow;->executeQuery()V
...
.method public static getInstance(Lio/realm/RealmConfiguration;)Lio/realm/internal/OsSharedRealm;
    ...
    .line 231
    invoke-static/range {v0 .. v0}, Lio/realm/internal/OsSharedRealm;->getInstance(Lio/realm/internal/OsRealmConfig$Builder;)Lio/realm/internal/OsSharedRealm;
...
.method public static getInstance(Lio/realm/internal/OsRealmConfig$Builder;)Lio/realm/internal/OsSharedRealm;
    ...
    .line 238
    invoke-virtual/range {p0 .. p0}, Lio/realm/internal/OsRealmConfig$Builder;->build()Lio/realm/internal/OsRealmConfig;
...
.method public static initialize(Ljava/io/File;)V
    ...
    .line 258
    :cond_3
    invoke-static/range {v0 .. v0}, Lio/realm/internal/OsSharedRealm;->nativeInit(Ljava/lang/String;)V
...
.method private static runMigrationCallback(JLio/realm/internal/OsRealmConfig;Lio/realm/internal/OsSharedRealm$MigrationCallback;J)V
    ...
    .line 534
    invoke-virtual/range {p2 .. p2}, Lio/realm/internal/OsRealmConfig;->getRealmConfiguration()Lio/realm/RealmConfiguration;
...
.method public beginTransaction()V
    ...
    .line 267
    invoke-direct/range {p0 .. p0}, Lio/realm/internal/OsSharedRealm;->detachIterators()V

    .line 268
    invoke-direct/range {p0 .. p0}, Lio/realm/internal/OsSharedRealm;->executePendingRowQueries()V

    .line 269
    iget-wide v0, p0, Lio/realm/internal/OsSharedRealm;->nativePtr:J

    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeBeginTransaction(J)V
...
.method public cancelTransaction()V
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeCancelTransaction(J)V
...
.method public close()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/RealmNotifier;->close()V
    ...
    invoke-static/range {v1 .. v2}, Lio/realm/internal/OsSharedRealm;->nativeCloseSharedRealm(J)V
...
.method public commitTransaction()V
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeCommitTransaction(J)V
...
.method public compact()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeCompact(J)Z
...
.method public getConfiguration()Lio/realm/RealmConfiguration;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/OsRealmConfig;->getRealmConfiguration()Lio/realm/RealmConfiguration;
...
.method public getObjectPrivileges(Lio/realm/internal/UncheckedRow;)I
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/UncheckedRow;->getNativePtr()J
...
.method public getPrivileges()I
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeGetRealmPrivileges(J)I
...
.method public getVersionID()Lio/realm/internal/OsSharedRealm$VersionID;
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeGetVersionID(J)[J
...
.method invalidateIterators()V
    ...
    .line 486
    invoke-virtual/range {v1 .. v1}, Lio/realm/internal/OsResults$Iterator;->invalidate()V
...
.method public isAutoRefresh()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeIsAutoRefresh(J)Z
...
.method public isClosed()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeIsClosed(J)Z
...
.method public isEmpty()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeIsEmpty(J)Z
...
.method public isInTransaction()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeIsInTransaction(J)Z
...
.method public isPartial()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeIsPartial(J)Z
...
.method public isSyncRealm()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/OsRealmConfig;->getResolvedRealmURI()Ljava/net/URI;
...
.method public refresh()V
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeRefresh(J)V
...
.method public size()J
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeSize(J)J
...
.method public stopWaitForChange()V
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeStopWaitForChange(J)V
...
.method public waitForChange()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsSharedRealm;->nativeWaitForChange(J)Z
