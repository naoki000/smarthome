...
.method static synthetic access$200(Lio/realm/RealmList;)V
    ...
    .line 62
    invoke-direct/range {p0 .. p0}, Lio/realm/RealmList;->checkValidRealm()V
...
.method private firstImpl(ZLjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/ManagedListOperator;->isEmpty()Z
...
.method private getOperator(Lio/realm/BaseRealm;Lio/realm/internal/OsList;Ljava/lang/Class;Ljava/lang/String;)Lio/realm/ManagedListOperator;
    ...
    .line 1226
    invoke-static/range {p3 .. p3}, Lio/realm/RealmList;->isClassForRealmModel(Ljava/lang/Class;)Z
...
.method private isAttached()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/ManagedListOperator;->isValid()Z
...
.method private lastImpl(ZLjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/ManagedListOperator;->size()I
...
.method public addChangeListener(Lio/realm/OrderedRealmCollectionChangeListener;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/ManagedListOperator;->getOsList()Lio/realm/internal/OsList;
...
.method public average(Ljava/lang/String;)D
    ...
    .line 616
    invoke-virtual/range {p0 .. p0}, Lio/realm/RealmList;->where()Lio/realm/RealmQuery;
...
.method public clear()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/ManagedListOperator;->removeAll()V
...
.method public contains(Ljava/lang/Object;)Z
    ...
    .line 697
    :cond_0
    invoke-super/range {p0 .. p1}, Ljava/util/AbstractList;->contains(Ljava/lang/Object;)Z
...
.method public createSnapshot()Lio/realm/OrderedRealmCollectionSnapshot;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/ManagedListOperator;->forRealmModel()Z
    ...
    .line 757
    invoke-virtual/range {v3 .. v3}, Lio/realm/ManagedListOperator;->getOsList()Lio/realm/internal/OsList;

    move-result-object v3

    invoke-virtual/range {v3 .. v3}, Lio/realm/internal/OsList;->getQuery()Lio/realm/internal/TableQuery;
...
.method public deleteAllFromRealm()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/ManagedListOperator;->deleteAll()V
...
.method public deleteLastFromRealm()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/ManagedListOperator;->deleteLast()V
...
.method public isValid()Z
    ...
    .line 146
    :cond_1
    invoke-direct/range {p0 .. p0}, Lio/realm/RealmList;->isAttached()Z
...
.method public iterator()Ljava/util/Iterator;
    ...
    .line 712
    :cond_0
    invoke-super/range {p0 .. p0}, Ljava/util/AbstractList;->iterator()Ljava/util/Iterator;
...
.method public listIterator(I)Ljava/util/ListIterator;
    ...
    .line 734
    :cond_0
    invoke-super/range {p0 .. p1}, Ljava/util/AbstractList;->listIterator(I)Ljava/util/ListIterator;
...
.method public remove(I)Ljava/lang/Object;
    ...
    .line 306
    invoke-virtual/range {p0 .. p1}, Lio/realm/RealmList;->get(I)Ljava/lang/Object;
...
.method public remove(Ljava/lang/Object;)Z
    ...
    :cond_1
    :goto_0
    invoke-super/range {p0 .. p1}, Ljava/util/AbstractList;->remove(Ljava/lang/Object;)Z
...
.method public removeAll(Ljava/util/Collection;)Z
    ...
    :cond_1
    :goto_0
    invoke-super/range {p0 .. p1}, Ljava/util/AbstractList;->removeAll(Ljava/util/Collection;)Z
...
.method public removeAllChangeListeners()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/OsList;->removeAllListeners()V
...
.method public size()I
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/ManagedListOperator;->size()I
...
.method public toString()Ljava/lang/String;
    ...
    .line 784
    invoke-static/range {v3 .. v3}, Ljava/lang/System;->identityHashCode(Ljava/lang/Object;)I
    ...
    invoke-static/range {v1 .. v1}, Lio/realm/RealmList;->isClassForRealmModel(Ljava/lang/Class;)Z
    ...
    invoke-virtual/range {v1 .. v1}, Lio/realm/RealmObjectSchema;->getClassName()Ljava/lang/String;
    ...
    invoke-interface/range {v1 .. v1}, Lio/realm/internal/Row;->getIndex()J
...
.method public where()Lio/realm/RealmQuery;
    ...
    .line 575
    invoke-static/range {p0 .. p0}, Lio/realm/RealmQuery;->createQueryFromList(Lio/realm/RealmList;)Lio/realm/RealmQuery;
