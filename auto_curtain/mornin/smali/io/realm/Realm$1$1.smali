...
.method public run()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/Realm;->isClosed()Z
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/Realm$Transaction$OnSuccess;->onSuccess()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/OsSharedRealm;->getVersionID()Lio/realm/internal/OsSharedRealm$VersionID;
