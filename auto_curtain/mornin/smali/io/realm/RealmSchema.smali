...
.method private checkIndices()V
    ...
    .line 262
    invoke-virtual/range {p0 .. p0}, Lio/realm/RealmSchema;->haveColumnInfo()Z
...
.method checkHasTable(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/BaseRealm;->getSharedRealm()Lio/realm/internal/OsSharedRealm;
...
.method public getAll()Ljava/util/Set;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/OsSharedRealm;->size()J
    ...
    invoke-virtual/range {v3 .. v3}, Lio/realm/BaseRealm;->getSharedRealm()Lio/realm/internal/OsSharedRealm;
    ...
    invoke-static/range {v3 .. v3}, Lio/realm/internal/Table;->getClassNameForTable(Ljava/lang/String;)Ljava/lang/String;
...
.method final getColumnInfo(Ljava/lang/Class;)Lio/realm/internal/ColumnInfo;
    ...
    .line 244
    invoke-direct/range {p0 .. p0}, Lio/realm/RealmSchema;->checkIndices()V
...
.method getSchemaForClass(Ljava/lang/Class;)Lio/realm/RealmObjectSchema;
    ...
    .line 203
    :cond_0
    invoke-static/range {p1 .. p1}, Lio/realm/internal/Util;->getOriginalModelClass(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    .line 209
    invoke-virtual/range {p0 .. p1}, Lio/realm/RealmSchema;->getTable(Ljava/lang/Class;)Lio/realm/internal/Table;
...
.method getSchemaForClass(Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    ...
    invoke-virtual/range {v2 .. v2}, Lio/realm/internal/Table;->isValid()Z
    ...
    invoke-virtual/range {v1 .. v1}, Lio/realm/BaseRealm;->getSharedRealm()Lio/realm/internal/OsSharedRealm;
    ...
    invoke-virtual/range {v2 .. v2}, Lio/realm/BaseRealm;->getSharedRealm()Lio/realm/internal/OsSharedRealm;
...
.method getTable(Ljava/lang/Class;)Lio/realm/internal/Table;
    ...
    .line 186
    invoke-virtual/range {v0 .. v0}, Lio/realm/BaseRealm;->getConfiguration()Lio/realm/RealmConfiguration;
    ...
    .line 185
    invoke-static/range {v0 .. v0}, Lio/realm/internal/Table;->getTableNameForClass(Ljava/lang/String;)Ljava/lang/String;
...
.method refresh()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/ColumnIndices;->refresh()V
