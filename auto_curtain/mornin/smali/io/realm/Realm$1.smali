...
.method public run()V
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/lang/Thread;->isInterrupted()Z
    ...
    .line 1511
    invoke-virtual/range {v0 .. v0}, Lio/realm/Realm;->beginTransaction()V
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/lang/Thread;->isInterrupted()Z
    ...
    .line 1527
    :try_start_1
    invoke-virtual/range {v0 .. v0}, Lio/realm/Realm;->isInTransaction()Z
    ...
    .line 1528
    invoke-virtual/range {v0 .. v0}, Lio/realm/Realm;->cancelTransaction()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 1531
    :cond_1
    invoke-virtual/range {v0 .. v0}, Lio/realm/Realm;->close()V
    ...
    :cond_2
    :try_start_2
    invoke-virtual/range {v0 .. v0}, Lio/realm/Realm;->commitTransaction()V

    .line 1522
    iget-object v2, v0, Lio/realm/Realm;->sharedRealm:Lio/realm/internal/OsSharedRealm;

    invoke-virtual/range {v2 .. v2}, Lio/realm/internal/OsSharedRealm;->getVersionID()Lio/realm/internal/OsSharedRealm$VersionID;
