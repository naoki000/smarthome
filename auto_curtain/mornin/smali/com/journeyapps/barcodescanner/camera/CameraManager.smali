...
.method private calculateDisplayRotation()I
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/journeyapps/barcodescanner/camera/DisplayConfiguration;->getRotation()I
...
.method private getDefaultCameraParameters()Landroid/hardware/Camera$Parameters;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/hardware/Camera;->getParameters()Landroid/hardware/Camera$Parameters;
    ...
    .line 244
    invoke-virtual/range {v0 .. v0}, Landroid/hardware/Camera$Parameters;->flatten()Ljava/lang/String;
...
.method private setDesiredParameters(Z)V
    ...
    .line 252
    invoke-direct/range {p0 .. p0}, Lcom/journeyapps/barcodescanner/camera/CameraManager;->getDefaultCameraParameters()Landroid/hardware/Camera$Parameters;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/journeyapps/barcodescanner/camera/CameraSettings;->getFocusMode()Lcom/journeyapps/barcodescanner/camera/CameraSettings$FocusMode;
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/journeyapps/barcodescanner/camera/CameraSettings;->isScanInverted()Z
    ...
    .line 272
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->setInvertColor(Landroid/hardware/Camera$Parameters;)V

    .line 275
    :cond_2
    iget-object p1, p0, Lcom/journeyapps/barcodescanner/camera/CameraManager;->settings:Lcom/journeyapps/barcodescanner/camera/CameraSettings;

    invoke-virtual/range {p1 .. p1}, Lcom/journeyapps/barcodescanner/camera/CameraSettings;->isBarcodeSceneModeEnabled()Z
    ...
    .line 276
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->setBarcodeSceneMode(Landroid/hardware/Camera$Parameters;)V

    .line 279
    :cond_3
    iget-object p1, p0, Lcom/journeyapps/barcodescanner/camera/CameraManager;->settings:Lcom/journeyapps/barcodescanner/camera/CameraSettings;

    invoke-virtual/range {p1 .. p1}, Lcom/journeyapps/barcodescanner/camera/CameraSettings;->isMeteringEnabled()Z
    ...
    .line 281
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->setVideoStabilization(Landroid/hardware/Camera$Parameters;)V

    .line 282
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->setFocusArea(Landroid/hardware/Camera$Parameters;)V

    .line 283
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->setMetering(Landroid/hardware/Camera$Parameters;)V

    .line 289
    :cond_4
    invoke-static/range {v0 .. v0}, Lcom/journeyapps/barcodescanner/camera/CameraManager;->getPreviewSizes(Landroid/hardware/Camera$Parameters;)Ljava/util/List;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/journeyapps/barcodescanner/camera/CameraManager;->isCameraRotated()Z
    ...
    .line 301
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->setBestPreviewFPS(Landroid/hardware/Camera$Parameters;)V
...
.method private setParameters()V
    ...
    .line 362
    :try_start_0
    invoke-direct/range {p0 .. p0}, Lcom/journeyapps/barcodescanner/camera/CameraManager;->calculateDisplayRotation()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/hardware/Camera$Parameters;->getPreviewSize()Landroid/hardware/Camera$Size;
...
.method public close()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/hardware/Camera;->release()V
...
.method public configure()V
    ...
    .line 159
    invoke-direct/range {p0 .. p0}, Lcom/journeyapps/barcodescanner/camera/CameraManager;->setParameters()V
...
.method public getPreviewSize()Lcom/journeyapps/barcodescanner/Size;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/journeyapps/barcodescanner/Size;->rotate()Lcom/journeyapps/barcodescanner/Size;
...
.method public isTorchOn()Z
    ...
    .line 487
    invoke-virtual/range {v0 .. v0}, Landroid/hardware/Camera$Parameters;->getFlashMode()Ljava/lang/String;
...
.method public open()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/journeyapps/barcodescanner/camera/CameraSettings;->getRequestedCameraId()I

    move-result v0

    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/open/OpenCameraInterface;->open(I)Landroid/hardware/Camera;
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/open/OpenCameraInterface;->getCameraId(I)I
    ...
    invoke-direct/range {v1 .. v1}, Landroid/hardware/Camera$CameraInfo;-><init>()V
...
.method public setTorch(Z)V
    ...
    .line 455
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lcom/journeyapps/barcodescanner/camera/CameraManager;->isTorchOn()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/journeyapps/barcodescanner/camera/AutoFocusManager;->stop()V
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/journeyapps/barcodescanner/camera/CameraSettings;->isExposureEnabled()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/journeyapps/barcodescanner/camera/AutoFocusManager;->start()V
    :try_end_0
...
.method public startPreview()V
    ...
    .line 181
    invoke-virtual/range {v0 .. v0}, Landroid/hardware/Camera;->startPreview()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/client/android/AmbientLightManager;->start()V
...
.method public stopPreview()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/client/android/AmbientLightManager;->stop()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/hardware/Camera;->stopPreview()V
