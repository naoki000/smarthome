...
.method constructor <init>(Lcom/crashlytics/android/core/ReportUploader;FLcom/crashlytics/android/core/ReportUploader$SendCheck;)V
    ...
    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/BackgroundPriorityRunnable;-><init>()V
...
.method private attemptUploadWithRetry()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/crashlytics/android/core/ReportUploader;->findReports()Ljava/util/List;
    ...
    invoke-static/range {v1 .. v1}, Lcom/crashlytics/android/core/ReportUploader;->access$100(Lcom/crashlytics/android/core/ReportUploader;)Lcom/crashlytics/android/core/ReportUploader$HandlingExceptionCheck;

    move-result-object v1

    invoke-interface/range {v1 .. v1}, Lcom/crashlytics/android/core/ReportUploader$HandlingExceptionCheck;->isHandlingException()Z
    ...
    invoke-interface/range {v1 .. v1}, Lcom/crashlytics/android/core/ReportUploader$SendCheck;->canSendReports()Z
    ...
    .line 219
    invoke-interface/range {v1 .. v1}, Lcom/crashlytics/android/core/Report;->remove()V
    ...
    invoke-static/range {v2 .. v2}, Lcom/crashlytics/android/core/ReportUploader;->access$100(Lcom/crashlytics/android/core/ReportUploader;)Lcom/crashlytics/android/core/ReportUploader$HandlingExceptionCheck;

    move-result-object v2

    invoke-interface/range {v2 .. v2}, Lcom/crashlytics/android/core/ReportUploader$HandlingExceptionCheck;->isHandlingException()Z
    ...
    .line 254
    :try_start_1
    invoke-static/range {v1 .. v2}, Ljava/lang/Thread;->sleep(J)V
    :try_end_1
...
.method public onRun()V
    ...
    .line 185
    :try_start_0
    invoke-direct/range {p0 .. p0}, Lcom/crashlytics/android/core/ReportUploader$Worker;->attemptUploadWithRetry()V
    :try_end_0
