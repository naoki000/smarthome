...
.method public constructor <init>(Lio/fabric/sdk/android/services/common/IdManager;)V
    ...
    .line 41
    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/services/common/IdManager;->getAppInstallIdentifier()Ljava/lang/String;

    move-result-object p1

    invoke-static/range {p1 .. p1}, Lio/fabric/sdk/android/services/common/CommonUtils;->sha1(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    .line 42
    invoke-static/range {v0 .. v0}, Lio/fabric/sdk/android/services/common/CommonUtils;->hexify([B)Ljava/lang/String;
...
.method private populatePID([B)V
    ...
    .line 73
    invoke-virtual/range {v0 .. v0}, Ljava/lang/Integer;->shortValue()S

    move-result v0

    int-to-long v0, v0

    invoke-static/range {v0 .. v1}, Lcom/crashlytics/android/core/CLSUUID;->convertLongToTwoByteBuffer(J)[B
...
.method private populateSequenceNumber([B)V
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/concurrent/atomic/AtomicLong;->incrementAndGet()J
...
.method private populateTime([B)V
    ...
    .line 54
    invoke-static/range {v4 .. v5}, Lcom/crashlytics/android/core/CLSUUID;->convertLongToFourByteBuffer(J)[B
