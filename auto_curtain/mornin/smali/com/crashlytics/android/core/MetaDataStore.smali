...
.method private static jsonToKeysData(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 157
    invoke-virtual/range {v0 .. v0}, Lorg/json/JSONObject;->keys()Ljava/util/Iterator;
...
.method private static userDataToJson(Lcom/crashlytics/android/core/UserMetaData;)Ljava/lang/String;
    ...
    .line 151
    invoke-virtual/range {v0 .. v0}, Lcom/crashlytics/android/core/MetaDataStore$1;->toString()Ljava/lang/String;
...
.method private static valueOrNull(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 170
    invoke-virtual/range {p0 .. p1}, Lorg/json/JSONObject;->isNull(Ljava/lang/String;)Z
...
.method public readKeyData(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 113
    invoke-virtual/range {p0 .. p1}, Lcom/crashlytics/android/core/MetaDataStore;->getKeysFileForSession(Ljava/lang/String;)Ljava/io/File;
    ...
    .line 121
    :try_start_1
    invoke-static/range {v1 .. v1}, Lio/fabric/sdk/android/services/common/CommonUtils;->streamToString(Ljava/io/InputStream;)Ljava/lang/String;

    move-result-object p1

    invoke-static/range {p1 .. p1}, Lcom/crashlytics/android/core/MetaDataStore;->jsonToKeysData(Ljava/lang/String;)Ljava/util/Map;
...
.method public readUserData(Ljava/lang/String;)Lcom/crashlytics/android/core/UserMetaData;
    ...
    .line 78
    invoke-virtual/range {p0 .. p1}, Lcom/crashlytics/android/core/MetaDataStore;->getUserDataFileForSession(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Lcom/crashlytics/android/core/MetaDataStore;->jsonToUserData(Ljava/lang/String;)Lcom/crashlytics/android/core/UserMetaData;
...
.method public writeKeyData(Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 99
    :try_start_0
    invoke-static/range {p2 .. p2}, Lcom/crashlytics/android/core/MetaDataStore;->keysDataToJson(Ljava/util/Map;)Ljava/lang/String;
    ...
    .line 104
    invoke-virtual/range {v1 .. v1}, Ljava/io/Writer;->flush()V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public writeUserData(Ljava/lang/String;Lcom/crashlytics/android/core/UserMetaData;)V
    ...
    .line 64
    :try_start_0
    invoke-static/range {p2 .. p2}, Lcom/crashlytics/android/core/MetaDataStore;->userDataToJson(Lcom/crashlytics/android/core/UserMetaData;)Ljava/lang/String;
