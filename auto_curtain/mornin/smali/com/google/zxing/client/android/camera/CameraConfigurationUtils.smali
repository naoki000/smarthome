...
.method private static buildMiddleArea(I)Ljava/util/List;
    ...
    invoke-static/range {v0 .. v0}, Ljava/util/Collections;->singletonList(Ljava/lang/Object;)Ljava/util/List;
...
.method public static collectStats(Landroid/hardware/Camera$Parameters;)Ljava/lang/String;
    ...
    .line 330
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->flatten()Ljava/lang/String;

    move-result-object p0

    invoke-static/range {p0 .. p0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->collectStats(Ljava/lang/CharSequence;)Ljava/lang/String;
...
.method private static indexOfClosestZoom(Landroid/hardware/Camera$Parameters;D)Ljava/lang/Integer;
    ...
    invoke-virtual/range {v6 .. v6}, Ljava/lang/Integer;->intValue()I
    ...
    invoke-static/range {v6 .. v7}, Ljava/lang/Math;->abs(D)D
...
.method public static setBarcodeSceneMode(Landroid/hardware/Camera$Parameters;)V
    ...
    .line 219
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getSceneMode()Ljava/lang/String;
...
.method public static setBestExposure(Landroid/hardware/Camera$Parameters;Z)V
    ...
    .line 130
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getExposureCompensation()I
...
.method public static setBestPreviewFPS(Landroid/hardware/Camera$Parameters;II)V
    ...
    .line 146
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getSupportedPreviewFpsRange()Ljava/util/List;
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->toString(Ljava/util/Collection;)Ljava/lang/String;
    ...
    invoke-static/range {v1 .. v1}, Ljava/util/Arrays;->toString([I)Ljava/lang/String;
...
.method public static setFocus(Landroid/hardware/Camera$Parameters;Lcom/journeyapps/barcodescanner/camera/CameraSettings$FocusMode;Z)V
    ...
    .line 57
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getSupportedFocusModes()Ljava/util/List;
    ...
    .line 88
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getFocusMode()Ljava/lang/String;
...
.method public static setFocusArea(Landroid/hardware/Camera$Parameters;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getFocusAreas()Ljava/util/List;

    move-result-object v2

    invoke-static/range {v2 .. v2}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->toString(Ljava/lang/Iterable;)Ljava/lang/String;
    ...
    .line 178
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->buildMiddleArea(I)Ljava/util/List;
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->toString(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method public static setInvertColor(Landroid/hardware/Camera$Parameters;)V
    ...
    .line 271
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getColorEffect()Ljava/lang/String;
...
.method public static setMetering(Landroid/hardware/Camera$Parameters;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getMeteringAreas()Ljava/util/List;
...
.method public static setTorch(Landroid/hardware/Camera$Parameters;Z)V
    ...
    .line 110
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getFlashMode()Ljava/lang/String;
...
.method public static setVideoStabilization(Landroid/hardware/Camera$Parameters;)V
    ...
    .line 207
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getVideoStabilization()Z
...
.method public static setZoom(Landroid/hardware/Camera$Parameters;D)V
    ...
    .line 232
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->isZoomSupported()Z
    ...
    .line 233
    invoke-static/range {p0 .. p2}, Lcom/google/zxing/client/android/camera/CameraConfigurationUtils;->indexOfClosestZoom(Landroid/hardware/Camera$Parameters;D)Ljava/lang/Integer;
    ...
    .line 237
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/hardware/Camera$Parameters;->getZoom()I
    ...
    const-string v0, "Zoom is already set to "
    ...
    const-string v1, "Setting zoom to "
