...
.method public playBeepSound()Landroid/media/MediaPlayer;
    ...
    invoke-direct/range {v6 .. v6}, Landroid/media/MediaPlayer;-><init>()V
    ...
    .line 114
    :try_start_1
    invoke-virtual/range {v7 .. v7}, Landroid/content/res/AssetFileDescriptor;->getFileDescriptor()Ljava/io/FileDescriptor;

    move-result-object v1

    invoke-virtual/range {v7 .. v7}, Landroid/content/res/AssetFileDescriptor;->getStartOffset()J

    move-result-wide v2

    invoke-virtual/range {v7 .. v7}, Landroid/content/res/AssetFileDescriptor;->getLength()J
    ...
    .line 116
    :try_start_2
    invoke-virtual/range {v7 .. v7}, Landroid/content/res/AssetFileDescriptor;->close()V
    ...
    .line 119
    invoke-virtual/range {v6 .. v6}, Landroid/media/MediaPlayer;->prepare()V

    .line 120
    invoke-virtual/range {v6 .. v6}, Landroid/media/MediaPlayer;->start()V
    ...
    .line 124
    invoke-virtual/range {v6 .. v6}, Landroid/media/MediaPlayer;->release()V
...
.method public declared-synchronized playBeepSoundAndVibrate()V
    ...
    .line 82
    invoke-virtual/range {p0 .. p0}, Lcom/google/zxing/client/android/BeepManager;->playBeepSound()Landroid/media/MediaPlayer;
