...
.method private static distance(Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;)F
    ...
    .line 558
    invoke-virtual/range {p0 .. p0}, Lcom/google/zxing/aztec/detector/Detector$Point;->getX()I

    move-result v0

    invoke-virtual/range {p0 .. p0}, Lcom/google/zxing/aztec/detector/Detector$Point;->getY()I

    move-result p0

    invoke-virtual/range {p1 .. p1}, Lcom/google/zxing/aztec/detector/Detector$Point;->getX()I

    move-result v1

    invoke-virtual/range {p1 .. p1}, Lcom/google/zxing/aztec/detector/Detector$Point;->getY()I
...
.method private static expandSquare([Lcom/google/zxing/ResultPoint;FF)[Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/ResultPoint;->getX()F
    ...
    invoke-virtual/range {v3 .. v3}, Lcom/google/zxing/ResultPoint;->getX()F
    ...
    invoke-virtual/range {v3 .. v3}, Lcom/google/zxing/ResultPoint;->getY()F
    ...
    invoke-virtual/range {v5 .. v5}, Lcom/google/zxing/ResultPoint;->getX()F
    ...
    invoke-virtual/range {v5 .. v5}, Lcom/google/zxing/ResultPoint;->getY()F

    move-result v5

    aget-object v6, p0, v2

    invoke-virtual/range {v6 .. v6}, Lcom/google/zxing/ResultPoint;->getY()F
    ...
    invoke-virtual/range {v8 .. v8}, Lcom/google/zxing/ResultPoint;->getY()F
    ...
    invoke-virtual/range {v8 .. v8}, Lcom/google/zxing/ResultPoint;->getX()F

    move-result v8

    aget-object v9, p0, v4

    invoke-virtual/range {v9 .. v9}, Lcom/google/zxing/ResultPoint;->getX()F
    ...
    invoke-virtual/range {v9 .. v9}, Lcom/google/zxing/ResultPoint;->getY()F
...
.method private getBullsEyeCorners(Lcom/google/zxing/aztec/detector/Detector$Point;)[Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v2 .. v2}, Lcom/google/zxing/aztec/detector/Detector$Point;->getX()I
    ...
    invoke-virtual/range {v2 .. v2}, Lcom/google/zxing/aztec/detector/Detector$Point;->getY()I
    ...
    invoke-virtual/range {v3 .. v3}, Lcom/google/zxing/aztec/detector/Detector$Point;->getX()I
    ...
    invoke-virtual/range {v3 .. v3}, Lcom/google/zxing/aztec/detector/Detector$Point;->getY()I
    ...
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/aztec/detector/Detector$Point;->getX()I
    ...
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/aztec/detector/Detector$Point;->getY()I
...
.method private getColor(Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;)I
    ...
    .line 464
    invoke-virtual/range {p2 .. p2}, Lcom/google/zxing/aztec/detector/Detector$Point;->getX()I
    ...
    .line 465
    invoke-virtual/range {p2 .. p2}, Lcom/google/zxing/aztec/detector/Detector$Point;->getY()I
    ...
    .line 473
    invoke-static/range {v4 .. v5}, Ljava/lang/Math;->ceil(D)D
    ...
    invoke-static/range {v3 .. v3}, Lcom/google/zxing/common/detector/MathUtils;->round(F)I

    move-result v9

    invoke-static/range {v6 .. v6}, Lcom/google/zxing/common/detector/MathUtils;->round(F)I
...
.method private getMatrixCenter()Lcom/google/zxing/aztec/detector/Detector$Point;
    ...
    invoke-virtual/range {v5 .. v5}, Lcom/google/zxing/common/detector/WhiteRectangleDetector;->detect()[Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v5 .. v5}, Lcom/google/zxing/common/BitMatrix;->getWidth()I
    ...
    invoke-virtual/range {v6 .. v6}, Lcom/google/zxing/common/BitMatrix;->getHeight()I
    ...
    invoke-virtual/range {v7 .. v7}, Lcom/google/zxing/aztec/detector/Detector$Point;->toResultPoint()Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v8 .. v8}, Lcom/google/zxing/aztec/detector/Detector$Point;->toResultPoint()Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v6 .. v6}, Lcom/google/zxing/aztec/detector/Detector$Point;->toResultPoint()Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v5 .. v5}, Lcom/google/zxing/aztec/detector/Detector$Point;->toResultPoint()Lcom/google/zxing/ResultPoint;
    ...
    .line 324
    :goto_0
    invoke-virtual/range {v6 .. v6}, Lcom/google/zxing/ResultPoint;->getX()F
    ...
    invoke-virtual/range {v7 .. v7}, Lcom/google/zxing/ResultPoint;->getX()F
    ...
    invoke-static/range {v9 .. v9}, Lcom/google/zxing/common/detector/MathUtils;->round(F)I
    ...
    invoke-virtual/range {v7 .. v7}, Lcom/google/zxing/ResultPoint;->getY()F
    ...
    invoke-virtual/range {v6 .. v6}, Lcom/google/zxing/common/detector/WhiteRectangleDetector;->detect()[Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/aztec/detector/Detector$Point;->toResultPoint()Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/ResultPoint;->getX()F
    ...
    invoke-static/range {v2 .. v2}, Lcom/google/zxing/common/detector/MathUtils;->round(F)I
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/ResultPoint;->getY()F
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/ResultPoint;->getY()F
...
.method private isValid(Lcom/google/zxing/ResultPoint;)Z
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/common/detector/MathUtils;->round(F)I
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/zxing/common/detector/MathUtils;->round(F)I
...
.method private isWhiteOrBlackRectangle(Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;Lcom/google/zxing/aztec/detector/Detector$Point;)Z
    ...
    invoke-virtual/range {p3 .. p3}, Lcom/google/zxing/aztec/detector/Detector$Point;->getX()I

    move-result v1

    add-int/lit8 v1, v1, 0x3

    invoke-virtual/range {p3 .. p3}, Lcom/google/zxing/aztec/detector/Detector$Point;->getY()I
    ...
    invoke-virtual/range {p4 .. p4}, Lcom/google/zxing/aztec/detector/Detector$Point;->getX()I

    move-result v1

    add-int/lit8 v1, v1, 0x3

    invoke-virtual/range {p4 .. p4}, Lcom/google/zxing/aztec/detector/Detector$Point;->getY()I
...
.method private sampleLine(Lcom/google/zxing/ResultPoint;Lcom/google/zxing/ResultPoint;I)I
    ...
    .line 403
    invoke-static/range {p1 .. p2}, Lcom/google/zxing/aztec/detector/Detector;->distance(Lcom/google/zxing/ResultPoint;Lcom/google/zxing/ResultPoint;)F
    ...
    invoke-static/range {v5 .. v5}, Lcom/google/zxing/common/detector/MathUtils;->round(F)I
