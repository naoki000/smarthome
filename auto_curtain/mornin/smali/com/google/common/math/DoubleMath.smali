...
.method private static checkFinite(D)D
    ...
    .line 515
    invoke-static/range {p0 .. p1}, Lcom/google/common/math/DoubleUtils;->isFinite(D)Z
...
.method public static isMathematicalInteger(D)Z
    ...
    invoke-static/range {p0 .. p1}, Lcom/google/common/math/DoubleUtils;->getSignificand(D)J

    move-result-wide v0

    invoke-static/range {v0 .. v1}, Ljava/lang/Long;->numberOfTrailingZeros(J)I

    move-result v0

    rsub-int/lit8 v0, v0, 0x34

    invoke-static/range {p0 .. p1}, Ljava/lang/Math;->getExponent(D)I
...
.method public static isPowerOfTwo(D)Z
    ...
    invoke-static/range {p0 .. p1}, Lcom/google/common/math/LongMath;->isPowerOfTwo(J)Z
...
.method public static log2(DLjava/math/RoundingMode;)I
    ...
    .line 236
    invoke-static/range {p0 .. p1}, Lcom/google/common/math/DoubleUtils;->isNormal(D)Z
    ...
    .line 261
    :pswitch_0
    invoke-static/range {p0 .. p1}, Lcom/google/common/math/DoubleUtils;->scaleNormalize(D)D
    ...
    .line 256
    :cond_2
    invoke-static/range {p0 .. p1}, Lcom/google/common/math/DoubleMath;->isPowerOfTwo(D)Z
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/common/math/MathPreconditions;->checkRoundingUnnecessary(Z)V
...
.method public static mean(Ljava/lang/Iterable;)D
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/common/math/DoubleMath;->mean(Ljava/util/Iterator;)D
...
.method public static mean(Ljava/util/Iterator;)D
    ...
    invoke-static/range {v0 .. v1}, Lcom/google/common/math/DoubleMath;->checkFinite(D)D
    ...
    invoke-virtual/range {v6 .. v6}, Ljava/lang/Number;->doubleValue()D

    move-result-wide v6

    invoke-static/range {v6 .. v7}, Lcom/google/common/math/DoubleMath;->checkFinite(D)D
...
.method public static varargs mean([D)D
    ...
    invoke-static/range {v7 .. v8}, Lcom/google/common/math/DoubleMath;->checkFinite(D)D
...
.method static roundIntermediate(DLjava/math/RoundingMode;)D
    ...
    .line 104
    invoke-static/range {v4 .. v5}, Ljava/lang/Math;->abs(D)D
    ...
    .line 82
    :pswitch_3
    invoke-static/range {p0 .. p1}, Lcom/google/common/math/DoubleMath;->isMathematicalInteger(D)Z
    ...
    invoke-static/range {p2 .. p2}, Lcom/google/common/math/MathPreconditions;->checkRoundingUnnecessary(Z)V
...
.method public static roundToBigInteger(DLjava/math/RoundingMode;)Ljava/math/BigInteger;
    ...
    .line 182
    invoke-static/range {p0 .. p2}, Lcom/google/common/math/DoubleMath;->roundIntermediate(DLjava/math/RoundingMode;)D
    ...
    .line 189
    invoke-virtual/range {p2 .. p2}, Ljava/math/BigInteger;->negate()Ljava/math/BigInteger;
...
.method public static roundToInt(DLjava/math/RoundingMode;)I
    ...
    .line 133
    invoke-static/range {p2 .. p2}, Lcom/google/common/math/MathPreconditions;->checkInRange(Z)V
