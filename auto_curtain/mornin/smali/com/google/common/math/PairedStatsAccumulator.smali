...
.method public constructor <init>()V
    ...
    invoke-direct/range {v0 .. v0}, Lcom/google/common/math/StatsAccumulator;-><init>()V
...
.method public add(DD)V
    ...
    .line 58
    invoke-static/range {p1 .. p2}, Lcom/google/common/primitives/Doubles;->isFinite(D)Z
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/math/StatsAccumulator;->count()J
    ...
    invoke-virtual/range {v2 .. v2}, Lcom/google/common/math/StatsAccumulator;->mean()D
...
.method public addAll(Lcom/google/common/math/PairedStats;)V
    ...
    .line 73
    invoke-virtual/range {p1 .. p1}, Lcom/google/common/math/PairedStats;->count()J
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/google/common/math/PairedStats;->xStats()Lcom/google/common/math/Stats;
    ...
    .line 79
    invoke-virtual/range {p1 .. p1}, Lcom/google/common/math/PairedStats;->sumOfProductsOfDeltas()D
    ...
    invoke-virtual/range {v4 .. v4}, Lcom/google/common/math/Stats;->mean()D

    move-result-wide v4

    iget-object v6, p0, Lcom/google/common/math/PairedStatsAccumulator;->xStats:Lcom/google/common/math/StatsAccumulator;

    invoke-virtual/range {v6 .. v6}, Lcom/google/common/math/StatsAccumulator;->mean()D

    move-result-wide v6

    sub-double/2addr v4, v6

    invoke-virtual/range {p1 .. p1}, Lcom/google/common/math/PairedStats;->yStats()Lcom/google/common/math/Stats;

    move-result-object v6

    invoke-virtual/range {v6 .. v6}, Lcom/google/common/math/Stats;->mean()D

    move-result-wide v6

    iget-object v8, p0, Lcom/google/common/math/PairedStatsAccumulator;->yStats:Lcom/google/common/math/StatsAccumulator;

    invoke-virtual/range {v8 .. v8}, Lcom/google/common/math/StatsAccumulator;->mean()D
...
.method public final leastSquaresFit()Lcom/google/common/math/LinearTransformation;
    ...
    .line 222
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/math/PairedStatsAccumulator;->count()J
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/math/StatsAccumulator;->sumOfSquaresOfDeltas()D
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/math/StatsAccumulator;->mean()D
...
.method public final pearsonsCorrelationCoefficient()D
    ...
    invoke-static/range {v2 .. v3}, Lcom/google/common/math/PairedStatsAccumulator;->ensureInUnitRange(D)D
...
.method public snapshot()Lcom/google/common/math/PairedStats;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/common/math/StatsAccumulator;->snapshot()Lcom/google/common/math/Stats;

    move-result-object v1

    iget-object v2, p0, Lcom/google/common/math/PairedStatsAccumulator;->yStats:Lcom/google/common/math/StatsAccumulator;

    invoke-virtual/range {v2 .. v2}, Lcom/google/common/math/StatsAccumulator;->snapshot()Lcom/google/common/math/Stats;
...
.method public xStats()Lcom/google/common/math/Stats;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/math/StatsAccumulator;->snapshot()Lcom/google/common/math/Stats;
