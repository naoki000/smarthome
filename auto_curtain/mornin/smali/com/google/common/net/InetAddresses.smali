...
.method static constructor <clinit>()V
    ...
    .line 106
    invoke-static/range {v0 .. v0}, Lcom/google/common/base/Splitter;->on(C)Lcom/google/common/base/Splitter;
    ...
    .line 107
    invoke-static/range {v0 .. v0}, Lcom/google/common/net/InetAddresses;->forString(Ljava/lang/String;)Ljava/net/InetAddress;
...
.method private static bytesToInetAddress([B)Ljava/net/InetAddress;
    ...
    .line 320
    :try_start_0
    invoke-static/range {p0 .. p0}, Ljava/net/InetAddress;->getByAddress([B)Ljava/net/InetAddress;
...
.method public static coerceToInteger(Ljava/net/InetAddress;)I
    ...
    .line 897
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->getCoercedIPv4Address(Ljava/net/InetAddress;)Ljava/net/Inet4Address;

    move-result-object p0

    invoke-virtual/range {p0 .. p0}, Ljava/net/Inet4Address;->getAddress()[B

    move-result-object p0

    invoke-static/range {p0 .. p0}, Lcom/google/common/io/ByteStreams;->newDataInput([B)Lcom/google/common/io/ByteArrayDataInput;

    move-result-object p0

    invoke-interface/range {p0 .. p0}, Lcom/google/common/io/ByteArrayDataInput;->readInt()I
...
.method private static convertDottedQuadToHex(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 279
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->textToNumericFormatV4(Ljava/lang/String;)[B
...
.method public static decrement(Ljava/net/InetAddress;)Ljava/net/InetAddress;
    ...
    .line 948
    invoke-static/range {v0 .. v0}, Lcom/google/common/net/InetAddresses;->bytesToInetAddress([B)Ljava/net/InetAddress;
...
.method public static forString(Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    .line 140
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->ipStringToBytes(Ljava/lang/String;)[B
...
.method public static forUriString(Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    .line 462
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->forUriStringNoThrow(Ljava/lang/String;)Ljava/net/InetAddress;
...
.method private static forUriStringNoThrow(Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    .line 491
    :cond_1
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->bytesToInetAddress([B)Ljava/net/InetAddress;
...
.method public static fromInteger(I)Ljava/net/Inet4Address;
    ...
    .line 907
    invoke-static/range {p0 .. p0}, Lcom/google/common/primitives/Ints;->toByteArray(I)[B

    move-result-object p0

    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->getInet4Address([B)Ljava/net/Inet4Address;
...
.method public static fromLittleEndianByteArray([B)Ljava/net/InetAddress;
    ...
    .line 925
    :cond_0
    invoke-static/range {v0 .. v0}, Ljava/net/InetAddress;->getByAddress([B)Ljava/net/InetAddress;
...
.method public static get6to4IPv4Address(Ljava/net/Inet6Address;)Ljava/net/Inet4Address;
    ...
    .line 578
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->is6to4Address(Ljava/net/Inet6Address;)Z

    move-result v0

    const-string v1, "Address \'%s\' is not a 6to4 address."

    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->toAddrString(Ljava/net/InetAddress;)Ljava/lang/String;
    ...
    .line 580
    invoke-virtual/range {p0 .. p0}, Ljava/net/Inet6Address;->getAddress()[B
...
.method public static getCoercedIPv4Address(Ljava/net/InetAddress;)Ljava/net/Inet4Address;
    ...
    .line 855
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->hasEmbeddedIPv4ClientAddress(Ljava/net/Inet6Address;)Z
    ...
    .line 856
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->getEmbeddedIPv4ClientAddress(Ljava/net/Inet6Address;)Ljava/net/Inet4Address;

    move-result-object p0

    invoke-virtual/range {p0 .. p0}, Ljava/net/Inet4Address;->hashCode()I
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/hash/HashCode;->asInt()I
...
.method public static getCompatIPv4Address(Ljava/net/Inet6Address;)Ljava/net/Inet4Address;
    ...
    .line 547
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->isCompatIPv4Address(Ljava/net/Inet6Address;)Z
...
.method public static getEmbeddedIPv4ClientAddress(Ljava/net/Inet6Address;)Ljava/net/Inet4Address;
    ...
    .line 765
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->getCompatIPv4Address(Ljava/net/Inet6Address;)Ljava/net/Inet4Address;
    ...
    .line 769
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->get6to4IPv4Address(Ljava/net/Inet6Address;)Ljava/net/Inet4Address;
    ...
    .line 772
    :cond_1
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->isTeredoAddress(Ljava/net/Inet6Address;)Z
    ...
    .line 773
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->getTeredoInfo(Ljava/net/Inet6Address;)Lcom/google/common/net/InetAddresses$TeredoInfo;

    move-result-object p0

    invoke-virtual/range {p0 .. p0}, Lcom/google/common/net/InetAddresses$TeredoInfo;->getClient()Ljava/net/Inet4Address;
...
.method public static getIsatapIPv4Address(Ljava/net/Inet6Address;)Ljava/net/Inet4Address;
    ...
    .line 730
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->isIsatapAddress(Ljava/net/Inet6Address;)Z
...
.method public static getTeredoInfo(Ljava/net/Inet6Address;)Lcom/google/common/net/InetAddresses$TeredoInfo;
    ...
    invoke-static/range {v1 .. v1}, Lcom/google/common/net/InetAddresses;->getInet4Address([B)Ljava/net/Inet4Address;
    ...
    invoke-interface/range {v0 .. v0}, Lcom/google/common/io/ByteArrayDataInput;->readShort()S
    ...
    invoke-interface/range {v3 .. v3}, Lcom/google/common/io/ByteArrayDataInput;->readShort()S
...
.method private static ipStringToBytes(Ljava/lang/String;)[B
    ...
    .line 183
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->convertDottedQuadToHex(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 188
    :cond_5
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->textToNumericFormatV6(Ljava/lang/String;)[B
...
.method public static isCompatIPv4Address(Ljava/net/Inet6Address;)Z
    ...
    .line 524
    invoke-virtual/range {p0 .. p0}, Ljava/net/Inet6Address;->isIPv4CompatibleAddress()Z
...
.method private static parseHextet(Ljava/lang/String;)S
    ...
    invoke-direct/range {p0 .. p0}, Ljava/lang/NumberFormatException;-><init>()V
...
.method private static textToNumericFormatV4(Ljava/lang/String;)[B
    ...
    .line 201
    invoke-static/range {v4 .. v4}, Lcom/google/common/net/InetAddresses;->parseOctet(Ljava/lang/String;)B
...
.method private static textToNumericFormatV6(Ljava/lang/String;)[B
    ...
    .line 257
    invoke-static/range {v2 .. v2}, Ljava/nio/ByteBuffer;->allocate(I)Ljava/nio/ByteBuffer;
    ...
    invoke-static/range {v7 .. v7}, Lcom/google/common/net/InetAddresses;->parseHextet(Ljava/lang/String;)S
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/common/net/InetAddresses;->parseHextet(Ljava/lang/String;)S
...
.method public static toAddrString(Ljava/net/InetAddress;)Ljava/lang/String;
    ...
    .line 353
    :cond_1
    invoke-static/range {v0 .. v0}, Lcom/google/common/net/InetAddresses;->compressLongestRunOfZeroes([I)V

    .line 354
    invoke-static/range {v0 .. v0}, Lcom/google/common/net/InetAddresses;->hextetsToIPv6String([I)Ljava/lang/String;
