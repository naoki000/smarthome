...
.method static getClassPathEntries(Ljava/lang/ClassLoader;)Lcom/google/common/collect/ImmutableMap;
    ...
    .line 424
    invoke-virtual/range {p0 .. p0}, Ljava/lang/ClassLoader;->getParent()Ljava/lang/ClassLoader;
    ...
    .line 426
    invoke-static/range {v1 .. v1}, Lcom/google/common/reflect/ClassPath$Scanner;->getClassPathEntries(Ljava/lang/ClassLoader;)Lcom/google/common/collect/ImmutableMap;
    ...
    .line 430
    invoke-virtual/range {v1 .. v1}, Ljava/net/URLClassLoader;->getURLs()[Ljava/net/URL;
    ...
    .line 431
    invoke-virtual/range {v4 .. v4}, Ljava/net/URL;->getProtocol()Ljava/lang/String;
    ...
    invoke-virtual/range {v4 .. v4}, Ljava/net/URL;->getFile()Ljava/lang/String;
...
.method static getClassPathFromManifest(Ljava/io/File;Ljava/util/jar/Manifest;)Lcom/google/common/collect/ImmutableSet;
    ...
    .line 400
    invoke-virtual/range {p1 .. p1}, Ljava/util/jar/Manifest;->getMainAttributes()Ljava/util/jar/Attributes;

    move-result-object p1

    sget-object v1, Ljava/util/jar/Attributes$Name;->CLASS_PATH:Ljava/util/jar/Attributes$Name;

    invoke-virtual/range {v1 .. v1}, Ljava/util/jar/Attributes$Name;->toString()Ljava/lang/String;
    ...
    .line 412
    invoke-virtual/range {v2 .. v2}, Ljava/net/URL;->getProtocol()Ljava/lang/String;
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/net/URL;->getFile()Ljava/lang/String;
...
.method private scanFrom(Ljava/io/File;Ljava/lang/ClassLoader;)V
    ...
    .line 362
    :cond_1
    invoke-direct/range {p0 .. p2}, Lcom/google/common/reflect/ClassPath$Scanner;->scanJar(Ljava/io/File;Ljava/lang/ClassLoader;)V
...
.method private scanJar(Ljava/io/File;Ljava/lang/ClassLoader;)V
    ...
    .line 375
    :try_start_1
    invoke-virtual/range {v0 .. v0}, Ljava/util/jar/JarFile;->getManifest()Ljava/util/jar/Manifest;
    ...
    .line 381
    :try_start_2
    invoke-virtual/range {v0 .. v0}, Ljava/util/jar/JarFile;->close()V
    :try_end_2
...
.method final scan(Ljava/io/File;Ljava/lang/ClassLoader;)V
    ...
    .line 345
    invoke-direct/range {p0 .. p2}, Lcom/google/common/reflect/ClassPath$Scanner;->scanFrom(Ljava/io/File;Ljava/lang/ClassLoader;)V
...
.method public final scan(Ljava/lang/ClassLoader;)V
    ...
    .line 331
    invoke-static/range {p1 .. p1}, Lcom/google/common/reflect/ClassPath$Scanner;->getClassPathEntries(Ljava/lang/ClassLoader;)Lcom/google/common/collect/ImmutableMap;
