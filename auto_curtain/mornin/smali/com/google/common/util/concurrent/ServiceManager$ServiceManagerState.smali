...
.method constructor <init>(Lcom/google/common/collect/ImmutableCollection;)V
    ...
    invoke-direct/range {v0 .. v0}, Lcom/google/common/util/concurrent/Monitor;-><init>()V
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/common/collect/MultimapBuilder;->enumKeys(Ljava/lang/Class;)Lcom/google/common/collect/MultimapBuilder$MultimapBuilderWithKeys;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Lcom/google/common/collect/MultimapBuilder$MultimapBuilderWithKeys;->linkedHashSetValues()Lcom/google/common/collect/MultimapBuilder$SetMultimapBuilder;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Lcom/google/common/collect/MultimapBuilder$SetMultimapBuilder;->build()Lcom/google/common/collect/SetMultimap;
    ...
    invoke-interface/range {v0 .. v0}, Lcom/google/common/collect/SetMultimap;->keys()Lcom/google/common/collect/Multiset;
    ...
    invoke-static/range {v0 .. v0}, Ljava/util/Collections;->synchronizedList(Ljava/util/List;)Ljava/util/List;
    ...
    .line 490
    invoke-virtual/range {p1 .. p1}, Lcom/google/common/collect/ImmutableCollection;->size()I
...
.method addListener(Lcom/google/common/util/concurrent/ServiceManager$Listener;Ljava/util/concurrent/Executor;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/util/concurrent/Monitor;->enter()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/util/concurrent/Monitor$Guard;->isSatisfied()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/google/common/util/concurrent/Monitor;->leave()V
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/common/util/concurrent/Monitor;->leave()V
...
.method awaitHealthy()V
    ...
    .line 555
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/ServiceManager$ServiceManagerState;->checkHealthy()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/util/concurrent/Monitor;->leave()V
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/common/util/concurrent/Monitor;->leave()V
...
.method awaitHealthy(JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/common/base/Predicates;->in(Ljava/util/Collection;)Lcom/google/common/base/Predicate;
...
.method awaitStopped(JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/common/base/Predicates;->not(Lcom/google/common/base/Predicate;)Lcom/google/common/base/Predicate;
...
.method checkHealthy()V
    ...
    invoke-static/range {v3 .. v3}, Lcom/google/common/base/Predicates;->equalTo(Ljava/lang/Object;)Lcom/google/common/base/Predicate;

    move-result-object v3

    invoke-static/range {v3 .. v3}, Lcom/google/common/base/Predicates;->not(Lcom/google/common/base/Predicate;)Lcom/google/common/base/Predicate;
...
.method executeListeners()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/util/concurrent/Monitor;->isOccupiedByCurrentThread()Z
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/common/util/concurrent/ListenerCallQueue;->execute()V
...
.method markReady()V
    ...
    .line 523
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/ServiceManager$ServiceManagerState;->servicesByState()Lcom/google/common/collect/ImmutableMultimap;

    move-result-object v1

    invoke-virtual/range {v1 .. v1}, Lcom/google/common/collect/ImmutableMultimap;->values()Lcom/google/common/collect/ImmutableCollection;
    ...
    .line 524
    invoke-interface/range {v2 .. v2}, Lcom/google/common/util/concurrent/Service;->state()Lcom/google/common/util/concurrent/Service$State;
...
.method servicesByState()Lcom/google/common/collect/ImmutableMultimap;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/common/util/concurrent/Monitor;->enter()V
    ...
    invoke-interface/range {v1 .. v1}, Lcom/google/common/collect/SetMultimap;->entries()Ljava/util/Set;
...
.method startupTimes()Lcom/google/common/collect/ImmutableMap;
    ...
    .line 619
    invoke-virtual/range {v2 .. v2}, Lcom/google/common/base/Stopwatch;->isRunning()Z
    ...
    .line 636
    invoke-static/range {v0 .. v0}, Lcom/google/common/collect/ImmutableMap;->copyOf(Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableMap;
...
.method transitionService(Lcom/google/common/util/concurrent/Service;Lcom/google/common/util/concurrent/Service$State;Lcom/google/common/util/concurrent/Service$State;)V
    ...
    .line 652
    :goto_0
    invoke-static/range {v2 .. v2}, Lcom/google/common/base/Preconditions;->checkArgument(Z)V
    ...
    invoke-virtual/range {v2 .. v2}, Lcom/google/common/util/concurrent/Monitor;->enter()V
    ...
    .line 701
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/ServiceManager$ServiceManagerState;->executeListeners()V
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/common/base/Stopwatch;->isRunning()Z
    ...
    .line 679
    invoke-virtual/range {p2 .. p2}, Lcom/google/common/base/Stopwatch;->stop()Lcom/google/common/base/Stopwatch;
    ...
    .line 688
    invoke-virtual/range {p0 .. p1}, Lcom/google/common/util/concurrent/ServiceManager$ServiceManagerState;->fireFailedListeners(Lcom/google/common/util/concurrent/Service;)V
    ...
    .line 694
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/ServiceManager$ServiceManagerState;->fireHealthyListeners()V
    ...
    .line 696
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/ServiceManager$ServiceManagerState;->fireStoppedListeners()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
