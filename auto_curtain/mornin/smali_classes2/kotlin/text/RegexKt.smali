...
.method public static final synthetic access$findNext(Ljava/util/regex/Matcher;ILjava/lang/CharSequence;)Lkotlin/text/MatchResult;
    ...
    .line 1
    invoke-static/range {p0 .. p2}, Lkotlin/text/RegexKt;->findNext(Ljava/util/regex/Matcher;ILjava/lang/CharSequence;)Lkotlin/text/MatchResult;
...
.method public static final synthetic access$matchEntire(Ljava/util/regex/Matcher;Ljava/lang/CharSequence;)Lkotlin/text/MatchResult;
    ...
    .line 1
    invoke-static/range {p0 .. p1}, Lkotlin/text/RegexKt;->matchEntire(Ljava/util/regex/Matcher;Ljava/lang/CharSequence;)Lkotlin/text/MatchResult;
...
.method public static final synthetic access$range(Ljava/util/regex/MatchResult;)Lkotlin/ranges/IntRange;
    ...
    .line 1
    invoke-static/range {p0 .. p0}, Lkotlin/text/RegexKt;->range(Ljava/util/regex/MatchResult;)Lkotlin/ranges/IntRange;
...
.method public static final synthetic access$range(Ljava/util/regex/MatchResult;I)Lkotlin/ranges/IntRange;
    ...
    .line 1
    invoke-static/range {p0 .. p1}, Lkotlin/text/RegexKt;->range(Ljava/util/regex/MatchResult;I)Lkotlin/ranges/IntRange;
...
.method public static final synthetic access$toInt(Ljava/lang/Iterable;)I
    ...
    .line 1
    invoke-static/range {p0 .. p0}, Lkotlin/text/RegexKt;->toInt(Ljava/lang/Iterable;)I
...
.method private static final findNext(Ljava/util/regex/Matcher;ILjava/lang/CharSequence;)Lkotlin/text/MatchResult;
    ...
    .line 233
    invoke-virtual/range {p0 .. p1}, Ljava/util/regex/Matcher;->find(I)Z
...
.method private static final fromInt(I)Ljava/util/Set;
    ...
    invoke-static/range {v0 .. v0}, Ljava/util/EnumSet;->allOf(Ljava/lang/Class;)Ljava/util/EnumSet;
...
.method private static final range(Ljava/util/regex/MatchResult;)Lkotlin/ranges/IntRange;
    ...
    .line 284
    invoke-interface/range {p0 .. p0}, Ljava/util/regex/MatchResult;->start()I

    move-result v0

    invoke-interface/range {p0 .. p0}, Ljava/util/regex/MatchResult;->end()I
...
.method private static final range(Ljava/util/regex/MatchResult;I)Lkotlin/ranges/IntRange;
    ...
    .line 285
    invoke-interface/range {p0 .. p1}, Ljava/util/regex/MatchResult;->start(I)I

    move-result v0

    invoke-interface/range {p0 .. p1}, Ljava/util/regex/MatchResult;->end(I)I
...
.method private static final toInt(Ljava/lang/Iterable;)I
    ...
    .line 30
    invoke-interface/range {v1 .. v1}, Lkotlin/text/FlagEnum;->getValue()I
