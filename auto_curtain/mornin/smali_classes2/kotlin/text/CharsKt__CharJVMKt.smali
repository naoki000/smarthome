...
.method public static final digitOf(CI)I
    ...
    .line 147
    invoke-static/range {p0 .. p1}, Ljava/lang/Character;->digit(II)I
...
.method public static final getCategory(C)Lkotlin/text/CharCategory;
    ...
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->getType(C)I
...
.method public static final getDirectionality(C)Lkotlin/text/CharDirectionality;
    ...
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->getDirectionality(C)B
...
.method private static final isDefined(C)Z
    ...
    .line 27
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isDefined(C)Z
...
.method private static final isDigit(C)Z
    ...
    .line 45
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isDigit(C)Z
...
.method private static final isHighSurrogate(C)Z
    ...
    .line 131
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isHighSurrogate(C)Z
...
.method private static final isISOControl(C)Z
    ...
    .line 59
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isISOControl(C)Z
...
.method private static final isIdentifierIgnorable(C)Z
    ...
    .line 53
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isIdentifierIgnorable(C)Z
...
.method private static final isJavaIdentifierPart(C)Z
    ...
    .line 65
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isJavaIdentifierPart(C)Z
...
.method private static final isJavaIdentifierStart(C)Z
    ...
    .line 71
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isJavaIdentifierStart(C)Z
...
.method private static final isLetter(C)Z
    ...
    .line 33
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isLetter(C)Z
...
.method private static final isLetterOrDigit(C)Z
    ...
    .line 39
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isLetterOrDigit(C)Z
...
.method private static final isLowerCase(C)Z
    ...
    .line 89
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isLowerCase(C)Z
...
.method private static final isTitleCase(C)Z
    ...
    .line 107
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isTitleCase(C)Z
...
.method public static final isWhitespace(C)Z
    ...
    .line 77
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isWhitespace(C)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->isSpaceChar(C)Z
...
.method private static final toLowerCase(C)C
    ...
    .line 101
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->toLowerCase(C)C
...
.method private static final toTitleCase(C)C
    ...
    .line 115
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->toTitleCase(C)C
...
.method private static final toUpperCase(C)C
    ...
    .line 95
    invoke-static/range {p0 .. p0}, Ljava/lang/Character;->toUpperCase(C)C
