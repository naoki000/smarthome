...
.method private static final read(Ljava/util/concurrent/locks/ReentrantReadWriteLock;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    ...
    .line 45
    invoke-virtual/range {p0 .. p0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;->readLock()Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;

    move-result-object p0

    .line 46
    invoke-virtual/range {p0 .. p0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;->lock()V
    ...
    invoke-static/range {v0 .. v0}, Lkotlin/jvm/internal/InlineMarker;->finallyStart(I)V

    .line 50
    invoke-virtual/range {p0 .. p0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;->unlock()V

    invoke-static/range {v0 .. v0}, Lkotlin/jvm/internal/InlineMarker;->finallyEnd(I)V
...
.method private static final write(Ljava/util/concurrent/locks/ReentrantReadWriteLock;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    ...
    .line 71
    invoke-virtual/range {p0 .. p0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;->getWriteHoldCount()I
    ...
    invoke-virtual/range {p0 .. p0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;->getReadHoldCount()I
    ...
    .line 72
    invoke-virtual/range {v0 .. v0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;->unlock()V
    ...
    invoke-static/range {v3 .. v3}, Lkotlin/jvm/internal/InlineMarker;->finallyStart(I)V

    :goto_2
    if-ge v2, v1, :cond_2

    .line 79
    invoke-virtual/range {v0 .. v0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;->lock()V
    ...
    invoke-static/range {v3 .. v3}, Lkotlin/jvm/internal/InlineMarker;->finallyEnd(I)V
