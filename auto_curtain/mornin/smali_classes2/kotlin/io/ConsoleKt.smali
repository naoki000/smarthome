...
.method static constructor <clinit>()V
    ...
    invoke-static/range {v1 .. v1}, Lkotlin/jvm/internal/Reflection;->property0(Lkotlin/jvm/internal/PropertyReference0;)Lkotlin/reflect/KProperty0;
    ...
    invoke-static/range {v0 .. v0}, Lkotlin/LazyKt;->lazy(Lkotlin/jvm/functions/Function0;)Lkotlin/Lazy;
...
.method private static final dequeue(Ljava/nio/CharBuffer;)C
    ...
    .line 215
    invoke-virtual/range {p0 .. p0}, Ljava/nio/CharBuffer;->flip()Ljava/nio/Buffer;

    .line 216
    invoke-virtual/range {p0 .. p0}, Ljava/nio/CharBuffer;->get()C

    move-result v0

    invoke-virtual/range {p0 .. p0}, Ljava/nio/CharBuffer;->compact()Ljava/nio/CharBuffer;
...
.method private static final println()V
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/io/PrintStream;->println()V
...
.method public static final readLine(Ljava/io/InputStream;Ljava/nio/charset/CharsetDecoder;)Ljava/lang/String;
    ...
    .line 152
    invoke-virtual/range {p1 .. p1}, Ljava/nio/charset/CharsetDecoder;->maxCharsPerByte()F
    ...
    .line 155
    invoke-static/range {v3 .. v3}, Ljava/nio/CharBuffer;->allocate(I)Ljava/nio/CharBuffer;
    ...
    .line 163
    invoke-static/range {v3 .. v3}, Lkotlin/io/ConsoleKt;->containsLineSeparator(Ljava/nio/CharBuffer;)Z
    ...
    .line 166
    :cond_2
    invoke-virtual/range {v3 .. v3}, Ljava/nio/CharBuffer;->hasRemaining()Z
    ...
    .line 167
    invoke-static/range {v3 .. v3}, Lkotlin/io/ConsoleKt;->dequeue(Ljava/nio/CharBuffer;)C
    ...
    .line 175
    invoke-virtual/range {p1 .. p1}, Ljava/nio/charset/CharsetDecoder;->reset()Ljava/nio/charset/CharsetDecoder;

    .line 179
    invoke-virtual/range {v3 .. v3}, Ljava/nio/CharBuffer;->position()I
...
.method private static final tryDecode(Ljava/nio/charset/CharsetDecoder;Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;Z)Z
    ...
    .line 197
    invoke-virtual/range {p0 .. p3}, Ljava/nio/charset/CharsetDecoder;->decode(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;Z)Ljava/nio/charset/CoderResult;

    move-result-object p0

    .line 198
    invoke-virtual/range {p0 .. p0}, Ljava/nio/charset/CoderResult;->isError()Z

    move-result p3

    if-eqz p3, :cond_0

    invoke-virtual/range {p0 .. p0}, Ljava/nio/charset/CoderResult;->throwException()V
    ...
    invoke-static/range {p1 .. p1}, Lkotlin/io/ConsoleKt;->flipBack(Ljava/nio/Buffer;)V
