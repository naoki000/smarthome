...
.method public constructor <init>(Lkotlin/io/FileTreeWalk;)V
    ...
    invoke-direct/range {p0 .. p0}, Lkotlin/collections/AbstractIterator;-><init>()V

    .line 64
    new-instance v0, Ljava/util/Stack;

    invoke-direct/range {v0 .. v0}, Ljava/util/Stack;-><init>()V

    iput-object v0, p0, Lkotlin/io/FileTreeWalk$FileTreeWalkIterator;->state:Ljava/util/Stack;

    .line 67
    invoke-static/range {p1 .. p1}, Lkotlin/io/FileTreeWalk;->access$getStart$p(Lkotlin/io/FileTreeWalk;)Ljava/io/File;
    ...
    .line 72
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lkotlin/io/FileTreeWalk$FileTreeWalkIterator;->done()V
...
.method private final directoryState(Ljava/io/File;)Lkotlin/io/FileTreeWalk$DirectoryState;
    ...
    invoke-static/range {v0 .. v0}, Lkotlin/io/FileTreeWalk;->access$getDirection$p(Lkotlin/io/FileTreeWalk;)Lkotlin/io/FileWalkDirection;

    move-result-object v0

    sget-object v1, Lkotlin/io/FileTreeWalk$FileTreeWalkIterator$WhenMappings;->$EnumSwitchMapping$0:[I

    invoke-virtual/range {v0 .. v0}, Lkotlin/io/FileWalkDirection;->ordinal()I
...
.method private final gotoNext()Ljava/io/File;
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/Stack;->empty()Z
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/Stack;->peek()Ljava/lang/Object;
    ...
    .line 101
    invoke-virtual/range {v0 .. v0}, Lkotlin/io/FileTreeWalk$WalkState;->step()Ljava/io/File;
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/Stack;->pop()Ljava/lang/Object;

    goto :goto_0

    .line 108
    :cond_2
    invoke-virtual/range {v0 .. v0}, Lkotlin/io/FileTreeWalk$WalkState;->getRoot()Ljava/io/File;
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/io/File;->isDirectory()Z
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/Stack;->size()I

    move-result v0

    iget-object v2, p0, Lkotlin/io/FileTreeWalk$FileTreeWalkIterator;->this$0:Lkotlin/io/FileTreeWalk;

    invoke-static/range {v2 .. v2}, Lkotlin/io/FileTreeWalk;->access$getMaxDepth$p(Lkotlin/io/FileTreeWalk;)I
...
.method protected computeNext()V
    ...
    .line 78
    invoke-direct/range {p0 .. p0}, Lkotlin/io/FileTreeWalk$FileTreeWalkIterator;->gotoNext()Ljava/io/File;
