...
.method public constructor <init>()V
    ...
    invoke-direct/range {p0 .. p0}, Lkotlin/io/FilesKt__FileTreeWalkKt;-><init>()V
...
.method public static final copyRecursively(Ljava/io/File;Ljava/io/File;ZLkotlin/jvm/functions/Function2;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Lkotlin/io/FileTreeWalk;->iterator()Ljava/util/Iterator;
    ...
    .line 263
    invoke-virtual/range {v3 .. v3}, Ljava/io/File;->exists()Z
    ...
    invoke-virtual/range {v3 .. v3}, Ljava/io/File;->isDirectory()Z

    move-result v4

    if-eqz v4, :cond_4

    invoke-virtual/range {v5 .. v5}, Ljava/io/File;->isDirectory()Z
    ...
    .line 273
    invoke-static/range {v5 .. v5}, Lkotlin/io/FilesKt;->deleteRecursively(Ljava/io/File;)Z
    ...
    .line 275
    :cond_7
    invoke-virtual/range {v5 .. v5}, Ljava/io/File;->delete()Z
    ...
    .line 289
    invoke-virtual/range {v5 .. v5}, Ljava/io/File;->mkdirs()Z
    ...
    invoke-virtual/range {v4 .. v4}, Ljava/io/File;->length()J

    move-result-wide v4

    invoke-virtual/range {v3 .. v3}, Ljava/io/File;->length()J
...
.method public static final createTempDir(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
    ...
    .line 23
    invoke-static/range {p0 .. p2}, Ljava/io/File;->createTempFile(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
...
.method public static final deleteRecursively(Ljava/io/File;)Z
    ...
    .line 310
    invoke-static/range {p0 .. p0}, Lkotlin/io/FilesKt;->walkBottomUp(Ljava/io/File;)Lkotlin/io/FileTreeWalk;
    ...
    .line 438
    invoke-interface/range {p0 .. p0}, Lkotlin/sequences/Sequence;->iterator()Ljava/util/Iterator;
...
.method public static final endsWith(Ljava/io/File;Ljava/io/File;)Z
    ...
    .line 349
    invoke-virtual/range {v1 .. v1}, Lkotlin/io/FilePathComponents;->isRooted()Z
    ...
    .line 351
    :cond_0
    invoke-virtual/range {v0 .. v0}, Lkotlin/io/FilePathComponents;->getSize()I

    move-result p0

    invoke-virtual/range {v1 .. v1}, Lkotlin/io/FilePathComponents;->getSize()I
    ...
    .line 353
    :cond_1
    invoke-virtual/range {v0 .. v0}, Lkotlin/io/FilePathComponents;->getSegments()Ljava/util/List;
    ...
    invoke-virtual/range {v1 .. v1}, Lkotlin/io/FilePathComponents;->getSegments()Ljava/util/List;
...
.method public static final normalize(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-virtual/range {p0 .. p0}, Lkotlin/io/FilePathComponents;->getRoot()Ljava/io/File;

    move-result-object v0

    invoke-virtual/range {p0 .. p0}, Lkotlin/io/FilePathComponents;->getSegments()Ljava/util/List;

    move-result-object p0

    invoke-static/range {p0 .. p0}, Lkotlin/io/FilesKt__UtilsKt;->normalize$FilesKt__UtilsKt(Ljava/util/List;)Ljava/util/List;
...
.method public static final relativeTo(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static/range {p0 .. p1}, Lkotlin/io/FilesKt;->toRelativeString(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
...
.method public static final relativeToOrNull(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    .line 108
    invoke-static/range {p0 .. p1}, Lkotlin/io/FilesKt__UtilsKt;->toRelativeStringOrNull$FilesKt__UtilsKt(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
...
.method public static final resolve(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    .line 400
    invoke-static/range {p1 .. p1}, Lkotlin/io/FilesKt;->isRooted(Ljava/io/File;)Z
...
.method public static final resolveSibling(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    .line 424
    invoke-virtual/range {p0 .. p0}, Lkotlin/io/FilePathComponents;->getSize()I
...
.method public static final startsWith(Ljava/io/File;Ljava/io/File;)Z
    ...
    invoke-virtual/range {p1 .. p1}, Lkotlin/io/FilePathComponents;->getRoot()Ljava/io/File;
    ...
    invoke-virtual/range {p1 .. p1}, Lkotlin/io/FilePathComponents;->getSize()I
    ...
    invoke-virtual/range {p1 .. p1}, Lkotlin/io/FilePathComponents;->getSegments()Ljava/util/List;
...
.method private static final toRelativeStringOrNull$FilesKt__UtilsKt(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v0}, Lkotlin/io/FilesKt__UtilsKt;->normalize$FilesKt__UtilsKt(Lkotlin/io/FilePathComponents;)Lkotlin/io/FilePathComponents;
    ...
    invoke-static/range {v1 .. v1}, Lkotlin/io/FilesKt__UtilsKt;->normalize$FilesKt__UtilsKt(Lkotlin/io/FilePathComponents;)Lkotlin/io/FilePathComponents;

    move-result-object v1

    .line 115
    invoke-virtual/range {v0 .. v0}, Lkotlin/io/FilePathComponents;->getRoot()Ljava/io/File;

    move-result-object v2

    invoke-virtual/range {v1 .. v1}, Lkotlin/io/FilePathComponents;->getRoot()Ljava/io/File;
    ...
    invoke-virtual/range {v8 .. v8}, Ljava/io/File;->getName()Ljava/lang/String;
