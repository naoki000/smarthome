...
.method private dispatch(Landroid/arch/lifecycle/Lifecycle$Event;)V
    ...
    .line 112
    invoke-virtual/range {p0 .. p0}, Landroid/arch/lifecycle/ReportFragment;->getActivity()Landroid/app/Activity;
    ...
    invoke-interface/range {v0 .. v0}, Landroid/arch/lifecycle/LifecycleRegistryOwner;->getLifecycle()Landroid/arch/lifecycle/LifecycleRegistry;
    ...
    invoke-interface/range {v0 .. v0}, Landroid/arch/lifecycle/LifecycleOwner;->getLifecycle()Landroid/arch/lifecycle/Lifecycle;
...
.method private dispatchCreate(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
    ...
    .line 54
    invoke-interface/range {p1 .. p1}, Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;->onCreate()V
...
.method private dispatchResume(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
    ...
    .line 66
    invoke-interface/range {p1 .. p1}, Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;->onResume()V
...
.method private dispatchStart(Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;)V
    ...
    .line 60
    invoke-interface/range {p1 .. p1}, Landroid/arch/lifecycle/ReportFragment$ActivityInitializationListener;->onStart()V
...
.method public static injectIfNeededIn(Landroid/app/Activity;)V
    ...
    .line 39
    invoke-virtual/range {p0 .. p0}, Landroid/app/FragmentManager;->beginTransaction()Landroid/app/FragmentTransaction;

    move-result-object v0

    new-instance v1, Landroid/arch/lifecycle/ReportFragment;

    invoke-direct/range {v1 .. v1}, Landroid/arch/lifecycle/ReportFragment;-><init>()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/app/FragmentTransaction;->commit()I

    .line 41
    invoke-virtual/range {p0 .. p0}, Landroid/app/FragmentManager;->executePendingTransactions()Z
