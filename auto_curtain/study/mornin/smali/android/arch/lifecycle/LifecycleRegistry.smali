...
.method public constructor <init>(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 97
    invoke-direct/range {p0 .. p0}, Landroid/arch/lifecycle/Lifecycle;-><init>()V

    .line 59
    new-instance v0, Landroid/arch/core/internal/FastSafeIterableMap;

    invoke-direct/range {v0 .. v0}, Landroid/arch/core/internal/FastSafeIterableMap;-><init>()V
...
.method private backwardPass(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 300
    invoke-virtual/range {v0 .. v0}, Landroid/arch/core/internal/FastSafeIterableMap;->descendingIterator()Ljava/util/Iterator;
    ...
    invoke-static/range {v3 .. v3}, Landroid/arch/lifecycle/LifecycleRegistry;->downEvent(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;

    move-result-object v3

    .line 307
    invoke-static/range {v3 .. v3}, Landroid/arch/lifecycle/LifecycleRegistry;->getStateAfter(Landroid/arch/lifecycle/Lifecycle$Event;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 309
    invoke-direct/range {p0 .. p0}, Landroid/arch/lifecycle/LifecycleRegistry;->popParentState()V
...
.method private static downEvent(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/arch/lifecycle/Lifecycle$State;->ordinal()I
...
.method private forwardPass(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 285
    invoke-virtual/range {v0 .. v0}, Landroid/arch/core/internal/FastSafeIterableMap;->iteratorWithAdditions()Landroid/arch/core/internal/SafeIterableMap$IteratorWithAdditions;
    ...
    invoke-static/range {v3 .. v3}, Landroid/arch/lifecycle/LifecycleRegistry;->upEvent(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;
...
.method static getStateAfter(Landroid/arch/lifecycle/Lifecycle$Event;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/arch/lifecycle/Lifecycle$Event;->ordinal()I
...
.method private isSynced()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/arch/core/internal/FastSafeIterableMap;->size()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/arch/core/internal/FastSafeIterableMap;->eldest()Ljava/util/Map$Entry;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/arch/core/internal/FastSafeIterableMap;->newest()Ljava/util/Map$Entry;
...
.method private moveToState(Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    .line 137
    invoke-direct/range {p0 .. p0}, Landroid/arch/lifecycle/LifecycleRegistry;->sync()V
...
.method private sync()V
    ...
    :cond_0
    :goto_0
    invoke-direct/range {p0 .. p0}, Landroid/arch/lifecycle/LifecycleRegistry;->isSynced()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/arch/core/internal/FastSafeIterableMap;->eldest()Ljava/util/Map$Entry;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/arch/core/internal/FastSafeIterableMap;->newest()Ljava/util/Map$Entry;
...
.method public addObserver(Landroid/arch/lifecycle/LifecycleObserver;)V
    ...
    .line 175
    :goto_2
    invoke-direct/range {p0 .. p1}, Landroid/arch/lifecycle/LifecycleRegistry;->calculateTargetState(Landroid/arch/lifecycle/LifecycleObserver;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    invoke-static/range {v4 .. v4}, Landroid/arch/lifecycle/LifecycleRegistry;->upEvent(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;
...
.method public handleLifecycleEvent(Landroid/arch/lifecycle/Lifecycle$Event;)V
    ...
    .line 122
    invoke-static/range {p1 .. p1}, Landroid/arch/lifecycle/LifecycleRegistry;->getStateAfter(Landroid/arch/lifecycle/Lifecycle$Event;)Landroid/arch/lifecycle/Lifecycle$State;
...
.method public markState(Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    .line 110
    invoke-direct/range {p0 .. p1}, Landroid/arch/lifecycle/LifecycleRegistry;->moveToState(Landroid/arch/lifecycle/Lifecycle$State;)V
