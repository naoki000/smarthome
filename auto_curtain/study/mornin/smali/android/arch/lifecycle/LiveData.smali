...
.method public constructor <init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/arch/core/internal/SafeIterableMap;-><init>()V
...
.method static synthetic access$400(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/LiveData$ObserverWrapper;)V
    ...
    .line 59
    invoke-direct/range {p0 .. p1}, Landroid/arch/lifecycle/LiveData;->dispatchingValue(Landroid/arch/lifecycle/LiveData$ObserverWrapper;)V
...
.method private static assertMainThread(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/arch/core/executor/ArchTaskExecutor;->isMainThread()Z
...
.method private considerNotify(Landroid/arch/lifecycle/LiveData$ObserverWrapper;)V
    ...
    .line 100
    :cond_0
    invoke-virtual/range {p1 .. p1}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->shouldBeActive()Z
...
.method private dispatchingValue(Landroid/arch/lifecycle/LiveData$ObserverWrapper;)V
    ...
    .line 125
    invoke-virtual/range {v1 .. v1}, Landroid/arch/core/internal/SafeIterableMap;->iteratorWithAdditions()Landroid/arch/core/internal/SafeIterableMap$IteratorWithAdditions;
...
.method public hasObservers()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/arch/core/internal/SafeIterableMap;->size()I
...
.method public observe(Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Observer;)V
    ...
    .line 166
    invoke-interface/range {p1 .. p1}, Landroid/arch/lifecycle/LifecycleOwner;->getLifecycle()Landroid/arch/lifecycle/Lifecycle;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/arch/lifecycle/Lifecycle;->getCurrentState()Landroid/arch/lifecycle/Lifecycle$State;
...
.method public removeObserver(Landroid/arch/lifecycle/Observer;)V
    ...
    .line 217
    invoke-static/range {v0 .. v0}, Landroid/arch/lifecycle/LiveData;->assertMainThread(Ljava/lang/String;)V
    ...
    .line 222
    :cond_0
    invoke-virtual/range {p1 .. p1}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->detachObserver()V
...
.method public removeObservers(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/arch/core/internal/SafeIterableMap;->iterator()Ljava/util/Iterator;
