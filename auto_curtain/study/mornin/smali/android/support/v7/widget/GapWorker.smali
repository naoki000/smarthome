...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/GapWorker$1;-><init>()V
...
.method private buildTaskList()V
    ...
    .line 218
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/RecyclerView;->getWindowVisibility()I
    ...
    invoke-direct/range {v8 .. v8}, Landroid/support/v7/widget/GapWorker$Task;-><init>()V
...
.method private flushTasksWithDeadline(J)V
    ...
    .line 359
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/GapWorker$Task;->clear()V
...
.method private prefetchInnerRecyclerViewWithDeadline(Landroid/support/v7/widget/RecyclerView;J)V
    ...
    .line 317
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView;->removeAndRecycleViews()V
    ...
    .line 326
    invoke-static/range {v1 .. v1}, Landroid/support/v4/os/TraceCompat;->beginSection(Ljava/lang/String;)V
...
.method private prefetchPositionWithDeadline(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 276
    invoke-static/range {p1 .. p2}, Landroid/support/v7/widget/GapWorker;->isPrefetchPositionAttached(Landroid/support/v7/widget/RecyclerView;I)Z
    ...
    .line 284
    :try_start_0
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView;->onEnterLayoutOrScroll()V
    ...
    .line 289
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isBound()Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isInvalid()Z
...
.method postFromTraversal(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 174
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView;->isAttachedToWindow()Z
    ...
    .line 179
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView;->getNanoTime()J
...
.method prefetch(J)V
    ...
    .line 364
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/GapWorker;->buildTaskList()V

    .line 365
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/widget/GapWorker;->flushTasksWithDeadline(J)V
...
.method public run()V
    ...
    .line 371
    invoke-static/range {v2 .. v2}, Landroid/support/v4/os/TraceCompat;->beginSection(Ljava/lang/String;)V
    ...
    .line 384
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/widget/RecyclerView;->getWindowVisibility()I
    ...
    .line 385
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/widget/RecyclerView;->getDrawingTime()J
