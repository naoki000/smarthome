...
.method private computeScrollDuration(IIII)I
    ...
    .line 5102
    invoke-static/range {p1 .. p2}, Ljava/lang/Math;->sqrt(D)D
...
.method public run()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView;->consumePendingUpdateOperations()V
    ...
    .line 4933
    invoke-virtual/range {v1 .. v1}, Landroid/widget/OverScroller;->computeScrollOffset()Z
    ...
    invoke-static/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView;->access$500(Landroid/support/v7/widget/RecyclerView;)[I

    move-result-object v3

    .line 4935
    invoke-virtual/range {v1 .. v1}, Landroid/widget/OverScroller;->getCurrX()I

    move-result v11

    .line 4936
    invoke-virtual/range {v1 .. v1}, Landroid/widget/OverScroller;->getCurrY()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView;->startInterceptRequestLayout()V

    .line 4952
    iget-object v3, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView;->onEnterLayoutOrScroll()V

    const-string v3, "RV Scroll"

    .line 4953
    invoke-static/range {v3 .. v3}, Landroid/support/v4/os/TraceCompat;->beginSection(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v9 .. v9}, Landroid/support/v7/widget/RecyclerView;->repositionShadowingViews()V

    .line 4966
    iget-object v9, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual/range {v9 .. v9}, Landroid/support/v7/widget/RecyclerView;->onExitLayoutOrScroll()V
    ...
    .line 4969
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->isPendingInitialRun()Z
    ...
    .line 4970
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->isRunning()Z
    ...
    invoke-virtual/range {v9 .. v9}, Landroid/support/v7/widget/RecyclerView$State;->getItemCount()I
    ...
    .line 4973
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->stop()V

    goto :goto_2

    .line 4974
    :cond_4
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->getTargetPosition()I
    ...
    invoke-virtual/range {v9 .. v9}, Ljava/util/ArrayList;->isEmpty()Z
    ...
    invoke-virtual/range {v9 .. v9}, Landroid/support/v7/widget/RecyclerView;->invalidate()V

    .line 4985
    :cond_8
    iget-object v9, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->this$0:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual/range {v9 .. v9}, Landroid/support/v7/widget/RecyclerView;->getOverScrollMode()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/RecyclerView;->getOverScrollMode()I
    ...
    .line 5007
    invoke-virtual/range {v1 .. v1}, Landroid/widget/OverScroller;->getFinalX()I
    ...
    .line 5008
    invoke-virtual/range {v1 .. v1}, Landroid/widget/OverScroller;->getFinalY()I
    ...
    .line 5009
    :cond_11
    invoke-virtual/range {v1 .. v1}, Landroid/widget/OverScroller;->abortAnimation()V
    ...
    invoke-static/range {v4 .. v4}, Landroid/support/v7/widget/RecyclerView;->access$700(Landroid/support/v7/widget/RecyclerView;)Z
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/RecyclerView;->invalidate()V
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollVertically()Z
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollHorizontally()Z
    ...
    .line 5027
    :goto_8
    invoke-virtual/range {v1 .. v1}, Landroid/widget/OverScroller;->isFinished()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;->clearPrefetchPositions()V
...
.method public smoothScrollBy(IIII)V
    ...
    .line 5088
    invoke-direct/range {p0 .. p4}, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->computeScrollDuration(IIII)I
