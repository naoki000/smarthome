...
.method public constructor <init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 724
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->setAnchorView(Landroid/view/View;)V
...
.method static synthetic access$301(Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;)V
    ...
    .line 716
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/ListPopupWindow;->show()V
...
.method computeContentWidth()V
    ...
    .line 757
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v7/widget/AppCompatSpinner;->access$100(Landroid/support/v7/widget/AppCompatSpinner;)Landroid/graphics/Rect;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/ViewUtils;->isLayoutRtl(Landroid/view/View;)Z
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner;->access$100(Landroid/support/v7/widget/AppCompatSpinner;)Landroid/graphics/Rect;
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v7/widget/AppCompatSpinner;->access$100(Landroid/support/v7/widget/AppCompatSpinner;)Landroid/graphics/Rect;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner;->getPaddingLeft()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/AppCompatSpinner;->getPaddingRight()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/AppCompatSpinner;->getWidth()I
    ...
    invoke-static/range {v4 .. v4}, Landroid/support/v7/widget/AppCompatSpinner;->access$200(Landroid/support/v7/widget/AppCompatSpinner;)I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/AppCompatSpinner;->getContext()Landroid/content/Context;
    ...
    .line 774
    invoke-virtual/range {v5 .. v5}, Landroid/content/res/Resources;->getDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    invoke-static/range {v6 .. v6}, Landroid/support/v7/widget/AppCompatSpinner;->access$100(Landroid/support/v7/widget/AppCompatSpinner;)Landroid/graphics/Rect;
    ...
    invoke-static/range {v4 .. v4}, Landroid/support/v7/widget/ViewUtils;->isLayoutRtl(Landroid/view/View;)Z
    ...
    .line 786
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->getWidth()I
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 743
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/ListPopupWindow;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public show()V
    ...
    .line 795
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->isShowing()Z

    move-result v0

    .line 797
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->computeContentWidth()V
    ...
    .line 801
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->getListView()Landroid/widget/ListView;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/AppCompatSpinner;->getSelectedItemPosition()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AppCompatSpinner;->getViewTreeObserver()Landroid/view/ViewTreeObserver;
