...
.method constructor <init>(Landroid/support/v7/widget/ViewBoundsCheck$Callback;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;-><init>()V
...
.method findOneViewWithinBoundFlags(IIII)Landroid/view/View;
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/ViewBoundsCheck$Callback;->getParentStart()I
    ...
    invoke-interface/range {v1 .. v1}, Landroid/support/v7/widget/ViewBoundsCheck$Callback;->getParentEnd()I
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->resetFlags()V
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->boundsMatch()Z
...
.method isViewWithinBoundFlags(Landroid/view/View;I)Z
    ...
    invoke-interface/range {v1 .. v1}, Landroid/support/v7/widget/ViewBoundsCheck$Callback;->getParentStart()I
    ...
    invoke-interface/range {v2 .. v2}, Landroid/support/v7/widget/ViewBoundsCheck$Callback;->getParentEnd()I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->resetFlags()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ViewBoundsCheck$BoundFlags;->boundsMatch()Z
