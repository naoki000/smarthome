...
.method public constructor <init>()V
    ...
    .line 36
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView$OnFlingListener;-><init>()V
...
.method private setupCallbacks()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView;->getOnFlingListener()Landroid/support/v7/widget/RecyclerView$OnFlingListener;
...
.method private snapFromFling(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)Z
    ...
    .line 163
    :cond_0
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/SnapHelper;->createScroller(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/RecyclerView$SmoothScroller;
    ...
    .line 168
    :cond_1
    invoke-virtual/range {p0 .. p3}, Landroid/support/v7/widget/SnapHelper;->findTargetSnapPosition(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)I
...
.method public attachToRecyclerView(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 99
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SnapHelper;->destroyCallbacks()V
    ...
    .line 103
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SnapHelper;->setupCallbacks()V
    ...
    invoke-direct/range {v1 .. v1}, Landroid/view/animation/DecelerateInterpolator;-><init>()V
    ...
    .line 106
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SnapHelper;->snapToTargetExistingView()V
...
.method public calculateScrollDistance(II)[I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/Scroller;->getFinalX()I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/Scroller;->getFinalY()I
...
.method protected createScroller(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/RecyclerView$SmoothScroller;
    ...
    .line 211
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/SnapHelper;->createSnapScroller(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/LinearSmoothScroller;
...
.method public onFling(II)Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView;->getAdapter()Landroid/support/v7/widget/RecyclerView$Adapter;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView;->getMinFlingVelocity()I
