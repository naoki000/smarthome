...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$3;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/ViewInfoStore;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$EdgeEffectFactory;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v7/widget/DefaultItemAnimator;-><init>()V
    ...
    invoke-direct/range {v3 .. v3}, Landroid/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;-><init>()V
    ...
    invoke-direct/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$State;-><init>()V
    ...
    .line 598
    invoke-virtual/range {v4 .. v4}, Landroid/content/res/TypedArray;->recycle()V
    ...
    .line 606
    invoke-virtual/range {v4 .. v4}, Landroid/view/ViewConfiguration;->getScaledTouchSlop()I
    ...
    .line 611
    invoke-virtual/range {v4 .. v4}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I
    ...
    .line 612
    invoke-virtual/range {v4 .. v4}, Landroid/view/ViewConfiguration;->getScaledMaximumFlingVelocity()I
...
.method static synthetic access$000(Landroid/support/v7/widget/RecyclerView;Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 156
    invoke-virtual/range {p0 .. p3}, Landroid/support/v7/widget/RecyclerView;->attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method static synthetic access$100(Landroid/support/v7/widget/RecyclerView;I)V
    ...
    .line 156
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->detachViewFromParent(I)V
...
.method static synthetic access$1200(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 156
    invoke-virtual/range {p0 .. p2}, Landroid/support/v7/widget/RecyclerView;->setMeasuredDimension(II)V
...
.method private addAnimatingView(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 1351
    invoke-virtual/range {v0 .. v0}, Landroid/view/View;->getParent()Landroid/view/ViewParent;
    ...
    .line 1353
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isTmpDetached()Z
...
.method private animateChange(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;ZZ)V
    ...
    .line 4061
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->addAnimatingView(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 4075
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->postAnimationRunner()V
...
.method private createLayoutManager(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/lang/Class;->getClassLoader()Ljava/lang/ClassLoader;
...
.method private dispatchContentChangedIfNecessary()V
    ...
    .line 3362
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->isAccessibilityEnabled()Z
...
.method private dispatchLayoutStep1()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ViewInfoStore;->clear()V
    ...
    .line 3718
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->saveFocusInfo()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$Adapter;->getItemCount()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ChildHelper;->getChildCount()I
    ...
    invoke-static/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;

    move-result-object v3

    .line 3730
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->shouldIgnore()Z

    move-result v4

    if-nez v4, :cond_2

    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isInvalid()Z
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/RecyclerView$Adapter;->hasStableIds()Z
    ...
    .line 3735
    invoke-static/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->buildAdapterChangeFlagsForAnimations(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I

    move-result v6

    .line 3736
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getUnmodifiedPayloads()Ljava/util/List;
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isUpdated()Z

    move-result v4

    if-eqz v4, :cond_2

    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isRemoved()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/ChildHelper;->getChildCount()I
    ...
    .line 3768
    invoke-static/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;

    move-result-object v1

    .line 3769
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->shouldIgnore()Z
    ...
    .line 3773
    invoke-static/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->buildAdapterChangeFlagsForAnimations(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    .line 3780
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getUnmodifiedPayloads()Ljava/util/List;
...
.method private dispatchLayoutStep2()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AdapterHelper;->consumeUpdatesInOnePass()V
...
.method private dispatchLayoutStep3()V
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;

    move-result-object v5

    .line 3839
    invoke-virtual/range {v5 .. v5}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->shouldIgnore()Z
    ...
    .line 3846
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->shouldIgnore()Z
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/util/ArrayList;->clear()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$Recycler;->updateViewCacheSize()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/ViewInfoStore;->clear()V
...
.method private findMinMaxChildLayoutPositions([I)V
    ...
    invoke-static/range {v6 .. v6}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 3992
    :cond_1
    invoke-virtual/range {v6 .. v6}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getLayoutPosition()I
...
.method static findNestedRecyclerView(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
    ...
    .line 5476
    invoke-static/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView;->findNestedRecyclerView(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
...
.method private findNextViewToFocus()Landroid/view/View;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$State;->getItemCount()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/view/View;->hasFocusable()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->hasFocusable()Z
...
.method private getFullClassName(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/lang/Class;->getPackage()Ljava/lang/Package;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Ljava/lang/Package;->getName()Ljava/lang/String;
...
.method private handleMissingPreInfoForChangeError(JLandroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$Adapter;->hasStableIds()Z
...
.method private isPreferredNextFocus(Landroid/view/View;Landroid/view/View;I)Z
    ...
    .line 2563
    :cond_2
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->findContainingItemView(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->getLayoutDirection()I
...
.method private predictiveItemAnimationsEnabled()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->supportsPredictiveItemAnimations()Z
...
.method private processAdapterUpdatesAndSetAnimationFlags()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AdapterHelper;->reset()V
    ...
    .line 3470
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->predictiveItemAnimationsEnabled()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AdapterHelper;->preProcess()V
...
.method private pullGlows(FFFF)V
    ...
    .line 2259
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->ensureLeftGlow()V
    ...
    .line 2263
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->ensureRightGlow()V
    ...
    .line 2269
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->ensureTopGlow()V
    ...
    .line 2273
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->ensureBottomGlow()V
...
.method private recoverFocusFromState()V
    ...
    .line 3635
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->requestFocus()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$Adapter;->hasStableIds()Z
    ...
    .line 3661
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->findNextViewToFocus()Landroid/view/View;
    ...
    .line 3672
    invoke-virtual/range {v0 .. v0}, Landroid/view/View;->isFocusable()Z
...
.method private releaseGlows()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/EdgeEffect;->isFinished()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/EdgeEffect;->onRelease()V

    .line 2291
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView;->mTopGlow:Landroid/widget/EdgeEffect;

    invoke-virtual/range {v1 .. v1}, Landroid/widget/EdgeEffect;->isFinished()Z
...
.method private saveFocusInfo()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$Adapter;->hasStableIds()Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getItemId()J
    ...
    .line 3558
    :cond_4
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isRemoved()Z
    ...
    .line 3559
    :cond_5
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getAdapterPosition()I
...
.method private setAdapterInternal(Landroid/support/v7/widget/RecyclerView$Adapter;ZZ)V
    ...
    .line 1124
    :cond_1
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->removeAndRecycleViews()V

    .line 1126
    :cond_2
    iget-object p3, p0, Landroid/support/v7/widget/RecyclerView;->mAdapterHelper:Landroid/support/v7/widget/AdapterHelper;

    invoke-virtual/range {p3 .. p3}, Landroid/support/v7/widget/AdapterHelper;->reset()V
...
.method private stopScrollersInternal()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->stop()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->stopSmoothScroller()V
...
.method public addItemDecoration(Landroid/support/v7/widget/RecyclerView$ItemDecoration;I)V
    ...
    .line 1497
    :goto_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->markItemDecorInsetsDirty()V
...
.method assertInLayoutOrScroll(Ljava/lang/String;)V
    ...
    .line 2748
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->isComputingLayout()Z
...
.method canReuseUpdatedViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
    ...
    .line 4353
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getUnmodifiedPayloads()Ljava/util/List;
...
.method clearOldPositions()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ChildHelper;->getUnfilteredChildCount()I
    ...
    .line 4235
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->shouldIgnore()Z
    ...
    .line 4236
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->clearOldPosition()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$Recycler;->clearOldPositions()V
...
.method public computeHorizontalScrollExtent()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollHorizontally()Z
...
.method public computeVerticalScrollExtent()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollVertically()Z
...
.method considerReleasingGlowsOnScroll(II)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/EdgeEffect;->onRelease()V

    .line 2314
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView;->mRightGlow:Landroid/widget/EdgeEffect;

    invoke-virtual/range {p1 .. p1}, Landroid/widget/EdgeEffect;->isFinished()Z
...
.method consumePendingUpdateOperations()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AdapterHelper;->hasPendingUpdates()Z
    ...
    .line 1750
    invoke-static/range {v0 .. v0}, Landroid/support/v4/os/TraceCompat;->beginSection(Ljava/lang/String;)V
    ...
    .line 1755
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->hasUpdatedView()Z
    ...
    .line 1756
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->dispatchLayout()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AdapterHelper;->consumePostponedUpdates()V
...
.method defaultOnMeasure(II)V
    ...
    .line 3292
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->getPaddingLeft()I

    move-result v0

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->getPaddingRight()I
    ...
    .line 3293
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ViewCompat;->getMinimumWidth(Landroid/view/View;)I
    ...
    .line 3295
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->getPaddingTop()I

    move-result v0

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->getPaddingBottom()I
...
.method dispatchChildAttached(Landroid/view/View;)V
    ...
    .line 7159
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->onChildAttachedToWindow(Landroid/view/View;)V
...
.method dispatchChildDetached(Landroid/view/View;)V
    ...
    .line 7145
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->onChildDetachedFromWindow(Landroid/view/View;)V
...
.method dispatchLayout()V
    ...
    .line 3527
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->dispatchLayoutStep1()V
    ...
    .line 3529
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->dispatchLayoutStep2()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/AdapterHelper;->hasUpdates()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->getWidth()I
    ...
    .line 3531
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->getHeight()I
    ...
    .line 3540
    :goto_1
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->dispatchLayoutStep3()V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    .line 11187
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->getScrollingChildHelper()Landroid/support/v4/view/NestedScrollingChildHelper;
...
.method dispatchOnScrollStateChanged(I)V
    ...
    .line 4873
    :cond_0
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->onScrollStateChanged(I)V
...
.method dispatchOnScrolled(II)V
    ...
    .line 4831
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->getScrollY()I
    ...
    .line 4835
    invoke-virtual/range {p0 .. p2}, Landroid/support/v7/widget/RecyclerView;->onScrolled(II)V
...
.method dispatchPendingImportantForAccessibilityChanges()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getParent()Landroid/view/ViewParent;
...
.method protected dispatchRestoreInstanceState(Landroid/util/SparseArray;)V
    ...
    .line 1338
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->dispatchThawSelfOnly(Landroid/util/SparseArray;)V
...
.method protected dispatchSaveInstanceState(Landroid/util/SparseArray;)V
    ...
    .line 1330
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->dispatchFreezeSelfOnly(Landroid/util/SparseArray;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 4157
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->isRunning()Z
...
.method ensureBottomGlow()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->getMeasuredWidth()I
    ...
    .line 2398
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->getMeasuredHeight()I
...
.method exceptionLabel()Ljava/lang/String;
    ...
    invoke-super/range {p0 .. p0}, Landroid/view/ViewGroup;->toString()Ljava/lang/String;
...
.method final fillRemainingScrollValues(Landroid/support/v7/widget/RecyclerView$State;)V
    ...
    .line 3693
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->getScrollState()I
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->access$400(Landroid/support/v7/widget/RecyclerView$ViewFlinger;)Landroid/widget/OverScroller;

    move-result-object v0

    .line 3695
    invoke-virtual/range {v0 .. v0}, Landroid/widget/OverScroller;->getFinalX()I

    move-result v1

    invoke-virtual/range {v0 .. v0}, Landroid/widget/OverScroller;->getCurrX()I
    ...
    .line 3696
    invoke-virtual/range {v0 .. v0}, Landroid/widget/OverScroller;->getFinalY()I

    move-result v1

    invoke-virtual/range {v0 .. v0}, Landroid/widget/OverScroller;->getCurrY()I
...
.method public findChildViewUnder(FF)Landroid/view/View;
    ...
    .line 4689
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getTranslationX()F

    move-result v2

    .line 4690
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getTranslationY()F

    move-result v3

    .line 4691
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getLeft()I
    ...
    .line 4692
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getRight()I
    ...
    .line 4693
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getTop()I
    ...
    .line 4694
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getBottom()I
...
.method public findViewHolderForItemId(J)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getItemId()J
...
.method findViewHolderForPosition(IZ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 4629
    :cond_0
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getLayoutPosition()I
...
.method public fling(II)Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollVertically()Z
...
.method public focusSearch(Landroid/view/View;I)Landroid/view/View;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->getLayoutDirection()I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->generateDefaultLayoutParams()Landroid/support/v7/widget/RecyclerView$LayoutParams;
...
.method getAdapterPositionFor(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    .line 11093
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isBound()Z
...
.method public getBaseline()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->getBaseline()I
    ...
    .line 1177
    :cond_0
    invoke-super/range {p0 .. p0}, Landroid/view/ViewGroup;->getBaseline()I
...
.method getChangedHolderKey(Landroid/support/v7/widget/RecyclerView$ViewHolder;)J
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getItemId()J
...
.method protected getChildDrawingOrder(II)I
    ...
    .line 13006
    invoke-super/range {p0 .. p2}, Landroid/view/ViewGroup;->getChildDrawingOrder(II)I
...
.method public getChildLayoutPosition(Landroid/view/View;)I
    ...
    .line 4532
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->getLayoutPosition()I
...
.method public getChildPosition(Landroid/view/View;)I
    ...
    .line 4506
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->getChildAdapterPosition(Landroid/view/View;)I
...
.method public getDecoratedBoundsWithMargins(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 4765
    invoke-static/range {p1 .. p2}, Landroid/support/v7/widget/RecyclerView;->getDecoratedBoundsWithMarginsInt(Landroid/view/View;Landroid/graphics/Rect;)V
...
.method getItemDecorInsetsForChild(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$State;->isPreLayout()Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutParams;->isItemChanged()Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutParams;->isViewInvalid()Z
...
.method public getRecycledViewPool()Landroid/support/v7/widget/RecyclerView$RecycledViewPool;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$Recycler;->getRecycledViewPool()Landroid/support/v7/widget/RecyclerView$RecycledViewPool;
...
.method public hasNestedScrollingParent()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/NestedScrollingChildHelper;->hasNestedScrollingParent()Z
...
.method isAccessibilityEnabled()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/view/accessibility/AccessibilityManager;->isEnabled()Z
...
.method public isAnimating()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->isRunning()Z
...
.method public isNestedScrollingEnabled()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/NestedScrollingChildHelper;->isNestedScrollingEnabled()Z
...
.method markItemDecorInsetsDirty()V
    ...
    .line 4100
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$Recycler;->markItemDecorInsetsDirty()V
...
.method markKnownViewsInvalid()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$Recycler;->markKnownViewsInvalid()V
...
.method offsetPositionRecordsForMove(II)V
    ...
    invoke-static/range {v7 .. v7}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;
...
.method offsetPositionRecordsForRemove(IIZ)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/ChildHelper;->getUnfilteredChildCount()I
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->isLayoutRequested()Z
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/GapWorker;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView;->mGapWorker:Landroid/support/v7/widget/GapWorker;

    .line 2695
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ViewCompat;->getDisplay(Landroid/view/View;)Landroid/view/Display;
    ...
    .line 2698
    invoke-virtual/range {v0 .. v0}, Landroid/view/Display;->getRefreshRate()F
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->endAnimations()V

    .line 2716
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->stopScroll()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ViewInfoStore;->onDetach()V
...
.method onExitLayoutOrScroll(Z)V
    ...
    .line 3349
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->dispatchContentChangedIfNecessary()V

    .line 3350
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->dispatchPendingImportantForAccessibilityChanges()V
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollHorizontally()Z
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollVertically()Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 2934
    invoke-static/range {v4 .. v4}, Ljava/lang/Math;->abs(I)I
    ...
    .line 2938
    invoke-static/range {v6 .. v6}, Ljava/lang/Math;->abs(I)I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/view/VelocityTracker;->clear()V
...
.method protected onLayout(ZIIII)V
    ...
    .line 4081
    invoke-static/range {p1 .. p1}, Landroid/support/v4/os/TraceCompat;->beginSection(Ljava/lang/String;)V
...
.method protected onMeasure(II)V
    ...
    .line 3196
    invoke-virtual/range {p0 .. p2}, Landroid/support/v7/widget/RecyclerView;->defaultOnMeasure(II)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->isAutoMeasureEnabled()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->shouldMeasureTwice()Z
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    .line 2673
    :cond_0
    invoke-super/range {p0 .. p2}, Landroid/view/ViewGroup;->onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$SavedState;->getSuperState()Landroid/os/Parcelable;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method protected onSizeChanged(IIII)V
    ...
    .line 3303
    invoke-super/range {p0 .. p4}, Landroid/view/ViewGroup;->onSizeChanged(IIII)V
    ...
    .line 3305
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->invalidateGlows()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 3051
    invoke-static/range {v5 .. v5}, Ljava/lang/Math;->abs(I)I
    ...
    .line 3059
    invoke-static/range {v13 .. v13}, Ljava/lang/Math;->abs(I)I
    ...
    .line 3114
    :cond_18
    invoke-virtual/range {v4 .. v4}, Landroid/view/MotionEvent;->recycle()V
...
.method processDataSetCompletelyChanged(Z)V
    ...
    .line 4372
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->markKnownViewsInvalid()V
...
.method recordAnimationInfoIfBouncedHiddenView(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isUpdated()Z
    ...
    .line 3971
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->isRemoved()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->shouldIgnore()Z
    ...
    .line 3972
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->getChangedHolderKey(Landroid/support/v7/widget/RecyclerView$ViewHolder;)J
...
.method removeAndRecycleViews()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/RecyclerView$Recycler;->clear()V
...
.method protected removeDetachedView(Landroid/view/View;Z)V
    ...
    .line 4027
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->dispatchChildDetached(Landroid/view/View;)V

    .line 4028
    invoke-super/range {p0 .. p2}, Landroid/view/ViewGroup;->removeDetachedView(Landroid/view/View;Z)V
...
.method public removeItemDecorationAt(I)V
    ...
    .line 1552
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->getItemDecorationAt(I)Landroid/support/v7/widget/RecyclerView$ItemDecoration;
...
.method repositionShadowingViews()V
    ...
    .line 5160
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getLeft()I

    move-result v4

    .line 5161
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getTop()I

    move-result v2

    .line 5162
    invoke-virtual/range {v3 .. v3}, Landroid/view/View;->getLeft()I

    move-result v5

    if-ne v4, v5, :cond_0

    invoke-virtual/range {v3 .. v3}, Landroid/view/View;->getTop()I
    ...
    .line 5164
    :cond_0
    invoke-virtual/range {v3 .. v3}, Landroid/view/View;->getWidth()I
    ...
    .line 5165
    invoke-virtual/range {v3 .. v3}, Landroid/view/View;->getHeight()I
...
.method public requestChildFocus(Landroid/view/View;Landroid/view/View;)V
    ...
    .line 2612
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/widget/RecyclerView;->requestChildOnScreen(Landroid/view/View;Landroid/view/View;)V

    .line 2614
    :cond_0
    invoke-super/range {p0 .. p2}, Landroid/view/ViewGroup;->requestChildFocus(Landroid/view/View;Landroid/view/View;)V
...
.method public requestLayout()V
    ...
    .line 4090
    invoke-super/range {p0 .. p0}, Landroid/view/ViewGroup;->requestLayout()V
...
.method saveOldPositions()V
    ...
    .line 4226
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->saveOldPosition()V
...
.method public scrollBy(II)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollVertically()Z
...
.method scrollByInternal(IILandroid/view/MotionEvent;)Z
    ...
    invoke-virtual/range {v5 .. v5}, Ljava/util/ArrayList;->isEmpty()Z
...
.method public sendAccessibilityEventUnchecked(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 3418
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->shouldDeferAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    .line 3421
    :cond_0
    invoke-super/range {p0 .. p1}, Landroid/view/ViewGroup;->sendAccessibilityEventUnchecked(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public setEdgeEffectFactory(Landroid/support/v7/widget/RecyclerView$EdgeEffectFactory;)V
    ...
    .line 2418
    invoke-static/range {p1 .. p1}, Landroid/support/v4/util/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public setLayoutManager(Landroid/support/v7/widget/RecyclerView$LayoutManager;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ChildHelper;->removeAllViewsUnfiltered()V
    ...
    .line 1264
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView;->exceptionLabel()Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$Recycler;->updateViewCacheSize()V
...
.method setScrollState(I)V
    ...
    .line 1465
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/RecyclerView;->stopScrollersInternal()V

    .line 1467
    :cond_1
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/RecyclerView;->dispatchOnScrollStateChanged(I)V
...
.method public setScrollingTouchSlop(I)V
    ...
    invoke-static/range {v0 .. v0}, Landroid/view/ViewConfiguration;->get(Landroid/content/Context;)Landroid/view/ViewConfiguration;
    ...
    .line 1045
    :pswitch_0
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewConfiguration;->getScaledPagingTouchSlop()I
    ...
    :goto_0
    :pswitch_1
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewConfiguration;->getScaledTouchSlop()I
...
.method shouldDeferAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    .line 3405
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/accessibility/AccessibilityEventCompat;->getContentChangeTypes(Landroid/view/accessibility/AccessibilityEvent;)I
...
.method public stopNestedScroll()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/view/NestedScrollingChildHelper;->stopNestedScroll()V
...
.method viewRangeUpdate(IILjava/lang/Object;)V
    ...
    .line 4336
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->shouldIgnore()Z
    ...
    .line 4345
    invoke-virtual/range {v3 .. v3}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
