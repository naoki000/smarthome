...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    .line 94
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/SearchView;->getSuggestionRowLayout()I
    ...
    .line 99
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/SearchView;->getSuggestionCommitIconResId()I
...
.method private checkIconCache(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 587
    :cond_0
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/drawable/Drawable$ConstantState;->newDrawable()Landroid/graphics/drawable/Drawable;
...
.method private getActivityIcon(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    .line 654
    invoke-virtual/range {v1 .. v1}, Landroid/content/pm/ActivityInfo;->getIconResource()I
    ...
    .line 651
    invoke-virtual/range {p1 .. p1}, Landroid/content/pm/PackageManager$NameNotFoundException;->toString()Ljava/lang/String;
...
.method private getActivityIconWithCache(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    .line 631
    :cond_1
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/SuggestionsAdapter;->getActivityIcon(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
...
.method private getDrawable(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
    ...
    .line 553
    :try_start_1
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/SuggestionsAdapter;->getDrawableFromResourceUri(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/io/FileNotFoundException;->getMessage()Ljava/lang/String;
...
.method private getDrawableFromResourceValue(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 514
    invoke-virtual/range {v3 .. v3}, Landroid/content/Context;->getPackageName()Ljava/lang/String;
    ...
    .line 527
    :catch_1
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/SuggestionsAdapter;->checkIconCache(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
...
.method private getIcon1(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    .line 369
    :cond_1
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/SuggestionsAdapter;->getDefaultIcon1(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
...
.method private setViewDrawable(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;I)V
    ...
    .line 387
    invoke-virtual/range {p1 .. p2}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private storeInIconCache(Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/graphics/drawable/Drawable;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
...
.method public changeCursor(Landroid/database/Cursor;)V
    ...
    :cond_1
    :try_start_0
    invoke-super/range {p0 .. p1}, Landroid/support/v4/widget/ResourceCursorAdapter;->changeCursor(Landroid/database/Cursor;)V
...
.method public convertToString(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/app/SearchableInfo;->shouldRewriteQueryFromData()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/app/SearchableInfo;->shouldRewriteQueryFromText()Z
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 472
    :try_start_0
    invoke-super/range {p0 .. p3}, Landroid/support/v4/widget/ResourceCursorAdapter;->getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 480
    invoke-virtual/range {p1 .. p1}, Ljava/lang/RuntimeException;->toString()Ljava/lang/String;
...
.method getSearchManagerSuggestions(Landroid/app/SearchableInfo;Ljava/lang/String;I)Landroid/database/Cursor;
    ...
    invoke-direct/range {v2 .. v2}, Landroid/net/Uri$Builder;-><init>()V
    ...
    .line 774
    :cond_4
    invoke-virtual/range {v1 .. v1}, Landroid/net/Uri$Builder;->build()Landroid/net/Uri;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 449
    :try_start_0
    invoke-super/range {p0 .. p3}, Landroid/support/v4/widget/ResourceCursorAdapter;->getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 243
    invoke-super/range {p0 .. p3}, Landroid/support/v4/widget/ResourceCursorAdapter;->newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public notifyDataSetChanged()V
    ...
    .line 180
    invoke-super/range {p0 .. p0}, Landroid/support/v4/widget/ResourceCursorAdapter;->notifyDataSetChanged()V

    .line 182
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SuggestionsAdapter;->getCursor()Landroid/database/Cursor;
...
.method public notifyDataSetInvalidated()V
    ...
    .line 188
    invoke-super/range {p0 .. p0}, Landroid/support/v4/widget/ResourceCursorAdapter;->notifyDataSetInvalidated()V
...
.method public runQueryOnBackgroundThread(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView;->getVisibility()I
    ...
    .line 152
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView;->getWindowVisibility()I
