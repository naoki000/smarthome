...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$AutoCompleteTextViewReflector;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 361
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/TintTypedArray;->recycle()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getDropDownAnchor()I
...
.method private createIntent(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/app/SearchableInfo;->getSearchActivity()Landroid/content/ComponentName;
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/app/SearchableInfo;->getSuggestIntentAction()Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/app/SearchableInfo;->getSuggestIntentData()Ljava/lang/String;
    ...
    invoke-static/range {v3 .. v3}, Landroid/net/Uri;->encode(Ljava/lang/String;)Ljava/lang/String;
...
.method private createVoiceAppSearchIntent(Landroid/content/Intent;Landroid/app/SearchableInfo;)Landroid/content/Intent;
    ...
    .line 1587
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->getContext()Landroid/content/Context;
    ...
    .line 1629
    :cond_5
    invoke-virtual/range {v0 .. v0}, Landroid/content/ComponentName;->flattenToShortString()Ljava/lang/String;
...
.method private dismissSuggestions()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->dismissDropDown()V
...
.method private getDecoratedHint(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getTextSize()F
...
.method private hasVoiceSearch()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/app/SearchableInfo;->getVoiceSearchEnabled()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/app/SearchableInfo;->getVoiceSearchLaunchWebSearch()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/app/SearchableInfo;->getVoiceSearchLaunchRecognizer()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;
...
.method private isSubmitAreaEnabled()Z
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->isIconified()Z
...
.method private launchSuggestion(IILjava/lang/String;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CursorAdapter;->getCursor()Landroid/database/Cursor;
...
.method private rewriteQueryFromSuggestion(I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getText()Landroid/text/Editable;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/widget/CursorAdapter;->getCursor()Landroid/database/Cursor;
...
.method private updateCloseButton()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/ImageView;->getDrawable()Landroid/graphics/drawable/Drawable;
...
.method private updateQueryHint()V
    ...
    .line 1100
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->getQueryHint()Ljava/lang/CharSequence;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/app/SearchableInfo;->getSuggestThreshold()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/app/SearchableInfo;->getImeOptions()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/app/SearchableInfo;->getInputType()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/app/SearchableInfo;->getSuggestAuthority()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/app/SearchableInfo;->getSuggestAuthority()Ljava/lang/String;
...
.method private updateSubmitArea()V
    ...
    .line 922
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->isSubmitAreaEnabled()Z
    ...
    .line 923
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ImageView;->getVisibility()I
...
.method private updateSubmitButton(Z)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->hasFocus()Z
...
.method private updateViewsVisibility(Z)V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getText()Landroid/text/Editable;
    ...
    .line 885
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->updateCloseButton()V
    ...
    .line 887
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->updateSubmitArea()V
...
.method adjustDropDownSizeAndPosition()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getDropDownBackground()Landroid/graphics/drawable/Drawable;
...
.method public clearFocus()V
    ...
    .line 496
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/LinearLayoutCompat;->clearFocus()V

    .line 497
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->clearFocus()V
...
.method public getImeOptions()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getImeOptions()I
...
.method public getInputType()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getInputType()I
...
.method public getQueryHint()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/app/SearchableInfo;->getHintId()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/app/SearchableInfo;->getHintId()I
...
.method public onActionViewCollapsed()V
    ...
    .line 1278
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->clearFocus()V
...
.method onCloseClicked()V
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$OnCloseListener;->onClose()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->requestFocus()Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 964
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/LinearLayoutCompat;->onDetachedFromWindow()V
...
.method onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1390
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->dismissSuggestions()V
...
.method onItemSelected(I)Z
    ...
    :cond_1
    :goto_0
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/SearchView;->rewriteQueryFromSuggestion(I)V
...
.method protected onMeasure(II)V
    ...
    :cond_3
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->getPreferredWidth()I
    ...
    .line 819
    :cond_7
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->getPreferredHeight()I
...
.method onQueryRefine(Ljava/lang/CharSequence;)V
    ...
    .line 971
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/SearchView;->setQuery(Ljava/lang/CharSequence;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1352
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/LinearLayoutCompat;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1356
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/SearchView$SavedState;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 1358
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->requestLayout()V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1343
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/LinearLayoutCompat;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method onSubmitQuery()V
    ...
    .line 1187
    invoke-static/range {v0 .. v0}, Landroid/text/TextUtils;->getTrimmedLength(Ljava/lang/CharSequence;)I
    ...
    .line 1189
    invoke-interface/range {v0 .. v0}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;
...
.method onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->getListSelection()I
    ...
    .line 1064
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->length()I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->clearListSelection()V
...
.method onTextFocusChanged()V
    ...
    .line 1259
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->postUpdateFocusedState()V

    .line 1260
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->hasFocus()Z
    ...
    .line 1261
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->forceSuggestionQuery()V
...
.method onVoiceClicked()V
    ...
    .line 1239
    :try_start_0
    invoke-virtual/range {v0 .. v0}, Landroid/app/SearchableInfo;->getVoiceSearchLaunchWebSearch()Z
    ...
    .line 1243
    :cond_1
    invoke-virtual/range {v0 .. v0}, Landroid/app/SearchableInfo;->getVoiceSearchLaunchRecognizer()Z
...
.method public onWindowFocusChanged(Z)V
    ...
    .line 1267
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/LinearLayoutCompat;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    .line 480
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->isFocusable()Z
    ...
    .line 489
    :cond_3
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/LinearLayoutCompat;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setIconified(Z)V
    ...
    .line 668
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->onCloseClicked()V

    goto :goto_0

    .line 670
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->onSearchClicked()V
...
.method public setIconifiedByDefault(Z)V
    ...
    .line 642
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/SearchView;->updateViewsVisibility(Z)V
...
.method public setQuery(Ljava/lang/CharSequence;Z)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/SearchView$SearchAutoComplete;->length()I
    ...
    .line 577
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->onSubmitQuery()V
...
.method public setSearchableInfo(Landroid/app/SearchableInfo;)V
    ...
    .line 406
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->updateSearchAutoComplete()V
    ...
    .line 410
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->hasVoiceSearch()Z
...
.method updateFocusedState()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 957
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SearchView;->invalidate()V
