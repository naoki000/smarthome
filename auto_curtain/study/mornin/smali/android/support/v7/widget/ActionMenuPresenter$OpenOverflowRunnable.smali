...
.method public run()V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter;->access$300(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/MenuBuilder;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter;->access$400(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/MenuBuilder;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuBuilder;->changeMenuMode()V

    .line 804
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter$OpenOverflowRunnable;->this$0:Landroid/support/v7/widget/ActionMenuPresenter;

    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter;->access$500(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/view/menu/MenuView;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter$OverflowPopup;->tryShow()Z
