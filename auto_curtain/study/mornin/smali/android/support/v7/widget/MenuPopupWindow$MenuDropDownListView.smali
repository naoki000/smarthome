...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 137
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/widget/DropDownListView;-><init>(Landroid/content/Context;Z)V
...
.method public bridge synthetic hasFocus()Z
    ...
    .line 128
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/DropDownListView;->hasFocus()Z
...
.method public bridge synthetic hasWindowFocus()Z
    ...
    .line 128
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/DropDownListView;->hasWindowFocus()Z
...
.method public bridge synthetic isFocused()Z
    ...
    .line 128
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/DropDownListView;->isFocused()Z
...
.method public bridge synthetic isInTouchMode()Z
    ...
    .line 128
    invoke-super/range {p0 .. p0}, Landroid/support/v7/widget/DropDownListView;->isInTouchMode()Z
...
.method public bridge synthetic lookForSelectablePosition(IZ)I
    ...
    .line 128
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/DropDownListView;->lookForSelectablePosition(IZ)I
...
.method public bridge synthetic onForwardedEvent(Landroid/view/MotionEvent;I)Z
    ...
    .line 128
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/DropDownListView;->onForwardedEvent(Landroid/view/MotionEvent;I)Z
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 187
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->getAdapter()Landroid/widget/ListAdapter;
    ...
    .line 190
    invoke-virtual/range {v0 .. v0}, Landroid/widget/HeaderViewListAdapter;->getHeadersCount()I

    move-result v1

    .line 191
    invoke-virtual/range {v0 .. v0}, Landroid/widget/HeaderViewListAdapter;->getWrappedAdapter()Landroid/widget/ListAdapter;
    ...
    .line 203
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuAdapter;->getCount()I
    ...
    .line 211
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuAdapter;->getAdapterMenu()Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 224
    :cond_3
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/DropDownListView;->onHoverEvent(Landroid/view/MotionEvent;)Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 161
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->getSelectedView()Landroid/view/View;
    ...
    .line 163
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/ListMenuItemView;->isEnabled()Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/ListMenuItemView;->getItemData()Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 166
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->getSelectedItemPosition()I

    move-result p1

    .line 167
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->getSelectedItemId()J
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuAdapter;->getAdapterMenu()Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 177
    :cond_2
    invoke-super/range {p0 .. p2}, Landroid/support/v7/widget/DropDownListView;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public bridge synthetic onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 128
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/DropDownListView;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public bridge synthetic setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 128
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/DropDownListView;->setSelector(Landroid/graphics/drawable/Drawable;)V
