...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 218
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/content/res/Resources;->getDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    .line 254
    :cond_4
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->applyThumbTint()V
    ...
    .line 269
    :cond_8
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->applyTrackTint()V
    ...
    .line 281
    invoke-virtual/range {p1 .. p1}, Landroid/view/ViewConfiguration;->getScaledTouchSlop()I
    ...
    .line 282
    invoke-virtual/range {p1 .. p1}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I
    ...
    .line 285
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->refreshDrawableState()V
...
.method private animateThumbToCheckedState(Z)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/animation/ObjectAnimator;->start()V
...
.method private cancelPositionAnimator()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/ObjectAnimator;->cancel()V
...
.method private getThumbOffset()I
    ...
    .line 1294
    :goto_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getThumbScrollRange()I
...
.method private getThumbScrollRange()I
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v7/widget/DrawableUtils;->getOpticalBounds(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method private stopDrag(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->isEnabled()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/VelocityTracker;->getXVelocity()F
    ...
    .line 1016
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/SwitchCompat;->cancelSuperTouch(Landroid/view/MotionEvent;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static/range {v6 .. v6}, Landroid/support/v7/widget/DrawableUtils;->getOpticalBounds(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public drawableHotspotChanged(FF)V
    ...
    .line 1350
    invoke-super/range {p0 .. p2}, Landroid/widget/CompoundButton;->drawableHotspotChanged(FF)V
...
.method protected drawableStateChanged()V
    ...
    .line 1327
    invoke-super/range {p0 .. p0}, Landroid/widget/CompoundButton;->drawableStateChanged()V
    ...
    .line 1343
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->invalidate()V
...
.method public getCompoundPaddingLeft()I
    ...
    .line 1260
    invoke-super/range {p0 .. p0}, Landroid/widget/CompoundButton;->getCompoundPaddingLeft()I
    ...
    .line 1263
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getText()Ljava/lang/CharSequence;
...
.method public getCompoundPaddingRight()I
    ...
    .line 1272
    invoke-super/range {p0 .. p0}, Landroid/widget/CompoundButton;->getCompoundPaddingRight()I
...
.method public jumpDrawablesToCurrentState()V
    ...
    .line 1369
    invoke-super/range {p0 .. p0}, Landroid/widget/CompoundButton;->jumpDrawablesToCurrentState()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable;->jumpToCurrentState()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/ObjectAnimator;->isStarted()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/ObjectAnimator;->end()V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1201
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Rect;->setEmpty()V
    ...
    .line 1212
    invoke-static/range {v4 .. v4}, Landroid/support/v7/widget/DrawableUtils;->getOpticalBounds(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 1242
    invoke-virtual/range {v4 .. v4}, Landroid/graphics/drawable/Drawable;->getBounds()Landroid/graphics/Rect;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/text/Layout;->getWidth()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/text/Layout;->getHeight()I
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 1387
    invoke-super/range {p0 .. p1}, Landroid/widget/CompoundButton;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    .line 1393
    invoke-super/range {p0 .. p1}, Landroid/widget/CompoundButton;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p3 .. p3}, Landroid/support/v7/widget/DrawableUtils;->getOpticalBounds(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 1093
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getPaddingLeft()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getPaddingRight()I
    ...
    .line 1102
    :goto_2
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getGravity()I
    ...
    .line 1105
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getPaddingTop()I
    ...
    .line 1116
    :cond_3
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getHeight()I

    move-result p1

    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getPaddingBottom()I
...
.method public onMeasure(II)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/graphics/drawable/Drawable;->getIntrinsicWidth()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/text/Layout;->getWidth()I

    move-result v4

    iget-object v5, p0, Landroid/support/v7/widget/SwitchCompat;->mOffLayout:Landroid/text/Layout;

    invoke-virtual/range {v5 .. v5}, Landroid/text/Layout;->getWidth()I
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I
    ...
    .line 853
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getMeasuredHeight()I
    ...
    .line 855
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getMeasuredWidthAndState()I
...
.method public onPopulateAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 861
    invoke-super/range {p0 .. p1}, Landroid/widget/CompoundButton;->onPopulateAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 928
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getParent()Landroid/view/ViewParent;
    ...
    .line 965
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/SwitchCompat;->stopDrag(Landroid/view/MotionEvent;)V
...
.method public setChecked(Z)V
    ...
    .line 1056
    invoke-super/range {p0 .. p1}, Landroid/widget/CompoundButton;->setChecked(Z)V
    ...
    .line 1062
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getWindowToken()Landroid/os/IBinder;
    ...
    .line 1066
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->cancelPositionAnimator()V
...
.method public setShowText(Z)V
    ...
    .line 779
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->requestLayout()V
...
.method public setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    .line 307
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getTextColors()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/text/TextPaint;->getTextSize()F
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/SwitchCompat;->getContext()Landroid/content/Context;
...
.method public setSwitchTypeface(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/text/TextPaint;->getTypeface()Landroid/graphics/Typeface;
...
.method public setSwitchTypeface(Landroid/graphics/Typeface;I)V
    ...
    .line 364
    :cond_0
    invoke-static/range {p1 .. p2}, Landroid/graphics/Typeface;->create(Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;
    ...
    .line 369
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/Typeface;->getStyle()I
    ...
    .line 376
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/SwitchCompat;->setSwitchTypeface(Landroid/graphics/Typeface;)V
...
.method protected verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1364
    invoke-super/range {p0 .. p1}, Landroid/widget/CompoundButton;->verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
