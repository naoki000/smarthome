...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/util/SparseBooleanArray;-><init>()V
...
.method private findViewForItem(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    .line 327
    invoke-interface/range {v5 .. v5}, Landroid/support/v7/view/menu/MenuView$ItemView;->getItemData()Landroid/support/v7/view/menu/MenuItemImpl;
...
.method public dismissPopupMenus()Z
    ...
    .line 380
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionMenuPresenter;->hideOverflowMenu()Z

    move-result v0

    .line 381
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionMenuPresenter;->hideSubMenus()Z
...
.method public filterLeftoverView(Landroid/view/ViewGroup;I)Z
    ...
    .line 279
    :cond_0
    invoke-super/range {p0 .. p2}, Landroid/support/v7/view/menu/BaseMenuPresenter;->filterLeftoverView(Landroid/view/ViewGroup;I)Z
...
.method public flagActionItems()Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/view/menu/MenuBuilder;->getVisibleItems()Ljava/util/ArrayList;
    ...
    .line 439
    invoke-virtual/range {v13 .. v13}, Landroid/support/v7/view/menu/MenuItemImpl;->requiresActionButton()Z
    ...
    .line 441
    :cond_1
    invoke-virtual/range {v13 .. v13}, Landroid/support/v7/view/menu/MenuItemImpl;->requestsActionButton()Z
    ...
    invoke-virtual/range {v13 .. v13}, Landroid/support/v7/view/menu/MenuItemImpl;->isActionViewExpanded()Z
    ...
    .line 461
    invoke-virtual/range {v4 .. v4}, Landroid/util/SparseBooleanArray;->clear()V
    ...
    .line 475
    invoke-virtual/range {v14 .. v14}, Landroid/support/v7/view/menu/MenuItemImpl;->requiresActionButton()Z
    ...
    .line 486
    :goto_5
    invoke-virtual/range {v15 .. v15}, Landroid/view/View;->getMeasuredWidth()I
    ...
    .line 491
    :goto_6
    invoke-virtual/range {v14 .. v14}, Landroid/support/v7/view/menu/MenuItemImpl;->getGroupId()I
    ...
    .line 496
    :cond_c
    invoke-virtual/range {v14 .. v14}, Landroid/support/v7/view/menu/MenuItemImpl;->requestsActionButton()Z
    ...
    :cond_12
    :goto_a
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->getMeasuredWidth()I
    ...
    .line 540
    invoke-virtual/range {v15 .. v15}, Landroid/support/v7/view/menu/MenuItemImpl;->getGroupId()I
    ...
    .line 542
    invoke-virtual/range {v15 .. v15}, Landroid/support/v7/view/menu/MenuItemImpl;->isActionButton()Z
...
.method public getItemView(Landroid/support/v7/view/menu/MenuItemImpl;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 194
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->getActionView()Landroid/view/View;
    ...
    .line 196
    :cond_0
    invoke-super/range {p0 .. p3}, Landroid/support/v7/view/menu/BaseMenuPresenter;->getItemView(Landroid/support/v7/view/menu/MenuItemImpl;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v0

    .line 198
    :cond_1
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuItemImpl;->isActionViewExpanded()Z
...
.method public getMenuView(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/MenuView;
    ...
    .line 185
    invoke-super/range {p0 .. p1}, Landroid/support/v7/view/menu/BaseMenuPresenter;->getMenuView(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/MenuView;
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter$OverflowMenuButton;->getDrawable()Landroid/graphics/drawable/Drawable;
...
.method public hideOverflowMenu()Z
    ...
    .line 369
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuPopupHelper;->dismiss()V
...
.method public hideSubMenus()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter$ActionButtonSubmenu;->dismiss()V
...
.method public initForMenu(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    .line 92
    invoke-super/range {p0 .. p2}, Landroid/support/v7/view/menu/BaseMenuPresenter;->initForMenu(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    .line 98
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/ActionBarPolicy;->showsOverflowMenuButton()Z
    ...
    .line 102
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/ActionBarPolicy;->getEmbeddedMenuWidthLimit()I
    ...
    .line 107
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/ActionBarPolicy;->getMaxActionButtons()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter$OverflowMenuButton;->getMeasuredWidth()I
...
.method public isOverflowMenuShowPending()Z
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionMenuPresenter;->isOverflowMenuShowing()Z
...
.method public isOverflowMenuShowing()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter$OverflowPopup;->isShowing()Z
...
.method public onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .line 561
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionMenuPresenter;->dismissPopupMenus()Z

    .line 562
    invoke-super/range {p0 .. p2}, Landroid/support/v7/view/menu/BaseMenuPresenter;->onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter$SavedState;-><init>()V
...
.method public onSubMenuSelected(Landroid/support/v7/view/menu/SubMenuBuilder;)Z
    ...
    .line 284
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/SubMenuBuilder;->hasVisibleItems()Z
    ...
    .line 287
    :goto_0
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/SubMenuBuilder;->getParentMenu()Landroid/view/Menu;
    ...
    .line 290
    :cond_1
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/SubMenuBuilder;->getItem()Landroid/view/MenuItem;
    ...
    .line 299
    :cond_2
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/SubMenuBuilder;->getItem()Landroid/view/MenuItem;

    move-result-object v2

    invoke-interface/range {v2 .. v2}, Landroid/view/MenuItem;->getItemId()I
    ...
    .line 302
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/SubMenuBuilder;->size()I
    ...
    .line 305
    invoke-interface/range {v5 .. v5}, Landroid/view/MenuItem;->isVisible()Z

    move-result v6

    if-eqz v6, :cond_3

    invoke-interface/range {v5 .. v5}, Landroid/view/MenuItem;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter$ActionButtonSubmenu;->show()V

    .line 315
    invoke-super/range {p0 .. p1}, Landroid/support/v7/view/menu/BaseMenuPresenter;->onSubMenuSelected(Landroid/support/v7/view/menu/SubMenuBuilder;)Z
...
.method public shouldIncludeItem(ILandroid/support/v7/view/menu/MenuItemImpl;)Z
    ...
    .line 224
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/view/menu/MenuItemImpl;->isActionButton()Z
...
.method public showOverflowMenu()Z
    ...
    .line 340
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuBuilder;->getNonActionItems()Ljava/util/ArrayList;
...
.method public updateMenuView(Z)V
    ...
    .line 229
    invoke-super/range {p0 .. p1}, Landroid/support/v7/view/menu/BaseMenuPresenter;->updateMenuView(Z)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->getActionItems()Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/view/menu/MenuItemImpl;->getSupportActionProvider()Landroid/support/v4/view/ActionProvider;
    ...
    .line 245
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->getNonActionItems()Ljava/util/ArrayList;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ActionMenuPresenter$OverflowMenuButton;->getParent()Landroid/view/ViewParent;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ActionMenuView;->generateOverflowButtonLayoutParams()Landroid/support/v7/widget/ActionMenuView$LayoutParams;
