...
.method appendToSpan(Landroid/view/View;)V
    ...
    .line 2606
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/StaggeredGridLayoutManager$Span;->getLayoutParams(Landroid/view/View;)Landroid/support/v7/widget/StaggeredGridLayoutManager$LayoutParams;
    ...
    .line 2613
    :cond_0
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/StaggeredGridLayoutManager$LayoutParams;->isItemRemoved()Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/StaggeredGridLayoutManager$LayoutParams;->isItemChanged()Z
...
.method cacheReferenceLineAndClear(ZI)V
    ...
    .line 2626
    :goto_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/StaggeredGridLayoutManager$Span;->clear()V
...
.method calculateCachedEnd()V
    ...
    .line 2576
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager$LayoutParams;->getViewLayoutPosition()I
...
.method clear()V
    ...
    .line 2642
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/StaggeredGridLayoutManager$Span;->invalidateCache()V
...
.method getEndLine()I
    ...
    .line 2588
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/StaggeredGridLayoutManager$Span;->calculateCachedEnd()V
...
.method public getFocusableViewAfter(II)Landroid/view/View;
    ...
    .line 2816
    :cond_1
    invoke-virtual/range {v2 .. v2}, Landroid/view/View;->hasFocusable()Z
...
.method getStartLine()I
    ...
    .line 2554
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/StaggeredGridLayoutManager$Span;->calculateCachedStart()V
...
.method popEnd()V
    ...
    .line 2660
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/StaggeredGridLayoutManager$LayoutParams;->isItemRemoved()Z

    move-result v3

    if-nez v3, :cond_0

    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/StaggeredGridLayoutManager$LayoutParams;->isItemChanged()Z
...
.method popStart()V
    ...
    .line 2676
    :cond_0
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager$LayoutParams;->isItemRemoved()Z

    move-result v2

    if-nez v2, :cond_1

    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager$LayoutParams;->isItemChanged()Z
