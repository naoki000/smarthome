...
.method public constructor <init>()V
    ...
    .line 32
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/SnapHelper;-><init>()V
...
.method private distanceToCenter(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;Landroid/support/v7/widget/OrientationHelper;)I
    ...
    .line 145
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->getClipToPadding()Z
    ...
    invoke-virtual/range {p3 .. p3}, Landroid/support/v7/widget/OrientationHelper;->getTotalSpace()I
    ...
    .line 148
    :cond_0
    invoke-virtual/range {p3 .. p3}, Landroid/support/v7/widget/OrientationHelper;->getEnd()I
...
.method private estimateNextPositionDiffForFling(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/OrientationHelper;II)I
    ...
    .line 167
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/widget/LinearSnapHelper;->computeDistancePerChild(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/OrientationHelper;)F
...
.method private findCenterView(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/OrientationHelper;)Landroid/view/View;
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v7/widget/OrientationHelper;->getTotalSpace()I
...
.method private getHorizontalHelper(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
    ...
    .line 282
    :cond_0
    invoke-static/range {p1 .. p1}, Landroid/support/v7/widget/OrientationHelper;->createHorizontalHelper(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
...
.method private getVerticalHelper(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
    ...
    .line 273
    :cond_0
    invoke-static/range {p1 .. p1}, Landroid/support/v7/widget/OrientationHelper;->createVerticalHelper(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
...
.method public calculateDistanceToFinalSnap(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;)[I
    ...
    .line 48
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/LinearSnapHelper;->getHorizontalHelper(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
    ...
    .line 55
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/LinearSnapHelper;->getVerticalHelper(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
...
.method public findTargetSnapPosition(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)I
    ...
    .line 74
    :cond_1
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/LinearSnapHelper;->findSnapView(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/view/View;
