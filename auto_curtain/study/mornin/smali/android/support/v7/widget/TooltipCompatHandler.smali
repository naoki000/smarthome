...
.method static synthetic access$000(Landroid/support/v7/widget/TooltipCompatHandler;Z)V
    ...
    .line 39
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/widget/TooltipCompatHandler;->show(Z)V
...
.method static synthetic access$100(Landroid/support/v7/widget/TooltipCompatHandler;)V
    ...
    .line 39
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/TooltipCompatHandler;->hide()V
...
.method private hide()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/TooltipPopup;->hide()V
    ...
    .line 197
    invoke-static/range {v1 .. v1}, Landroid/support/v7/widget/TooltipCompatHandler;->setPendingHandler(Landroid/support/v7/widget/TooltipCompatHandler;)V
...
.method private static setPendingHandler(Landroid/support/v7/widget/TooltipCompatHandler;)V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/TooltipCompatHandler;->cancelPendingShow()V
    ...
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/TooltipCompatHandler;->scheduleShow()V
...
.method public static setTooltipText(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/support/v7/widget/TooltipCompatHandler;->hide()V
...
.method private show(Z)V
    ...
    .line 160
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/TooltipCompatHandler;->setPendingHandler(Landroid/support/v7/widget/TooltipCompatHandler;)V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v7/widget/TooltipCompatHandler;->hide()V
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewCompat;->getWindowSystemUiVisibility(Landroid/view/View;)I
...
.method public onHover(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 127
    invoke-virtual/range {p1 .. p1}, Landroid/view/accessibility/AccessibilityManager;->isEnabled()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual/range {p1 .. p1}, Landroid/view/accessibility/AccessibilityManager;->isTouchExplorationEnabled()Z
    ...
    .line 135
    invoke-static/range {p0 .. p0}, Landroid/support/v7/widget/TooltipCompatHandler;->setPendingHandler(Landroid/support/v7/widget/TooltipCompatHandler;)V
