...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 79
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/widget/LinearLayoutCompat;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method static measureChildForCells(Landroid/view/View;IIII)I
    ...
    .line 412
    invoke-virtual/range {p4 .. p4}, Landroid/support/v7/view/menu/ActionMenuItemView;->hasText()Z
...
.method private onMeasureExactFormat(II)V
    ...
    .line 214
    invoke-virtual/range {v11 .. v11}, Landroid/view/View;->getVisibility()I
    ...
    .line 225
    :goto_1
    invoke-virtual/range {v11 .. v11}, Landroid/view/View;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/view/menu/ActionMenuItemView;->hasText()Z
    ...
    .line 245
    invoke-virtual/range {v11 .. v11}, Landroid/view/View;->getMeasuredHeight()I
...
.method public dismissPopupMenus()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter;->dismissPopupMenus()Z
...
.method protected bridge synthetic generateDefaultLayoutParams()Landroid/support/v7/widget/LinearLayoutCompat$LayoutParams;
    ...
    .line 47
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionMenuView;->generateDefaultLayoutParams()Landroid/support/v7/widget/ActionMenuView$LayoutParams;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/v7/widget/LinearLayoutCompat$LayoutParams;
    ...
    .line 47
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/ActionMenuView;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/support/v7/widget/ActionMenuView$LayoutParams;
...
.method protected bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/LinearLayoutCompat$LayoutParams;
    ...
    .line 47
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/ActionMenuView;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/ActionMenuView$LayoutParams;
...
.method public getMenu()Landroid/view/Menu;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/v7/widget/ActionMenuView$ActionMenuPresenterCallback;-><init>()V
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 564
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionMenuView;->getMenu()Landroid/view/Menu;

    .line 565
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->mPresenter:Landroid/support/v7/widget/ActionMenuPresenter;

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter;->getOverflowIcon()Landroid/graphics/drawable/Drawable;
...
.method protected hasSupportDividerBeforeChildAt(I)Z
    ...
    .line 736
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/widget/ActionMenuView;->getChildAt(I)Landroid/view/View;
    ...
    invoke-interface/range {v1 .. v1}, Landroid/support/v7/widget/ActionMenuView$ActionMenuChildView;->needsDividerAfter()Z
    ...
    invoke-interface/range {v2 .. v2}, Landroid/support/v7/widget/ActionMenuView$ActionMenuChildView;->needsDividerBefore()Z
...
.method public hideOverflowMenu()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter;->hideOverflowMenu()Z
...
.method public isOverflowMenuShowPending()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter;->isOverflowMenuShowPending()Z
...
.method public isOverflowMenuShowing()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter;->isOverflowMenuShowing()Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 127
    invoke-super/range {p0 .. p1}, Landroid/support/v7/widget/LinearLayoutCompat;->onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ActionMenuPresenter;->isOverflowMenuShowing()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ActionMenuPresenter;->hideOverflowMenu()Z

    .line 134
    iget-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->mPresenter:Landroid/support/v7/widget/ActionMenuPresenter;

    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/ActionMenuPresenter;->showOverflowMenu()Z
...
.method public onDetachedFromWindow()V
    ...
    .line 544
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/ActionMenuView;->dismissPopupMenus()V
...
.method protected onMeasure(II)V
    ...
    .line 163
    invoke-direct/range {p0 .. p2}, Landroid/support/v7/widget/ActionMenuView;->onMeasureExactFormat(II)V
...
.method public showOverflowMenu()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/ActionMenuPresenter;->showOverflowMenu()Z
