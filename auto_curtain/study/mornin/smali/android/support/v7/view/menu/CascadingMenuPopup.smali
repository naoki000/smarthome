...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    .line 218
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuPopup;-><init>()V
    ...
    .line 226
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/view/menu/CascadingMenuPopup;->getInitialMenuPosition()I
    ...
    invoke-direct/range {p1 .. p1}, Landroid/os/Handler;-><init>()V
...
.method private findMenuItemForSubmenu(Landroid/support/v7/view/menu/MenuBuilder;Landroid/support/v7/view/menu/MenuBuilder;)Landroid/view/MenuItem;
    ...
    .line 512
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->size()I
    ...
    .line 514
    invoke-interface/range {v2 .. v2}, Landroid/view/MenuItem;->hasSubMenu()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface/range {v2 .. v2}, Landroid/view/MenuItem;->getSubMenu()Landroid/view/SubMenu;
...
.method private findParentViewForSubmenu(Landroid/support/v7/view/menu/CascadingMenuPopup$CascadingMenuInfo;Landroid/support/v7/view/menu/MenuBuilder;)Landroid/view/View;
    ...
    .line 542
    :cond_0
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/view/menu/CascadingMenuPopup$CascadingMenuInfo;->getListView()Landroid/widget/ListView;
    ...
    .line 546
    invoke-virtual/range {v1 .. v1}, Landroid/widget/HeaderViewListAdapter;->getHeadersCount()I

    move-result v2

    .line 547
    invoke-virtual/range {v1 .. v1}, Landroid/widget/HeaderViewListAdapter;->getWrappedAdapter()Landroid/widget/ListAdapter;
    ...
    .line 555
    :goto_0
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/view/menu/MenuAdapter;->getCount()I
...
.method private getNextMenuPosition(I)I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/CascadingMenuPopup$CascadingMenuInfo;->getListView()Landroid/widget/ListView;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/graphics/Rect;-><init>()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ListView;->getWidth()I
...
.method private showMenu(Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    invoke-virtual/range {v6 .. v6}, Landroid/view/View;->getWidth()I
    ...
    .line 482
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/MenuPopupWindow;->show()V

    .line 484
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/MenuPopupWindow;->getListView()Landroid/widget/ListView;
...
.method public addMenu(Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    .line 353
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/view/menu/CascadingMenuPopup;->showMenu(Landroid/support/v7/view/menu/MenuBuilder;)V
...
.method public dismiss()V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v7/widget/MenuPopupWindow;->isShowing()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v7/widget/MenuPopupWindow;->dismiss()V
...
.method public isShowing()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/MenuPopupWindow;->isShowing()Z
...
.method public onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .line 663
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/view/menu/CascadingMenuPopup;->findIndexOfAddedMenu(Landroid/support/v7/view/menu/MenuBuilder;)I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/widget/MenuPopupWindow;->dismiss()V
    ...
    .line 694
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/view/menu/CascadingMenuPopup;->dismiss()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/view/ViewTreeObserver;->isAlive()Z
    ...
    invoke-interface/range {p1 .. p1}, Landroid/widget/PopupWindow$OnDismissListener;->onDismiss()V
...
.method public onDismiss()V
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/support/v7/widget/MenuPopupWindow;->isShowing()Z
...
.method public onSubMenuSelected(Landroid/support/v7/view/menu/SubMenuBuilder;)Z
    ...
    .line 628
    invoke-virtual/range {v1 .. v1}, Landroid/support/v7/view/menu/CascadingMenuPopup$CascadingMenuInfo;->getListView()Landroid/widget/ListView;

    move-result-object p1

    invoke-virtual/range {p1 .. p1}, Landroid/widget/ListView;->requestFocus()Z
    ...
    .line 634
    invoke-virtual/range {p0 .. p1}, Landroid/support/v7/view/menu/CascadingMenuPopup;->addMenu(Landroid/support/v7/view/menu/MenuBuilder;)V
...
.method public show()V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;
...
.method public updateMenuView(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/ListView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-static/range {v0 .. v0}, Landroid/support/v7/view/menu/CascadingMenuPopup;->toMenuAdapter(Landroid/widget/ListAdapter;)Landroid/support/v7/view/menu/MenuAdapter;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuAdapter;->notifyDataSetChanged()V
