...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;Landroid/support/v7/view/menu/MenuItemImpl;)V
    ...
    .line 41
    invoke-direct/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;-><init>(Landroid/content/Context;)V
...
.method dispatchMenuItemSelected(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
    ...
    .line 88
    invoke-super/range {p0 .. p2}, Landroid/support/v7/view/menu/MenuBuilder;->dispatchMenuItemSelected(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
...
.method public getActionViewStatesKey()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuItemImpl;->getItemId()I
    ...
    invoke-super/range {p0 .. p0}, Landroid/support/v7/view/menu/MenuBuilder;->getActionViewStatesKey()Ljava/lang/String;
...
.method public getRootMenu()Landroid/support/v7/view/menu/MenuBuilder;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v7/view/menu/MenuBuilder;->getRootMenu()Landroid/support/v7/view/menu/MenuBuilder;
...
.method public setHeaderIcon(I)Landroid/view/SubMenu;
    ...
    .line 111
    invoke-super/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->setHeaderIconInt(I)Landroid/support/v7/view/menu/MenuBuilder;
...
.method public setHeaderIcon(Landroid/graphics/drawable/Drawable;)Landroid/view/SubMenu;
    ...
    .line 106
    invoke-super/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->setHeaderIconInt(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/view/menu/MenuBuilder;
...
.method public setHeaderTitle(I)Landroid/view/SubMenu;
    ...
    .line 121
    invoke-super/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->setHeaderTitleInt(I)Landroid/support/v7/view/menu/MenuBuilder;
...
.method public setHeaderTitle(Ljava/lang/CharSequence;)Landroid/view/SubMenu;
    ...
    .line 116
    invoke-super/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->setHeaderTitleInt(Ljava/lang/CharSequence;)Landroid/support/v7/view/menu/MenuBuilder;
...
.method public setHeaderView(Landroid/view/View;)Landroid/view/SubMenu;
    ...
    .line 126
    invoke-super/range {p0 .. p1}, Landroid/support/v7/view/menu/MenuBuilder;->setHeaderViewInt(Landroid/view/View;)Landroid/support/v7/view/menu/MenuBuilder;
