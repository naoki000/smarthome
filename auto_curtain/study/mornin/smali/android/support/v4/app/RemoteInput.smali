...
.method public static addDataResultToIntent(Landroid/support/v4/app/RemoteInput;Landroid/content/Intent;Ljava/util/Map;)V
    ...
    .line 381
    invoke-static/range {p0 .. p0}, Landroid/support/v4/app/RemoteInput;->fromCompat(Landroid/support/v4/app/RemoteInput;)Landroid/app/RemoteInput;
    ...
    .line 383
    invoke-static/range {p1 .. p1}, Landroid/support/v4/app/RemoteInput;->getClipDataIntentFromIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 394
    :cond_2
    invoke-static/range {v2 .. v2}, Landroid/support/v4/app/RemoteInput;->getExtraResultsKeyForData(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/net/Uri;->toString()Ljava/lang/String;
...
.method public static addResultsToIntent([Landroid/support/v4/app/RemoteInput;Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    .line 328
    invoke-static/range {p1 .. p1}, Landroid/support/v4/app/RemoteInput;->getResultsFromIntent(Landroid/content/Intent;)Landroid/os/Bundle;
    ...
    .line 338
    invoke-virtual/range {v3 .. v3}, Landroid/support/v4/app/RemoteInput;->getResultKey()Ljava/lang/String;
    ...
    .line 342
    invoke-static/range {v5 .. v5}, Landroid/support/v4/app/RemoteInput;->fromCompat([Landroid/support/v4/app/RemoteInput;)[Landroid/app/RemoteInput;
    ...
    .line 357
    invoke-virtual/range {v4 .. v4}, Landroid/support/v4/app/RemoteInput;->getResultKey()Ljava/lang/String;
...
.method static fromCompat(Landroid/support/v4/app/RemoteInput;)Landroid/app/RemoteInput;
    ...
    .line 430
    invoke-virtual/range {p0 .. p0}, Landroid/app/RemoteInput$Builder;->build()Landroid/app/RemoteInput;
...
.method static fromCompat([Landroid/support/v4/app/RemoteInput;)[Landroid/app/RemoteInput;
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v4/app/RemoteInput;->fromCompat(Landroid/support/v4/app/RemoteInput;)Landroid/app/RemoteInput;
...
.method private static getClipDataIntentFromIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 439
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/content/ClipData;->getDescription()Landroid/content/ClipDescription;
    ...
    .line 443
    :cond_1
    invoke-virtual/range {v1 .. v1}, Landroid/content/ClipDescription;->getLabel()Ljava/lang/CharSequence;
...
.method public static getDataResultsFromIntent(Landroid/content/Intent;Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 256
    invoke-static/range {p0 .. p1}, Landroid/app/RemoteInput;->getDataResultsFromIntent(Landroid/content/Intent;Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 258
    invoke-static/range {p0 .. p0}, Landroid/support/v4/app/RemoteInput;->getClipDataIntentFromIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 264
    invoke-virtual/range {v1 .. v1}, Landroid/os/Bundle;->keySet()Ljava/util/Set;
...
.method public static getResultsFromIntent(Landroid/content/Intent;)Landroid/os/Bundle;
    ...
    .line 295
    invoke-static/range {p0 .. p0}, Landroid/app/RemoteInput;->getResultsFromIntent(Landroid/content/Intent;)Landroid/os/Bundle;
