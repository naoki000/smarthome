...
.method private static ensureActionReflectionReadyLocked()Z
    ...
    .line 209
    invoke-static/range {v1 .. v1}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;
...
.method private static fromBundle(Landroid/os/Bundle;)Landroid/support/v4/app/RemoteInput;
    ...
    invoke-direct/range {v7 .. v7}, Ljava/util/HashSet;-><init>()V
...
.method private static fromBundleArray([Landroid/os/Bundle;)[Landroid/support/v4/app/RemoteInput;
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v4/app/NotificationCompatJellybean;->fromBundle(Landroid/os/Bundle;)Landroid/support/v4/app/RemoteInput;
...
.method public static getAction(Landroid/app/Notification;I)Landroid/support/v4/app/NotificationCompat$Action;
    ...
    .line 162
    :try_start_0
    invoke-static/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompatJellybean;->getActionObjectsLocked(Landroid/app/Notification;)[Ljava/lang/Object;
    ...
    .line 166
    invoke-static/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompatJellybean;->getExtras(Landroid/app/Notification;)Landroid/os/Bundle;
...
.method static getActionFromBundle(Landroid/os/Bundle;)Landroid/support/v4/app/NotificationCompat$Action;
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v4/app/NotificationCompatJellybean;->fromBundleArray([Landroid/os/Bundle;)[Landroid/support/v4/app/RemoteInput;
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompatJellybean;->fromBundleArray([Landroid/os/Bundle;)[Landroid/support/v4/app/RemoteInput;
...
.method private static getBundleArrayFromBundle(Landroid/os/Bundle;Ljava/lang/String;)[Landroid/os/Bundle;
    ...
    .line 324
    invoke-virtual/range {p0 .. p1}, Landroid/os/Bundle;->getParcelableArray(Ljava/lang/String;)[Landroid/os/Parcelable;
...
.method static getBundleForAction(Landroid/support/v4/app/NotificationCompat$Action;)Landroid/os/Bundle;
    ...
    .line 244
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompat$Action;->getIcon()I
    ...
    .line 245
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompat$Action;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 246
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompat$Action;->getActionIntent()Landroid/app/PendingIntent;
    ...
    .line 248
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompat$Action;->getExtras()Landroid/os/Bundle;
    ...
    .line 254
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompat$Action;->getAllowGeneratedReplies()Z
    ...
    .line 256
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompat$Action;->getRemoteInputs()[Landroid/support/v4/app/RemoteInput;

    move-result-object p0

    invoke-static/range {p0 .. p0}, Landroid/support/v4/app/NotificationCompatJellybean;->toBundleArray([Landroid/support/v4/app/RemoteInput;)[Landroid/os/Bundle;
...
.method public static getExtras(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    invoke-virtual/range {v3 .. v3}, Ljava/lang/reflect/Field;->getType()Ljava/lang/Class;
...
.method public static readAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;)Landroid/support/v4/app/NotificationCompat$Action;
    ...
    .line 124
    invoke-static/range {v0 .. v0}, Landroid/support/v4/app/NotificationCompatJellybean;->fromBundleArray([Landroid/os/Bundle;)[Landroid/support/v4/app/RemoteInput;
...
.method private static toBundle(Landroid/support/v4/app/RemoteInput;)Landroid/os/Bundle;
    ...
    .line 279
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/RemoteInput;->getResultKey()Ljava/lang/String;
    ...
    .line 280
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/RemoteInput;->getLabel()Ljava/lang/CharSequence;
    ...
    .line 281
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/RemoteInput;->getChoices()[Ljava/lang/CharSequence;
    ...
    .line 282
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/RemoteInput;->getAllowFreeFormInput()Z
    ...
    .line 283
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/RemoteInput;->getExtras()Landroid/os/Bundle;
    ...
    .line 285
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/RemoteInput;->getAllowedDataTypes()Ljava/util/Set;
...
.method private static toBundleArray([Landroid/support/v4/app/RemoteInput;)[Landroid/os/Bundle;
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v4/app/NotificationCompatJellybean;->toBundle(Landroid/support/v4/app/RemoteInput;)Landroid/os/Bundle;
...
.method public static writeActionAndGetExtras(Landroid/app/Notification$Builder;Landroid/support/v4/app/NotificationCompat$Action;)Landroid/os/Bundle;
    ...
    .line 137
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$Action;->getIcon()I

    move-result v0

    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$Action;->getTitle()Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$Action;->getActionIntent()Landroid/app/PendingIntent;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$Action;->getExtras()Landroid/os/Bundle;
    ...
    .line 139
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$Action;->getRemoteInputs()[Landroid/support/v4/app/RemoteInput;
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v4/app/NotificationCompatJellybean;->toBundleArray([Landroid/support/v4/app/RemoteInput;)[Landroid/os/Bundle;
    ...
    .line 143
    :cond_0
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$Action;->getDataOnlyRemoteInputs()[Landroid/support/v4/app/RemoteInput;
    ...
    .line 148
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/NotificationCompat$Action;->getAllowGeneratedReplies()Z
