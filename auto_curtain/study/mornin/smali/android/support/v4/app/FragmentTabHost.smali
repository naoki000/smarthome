...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 140
    invoke-direct/range {p0 .. p2}, Landroid/widget/TabHost;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 141
    invoke-direct/range {p0 .. p2}, Landroid/support/v4/app/FragmentTabHost;->initFragmentTabHost(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private doTabChanged(Ljava/lang/String;Landroid/support/v4/app/FragmentTransaction;)Landroid/support/v4/app/FragmentTransaction;
    ...
    .line 334
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/app/FragmentTabHost;->getTabInfoForTag(Ljava/lang/String;)Landroid/support/v4/app/FragmentTabHost$TabInfo;
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/app/FragmentManager;->beginTransaction()Landroid/support/v4/app/FragmentTransaction;
...
.method public addTab(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
    ...
    .line 235
    invoke-virtual/range {p1 .. p1}, Landroid/widget/TabHost$TabSpec;->getTag()Ljava/lang/String;
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/app/Fragment;->isDetached()Z
    ...
    .line 246
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/app/FragmentTransaction;->commit()I
    ...
    .line 251
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/app/FragmentTabHost;->addTab(Landroid/widget/TabHost$TabSpec;)V
...
.method protected onAttachedToWindow()V
    ...
    .line 256
    invoke-super/range {p0 .. p0}, Landroid/widget/TabHost;->onAttachedToWindow()V

    .line 258
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/FragmentTabHost;->getCurrentTabTag()Ljava/lang/String;
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/v4/app/Fragment;->isDetached()Z
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/app/FragmentManager;->beginTransaction()Landroid/support/v4/app/FragmentTransaction;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/app/FragmentManager;->executePendingTransactions()Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 295
    invoke-super/range {p0 .. p0}, Landroid/widget/TabHost;->onDetachedFromWindow()V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 310
    invoke-super/range {p0 .. p1}, Landroid/widget/TabHost;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 314
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/app/FragmentTabHost$SavedState;->getSuperState()Landroid/os/Parcelable;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 301
    invoke-super/range {p0 .. p0}, Landroid/widget/TabHost;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method public setup(Landroid/content/Context;Landroid/support/v4/app/FragmentManager;)V
    ...
    .line 193
    invoke-direct/range {p0 .. p1}, Landroid/support/v4/app/FragmentTabHost;->ensureHierarchy(Landroid/content/Context;)V

    .line 194
    invoke-super/range {p0 .. p0}, Landroid/widget/TabHost;->setup()V
    ...
    .line 197
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/app/FragmentTabHost;->ensureContent()V
...
.method public setup(Landroid/content/Context;Landroid/support/v4/app/FragmentManager;I)V
    ...
    .line 211
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/app/FragmentTabHost;->getId()I
