...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/view/MenuItemCompat$MenuItemCompatApi26Impl;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/view/MenuItemCompat$MenuItemCompatBaseImpl;-><init>()V
...
.method public static collapseActionView(Landroid/view/MenuItem;)Z
    ...
    .line 430
    invoke-interface/range {p0 .. p0}, Landroid/view/MenuItem;->collapseActionView()Z
...
.method public static expandActionView(Landroid/view/MenuItem;)Z
    ...
    .line 411
    invoke-interface/range {p0 .. p0}, Landroid/view/MenuItem;->expandActionView()Z
...
.method public static getActionProvider(Landroid/view/MenuItem;)Landroid/support/v4/view/ActionProvider;
    ...
    invoke-interface/range {p0 .. p0}, Landroid/support/v4/internal/view/SupportMenuItem;->getSupportActionProvider()Landroid/support/v4/view/ActionProvider;
...
.method public static getAlphabeticModifiers(Landroid/view/MenuItem;)I
    ...
    invoke-interface/range {p0 .. p0}, Landroid/support/v4/internal/view/SupportMenuItem;->getAlphabeticModifiers()I
...
.method public static getContentDescription(Landroid/view/MenuItem;)Ljava/lang/CharSequence;
    ...
    invoke-interface/range {p0 .. p0}, Landroid/support/v4/internal/view/SupportMenuItem;->getContentDescription()Ljava/lang/CharSequence;
...
.method public static getIconTintList(Landroid/view/MenuItem;)Landroid/content/res/ColorStateList;
    ...
    invoke-interface/range {p0 .. p0}, Landroid/support/v4/internal/view/SupportMenuItem;->getIconTintList()Landroid/content/res/ColorStateList;
...
.method public static getIconTintMode(Landroid/view/MenuItem;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-interface/range {p0 .. p0}, Landroid/support/v4/internal/view/SupportMenuItem;->getIconTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public static getNumericModifiers(Landroid/view/MenuItem;)I
    ...
    invoke-interface/range {p0 .. p0}, Landroid/support/v4/internal/view/SupportMenuItem;->getNumericModifiers()I
...
.method public static getTooltipText(Landroid/view/MenuItem;)Ljava/lang/CharSequence;
    ...
    invoke-interface/range {p0 .. p0}, Landroid/support/v4/internal/view/SupportMenuItem;->getTooltipText()Ljava/lang/CharSequence;
...
.method public static setActionView(Landroid/view/MenuItem;I)Landroid/view/MenuItem;
    ...
    .line 337
    invoke-interface/range {p0 .. p1}, Landroid/view/MenuItem;->setActionView(I)Landroid/view/MenuItem;
...
.method public static setActionView(Landroid/view/MenuItem;Landroid/view/View;)Landroid/view/MenuItem;
    ...
    .line 315
    invoke-interface/range {p0 .. p1}, Landroid/view/MenuItem;->setActionView(Landroid/view/View;)Landroid/view/MenuItem;
...
.method public static setShowAsAction(Landroid/view/MenuItem;I)V
    ...
    .line 297
    invoke-interface/range {p0 .. p1}, Landroid/view/MenuItem;->setShowAsAction(I)V
