...
.method static constructor <clinit>()V
    ...
    .line 114
    invoke-static/range {v0 .. v0}, Ljava/lang/Character;->toString(C)Ljava/lang/String;
...
.method synthetic constructor <init>(ZILandroid/support/v4/text/TextDirectionHeuristicCompat;Landroid/support/v4/text/BidiFormatter$1;)V
    ...
    .line 79
    invoke-direct/range {p0 .. p3}, Landroid/support/v4/text/BidiFormatter;-><init>(ZILandroid/support/v4/text/TextDirectionHeuristicCompat;)V
...
.method static synthetic access$000(Ljava/util/Locale;)Z
    ...
    .line 79
    invoke-static/range {p0 .. p0}, Landroid/support/v4/text/BidiFormatter;->isRtlLocale(Ljava/util/Locale;)Z
...
.method private static getEntryDir(Ljava/lang/CharSequence;)I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->getEntryDir()I
...
.method private static getExitDir(Ljava/lang/CharSequence;)I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->getExitDir()I
...
.method public static getInstance()Landroid/support/v4/text/BidiFormatter;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/text/BidiFormatter$Builder;-><init>()V

    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/text/BidiFormatter$Builder;->build()Landroid/support/v4/text/BidiFormatter;
...
.method private static isRtlLocale(Ljava/util/Locale;)Z
    ...
    .line 515
    invoke-static/range {p0 .. p0}, Landroid/support/v4/text/TextUtilsCompat;->getLayoutDirectionFromLocale(Ljava/util/Locale;)I
...
.method private markAfter(Ljava/lang/CharSequence;Landroid/support/v4/text/TextDirectionHeuristicCompat;)Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/text/BidiFormatter;->getExitDir(Ljava/lang/CharSequence;)I
...
.method private markBefore(Ljava/lang/CharSequence;Landroid/support/v4/text/TextDirectionHeuristicCompat;)Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/text/BidiFormatter;->getEntryDir(Ljava/lang/CharSequence;)I
...
.method public isRtl(Ljava/lang/String;)Z
    ...
    .line 346
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/text/BidiFormatter;->isRtl(Ljava/lang/CharSequence;)Z
...
.method public unicodeWrap(Ljava/lang/CharSequence;Landroid/support/v4/text/TextDirectionHeuristicCompat;Z)Ljava/lang/CharSequence;
    ...
    .line 413
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/text/BidiFormatter;->getStereoReset()Z
...
.method public unicodeWrap(Ljava/lang/String;Landroid/support/v4/text/TextDirectionHeuristicCompat;Z)Ljava/lang/String;
    ...
    .line 391
    :cond_0
    invoke-virtual/range {p0 .. p3}, Landroid/support/v4/text/BidiFormatter;->unicodeWrap(Ljava/lang/CharSequence;Landroid/support/v4/text/TextDirectionHeuristicCompat;Z)Ljava/lang/CharSequence;
