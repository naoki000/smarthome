...
.method constructor <init>(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V
    ...
    .line 390
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->computeBitmapSize()V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 266
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->updateDstRect()V

    .line 267
    iget-object v1, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->mPaint:Landroid/graphics/Paint;

    invoke-virtual/range {v1 .. v1}, Landroid/graphics/Paint;->getShader()Landroid/graphics/Shader;
...
.method public getAlpha()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Paint;->getAlpha()I
...
.method public getColorFilter()Landroid/graphics/ColorFilter;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Paint;->getColorFilter()Landroid/graphics/ColorFilter;
...
.method public getOpacity()I
    ...
    .line 377
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Bitmap;->hasAlpha()Z
    ...
    .line 379
    invoke-static/range {v0 .. v0}, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->isGreaterThanZero(F)Z
...
.method public hasAntiAlias()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Paint;->isAntiAlias()Z
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    .line 348
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->updateCircularCornerRadius()V
...
.method public setAlpha(I)V
    ...
    .line 279
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->invalidateSelf()V
...
.method public setCornerRadius(F)V
    ...
    .line 334
    invoke-static/range {p1 .. p1}, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->isGreaterThanZero(F)Z
...
.method updateDstRect()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->getBounds()Landroid/graphics/Rect;
    ...
    .line 249
    invoke-virtual/range {v2 .. v2}, Landroid/graphics/RectF;->width()F

    move-result v2

    iget-object v3, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->mBitmap:Landroid/graphics/Bitmap;

    invoke-virtual/range {v3 .. v3}, Landroid/graphics/Bitmap;->getWidth()I
    ...
    .line 250
    invoke-virtual/range {v3 .. v3}, Landroid/graphics/RectF;->height()F

    move-result v3

    iget-object v4, p0, Landroid/support/v4/graphics/drawable/RoundedBitmapDrawable;->mBitmap:Landroid/graphics/Bitmap;

    invoke-virtual/range {v4 .. v4}, Landroid/graphics/Bitmap;->getHeight()I
