...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/v4/provider/FontsContractCompat$5;-><init>()V
...
.method static synthetic access$000(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;I)Landroid/support/v4/provider/FontsContractCompat$TypefaceResult;
    ...
    .line 71
    invoke-static/range {p0 .. p2}, Landroid/support/v4/provider/FontsContractCompat;->getFontInternal(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;I)Landroid/support/v4/provider/FontsContractCompat$TypefaceResult;
...
.method private static convertToByteArrayList([Landroid/content/pm/Signature;)Ljava/util/List;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/content/pm/Signature;->toByteArray()[B
...
.method private static getCertificates(Landroid/support/v4/provider/FontRequest;Landroid/content/res/Resources;)Ljava/util/List;
    ...
    .line 768
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/provider/FontRequest;->getCertificates()Ljava/util/List;
    ...
    .line 771
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/provider/FontRequest;->getCertificatesArrayResId()I
...
.method static getFontFromProvider(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroid/support/v4/provider/FontsContractCompat$FontInfo;
    ...
    .line 818
    invoke-virtual/range {v2 .. v2}, Landroid/net/Uri$Builder;->build()Landroid/net/Uri;
    ...
    invoke-direct/range {v3 .. v3}, Landroid/net/Uri$Builder;-><init>()V
    ...
    .line 839
    invoke-interface/range {v10 .. v10}, Landroid/database/Cursor;->getCount()I
    ...
    .line 847
    :goto_2
    invoke-interface/range {v10 .. v10}, Landroid/database/Cursor;->moveToNext()Z
    ...
    .line 869
    invoke-interface/range {v10 .. v10}, Landroid/database/Cursor;->close()V
...
.method private static getFontInternal(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;I)Landroid/support/v4/provider/FontsContractCompat$TypefaceResult;
    ...
    .line 189
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/provider/FontsContractCompat$FontFamilyResult;->getStatusCode()I
    ...
    .line 191
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/provider/FontsContractCompat$FontFamilyResult;->getFonts()[Landroid/support/v4/provider/FontsContractCompat$FontInfo;
...
.method public static getFontSync(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;Landroid/support/v4/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/provider/FontRequest;->getIdentifier()Ljava/lang/String;
...
.method public static getProvider(Landroid/content/pm/PackageManager;Landroid/support/v4/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    .line 735
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/provider/FontRequest;->getProviderAuthority()Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/provider/FontRequest;->getProviderPackage()Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/provider/FontsContractCompat;->convertToByteArrayList([Landroid/content/pm/Signature;)Ljava/util/List;
    ...
    .line 755
    invoke-static/range {p1 .. p2}, Landroid/support/v4/provider/FontsContractCompat;->getCertificates(Landroid/support/v4/provider/FontRequest;Landroid/content/res/Resources;)Ljava/util/List;
...
.method public static prepareFontData(Landroid/content/Context;[Landroid/support/v4/provider/FontsContractCompat$FontInfo;Landroid/os/CancellationSignal;)Ljava/util/Map;
    ...
    .line 683
    invoke-virtual/range {v3 .. v3}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getResultCode()I
    ...
    .line 687
    :cond_0
    invoke-virtual/range {v3 .. v3}, Landroid/support/v4/provider/FontsContractCompat$FontInfo;->getUri()Landroid/net/Uri;
...
.method public static resetCache()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/util/LruCache;->evictAll()V
