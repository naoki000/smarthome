...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/view/ViewConfiguration;->getScaledTouchSlop()I
    ...
    .line 335
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->getResources()Landroid/content/res/Resources;
    ...
    .line 344
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->createProgressView()V
...
.method private animateOffsetToCorrectPosition(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/view/animation/Animation;->reset()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/widget/CircleImageView;->clearAnimation()V
...
.method private animateOffsetToStartPosition(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    .line 1081
    invoke-direct/range {p0 .. p2}, Landroid/support/v4/widget/SwipeRefreshLayout;->startScaleDownReturnToStartAnimation(ILandroid/view/animation/Animation$AnimationListener;)V
...
.method private createProgressView()V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->getContext()Landroid/content/Context;
...
.method private ensureTarget()V
    ...
    .line 569
    :goto_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->getChildCount()I
...
.method private isAnimationRunning(Landroid/view/animation/Animation;)Z
    ...
    .line 893
    invoke-virtual/range {p1 .. p1}, Landroid/view/animation/Animation;->hasStarted()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual/range {p1 .. p1}, Landroid/view/animation/Animation;->hasEnded()Z
...
.method private moveSpinner(F)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircleImageView;->getVisibility()I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/widget/CircularProgressDrawable;->getAlpha()I
...
.method private setColorViewAlpha(I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircleImageView;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method private setRefreshing(ZZ)V
    ...
    .line 448
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->ensureTarget()V
...
.method private startProgressAlphaMaxAnimation()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable;->getAlpha()I
...
.method private startScaleDownReturnToStartAnimation(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/widget/CircleImageView;->getScaleX()F
...
.method moveToStart(F)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/widget/CircleImageView;->getTop()I
...
.method protected onDetachedFromWindow()V
    ...
    .line 223
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->reset()V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/widget/CircleImageView;->getTop()I
...
.method protected onLayout(ZIIII)V
    ...
    .line 590
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->getMeasuredWidth()I

    move-result p1

    .line 591
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->getMeasuredHeight()I
    ...
    .line 602
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->getPaddingLeft()I

    move-result p4

    .line 603
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->getPaddingTop()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->getPaddingRight()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->getPaddingBottom()I
    ...
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/widget/CircleImageView;->getMeasuredWidth()I
    ...
    invoke-virtual/range {p3 .. p3}, Landroid/support/v4/widget/CircleImageView;->getMeasuredHeight()I
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    .line 808
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/widget/SwipeRefreshLayout;->stopNestedScroll()V
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    .line 735
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/ViewCompat;->isNestedScrollingEnabled(Landroid/view/View;)Z
...
.method reset()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircleImageView;->clearAnimation()V

    .line 200
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->mProgress:Landroid/support/v4/widget/CircularProgressDrawable;

    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircularProgressDrawable;->stop()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircleImageView;->getTop()I
...
.method public varargs setColorScheme([I)V
    ...
    .line 526
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->setColorSchemeResources([I)V
...
.method public setProgressBackgroundColor(I)V
    ...
    .line 500
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->setProgressBackgroundColorSchemeResource(I)V
...
.method public setProgressViewEndTarget(ZI)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/widget/CircleImageView;->invalidate()V
...
.method setTargetOffsetTopAndBottom(I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/widget/CircleImageView;->bringToFront()V
