...
.method public static buildMediaButtonPendingIntent(Landroid/content/Context;J)Landroid/app/PendingIntent;
    ...
    .line 221
    invoke-static/range {p0 .. p0}, Landroid/support/v4/media/session/MediaButtonReceiver;->getMediaButtonReceiverComponent(Landroid/content/Context;)Landroid/content/ComponentName;
...
.method public static buildMediaButtonPendingIntent(Landroid/content/Context;Landroid/content/ComponentName;J)Landroid/app/PendingIntent;
    ...
    .line 258
    :cond_0
    invoke-static/range {p2 .. p3}, Landroid/support/v4/media/session/PlaybackStateCompat;->toKeyCode(J)I
...
.method public static handleIntent(Landroid/support/v4/media/session/MediaSessionCompat;Landroid/content/Intent;)Landroid/view/KeyEvent;
    ...
    .line 193
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/MediaSessionCompat;->getController()Landroid/support/v4/media/session/MediaControllerCompat;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 108
    invoke-static/range {p1 .. p2}, Landroid/support/v4/media/session/MediaButtonReceiver;->startForegroundService(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 114
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/MediaButtonReceiver;->goAsync()Landroid/content/BroadcastReceiver$PendingResult;
    ...
    .line 121
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/MediaBrowserCompat;->connect()V
