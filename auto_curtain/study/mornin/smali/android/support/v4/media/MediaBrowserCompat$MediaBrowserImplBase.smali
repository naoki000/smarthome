...
.method public connect()V
    ...
    .line 1005
    invoke-static/range {v2 .. v2}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->getStateLabel(I)Ljava/lang/String;
...
.method public getExtras()Landroid/os/Bundle;
    ...
    .line 1141
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->isConnected()Z
...
.method public onConnectionFailed(Landroid/os/Messenger;)V
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->getStateLabel(I)Ljava/lang/String;
    ...
    .line 1365
    :cond_1
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->forceCloseConnection()V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/media/MediaBrowserCompat$ConnectionCallback;->onConnectionFailed()V
...
.method public onServiceConnected(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    invoke-static/range {p3 .. p3}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->getStateLabel(I)Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/media/MediaBrowserCompat$ConnectionCallback;->onConnected()V

    .line 1332
    :try_start_0
    iget-object p1, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->mSubscriptions:Landroid/support/v4/util/ArrayMap;

    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/util/ArrayMap;->entrySet()Ljava/util/Set;
    ...
    .line 1335
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/MediaBrowserCompat$Subscription;->getCallbacks()Ljava/util/List;

    move-result-object p4

    .line 1336
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/MediaBrowserCompat$Subscription;->getOptionsList()Ljava/util/List;
    ...
    invoke-static/range {v2 .. v2}, Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;->access$000(Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)Landroid/os/IBinder;
