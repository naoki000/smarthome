...
.method private onMediaButtonEvent(Landroid/view/KeyEvent;Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/PlaybackStateCompat;->getActions()J
    ...
    .line 2935
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onPause()V
    ...
    .line 2929
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onPlay()V
    ...
    .line 2955
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onFastForward()V
    ...
    .line 2960
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onRewind()V
    ...
    .line 2945
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onSkipToPrevious()V
    ...
    .line 2940
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onSkipToNext()V
    ...
    .line 2950
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onStop()V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 2870
    :pswitch_e
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onRewind()V

    goto/16 :goto_1

    .line 2867
    :pswitch_f
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onFastForward()V

    goto/16 :goto_1

    .line 2864
    :pswitch_10
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onSkipToPrevious()V

    goto/16 :goto_1

    .line 2861
    :pswitch_11
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onSkipToNext()V

    goto/16 :goto_1

    .line 2858
    :pswitch_12
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onStop()V

    goto/16 :goto_1

    .line 2855
    :pswitch_13
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onPause()V
    ...
    .line 2840
    :pswitch_18
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onPlay()V
    ...
    .line 2828
    :pswitch_1c
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onPrepare()V
...
.method public post(ILjava/lang/Object;)V
    ...
    .line 2796
    invoke-virtual/range {p0 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase$MessageHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
