...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    .line 1899
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->getToken()Ljava/lang/Object;
    ...
    .line 1901
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->getExtraBinder()Landroid/support/v4/media/session/IMediaSession;
    ...
    .line 1903
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->requestExtraBinder()V
    ...
    invoke-direct/range {p1 .. p1}, Landroid/os/RemoteException;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat;)V
    ...
    .line 1889
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat;->getSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->getToken()Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->getExtraBinder()Landroid/support/v4/media/session/IMediaSession;
...
.method static synthetic access$300(Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;)V
    ...
    .line 1877
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->processPendingCallbacks()V
...
.method private processPendingCallbacks()V
    ...
    .line 2150
    :try_start_2
    invoke-virtual/range {v2 .. v2}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->onSessionReady()V
...
.method private requestExtraBinder()V
    ...
    invoke-direct/range {v2 .. v2}, Landroid/os/Handler;-><init>()V
...
.method public addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    .line 1986
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->getFlags()J
...
.method public getExtras()Landroid/os/Bundle;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getExtras(Ljava/lang/Object;)Landroid/os/Bundle;
...
.method public getFlags()J
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getFlags(Ljava/lang/Object;)J
...
.method public getMetadata()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getMetadata(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1975
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/MediaMetadataCompat;->fromMediaMetadata(Ljava/lang/Object;)Landroid/support/v4/media/MediaMetadataCompat;
...
.method public getPackageName()Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getPackageName(Ljava/lang/Object;)Ljava/lang/String;
...
.method public getPlaybackInfo()Landroid/support/v4/media/session/MediaControllerCompat$PlaybackInfo;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getPlaybackInfo(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 2088
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21$PlaybackInfo;->getPlaybackType(Ljava/lang/Object;)I

    move-result v2

    .line 2089
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21$PlaybackInfo;->getLegacyAudioStream(Ljava/lang/Object;)I

    move-result v3

    .line 2090
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21$PlaybackInfo;->getVolumeControl(Ljava/lang/Object;)I

    move-result v4

    .line 2091
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21$PlaybackInfo;->getMaxVolume(Ljava/lang/Object;)I

    move-result v5

    .line 2092
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21$PlaybackInfo;->getCurrentVolume(Ljava/lang/Object;)I
...
.method public getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v4/media/session/IMediaSession;->getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getPlaybackState(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1969
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/PlaybackStateCompat;->fromPlaybackState(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public getQueue()Ljava/util/List;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getQueue(Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 1981
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->fromQueueItemList(Ljava/util/List;)Ljava/util/List;
...
.method public getQueueTitle()Ljava/lang/CharSequence;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getQueueTitle(Ljava/lang/Object;)Ljava/lang/CharSequence;
...
.method public getRatingType()I
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v4/media/session/IMediaSession;->getRatingType()I
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getRatingType(Ljava/lang/Object;)I
...
.method public getRepeatMode()I
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v4/media/session/IMediaSession;->getRepeatMode()I
...
.method public getSessionActivity()Landroid/app/PendingIntent;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getSessionActivity(Ljava/lang/Object;)Landroid/app/PendingIntent;
...
.method public getShuffleMode()I
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v4/media/session/IMediaSession;->getShuffleMode()I
...
.method public getTransportControls()Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->getTransportControls(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public isCaptioningEnabled()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/v4/media/session/IMediaSession;->isCaptioningEnabled()Z
...
.method public final registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 1910
    invoke-static/range {p1 .. p1}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->access$000(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)Ljava/lang/Object;
