...
.method public constructor <init>()V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompatApi24;->createCallback(Landroid/support/v4/media/session/MediaSessionCompatApi24$Callback;)Ljava/lang/Object;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompatApi23;->createCallback(Landroid/support/v4/media/session/MediaSessionCompatApi23$Callback;)Ljava/lang/Object;
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompatApi21;->createCallback(Landroid/support/v4/media/session/MediaSessionCompatApi21$Callback;)Ljava/lang/Object;
...
.method static synthetic access$000(Landroid/support/v4/media/session/MediaSessionCompat$Callback;)V
    ...
    .line 839
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->handleMediaPlayPauseKeySingleTapIfPending()V
...
.method static synthetic access$300(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImpl;Landroid/os/Handler;)V
    ...
    .line 839
    invoke-direct/range {p0 .. p2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->setSessionImpl(Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImpl;Landroid/os/Handler;)V
...
.method private handleMediaPlayPauseKeySingleTapIfPending()V
    ...
    .line 939
    :cond_1
    invoke-interface/range {v1 .. v1}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImpl;->getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 940
    :cond_2
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/media/session/PlaybackStateCompat;->getActions()J
    ...
    .line 942
    invoke-virtual/range {v1 .. v1}, Landroid/support/v4/media/session/PlaybackStateCompat;->getState()I
    ...
    .line 948
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onPause()V
    ...
    .line 950
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onPlay()V
...
.method public onMediaButtonEvent(Landroid/content/Intent;)Z
    ...
    .line 906
    invoke-interface/range {v0 .. v0}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImpl;->getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 910
    invoke-virtual/range {p0 .. p0}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->onSkipToNext()V
