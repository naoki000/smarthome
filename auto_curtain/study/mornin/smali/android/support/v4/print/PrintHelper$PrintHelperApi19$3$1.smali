...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19$3$1;->doInBackground([Landroid/net/Uri;)Landroid/graphics/Bitmap;
...
.method protected onCancelled(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/print/PrintDocumentAdapter$LayoutResultCallback;->onLayoutCancelled()V
...
.method protected bridge synthetic onCancelled(Ljava/lang/Object;)V
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19$3$1;->onCancelled(Landroid/graphics/Bitmap;)V
...
.method protected onPostExecute(Landroid/graphics/Bitmap;)V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19$3;->access$500(Landroid/support/v4/print/PrintHelper$PrintHelperApi19$3;)Landroid/print/PrintAttributes;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/print/PrintAttributes;->getMediaSize()Landroid/print/PrintAttributes$MediaSize;
    ...
    .line 650
    invoke-virtual/range {v0 .. v0}, Landroid/print/PrintAttributes$MediaSize;->isPortrait()Z

    move-result v0

    invoke-static/range {p1 .. p1}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19;->access$600(Landroid/graphics/Bitmap;)Z
    ...
    invoke-direct/range {v7 .. v7}, Landroid/graphics/Matrix;-><init>()V
    ...
    .line 666
    invoke-virtual/range {p1 .. p1}, Landroid/print/PrintDocumentInfo$Builder;->build()Landroid/print/PrintDocumentInfo;
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual/range {p0 .. p1}, Landroid/support/v4/print/PrintHelper$PrintHelperApi19$3$1;->onPostExecute(Landroid/graphics/Bitmap;)V
