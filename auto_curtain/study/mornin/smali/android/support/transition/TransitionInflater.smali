...
.method private createCustom(Landroid/util/AttributeSet;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/content/Context;->getClassLoader()Ljava/lang/ClassLoader;
...
.method private createTransitionFromXml(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)Landroid/support/transition/Transition;
    ...
    .line 155
    invoke-direct/range {p0 .. p3}, Landroid/support/transition/TransitionInflater;->getTargetIds(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)V
...
.method private createTransitionManagerFromXml(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/ViewGroup;)Landroid/support/transition/TransitionManager;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/transition/TransitionManager;-><init>()V
...
.method private getTargetIds(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)V
    ...
    .line 256
    :try_start_0
    invoke-static/range {v2 .. v2}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;
    ...
    .line 260
    :try_start_1
    invoke-static/range {v3 .. v3}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;
...
.method public inflateTransition(I)Landroid/support/transition/Transition;
    ...
    .line 75
    invoke-interface/range {p1 .. p1}, Landroid/content/res/XmlResourceParser;->getPositionDescription()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/io/IOException;->getMessage()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Lorg/xmlpull/v1/XmlPullParserException;->getMessage()Ljava/lang/String;
...
.method public inflateTransitionManager(ILandroid/view/ViewGroup;)Landroid/support/transition/TransitionManager;
    ...
    invoke-virtual/range {p2 .. p2}, Lorg/xmlpull/v1/XmlPullParserException;->getMessage()Ljava/lang/String;
