...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/transition/Transition$1;-><init>()V
...
.method public constructor <init>()V
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/transition/TransitionValuesMaps;-><init>()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 293
    invoke-static/range {p1 .. p1}, Landroid/support/transition/Transition;->parseMatchOrder(Ljava/lang/String;)[I
...
.method private addUnmatched(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;)V
    ...
    :cond_1
    :goto_1
    invoke-virtual/range {p2 .. p2}, Landroid/support/v4/util/ArrayMap;->size()I
...
.method private static addViewValues(Landroid/support/transition/TransitionValuesMaps;Landroid/view/View;Landroid/support/transition/TransitionValues;)V
    ...
    :cond_1
    :goto_0
    invoke-static/range {p1 .. p1}, Landroid/support/v4/view/ViewCompat;->getTransitionName(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-interface/range {v1 .. v1}, Landroid/widget/ListAdapter;->hasStableIds()Z
...
.method private captureHierarchy(Landroid/view/View;Z)V
    ...
    invoke-direct/range {v1 .. v1}, Landroid/support/transition/TransitionValues;-><init>()V
...
.method private static excludeObject(Ljava/util/ArrayList;Ljava/lang/Object;Z)Ljava/util/ArrayList;
    ...
    .line 1159
    invoke-static/range {p0 .. p1}, Landroid/support/transition/Transition$ArrayListManager;->add(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    .line 1161
    :cond_0
    invoke-static/range {p0 .. p1}, Landroid/support/transition/Transition$ArrayListManager;->remove(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;
...
.method private excludeType(Ljava/util/ArrayList;Ljava/lang/Class;Z)Ljava/util/ArrayList;
    ...
    .line 1391
    invoke-static/range {p1 .. p2}, Landroid/support/transition/Transition$ArrayListManager;->add(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    .line 1393
    :cond_0
    invoke-static/range {p1 .. p2}, Landroid/support/transition/Transition$ArrayListManager;->remove(Ljava/util/ArrayList;Ljava/lang/Object;)Ljava/util/ArrayList;
...
.method private matchItemIds(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/LongSparseArray;Landroid/support/v4/util/LongSparseArray;)V
    ...
    .line 562
    invoke-virtual/range {p3 .. p3}, Landroid/support/v4/util/LongSparseArray;->size()I
...
.method private static parseMatchOrder(Ljava/lang/String;)[I
    ...
    .line 302
    invoke-virtual/range {v0 .. v0}, Ljava/util/StringTokenizer;->countTokens()I
    ...
    .line 304
    :goto_0
    invoke-virtual/range {v0 .. v0}, Ljava/util/StringTokenizer;->hasMoreTokens()Z
    ...
    .line 305
    invoke-virtual/range {v0 .. v0}, Ljava/util/StringTokenizer;->nextToken()Ljava/lang/String;
    ...
    .line 314
    :cond_3
    invoke-virtual/range {v3 .. v3}, Ljava/lang/String;->isEmpty()Z
...
.method private runAnimator(Landroid/animation/Animator;Landroid/support/v4/util/ArrayMap;)V
    ...
    .line 906
    invoke-virtual/range {p0 .. p1}, Landroid/support/transition/Transition;->animate(Landroid/animation/Animator;)V
...
.method protected animate(Landroid/animation/Animator;)V
    ...
    .line 1894
    invoke-virtual/range {p0 .. p0}, Landroid/support/transition/Transition;->end()V

    goto :goto_0

    .line 1896
    :cond_0
    invoke-virtual/range {p0 .. p0}, Landroid/support/transition/Transition;->getDuration()J
    ...
    .line 1899
    :cond_1
    invoke-virtual/range {p0 .. p0}, Landroid/support/transition/Transition;->getStartDelay()J
    ...
    .line 1902
    :cond_2
    invoke-virtual/range {p0 .. p0}, Landroid/support/transition/Transition;->getInterpolator()Landroid/animation/TimeInterpolator;
    ...
    .line 1912
    invoke-virtual/range {p1 .. p1}, Landroid/animation/Animator;->start()V
...
.method protected cancel()V
    ...
    .line 2009
    invoke-virtual/range {v1 .. v1}, Landroid/animation/Animator;->cancel()V
    ...
    .line 2013
    invoke-virtual/range {v0 .. v0}, Ljava/util/ArrayList;->clone()Ljava/lang/Object;
...
.method capturePropagationValues(Landroid/support/transition/TransitionValues;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/transition/TransitionPropagation;->getPropagationProperties()[Ljava/lang/String;
...
.method captureValues(Landroid/view/ViewGroup;Z)V
    ...
    .line 1508
    :cond_2
    invoke-direct/range {p0 .. p2}, Landroid/support/transition/Transition;->captureHierarchy(Landroid/view/View;Z)V
    ...
    invoke-direct/range {v3 .. v3}, Landroid/support/transition/TransitionValues;-><init>()V
    ...
    invoke-direct/range {v2 .. v2}, Landroid/support/transition/TransitionValues;-><init>()V
...
.method clearValues(Z)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/v4/util/LongSparseArray;->clear()V
...
.method public clone()Landroid/support/transition/Transition;
    ...
    invoke-direct/range {v2 .. v2}, Landroid/support/transition/TransitionValuesMaps;-><init>()V
...
.method public bridge synthetic clone()Ljava/lang/Object;
    ...
    .line 118
    invoke-virtual/range {p0 .. p0}, Landroid/support/transition/Transition;->clone()Landroid/support/transition/Transition;
...
.method protected createAnimators(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValuesMaps;Landroid/support/transition/TransitionValuesMaps;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-direct/range {v9 .. v9}, Landroid/util/SparseIntArray;-><init>()V
    ...
    invoke-direct/range {v11 .. v11}, Landroid/support/transition/TransitionValues;-><init>()V
    ...
    .line 760
    invoke-virtual/range {v8 .. v8}, Landroid/support/v4/util/ArrayMap;->size()I
    ...
    .line 792
    :goto_8
    invoke-virtual/range {v9 .. v9}, Landroid/util/SparseIntArray;->size()I
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/animation/Animator;->getStartDelay()J
...
.method protected end()V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/v4/util/LongSparseArray;->size()I
...
.method forceToEnd(Landroid/view/ViewGroup;)V
    ...
    .line 1986
    invoke-virtual/range {v0 .. v0}, Landroid/support/v4/util/ArrayMap;->size()I
...
.method public isTransitionRequired(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Z
    ...
    invoke-interface/range {v2 .. v2}, Ljava/util/Map;->keySet()Ljava/util/Set;
...
.method public pause(Landroid/view/View;)V
    ...
    .line 1724
    invoke-static/range {v3 .. v3}, Landroid/support/transition/AnimatorUtils;->pause(Landroid/animation/Animator;)V
...
.method playTransition(Landroid/view/ViewGroup;)V
    ...
    .line 1799
    invoke-virtual/range {v4 .. v4}, Landroid/animation/Animator;->isRunning()Z

    move-result v5

    if-nez v5, :cond_3

    invoke-virtual/range {v4 .. v4}, Landroid/animation/Animator;->isStarted()Z
    ...
    :cond_3
    :goto_2
    invoke-virtual/range {v4 .. v4}, Landroid/animation/Animator;->cancel()V
...
.method public resume(Landroid/view/View;)V
    ...
    .line 1757
    invoke-static/range {v3 .. v3}, Landroid/support/transition/AnimatorUtils;->resume(Landroid/animation/Animator;)V
...
.method protected runAnimators()V
    ...
    .line 874
    invoke-virtual/range {p0 .. p0}, Landroid/support/transition/Transition;->start()V
...
.method public varargs setMatchOrder([I)V
    ...
    .line 510
    invoke-static/range {v1 .. v1}, Landroid/support/transition/Transition;->isValidMatch(I)Z
    ...
    .line 517
    :cond_3
    invoke-virtual/range {p1 .. p1}, [I->clone()Ljava/lang/Object;
