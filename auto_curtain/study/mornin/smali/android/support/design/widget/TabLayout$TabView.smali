...
.method public constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    .line 1526
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout$TabView;->getContext()Landroid/content/Context;
...
.method private approximateLineWidth(Landroid/text/Layout;IF)F
    ...
    .line 1780
    invoke-virtual/range {p1 .. p2}, Landroid/text/Layout;->getLineWidth(I)F
...
.method private updateTextAndIcon(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$Tab;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/TabLayout$Tab;->getText()Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/design/widget/TabLayout$Tab;->getContentDescription()Ljava/lang/CharSequence;
    ...
    .line 1760
    invoke-virtual/range {p2 .. p2}, Landroid/widget/ImageView;->getVisibility()I
    ...
    .line 1766
    invoke-virtual/range {p2 .. p2}, Landroid/widget/ImageView;->requestLayout()V
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 1570
    invoke-super/range {p0 .. p1}, Landroid/widget/LinearLayout;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    .line 1577
    invoke-super/range {p0 .. p1}, Landroid/widget/LinearLayout;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method public onMeasure(II)V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/TabLayout;->getTabMaxWidth()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/widget/ImageView;->getVisibility()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/widget/TextView;->getLineCount()I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/widget/TextView;->getTextSize()F
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/widget/TextView;->getLineCount()I
    ...
    invoke-static/range {v5 .. v5}, Landroid/support/v4/widget/TextViewCompat;->getMaxLines(Landroid/widget/TextView;)I
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/widget/TextView;->getLayout()Landroid/text/Layout;
...
.method public performClick()Z
    ...
    .line 1531
    invoke-super/range {p0 .. p0}, Landroid/widget/LinearLayout;->performClick()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$Tab;->select()V
...
.method public setSelected(Z)V
    ...
    .line 1546
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout$TabView;->isSelected()Z
    ...
    .line 1548
    :goto_0
    invoke-super/range {p0 .. p1}, Landroid/widget/LinearLayout;->setSelected(Z)V
...
.method setTab(Landroid/support/design/widget/TabLayout$Tab;)V
    ...
    .line 1651
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TabLayout$TabView;->update()V
...
.method final update()V
    ...
    .line 1662
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$Tab;->getCustomView()Landroid/view/View;
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v4/widget/TextViewCompat;->getMaxLines(Landroid/widget/TextView;)I
    ...
    .line 1723
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/TabLayout$Tab;->isSelected()Z
