...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ShadowViewDelegate;)V
    ...
    .line 46
    invoke-direct/range {p0 .. p2}, Landroid/support/design/widget/FloatingActionButtonImpl;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/ShadowViewDelegate;)V
...
.method public getElevation()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->getElevation()F
...
.method getPadding(Landroid/graphics/Rect;)V
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/design/widget/ShadowViewDelegate;->isCompatPaddingEnabled()Z
    ...
    invoke-interface/range {v0 .. v0}, Landroid/support/design/widget/ShadowViewDelegate;->getRadius()F

    move-result v0

    .line 203
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonLollipop;->getElevation()F
...
.method newCircularDrawable()Landroid/support/design/widget/CircularBorderDrawable;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/design/widget/CircularBorderDrawableLollipop;-><init>()V
...
.method newGradientDrawableForShape()Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-direct/range {v0 .. v0}, Landroid/support/design/widget/FloatingActionButtonLollipop$AlwaysStatefulGradientDrawable;-><init>()V
...
.method onElevationsChanged(FF)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/VisibilityAwareImageButton;->isEnabled()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/VisibilityAwareImageButton;->isFocused()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/VisibilityAwareImageButton;->isPressed()Z
    ...
    invoke-direct/range {v0 .. v0}, Landroid/animation/StateListAnimator;-><init>()V

    .line 105
    new-instance v2, Landroid/animation/AnimatorSet;

    invoke-direct/range {v2 .. v2}, Landroid/animation/AnimatorSet;-><init>()V
    ...
    .line 130
    invoke-virtual/range {v6 .. v6}, Landroid/support/design/widget/VisibilityAwareImageButton;->getTranslationZ()F
    ...
    invoke-direct/range {p1 .. p1}, Landroid/animation/AnimatorSet;-><init>()V
    ...
    invoke-interface/range {p1 .. p1}, Landroid/support/design/widget/ShadowViewDelegate;->isCompatPaddingEnabled()Z
...
.method setBackgroundDrawable(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    .line 53
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/FloatingActionButtonLollipop;->createShapeDrawable()Landroid/graphics/drawable/GradientDrawable;
...
.method setRippleColor(I)V
    ...
    .line 81
    :cond_0
    invoke-super/range {p0 .. p1}, Landroid/support/design/widget/FloatingActionButtonImpl;->setRippleColor(I)V
