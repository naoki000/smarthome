...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct/range {v3 .. v3}, Landroid/view/animation/AccelerateInterpolator;-><init>()V
    ...
    .line 255
    :cond_3
    invoke-virtual/range {p1 .. p1}, Landroid/support/v7/widget/TintTypedArray;->recycle()V
...
.method static synthetic access$100(Landroid/support/design/widget/TextInputLayout;Z)V
    ...
    .line 118
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/TextInputLayout;->passwordVisibilityToggleRequested(Z)V
...
.method private addIndicator(Landroid/widget/TextView;I)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->getContext()Landroid/content/Context;
    ...
    .line 591
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->adjustIndicatorPadding()V
...
.method private adjustIndicatorPadding()V
    ...
    invoke-static/range {v1 .. v1}, Landroid/support/v4/view/ViewCompat;->getPaddingStart(Landroid/view/View;)I
    ...
    .line 602
    invoke-static/range {v2 .. v2}, Landroid/support/v4/view/ViewCompat;->getPaddingEnd(Landroid/view/View;)I

    move-result v2

    iget-object v3, p0, Landroid/support/design/widget/TextInputLayout;->mEditText:Landroid/widget/EditText;

    invoke-virtual/range {v3 .. v3}, Landroid/widget/EditText;->getPaddingBottom()I
...
.method private applyPasswordToggleTint()V
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/graphics/drawable/DrawableCompat;->wrap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable;->mutate()Landroid/graphics/drawable/Drawable;
    ...
    .line 1371
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CheckableImageButton;->getDrawable()Landroid/graphics/drawable/Drawable;
...
.method private collapseHint(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/ValueAnimator;->isRunning()Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/animation/ValueAnimator;->cancel()V
...
.method private ensureBackgroundDrawableStateWorkaround()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/EditText;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 944
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/drawable/Drawable;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;

    move-result-object v1

    invoke-virtual/range {v1 .. v1}, Landroid/graphics/drawable/Drawable$ConstantState;->newDrawable()Landroid/graphics/drawable/Drawable;
    ...
    .line 951
    invoke-virtual/range {v1 .. v1}, Landroid/graphics/drawable/Drawable;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;
...
.method private hasPasswordTransformation()Z
    ...
    .line 1351
    invoke-virtual/range {v0 .. v0}, Landroid/widget/EditText;->getTransformationMethod()Landroid/text/method/TransformationMethod;
...
.method private passwordVisibilityToggleRequested(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/EditText;->getSelectionEnd()I

    move-result v0

    .line 1331
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->hasPasswordTransformation()Z
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/CheckableImageButton;->jumpDrawablesToCurrentState()V
...
.method private setEditText(Landroid/widget/EditText;)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/EditText;->getTypeface()Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/EditText;->getTextSize()F
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/EditText;->getGravity()I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/EditText;->getHintTextColors()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/widget/EditText;->getHint()Ljava/lang/CharSequence;
    ...
    .line 404
    :cond_5
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->updatePasswordToggleView()V
...
.method private setError(Ljava/lang/CharSequence;Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/TextView;->animate()Landroid/view/ViewPropertyAnimator;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewPropertyAnimator;->cancel()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/TextView;->getAlpha()F
    ...
    .line 747
    invoke-virtual/range {p1 .. p1}, Landroid/view/ViewPropertyAnimator;->start()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/TextView;->getVisibility()I
    ...
    :cond_6
    :goto_0
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->updateEditTextBackground()V
...
.method private updateEditTextBackground()V
    ...
    .line 904
    :cond_1
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->ensureBackgroundDrawableStateWorkaround()V

    .line 906
    invoke-static/range {v0 .. v0}, Landroid/support/v7/widget/DrawableUtils;->canSafelyMutateDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 914
    invoke-virtual/range {v1 .. v1}, Landroid/widget/TextView;->getCurrentTextColor()I
    ...
    .line 923
    :cond_4
    invoke-static/range {v0 .. v0}, Landroid/support/v4/graphics/drawable/DrawableCompat;->clearColorFilter(Landroid/graphics/drawable/Drawable;)V

    .line 924
    iget-object v0, p0, Landroid/support/design/widget/TextInputLayout;->mEditText:Landroid/widget/EditText;

    invoke-virtual/range {v0 .. v0}, Landroid/widget/EditText;->refreshDrawableState()V
...
.method private updateInputLayoutMargins()V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/FrameLayout;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct/range {v1 .. v1}, Landroid/graphics/Paint;-><init>()V
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/CollapsingTextHelper;->getCollapsedTypeface()Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/support/design/widget/CollapsingTextHelper;->getCollapsedTextSize()F
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/graphics/Paint;->ascent()F
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/FrameLayout;->requestLayout()V
...
.method private updatePasswordToggleView()V
    ...
    .line 1102
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->shouldShowPasswordIcon()Z
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/view/ViewCompat;->getMinimumHeight(Landroid/view/View;)I
    ...
    invoke-static/range {v5 .. v5}, Landroid/support/v4/view/ViewCompat;->getMinimumHeight(Landroid/view/View;)I
    ...
    invoke-direct/range {v0 .. v0}, Landroid/graphics/drawable/ColorDrawable;-><init>()V
    ...
    invoke-virtual/range {v5 .. v5}, Landroid/support/design/widget/CheckableImageButton;->getMeasuredWidth()I
    ...
    invoke-static/range {v0 .. v0}, Landroid/support/v4/widget/TextViewCompat;->getCompoundDrawablesRelative(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/EditText;->getPaddingLeft()I
    ...
    .line 1145
    invoke-virtual/range {v2 .. v2}, Landroid/widget/EditText;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroid/support/design/widget/TextInputLayout;->mEditText:Landroid/widget/EditText;

    invoke-virtual/range {v3 .. v3}, Landroid/widget/EditText;->getPaddingRight()I
    ...
    .line 1146
    invoke-virtual/range {v4 .. v4}, Landroid/widget/EditText;->getPaddingBottom()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CheckableImageButton;->getVisibility()I
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 283
    invoke-direct/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->updateInputLayoutMargins()V
...
.method animateToExpansionFraction(F)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/support/design/widget/CollapsingTextHelper;->getExpansionFraction()F
    ...
    invoke-direct/range {v0 .. v0}, Landroid/animation/ValueAnimator;-><init>()V
    ...
    invoke-virtual/range {v3 .. v3}, Landroid/support/design/widget/CollapsingTextHelper;->getExpansionFraction()F
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/animation/ValueAnimator;->start()V
...
.method public dispatchProvideAutofillStructure(Landroid/view/ViewStructure;I)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/EditText;->getHint()Ljava/lang/CharSequence;
    ...
    .line 332
    :try_start_0
    invoke-super/range {p0 .. p2}, Landroid/widget/LinearLayout;->dispatchProvideAutofillStructure(Landroid/view/ViewStructure;I)V
    :try_end_0
...
.method protected dispatchRestoreInstanceState(Landroid/util/SparseArray;)V
    ...
    .line 1041
    invoke-super/range {p0 .. p1}, Landroid/widget/LinearLayout;->dispatchRestoreInstanceState(Landroid/util/SparseArray;)V
...
.method protected drawableStateChanged()V
    ...
    .line 1424
    invoke-super/range {p0 .. p0}, Landroid/widget/LinearLayout;->drawableStateChanged()V

    .line 1426
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->getDrawableState()[I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->isEnabled()Z
    ...
    .line 1439
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->invalidate()V
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual/range {p4 .. p4}, Landroid/widget/EditText;->getCompoundPaddingLeft()I
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/EditText;->getCompoundPaddingRight()I
    ...
    .line 1389
    invoke-virtual/range {v2 .. v2}, Landroid/widget/EditText;->getCompoundPaddingTop()I
    ...
    .line 1390
    invoke-virtual/range {v2 .. v2}, Landroid/widget/EditText;->getCompoundPaddingBottom()I
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->getPaddingTop()I
    ...
    .line 1395
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->getPaddingBottom()I
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/CollapsingTextHelper;->recalculate()V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1026
    invoke-super/range {p0 .. p1}, Landroid/widget/LinearLayout;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1030
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/TextInputLayout$SavedState;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 1035
    :cond_1
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->requestLayout()V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1017
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->getError()Ljava/lang/CharSequence;
...
.method public setCounterEnabled(Z)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/widget/EditText;->getText()Landroid/text/Editable;

    move-result-object v0

    invoke-interface/range {v0 .. v0}, Landroid/text/Editable;->length()I
...
.method public setEnabled(Z)V
    ...
    .line 851
    invoke-static/range {p0 .. p1}, Landroid/support/design/widget/TextInputLayout;->recursiveSetEnabled(Landroid/view/ViewGroup;Z)V

    .line 852
    invoke-super/range {p0 .. p1}, Landroid/widget/LinearLayout;->setEnabled(Z)V
...
.method public setError(Ljava/lang/CharSequence;)V
    ...
    .line 709
    invoke-virtual/range {v0 .. v0}, Landroid/widget/TextView;->getText()Ljava/lang/CharSequence;
...
.method public setErrorEnabled(Z)V
    ...
    .line 638
    invoke-virtual/range {v2 .. v2}, Landroid/widget/TextView;->getTextColors()Landroid/content/res/ColorStateList;

    move-result-object v2

    invoke-virtual/range {v2 .. v2}, Landroid/content/res/ColorStateList;->getDefaultColor()I
...
.method public setHint(Ljava/lang/CharSequence;)V
    ...
    .line 485
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/TextInputLayout;->setHintInternal(Ljava/lang/CharSequence;)V
...
.method public setHintTextAppearance(I)V
    ...
    invoke-virtual/range {p1 .. p1}, Landroid/support/design/widget/CollapsingTextHelper;->getCollapsedTextColor()Landroid/content/res/ColorStateList;
...
.method public setPasswordVisibilityToggleContentDescription(I)V
    ...
    .line 1213
    invoke-virtual/range {p0 .. p0}, Landroid/support/design/widget/TextInputLayout;->getResources()Landroid/content/res/Resources;
...
.method updateLabelState(ZZ)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/widget/EditText;->getText()Landroid/text/Editable;
    ...
    invoke-virtual/range {v4 .. v4}, Landroid/widget/TextView;->getTextColors()Landroid/content/res/ColorStateList;
    ...
    .line 463
    :cond_6
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/TextInputLayout;->expandHint(Z)V
    ...
    .line 458
    :cond_8
    invoke-direct/range {p0 .. p1}, Landroid/support/design/widget/TextInputLayout;->collapseHint(Z)V
