...
.method constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    ...
    .line 514
    invoke-static/range {p1 .. p1}, Lcom/google/common/collect/Maps;->access$100(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 515
    invoke-static/range {p2 .. p2}, Lcom/google/common/collect/Maps;->access$100(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 516
    invoke-static/range {p3 .. p3}, Lcom/google/common/collect/Maps;->access$100(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 517
    invoke-static/range {p4 .. p4}, Lcom/google/common/collect/Maps;->access$100(Ljava/util/Map;)Ljava/util/Map;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 552
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/collect/Maps$MapDifferenceImpl;->entriesOnlyOnLeft()Ljava/util/Map;

    move-result-object v1

    invoke-interface/range {p1 .. p1}, Lcom/google/common/collect/MapDifference;->entriesOnlyOnLeft()Ljava/util/Map;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/collect/Maps$MapDifferenceImpl;->entriesOnlyOnRight()Ljava/util/Map;

    move-result-object v1

    invoke-interface/range {p1 .. p1}, Lcom/google/common/collect/MapDifference;->entriesOnlyOnRight()Ljava/util/Map;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/collect/Maps$MapDifferenceImpl;->entriesInCommon()Ljava/util/Map;

    move-result-object v1

    invoke-interface/range {p1 .. p1}, Lcom/google/common/collect/MapDifference;->entriesInCommon()Ljava/util/Map;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/collect/Maps$MapDifferenceImpl;->entriesDiffering()Ljava/util/Map;

    move-result-object v1

    invoke-interface/range {p1 .. p1}, Lcom/google/common/collect/MapDifference;->entriesDiffering()Ljava/util/Map;
...
.method public toString()Ljava/lang/String;
    ...
    .line 568
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/collect/Maps$MapDifferenceImpl;->areEqual()Z
