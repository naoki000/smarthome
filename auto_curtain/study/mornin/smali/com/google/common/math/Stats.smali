...
.method public static meanOf(Ljava/lang/Iterable;)D
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/common/math/Stats;->meanOf(Ljava/util/Iterator;)D
...
.method public static meanOf(Ljava/util/Iterator;)D
    ...
    .line 413
    invoke-static/range {v6 .. v7}, Lcom/google/common/primitives/Doubles;->isFinite(D)Z

    move-result v8

    if-eqz v8, :cond_0

    invoke-static/range {v4 .. v5}, Lcom/google/common/primitives/Doubles;->isFinite(D)Z
...
.method public static varargs meanOf([D)D
    ...
    .line 437
    invoke-static/range {v3 .. v4}, Lcom/google/common/primitives/Doubles;->isFinite(D)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-static/range {v0 .. v1}, Lcom/google/common/primitives/Doubles;->isFinite(D)Z
...
.method public populationStandardDeviation()D
    ...
    .line 242
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/math/Stats;->populationVariance()D
...
.method public populationVariance()D
    ...
    invoke-static/range {v0 .. v1}, Lcom/google/common/math/DoubleUtils;->ensureNonNegative(D)D

    move-result-wide v0

    invoke-virtual/range {p0 .. p0}, Lcom/google/common/math/Stats;->count()J
...
.method public sampleStandardDeviation()D
    ...
    .line 288
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/math/Stats;->sampleVariance()D
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/math/Stats;->populationStandardDeviation()D
