...
.method synthetic constructor <init>(Lcom/google/common/hash/BloomFilterStrategies$BitArray;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;Lcom/google/common/hash/BloomFilter$1;)V
    ...
    .line 61
    invoke-direct/range {p0 .. p4}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$BitArray;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
...
.method public static readFrom(Ljava/io/InputStream;Lcom/google/common/hash/Funnel;)Lcom/google/common/hash/BloomFilter;
    ...
    .line 506
    invoke-virtual/range {v1 .. v1}, Ljava/io/DataInputStream;->readByte()B
    ...
    .line 508
    :try_start_2
    invoke-virtual/range {v1 .. v1}, Ljava/io/DataInputStream;->readInt()I
    ...
    .line 513
    invoke-virtual/range {v1 .. v1}, Ljava/io/DataInputStream;->readLong()J
...
.method public apply(Ljava/lang/Object;)Z
    ...
    .line 146
    invoke-virtual/range {p0 .. p1}, Lcom/google/common/hash/BloomFilter;->mightContain(Ljava/lang/Object;)Z
...
.method bitSize()J
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/hash/BloomFilterStrategies$BitArray;->bitSize()J
...
.method public copy()Lcom/google/common/hash/BloomFilter;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/common/hash/BloomFilterStrategies$BitArray;->copy()Lcom/google/common/hash/BloomFilterStrategies$BitArray;
...
.method public expectedFpp()D
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/hash/BloomFilterStrategies$BitArray;->bitCount()J
...
.method public writeTo(Ljava/io/OutputStream;)V
    ...
    invoke-interface/range {p1 .. p1}, Lcom/google/common/hash/BloomFilter$Strategy;->ordinal()I

    move-result p1

    int-to-long v1, p1

    invoke-static/range {v1 .. v2}, Lcom/google/common/primitives/SignedBytes;->checkedCast(J)B
    ...
    invoke-static/range {v1 .. v2}, Lcom/google/common/primitives/UnsignedBytes;->checkedCast(J)B
