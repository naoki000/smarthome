...
.method constructor <init>(Ljava/io/Reader;Ljava/nio/charset/Charset;I)V
    ...
    .line 82
    invoke-virtual/range {p2 .. p2}, Ljava/nio/charset/Charset;->newEncoder()Ljava/nio/charset/CharsetEncoder;
...
.method constructor <init>(Ljava/io/Reader;Ljava/nio/charset/CharsetEncoder;I)V
    ...
    .line 104
    invoke-virtual/range {p2 .. p2}, Ljava/nio/charset/CharsetEncoder;->reset()Ljava/nio/charset/CharsetEncoder;

    .line 106
    invoke-static/range {p3 .. p3}, Ljava/nio/CharBuffer;->allocate(I)Ljava/nio/CharBuffer;
    ...
    invoke-virtual/range {p1 .. p1}, Ljava/nio/CharBuffer;->flip()Ljava/nio/Buffer;
...
.method private static availableCapacity(Ljava/nio/Buffer;)I
    ...
    .line 229
    invoke-virtual/range {p0 .. p0}, Ljava/nio/Buffer;->capacity()I
...
.method private static grow(Ljava/nio/CharBuffer;)Ljava/nio/CharBuffer;
    ...
    .line 190
    invoke-virtual/range {p0 .. p0}, Ljava/nio/CharBuffer;->array()[C

    move-result-object v0

    invoke-virtual/range {p0 .. p0}, Ljava/nio/CharBuffer;->capacity()I
    ...
    .line 191
    invoke-static/range {v0 .. v0}, Ljava/nio/CharBuffer;->wrap([C)Ljava/nio/CharBuffer;

    move-result-object v0

    .line 192
    invoke-virtual/range {p0 .. p0}, Ljava/nio/CharBuffer;->position()I
    ...
    .line 193
    invoke-virtual/range {p0 .. p0}, Ljava/nio/CharBuffer;->limit()I
...
.method private readMoreChars()V
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/common/io/ReaderInputStream;->availableCapacity(Ljava/nio/Buffer;)I
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/nio/CharBuffer;->position()I
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/nio/CharBuffer;->compact()Ljava/nio/CharBuffer;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Ljava/nio/CharBuffer;->flip()Ljava/nio/Buffer;
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/common/io/ReaderInputStream;->grow(Ljava/nio/CharBuffer;)Ljava/nio/CharBuffer;
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/nio/CharBuffer;->limit()I
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/nio/CharBuffer;->array()[C

    move-result-object v2

    iget-object v3, p0, Lcom/google/common/io/ReaderInputStream;->charBuffer:Ljava/nio/CharBuffer;

    invoke-static/range {v3 .. v3}, Lcom/google/common/io/ReaderInputStream;->availableCapacity(Ljava/nio/Buffer;)I
...
.method public close()V
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/io/Reader;->close()V
...
.method public read([BII)I
    ...
    invoke-virtual/range {v3 .. v3}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;
    ...
    .line 161
    :goto_4
    invoke-virtual/range {v3 .. v3}, Ljava/nio/charset/CoderResult;->isOverflow()Z
    ...
    .line 165
    :cond_7
    invoke-virtual/range {v3 .. v3}, Ljava/nio/charset/CoderResult;->isUnderflow()Z
    ...
    .line 177
    :cond_9
    invoke-direct/range {p0 .. p0}, Lcom/google/common/io/ReaderInputStream;->readMoreChars()V

    goto :goto_3

    .line 179
    :cond_a
    invoke-virtual/range {v3 .. v3}, Ljava/nio/charset/CoderResult;->isError()Z
    ...
    .line 181
    invoke-virtual/range {v3 .. v3}, Ljava/nio/charset/CoderResult;->throwException()V
