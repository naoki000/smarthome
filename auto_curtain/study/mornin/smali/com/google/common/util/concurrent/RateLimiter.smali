...
.method private canAcquire(JJ)Z
    ...
    .line 360
    invoke-virtual/range {p0 .. p2}, Lcom/google/common/util/concurrent/RateLimiter;->queryEarliestAvailable(J)J
...
.method public acquire(I)D
    ...
    .line 271
    invoke-virtual/range {p0 .. p1}, Lcom/google/common/util/concurrent/RateLimiter;->reserve(I)J
...
.method public final getRate()D
    ...
    .line 239
    invoke-direct/range {p0 .. p0}, Lcom/google/common/util/concurrent/RateLimiter;->mutex()Ljava/lang/Object;
    ...
    .line 240
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/RateLimiter;->doGetRate()D
...
.method final reserve(I)J
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/common/util/concurrent/RateLimiter$SleepingStopwatch;->readMicros()J
...
.method final reserveAndGetWaitLength(IJ)J
    ...
    .line 369
    invoke-virtual/range {p0 .. p3}, Lcom/google/common/util/concurrent/RateLimiter;->reserveEarliestAvailable(IJ)J
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/RateLimiter;->getRate()D

    move-result-wide v3

    invoke-static/range {v3 .. v4}, Ljava/lang/Double;->valueOf(D)Ljava/lang/Double;
...
.method public tryAcquire(IJLjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/util/concurrent/RateLimiter$SleepingStopwatch;->readMicros()J
