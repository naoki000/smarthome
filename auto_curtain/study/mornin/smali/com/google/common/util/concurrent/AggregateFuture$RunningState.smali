...
.method constructor <init>(Lcom/google/common/util/concurrent/AggregateFuture;Lcom/google/common/collect/ImmutableCollection;ZZ)V
    ...
    .line 87
    invoke-virtual/range {p2 .. p2}, Lcom/google/common/collect/ImmutableCollection;->size()I
...
.method static synthetic access$100(Lcom/google/common/util/concurrent/AggregateFuture$RunningState;)V
    ...
    .line 78
    invoke-direct/range {p0 .. p0}, Lcom/google/common/util/concurrent/AggregateFuture$RunningState;->init()V
...
.method static synthetic access$200(Lcom/google/common/util/concurrent/AggregateFuture$RunningState;ILjava/util/concurrent/Future;)V
    ...
    .line 78
    invoke-direct/range {p0 .. p2}, Lcom/google/common/util/concurrent/AggregateFuture$RunningState;->handleOneInputDone(ILjava/util/concurrent/Future;)V
...
.method static synthetic access$300(Lcom/google/common/util/concurrent/AggregateFuture$RunningState;)V
    ...
    .line 78
    invoke-direct/range {p0 .. p0}, Lcom/google/common/util/concurrent/AggregateFuture$RunningState;->decrementCountAndMaybeComplete()V
...
.method private decrementCountAndMaybeComplete()V
    ...
    .line 229
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/AggregateFuture$RunningState;->decrementRemainingAndGet()I
    ...
    .line 232
    invoke-direct/range {p0 .. p0}, Lcom/google/common/util/concurrent/AggregateFuture$RunningState;->processCompleted()V
...
.method private handleException(Ljava/lang/Throwable;)V
    ...
    .line 166
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/AggregateFuture$RunningState;->releaseResourcesAfterFailure()V

    goto :goto_0

    .line 170
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/AggregateFuture$RunningState;->getOrInitSeenExceptions()Ljava/util/Set;
...
.method private handleOneInputDone(ILjava/util/concurrent/Future;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/util/concurrent/AggregateFuture;->isDone()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/util/concurrent/AggregateFuture;->isCancelled()Z
    ...
    .line 206
    invoke-interface/range {p2 .. p2}, Ljava/util/concurrent/Future;->isCancelled()Z
    ...
    .line 213
    :cond_2
    invoke-static/range {p2 .. p2}, Lcom/google/common/util/concurrent/Futures;->getDone(Ljava/util/concurrent/Future;)Ljava/lang/Object;
...
.method private init()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/collect/ImmutableCollection;->isEmpty()Z
    ...
    .line 108
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/util/concurrent/AggregateFuture$RunningState;->handleAllCompleted()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/collect/ImmutableCollection;->iterator()Ljava/util/Iterator;
...
.method final addInitialException(Ljava/util/Set;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/util/concurrent/AggregateFuture;->trustedGetException()Ljava/lang/Throwable;
