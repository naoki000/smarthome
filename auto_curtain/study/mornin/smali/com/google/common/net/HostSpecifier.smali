...
.method public static from(Ljava/lang/String;)Lcom/google/common/net/HostSpecifier;
    ...
    .line 113
    :try_start_0
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/HostSpecifier;->fromValid(Ljava/lang/String;)Lcom/google/common/net/HostSpecifier;
...
.method public static fromValid(Ljava/lang/String;)Lcom/google/common/net/HostSpecifier;
    ...
    .line 72
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/HostAndPort;->fromString(Ljava/lang/String;)Lcom/google/common/net/HostAndPort;

    move-result-object p0

    .line 73
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/net/HostAndPort;->hasPort()Z
    ...
    .line 74
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/net/HostAndPort;->getHost()Ljava/lang/String;
    ...
    .line 82
    :try_start_0
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/InetAddresses;->forString(Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/common/net/InetAddresses;->toUriString(Ljava/net/InetAddress;)Ljava/lang/String;
    ...
    .line 96
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/net/InternetDomainName;->hasPublicSuffix()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/net/InternetDomainName;->toString()Ljava/lang/String;
