...
.method static constructor <clinit>()V
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/nio/charset/Charset;->name()Ljava/lang/String;

    move-result-object v1

    invoke-static/range {v1 .. v1}, Lcom/google/common/base/Ascii;->toLowerCase(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/common/base/CharMatcher;->negate()Lcom/google/common/base/CharMatcher;
    ...
    invoke-static/range {v1 .. v1}, Lcom/google/common/base/CharMatcher;->isNot(C)Lcom/google/common/base/CharMatcher;
    ...
    invoke-static/range {v1 .. v1}, Lcom/google/common/base/CharMatcher;->noneOf(Ljava/lang/CharSequence;)Lcom/google/common/base/CharMatcher;
    ...
    .line 96
    invoke-static/range {v0 .. v0}, Lcom/google/common/base/CharMatcher;->anyOf(Ljava/lang/CharSequence;)Lcom/google/common/base/CharMatcher;
...
.method static synthetic access$100(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 80
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/MediaType;->escapeAndQuote(Ljava/lang/String;)Ljava/lang/String;
...
.method private computeToString()Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/common/collect/ImmutableListMultimap;->isEmpty()Z
    ...
    invoke-interface/range {v1 .. v1}, Lcom/google/common/collect/Multimap;->entries()Ljava/util/Collection;
...
.method private static create(Ljava/lang/String;Ljava/lang/String;Lcom/google/common/collect/Multimap;)Lcom/google/common/net/MediaType;
    ...
    .line 736
    invoke-static/range {p0 .. p0}, Lcom/google/common/net/MediaType;->normalizeToken(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    .line 737
    invoke-static/range {p1 .. p1}, Lcom/google/common/net/MediaType;->normalizeToken(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 742
    invoke-interface/range {p2 .. p2}, Lcom/google/common/collect/Multimap;->entries()Ljava/util/Collection;
    ...
    invoke-static/range {v2 .. v2}, Lcom/google/common/net/MediaType;->normalizeToken(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/collect/ImmutableListMultimap$Builder;->build()Lcom/google/common/collect/ImmutableListMultimap;
...
.method private static createConstant(Ljava/lang/String;Ljava/lang/String;)Lcom/google/common/net/MediaType;
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/common/net/MediaType;->addKnownType(Lcom/google/common/net/MediaType;)Lcom/google/common/net/MediaType;
...
.method private static normalizeParameterValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, Lcom/google/common/base/Ascii;->toLowerCase(Ljava/lang/String;)Ljava/lang/String;
...
.method private static normalizeToken(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 753
    invoke-static/range {p0 .. p0}, Lcom/google/common/base/Ascii;->toLowerCase(Ljava/lang/String;)Ljava/lang/String;
...
.method private parametersAsMap()Ljava/util/Map;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/collect/ImmutableListMultimap;->asMap()Lcom/google/common/collect/ImmutableMap;
...
.method public static parse(Ljava/lang/String;)Lcom/google/common/net/MediaType;
    ...
    .line 773
    :goto_0
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/net/MediaType$Tokenizer;->hasMore()Z
    ...
    .line 780
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/net/MediaType$Tokenizer;->previewChar()C
    ...
    .line 798
    :cond_3
    invoke-virtual/range {v3 .. v3}, Lcom/google/common/collect/ImmutableListMultimap$Builder;->build()Lcom/google/common/collect/ImmutableListMultimap;
...
.method public charset()Lcom/google/common/base/Optional;
    ...
    invoke-static/range {v0 .. v0}, Lcom/google/common/collect/ImmutableSet;->copyOf(Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSet;

    move-result-object v0

    .line 573
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/collect/ImmutableSet;->size()I
    ...
    .line 577
    :pswitch_0
    invoke-static/range {v0 .. v0}, Lcom/google/common/collect/Iterables;->getOnlyElement(Ljava/lang/Iterable;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Ljava/lang/String;

    invoke-static/range {v0 .. v0}, Ljava/nio/charset/Charset;->forName(Ljava/lang/String;)Ljava/nio/charset/Charset;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/google/common/net/MediaType;->parametersAsMap()Ljava/util/Map;

    move-result-object v1

    invoke-direct/range {p1 .. p1}, Lcom/google/common/net/MediaType;->parametersAsMap()Ljava/util/Map;
...
.method public is(Lcom/google/common/net/MediaType;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/collect/ImmutableListMultimap;->entries()Lcom/google/common/collect/ImmutableCollection;

    move-result-object v0

    iget-object p1, p1, Lcom/google/common/net/MediaType;->parameters:Lcom/google/common/collect/ImmutableListMultimap;

    invoke-virtual/range {p1 .. p1}, Lcom/google/common/collect/ImmutableListMultimap;->entries()Lcom/google/common/collect/ImmutableCollection;
...
.method public toString()Ljava/lang/String;
    ...
    .line 888
    invoke-direct/range {p0 .. p0}, Lcom/google/common/net/MediaType;->computeToString()Ljava/lang/String;
...
.method public withCharset(Ljava/nio/charset/Charset;)Lcom/google/common/net/MediaType;
    ...
    .line 636
    invoke-virtual/range {p1 .. p1}, Ljava/nio/charset/Charset;->name()Ljava/lang/String;
...
.method public withParameter(Ljava/lang/String;Ljava/lang/String;)Lcom/google/common/net/MediaType;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/common/collect/ImmutableListMultimap;->entries()Lcom/google/common/collect/ImmutableCollection;
...
.method public withoutParameters()Lcom/google/common/net/MediaType;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/common/collect/ImmutableListMultimap;->isEmpty()Z
