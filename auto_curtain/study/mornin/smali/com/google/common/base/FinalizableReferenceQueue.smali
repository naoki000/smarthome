...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/common/base/FinalizableReferenceQueue$SystemLoader;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/common/base/FinalizableReferenceQueue$DecoupledLoader;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/common/base/FinalizableReferenceQueue$DirectLoader;-><init>()V

    const/4 v2, 0x2

    aput-object v1, v0, v2

    invoke-static/range {v0 .. v0}, Lcom/google/common/base/FinalizableReferenceQueue;->loadFinalizer([Lcom/google/common/base/FinalizableReferenceQueue$FinalizerLoader;)Ljava/lang/Class;

    move-result-object v0

    .line 138
    invoke-static/range {v0 .. v0}, Lcom/google/common/base/FinalizableReferenceQueue;->getStartFinalizer(Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method public constructor <init>()V
    ...
    invoke-direct/range {v0 .. v0}, Ljava/lang/ref/ReferenceQueue;-><init>()V
...
.method private static varargs loadFinalizer([Lcom/google/common/base/FinalizableReferenceQueue$FinalizerLoader;)Ljava/lang/Class;
    ...
    .line 215
    invoke-interface/range {v2 .. v2}, Lcom/google/common/base/FinalizableReferenceQueue$FinalizerLoader;->loadFinalizer()Ljava/lang/Class;
...
.method cleanUp()V
    ...
    .line 199
    invoke-virtual/range {v0 .. v0}, Ljava/lang/ref/Reference;->clear()V

    .line 201
    :try_start_0
    check-cast v0, Lcom/google/common/base/FinalizableReference;

    invoke-interface/range {v0 .. v0}, Lcom/google/common/base/FinalizableReference;->finalizeReferent()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public close()V
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/lang/ref/PhantomReference;->enqueue()Z

    .line 180
    invoke-virtual/range {p0 .. p0}, Lcom/google/common/base/FinalizableReferenceQueue;->cleanUp()V
