...
.method public constructor <init>()V
    ...
    .line 48
    invoke-direct/range {p0 .. p0}, Lcom/google/zxing/qrcode/QRCodeReader;-><init>()V
...
.method private static processStructuredAppend(Ljava/util/List;)Ljava/util/List;
    ...
    .line 104
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/Result;->getResultMetadata()Ljava/util/Map;
    ...
    .line 118
    invoke-virtual/range {v3 .. v3}, Lcom/google/zxing/Result;->getResultMetadata()Ljava/util/Map;
    ...
    .line 128
    invoke-virtual/range {v6 .. v6}, Lcom/google/zxing/Result;->getText()Ljava/lang/String;
    ...
    .line 129
    invoke-virtual/range {v6 .. v6}, Lcom/google/zxing/Result;->getRawBytes()[B
    ...
    .line 130
    invoke-virtual/range {v6 .. v6}, Lcom/google/zxing/Result;->getResultMetadata()Ljava/util/Map;
    ...
    .line 144
    invoke-virtual/range {v8 .. v8}, Lcom/google/zxing/Result;->getRawBytes()[B
    ...
    .line 146
    invoke-virtual/range {v8 .. v8}, Lcom/google/zxing/Result;->getResultMetadata()Ljava/util/Map;
    ...
    .line 150
    invoke-interface/range {v8 .. v8}, Ljava/lang/Iterable;->iterator()Ljava/util/Iterator;
...
.method public decodeMultiple(Lcom/google/zxing/BinaryBitmap;Ljava/util/Map;)[Lcom/google/zxing/Result;
    ...
    .line 64
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lcom/google/zxing/multi/qrcode/QRCodeMultiReader;->getDecoder()Lcom/google/zxing/qrcode/decoder/Decoder;

    move-result-object v4

    invoke-virtual/range {v3 .. v3}, Lcom/google/zxing/common/DetectorResult;->getBits()Lcom/google/zxing/common/BitMatrix;
    ...
    .line 65
    invoke-virtual/range {v3 .. v3}, Lcom/google/zxing/common/DetectorResult;->getPoints()[Lcom/google/zxing/ResultPoint;

    move-result-object v3

    .line 67
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/common/DecoderResult;->getOther()Ljava/lang/Object;
    ...
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/common/DecoderResult;->getText()Ljava/lang/String;

    move-result-object v6

    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/common/DecoderResult;->getRawBytes()[B
    ...
    .line 72
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/common/DecoderResult;->getByteSegments()Ljava/util/List;
    ...
    .line 76
    :cond_1
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/common/DecoderResult;->getECLevel()Ljava/lang/String;
    ...
    .line 80
    :cond_2
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/common/DecoderResult;->hasStructuredAppend()Z
    ...
    .line 82
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/common/DecoderResult;->getStructuredAppendSequenceNumber()I
    ...
    .line 84
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/common/DecoderResult;->getStructuredAppendParity()I
    ...
    .line 94
    :cond_5
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/multi/qrcode/QRCodeMultiReader;->processStructuredAppend(Ljava/util/List;)Ljava/util/List;
