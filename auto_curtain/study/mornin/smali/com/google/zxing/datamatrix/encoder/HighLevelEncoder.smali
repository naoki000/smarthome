...
.method public static determineConsecutiveDigitCount(Ljava/lang/CharSequence;I)I
    ...
    :cond_0
    :goto_0
    invoke-static/range {v2 .. v2}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isDigit(C)Z
...
.method public static encodeHighLevel(Ljava/lang/String;Lcom/google/zxing/datamatrix/encoder/SymbolShapeHint;Lcom/google/zxing/Dimension;Lcom/google/zxing/Dimension;)Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/ASCIIEncoder;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/C40Encoder;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/TextEncoder;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/X12Encoder;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/EdifactEncoder;-><init>()V
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/Base256Encoder;-><init>()V
    ...
    :cond_1
    :goto_0
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/EncoderContext;->hasMoreCharacters()Z
    ...
    .line 183
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/EncoderContext;->getNewEncoding()I
    ...
    .line 185
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/EncoderContext;->resetEncoderSignal()V

    goto :goto_0

    .line 188
    :cond_2
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/EncoderContext;->getCodewordCount()I

    move-result p0

    .line 189
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/EncoderContext;->updateSymbolInfo()V

    .line 190
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/EncoderContext;->getSymbolInfo()Lcom/google/zxing/datamatrix/encoder/SymbolInfo;
    ...
    .line 195
    :cond_3
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/datamatrix/encoder/EncoderContext;->getCodewords()Ljava/lang/StringBuilder;
...
.method private static isNativeX12(C)Z
    ...
    .line 399
    invoke-static/range {p0 .. p0}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isX12TermSep(C)Z
...
.method static lookAheadTest(Ljava/lang/CharSequence;II)I
    ...
    .line 227
    invoke-static/range {v0 .. v0}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->getMinimumCount([B)I
    ...
    .line 251
    invoke-static/range {v6 .. v6}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isDigit(C)Z
    ...
    .line 253
    :cond_9
    invoke-static/range {v6 .. v6}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isExtendedASCII(C)Z
    ...
    invoke-static/range {v8 .. v9}, Ljava/lang/Math;->ceil(D)D
    ...
    invoke-static/range {v7 .. v8}, Ljava/lang/Math;->ceil(D)D
    ...
    .line 262
    :goto_1
    invoke-static/range {v6 .. v6}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isNativeC40(C)Z
    ...
    .line 271
    :goto_2
    invoke-static/range {v6 .. v6}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isNativeText(C)Z
    ...
    .line 280
    :goto_3
    invoke-static/range {v6 .. v6}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isNativeX12(C)Z
    ...
    .line 289
    :goto_4
    invoke-static/range {v6 .. v6}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isNativeEDIFACT(C)Z
    ...
    .line 298
    :goto_5
    invoke-static/range {v6 .. v6}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isSpecialB256(C)Z
    ...
    .line 309
    invoke-static/range {v8 .. v8}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->getMinimumCount([B)I
    ...
    .line 342
    invoke-static/range {v2 .. v2}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isX12TermSep(C)Z
    ...
    .line 345
    :cond_1a
    invoke-static/range {v2 .. v2}, Lcom/google/zxing/datamatrix/encoder/HighLevelEncoder;->isNativeX12(C)Z
