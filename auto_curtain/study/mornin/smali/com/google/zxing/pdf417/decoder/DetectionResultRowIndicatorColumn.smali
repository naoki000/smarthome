...
.method constructor <init>(Lcom/google/zxing/pdf417/decoder/BoundingBox;Z)V
    ...
    .line 30
    invoke-direct/range {p0 .. p1}, Lcom/google/zxing/pdf417/decoder/DetectionResultColumn;-><init>(Lcom/google/zxing/pdf417/decoder/BoundingBox;)V
...
.method private adjustIncompleteIndicatorColumnRowNumbers(Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/pdf417/decoder/BoundingBox;->getTopLeft()Lcom/google/zxing/ResultPoint;
    ...
    :cond_0
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/pdf417/decoder/BoundingBox;->getTopRight()Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/pdf417/decoder/BoundingBox;->getBottomLeft()Lcom/google/zxing/ResultPoint;
    ...
    :cond_1
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/pdf417/decoder/BoundingBox;->getBottomRight()Lcom/google/zxing/ResultPoint;
    ...
    .line 153
    invoke-virtual/range {v7 .. v7}, Lcom/google/zxing/pdf417/decoder/Codeword;->setRowNumberAsRowIndicatorColumn()V

    .line 155
    invoke-virtual/range {v7 .. v7}, Lcom/google/zxing/pdf417/decoder/Codeword;->getRowNumber()I
...
.method private removeIncorrectCodewords([Lcom/google/zxing/pdf417/decoder/Codeword;Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;)V
    ...
    .line 228
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/pdf417/decoder/Codeword;->getValue()I
    ...
    .line 229
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/pdf417/decoder/Codeword;->getRowNumber()I

    move-result v1

    .line 230
    invoke-virtual/range {p2 .. p2}, Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;->getRowCount()I
    ...
    .line 250
    invoke-virtual/range {p2 .. p2}, Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;->getColumnCount()I
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;->getErrorCorrectionLevel()I
    ...
    .line 245
    invoke-virtual/range {p2 .. p2}, Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;->getRowCountLowerPart()I
    ...
    .line 239
    invoke-virtual/range {p2 .. p2}, Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;->getRowCountUpperPart()I
...
.method private setRowNumbers()V
    ...
    .line 37
    invoke-virtual/range {v3 .. v3}, Lcom/google/zxing/pdf417/decoder/Codeword;->setRowNumberAsRowIndicatorColumn()V
...
.method adjustCompleteIndicatorColumnRowNumbers(Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;)V
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/pdf417/decoder/BoundingBox;->getTopLeft()Lcom/google/zxing/ResultPoint;
    ...
    :cond_0
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/pdf417/decoder/BoundingBox;->getTopRight()Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/pdf417/decoder/BoundingBox;->getBottomLeft()Lcom/google/zxing/ResultPoint;
    ...
    :cond_1
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/pdf417/decoder/BoundingBox;->getBottomRight()Lcom/google/zxing/ResultPoint;

    move-result-object v1

    .line 53
    :goto_1
    invoke-virtual/range {v2 .. v2}, Lcom/google/zxing/ResultPoint;->getY()F
...
.method getBarcodeMetadata()Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;
    ...
    invoke-direct/range {v1 .. v1}, Lcom/google/zxing/pdf417/decoder/BarcodeValue;-><init>()V

    .line 178
    new-instance v2, Lcom/google/zxing/pdf417/decoder/BarcodeValue;

    invoke-direct/range {v2 .. v2}, Lcom/google/zxing/pdf417/decoder/BarcodeValue;-><init>()V

    .line 179
    new-instance v3, Lcom/google/zxing/pdf417/decoder/BarcodeValue;

    invoke-direct/range {v3 .. v3}, Lcom/google/zxing/pdf417/decoder/BarcodeValue;-><init>()V

    .line 180
    new-instance v4, Lcom/google/zxing/pdf417/decoder/BarcodeValue;

    invoke-direct/range {v4 .. v4}, Lcom/google/zxing/pdf417/decoder/BarcodeValue;-><init>()V
    ...
    .line 185
    invoke-virtual/range {v9 .. v9}, Lcom/google/zxing/pdf417/decoder/Codeword;->setRowNumberAsRowIndicatorColumn()V

    .line 186
    invoke-virtual/range {v9 .. v9}, Lcom/google/zxing/pdf417/decoder/Codeword;->getValue()I
    ...
    .line 187
    invoke-virtual/range {v9 .. v9}, Lcom/google/zxing/pdf417/decoder/Codeword;->getRowNumber()I
    ...
    .line 205
    :cond_2
    invoke-virtual/range {v1 .. v1}, Lcom/google/zxing/pdf417/decoder/BarcodeValue;->getValue()[I
    ...
    .line 206
    invoke-virtual/range {v2 .. v2}, Lcom/google/zxing/pdf417/decoder/BarcodeValue;->getValue()[I
    ...
    .line 207
    invoke-virtual/range {v3 .. v3}, Lcom/google/zxing/pdf417/decoder/BarcodeValue;->getValue()[I
    ...
    .line 208
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/pdf417/decoder/BarcodeValue;->getValue()[I
...
.method getRowHeights()[I
    ...
    .line 119
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/pdf417/decoder/BarcodeMetadata;->getRowCount()I
    ...
    .line 122
    invoke-virtual/range {v4 .. v4}, Lcom/google/zxing/pdf417/decoder/Codeword;->getRowNumber()I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-super/range {p0 .. p0}, Lcom/google/zxing/pdf417/decoder/DetectionResultColumn;->toString()Ljava/lang/String;
