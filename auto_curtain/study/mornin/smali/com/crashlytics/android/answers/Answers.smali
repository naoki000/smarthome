...
.method protected doInBackground()Ljava/lang/Boolean;
    ...
    .line 438
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/answers/Answers;->getOverridenSpiEndpoint()Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/crashlytics/android/answers/SessionAnalyticsManager;->disable()V
...
.method protected bridge synthetic doInBackground()Ljava/lang/Object;
    ...
    .line 21
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/answers/Answers;->doInBackground()Ljava/lang/Boolean;
...
.method public onException(Lio/fabric/sdk/android/services/common/Crash$FatalException;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/services/common/Crash$FatalException;->getSessionId()Ljava/lang/String;

    move-result-object v1

    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/services/common/Crash$FatalException;->getExceptionName()Ljava/lang/String;
...
.method public onException(Lio/fabric/sdk/android/services/common/Crash$LoggedException;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/services/common/Crash$LoggedException;->getSessionId()Ljava/lang/String;
...
.method protected onPreExecute()Z
    ...
    .line 397
    invoke-virtual/range {v8 .. v8}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v1

    .line 398
    invoke-virtual/range {v8 .. v8}, Landroid/content/Context;->getPackageName()Ljava/lang/String;
    ...
    invoke-static/range {v4 .. v4}, Ljava/lang/Integer;->toString(I)Ljava/lang/String;
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/io/File;->lastModified()J
    ...
    invoke-virtual/range {v1 .. v1}, Lcom/crashlytics/android/answers/SessionAnalyticsManager;->enable()V

    .line 417
    new-instance v1, Lio/fabric/sdk/android/services/common/FirebaseInfo;

    invoke-direct/range {v1 .. v1}, Lio/fabric/sdk/android/services/common/FirebaseInfo;-><init>()V
