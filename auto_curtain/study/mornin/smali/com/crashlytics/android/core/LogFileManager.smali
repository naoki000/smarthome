...
.method private getWorkingFileForSession(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-interface/range {v1 .. v1}, Lcom/crashlytics/android/core/LogFileManager$DirectoryProvider;->getLogFileDir()Ljava/io/File;
...
.method clearLog()V
    ...
    invoke-interface/range {v0 .. v0}, Lcom/crashlytics/android/core/FileLogStore;->deleteLogFile()V
...
.method discardOldLogFiles(Ljava/util/Set;)V
    ...
    invoke-interface/range {v0 .. v0}, Lcom/crashlytics/android/core/LogFileManager$DirectoryProvider;->getLogFileDir()Ljava/io/File;
...
.method getByteStringForLog()Lcom/crashlytics/android/core/ByteString;
    ...
    invoke-interface/range {v0 .. v0}, Lcom/crashlytics/android/core/FileLogStore;->getLogAsByteString()Lcom/crashlytics/android/core/ByteString;
...
.method getBytesForLog()[B
    ...
    invoke-interface/range {v0 .. v0}, Lcom/crashlytics/android/core/FileLogStore;->getLogAsBytes()[B
...
.method final setCurrentSession(Ljava/lang/String;)V
    ...
    invoke-interface/range {v0 .. v0}, Lcom/crashlytics/android/core/FileLogStore;->closeLogFile()V
    ...
    .line 67
    :cond_1
    invoke-direct/range {p0 .. p1}, Lcom/crashlytics/android/core/LogFileManager;->getWorkingFileForSession(Ljava/lang/String;)Ljava/io/File;
