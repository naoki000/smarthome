...
.method constructor <init>(FLcom/crashlytics/android/core/CrashlyticsListener;Lcom/crashlytics/android/core/PinningInfoProvider;Z)V
    ...
    .line 181
    invoke-static/range {v0 .. v0}, Lio/fabric/sdk/android/services/common/ExecutorUtils;->buildSingleThreadExecutorService(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
...
.method constructor <init>(FLcom/crashlytics/android/core/CrashlyticsListener;Lcom/crashlytics/android/core/PinningInfoProvider;ZLjava/util/concurrent/ExecutorService;)V
    ...
    .line 189
    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/Kit;-><init>()V
    ...
    invoke-direct/range {p1 .. p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V
...
.method private checkForPreviousCrash()V
    ...
    invoke-interface/range {v0 .. v0}, Lcom/crashlytics/android/core/CrashlyticsListener;->crashlyticsDidDetectCrashDuringPreviousExecution()V
    :try_end_0
...
.method private doLog(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 429
    invoke-static/range {v0 .. v0}, Lcom/crashlytics/android/core/CrashlyticsCore;->ensureFabricWithCalled(Ljava/lang/String;)Z
    ...
    invoke-static/range {p1 .. p3}, Lcom/crashlytics/android/core/CrashlyticsCore;->formatLogMessage(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private finishInitSynchronously()V
    ...
    .line 696
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->getDependencies()Ljava/util/Collection;
    ...
    .line 700
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->getFabric()Lio/fabric/sdk/android/Fabric;

    move-result-object v1

    invoke-virtual/range {v1 .. v1}, Lio/fabric/sdk/android/Fabric;->getExecutorService()Ljava/util/concurrent/ExecutorService;
...
.method private static formatLogMessage(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->logPriorityToString(I)Ljava/lang/String;
...
.method static isBuildIdValid(Ljava/lang/String;Z)Z
    ...
    .line 883
    :cond_0
    invoke-static/range {p0 .. p0}, Lio/fabric/sdk/android/services/common/CommonUtils;->isNullOrEmpty(Ljava/lang/String;)Z
...
.method public crash()V
    ...
    invoke-direct/range {v0 .. v0}, Lcom/crashlytics/android/core/CrashTest;-><init>()V

    invoke-virtual/range {v0 .. v0}, Lcom/crashlytics/android/core/CrashTest;->indexOutOfBounds()V
...
.method createCrashMarker()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/crashlytics/android/core/CrashlyticsFileMarker;->create()Z
...
.method protected bridge synthetic doInBackground()Ljava/lang/Object;
    ...
    .line 44
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->doInBackground()Ljava/lang/Void;
...
.method protected doInBackground()Ljava/lang/Void;
    ...
    .line 305
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->markInitializationStarted()V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/crashlytics/android/core/CrashlyticsController;->cleanInvalidTempFiles()V
    ...
    invoke-virtual/range {v1 .. v1}, Lio/fabric/sdk/android/services/settings/Settings;->awaitSettingsData()Lio/fabric/sdk/android/services/settings/SettingsData;
    ...
    .line 349
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->markInitializationComplete()V
    ...
    :cond_1
    :try_start_2
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->getNativeCrashData()Lcom/crashlytics/android/core/CrashlyticsNdkData;
...
.method getNativeCrashData()Lcom/crashlytics/android/core/CrashlyticsNdkData;
    ...
    invoke-interface/range {v0 .. v0}, Lcom/crashlytics/android/core/CrashlyticsNdkDataProvider;->getCrashlyticsNdkData()Lcom/crashlytics/android/core/CrashlyticsNdkData;
...
.method getUserEmail()Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/common/IdManager;->canCollectUserIds()Z
...
.method internalVerifyPinning(Ljava/net/URL;)Z
    ...
    .line 779
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/core/CrashlyticsCore;->getPinningInfoProvider()Lcom/crashlytics/android/core/PinningInfoProvider;
    ...
    .line 782
    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/services/network/HttpRequest;->getConnection()Ljava/net/HttpURLConnection;
    ...
    .line 786
    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/services/network/HttpRequest;->code()I
...
.method public log(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 451
    invoke-direct/range {p0 .. p3}, Lcom/crashlytics/android/core/CrashlyticsCore;->doLog(ILjava/lang/String;Ljava/lang/String;)V
...
.method protected onPreExecute()Z
    ...
    .line 206
    invoke-super/range {p0 .. p0}, Lio/fabric/sdk/android/Kit;->getContext()Landroid/content/Context;
...
.method onPreExecute(Landroid/content/Context;)Z
    ...
    invoke-direct/range {v1 .. v1}, Lio/fabric/sdk/android/services/common/ApiKey;-><init>()V
    ...
    invoke-direct/range {v2 .. v2}, Lio/fabric/sdk/android/services/common/FirebaseInfo;-><init>()V
...
.method public setFloat(Ljava/lang/String;F)V
    ...
    .line 592
    invoke-static/range {p2 .. p2}, Ljava/lang/Float;->toString(F)Ljava/lang/String;
...
.method public setString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 546
    invoke-static/range {p1 .. p1}, Lio/fabric/sdk/android/services/common/CommonUtils;->isAppDebuggable(Landroid/content/Context;)Z
    ...
    .line 555
    :cond_4
    invoke-static/range {p1 .. p1}, Lcom/crashlytics/android/core/CrashlyticsCore;->sanitizeAttribute(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/concurrent/ConcurrentHashMap;->size()I
    ...
    .line 563
    :cond_6
    invoke-static/range {p2 .. p2}, Lcom/crashlytics/android/core/CrashlyticsCore;->sanitizeAttribute(Ljava/lang/String;)Ljava/lang/String;
...
.method public verifyPinning(Ljava/net/URL;)Z
    ...
    .line 630
    :try_start_0
    invoke-virtual/range {p0 .. p1}, Lcom/crashlytics/android/core/CrashlyticsCore;->internalVerifyPinning(Ljava/net/URL;)Z
