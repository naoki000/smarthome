...
.method private static binaryImagesJsonFromFile(Ljava/io/File;Landroid/content/Context;)[B
    ...
    .line 66
    invoke-static/range {p0 .. p0}, Lcom/crashlytics/android/core/NativeFileUtils;->readFile(Ljava/io/File;)[B
...
.method static minidumpFromDirectory(Ljava/io/File;)[B
    ...
    :cond_0
    invoke-static/range {p0 .. p0}, Lcom/crashlytics/android/core/NativeFileUtils;->minidumpFromFile(Ljava/io/File;)[B
...
.method private static processBinaryImages(Landroid/content/Context;Ljava/lang/String;)[B
    ...
    invoke-direct/range {v1 .. v1}, Lcom/crashlytics/android/core/Sha1FileIdStrategy;-><init>()V
...
.method private static readBytes(Ljava/io/InputStream;)[B
    ...
    invoke-direct/range {v1 .. v1}, Ljava/io/ByteArrayOutputStream;-><init>()V
    ...
    .line 37
    :cond_0
    invoke-virtual/range {v1 .. v1}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B
...
.method static readFile(Ljava/io/File;)[B
    ...
    .line 20
    :try_start_1
    invoke-static/range {v1 .. v1}, Lcom/crashlytics/android/core/NativeFileUtils;->readBytes(Ljava/io/InputStream;)[B
