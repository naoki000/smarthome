...
.method public constructor <init>()V
    ...
    invoke-direct/range {v0 .. v0}, Lio/fabric/sdk/android/services/cache/MemoryValueCache;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Lcom/crashlytics/android/beta/DeviceTokenLoader;-><init>()V
...
.method private loadBuildProperties(Landroid/content/Context;)Lcom/crashlytics/android/beta/BuildProperties;
    ...
    .line 175
    :try_start_1
    invoke-static/range {p1 .. p1}, Lcom/crashlytics/android/beta/BuildProperties;->fromPropertiesStream(Ljava/io/InputStream;)Lcom/crashlytics/android/beta/BuildProperties;
...
.method createUpdatesController(ILandroid/app/Application;)Lcom/crashlytics/android/beta/UpdatesController;
    ...
    .line 102
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/beta/Beta;->getFabric()Lio/fabric/sdk/android/Fabric;

    move-result-object p1

    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/Fabric;->getActivityLifecycleManager()Lio/fabric/sdk/android/ActivityLifecycleManager;
    ...
    invoke-virtual/range {p2 .. p2}, Lio/fabric/sdk/android/Fabric;->getExecutorService()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct/range {p1 .. p1}, Lcom/crashlytics/android/beta/ImmediateCheckForUpdatesController;-><init>()V
...
.method protected doInBackground()Ljava/lang/Boolean;
    ...
    .line 62
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/beta/Beta;->getContext()Landroid/content/Context;

    move-result-object v4

    .line 63
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/beta/Beta;->getIdManager()Lio/fabric/sdk/android/services/common/IdManager;

    move-result-object v6

    .line 64
    invoke-virtual/range {v6 .. v6}, Lio/fabric/sdk/android/services/common/IdManager;->getInstallerPackageName()Ljava/lang/String;
    ...
    .line 74
    invoke-direct/range {p0 .. p0}, Lcom/crashlytics/android/beta/Beta;->getBetaSettingsData()Lio/fabric/sdk/android/services/settings/BetaSettingsData;
    ...
    invoke-direct/range {v10 .. v10}, Lio/fabric/sdk/android/services/common/SystemCurrentTimeProvider;-><init>()V
...
.method protected bridge synthetic doInBackground()Ljava/lang/Object;
    ...
    .line 30
    invoke-virtual/range {p0 .. p0}, Lcom/crashlytics/android/beta/Beta;->doInBackground()Ljava/lang/Boolean;
...
.method public getDeviceIdentifiers()Ljava/util/Map;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/common/IdManager;->getInstallerPackageName()Ljava/lang/String;
