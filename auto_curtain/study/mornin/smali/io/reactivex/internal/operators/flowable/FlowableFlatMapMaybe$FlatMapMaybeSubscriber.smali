...
.method drain()V
    ...
    .line 279
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->getAndIncrement()I
    ...
    .line 280
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->drainLoop()V
...
.method drainLoop()V
    ...
    invoke-virtual/range {v14 .. v14}, Lio/reactivex/internal/util/AtomicThrowable;->get()Ljava/lang/Object;
    ...
    invoke-virtual/range {v2 .. v2}, Lio/reactivex/internal/util/AtomicThrowable;->terminate()Ljava/lang/Throwable;
    ...
    .line 317
    :cond_2
    invoke-virtual/range {v2 .. v2}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I
    ...
    .line 319
    invoke-virtual/range {v15 .. v15}, Lio/reactivex/internal/queue/SpscLinkedArrayQueue;->poll()Ljava/lang/Object;
    ...
    .line 327
    :cond_6
    invoke-interface/range {v1 .. v1}, Lorg/reactivestreams/Subscriber;->onComplete()V
    ...
    invoke-virtual/range {v6 .. v6}, Lio/reactivex/internal/util/AtomicThrowable;->get()Ljava/lang/Object;
...
.method innerComplete(Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber$InnerObserver;)V
    ...
    .line 248
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->get()I
    ...
    invoke-virtual/range {v4 .. v4}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I
    ...
    .line 252
    invoke-virtual/range {v3 .. v3}, Lio/reactivex/internal/queue/SpscLinkedArrayQueue;->isEmpty()Z
    ...
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/internal/util/AtomicThrowable;->terminate()Ljava/lang/Throwable;
    ...
    .line 265
    :cond_4
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->decrementAndGet()I
    ...
    .line 274
    :cond_7
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->drain()V
...
.method innerSuccess(Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber$InnerObserver;Ljava/lang/Object;)V
    ...
    invoke-virtual/range {v1 .. v1}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I
    ...
    .line 179
    invoke-virtual/range {p2 .. p2}, Lio/reactivex/internal/queue/SpscLinkedArrayQueue;->isEmpty()Z
    ...
    .line 193
    :cond_4
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->getOrCreateQueue()Lio/reactivex/internal/queue/SpscLinkedArrayQueue;
...
.method public onComplete()V
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I
