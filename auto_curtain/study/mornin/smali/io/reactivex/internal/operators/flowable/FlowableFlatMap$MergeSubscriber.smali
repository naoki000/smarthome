...
.method constructor <init>(Lorg/reactivestreams/Subscriber;Lio/reactivex/functions/Function;ZII)V
    ...
    .line 98
    invoke-direct/range {p0 .. p0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    .line 76
    new-instance v0, Lio/reactivex/internal/util/AtomicThrowable;

    invoke-direct/range {v0 .. v0}, Lio/reactivex/internal/util/AtomicThrowable;-><init>()V
    ...
    invoke-direct/range {v0 .. v0}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V
...
.method addInner(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)Z
    ...
    .line 172
    invoke-virtual/range {p1 .. p1}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->dispose()V
...
.method public cancel()V
    ...
    .line 354
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->disposeAll()V
    ...
    .line 358
    invoke-interface/range {v0 .. v0}, Lio/reactivex/internal/fuseable/SimpleQueue;->clear()V
...
.method checkTerminate()Z
    ...
    .line 559
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->clearScalarQueue()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/internal/util/AtomicThrowable;->get()Ljava/lang/Object;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/reactivex/internal/util/AtomicThrowable;->terminate()Ljava/lang/Throwable;
...
.method disposeAll()V
    ...
    .line 586
    invoke-virtual/range {v3 .. v3}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->dispose()V
    ...
    .line 590
    invoke-static/range {v0 .. v0}, Lio/reactivex/plugins/RxJavaPlugins;->onError(Ljava/lang/Throwable;)V
...
.method drain()V
    ...
    .line 366
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->drainLoop()V
...
.method drainLoop()V
    ...
    invoke-virtual/range {v5 .. v5}, Ljava/util/concurrent/atomic/AtomicLong;->get()J
    ...
    .line 389
    invoke-interface/range {v0 .. v0}, Lio/reactivex/internal/fuseable/SimplePlainQueue;->poll()Ljava/lang/Object;
    ...
    invoke-virtual/range {v8 .. v8}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;
    ...
    .line 422
    invoke-interface/range {v7 .. v7}, Lio/reactivex/internal/fuseable/SimplePlainQueue;->isEmpty()Z
    ...
    .line 426
    invoke-interface/range {v2 .. v2}, Lorg/reactivestreams/Subscriber;->onComplete()V
    ...
    .line 480
    :try_start_0
    invoke-interface/range {v12 .. v12}, Lio/reactivex/internal/fuseable/SimpleQueue;->poll()Ljava/lang/Object;
    ...
    .line 482
    invoke-static/range {v10 .. v10}, Lio/reactivex/exceptions/Exceptions;->throwIfFatal(Ljava/lang/Throwable;)V

    .line 483
    invoke-virtual/range {v7 .. v7}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->dispose()V
    ...
    .line 523
    invoke-interface/range {v11 .. v11}, Lio/reactivex/internal/fuseable/SimpleQueue;->isEmpty()Z
...
.method innerError(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;Ljava/lang/Throwable;)V
    ...
    .line 602
    invoke-virtual/range {v1 .. v1}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->dispose()V
    ...
    .line 605
    :cond_0
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->drain()V

    goto :goto_1

    .line 607
    :cond_1
    invoke-static/range {p2 .. p2}, Lio/reactivex/plugins/RxJavaPlugins;->onError(Ljava/lang/Throwable;)V
...
.method tryEmit(Ljava/lang/Object;Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)V
    ...
    .line 278
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->get()I
    ...
    .line 281
    invoke-interface/range {v2 .. v2}, Lio/reactivex/internal/fuseable/SimpleQueue;->isEmpty()Z
    ...
    invoke-virtual/range {p1 .. p1}, Ljava/util/concurrent/atomic/AtomicLong;->decrementAndGet()J
    ...
    :cond_4
    :goto_0
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->decrementAndGet()I
...
.method tryEmitScalar(Ljava/lang/Object;)V
    ...
    invoke-virtual/range {v2 .. v2}, Ljava/util/concurrent/atomic/AtomicLong;->get()J
    ...
    .line 233
    invoke-interface/range {v4 .. v4}, Lio/reactivex/internal/fuseable/SimpleQueue;->isEmpty()Z
    ...
    .line 245
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->getMainQueue()Lio/reactivex/internal/fuseable/SimpleQueue;
