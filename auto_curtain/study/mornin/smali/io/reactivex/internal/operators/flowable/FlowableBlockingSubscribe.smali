...
.method public static subscribe(Lorg/reactivestreams/Publisher;)V
    ...
    invoke-direct/range {v0 .. v0}, Lio/reactivex/internal/util/BlockingIgnoringReceiver;-><init>()V
...
.method public static subscribe(Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Subscriber;)V
    ...
    invoke-direct/range {v0 .. v0}, Ljava/util/concurrent/LinkedBlockingQueue;-><init>()V
    ...
    :cond_0
    :try_start_0
    invoke-virtual/range {v1 .. v1}, Lio/reactivex/internal/subscribers/BlockingSubscriber;->isCancelled()Z
    ...
    .line 55
    :cond_1
    invoke-interface/range {v0 .. v0}, Ljava/util/concurrent/BlockingQueue;->poll()Ljava/lang/Object;
    ...
    .line 61
    invoke-interface/range {v0 .. v0}, Ljava/util/concurrent/BlockingQueue;->take()Ljava/lang/Object;
    ...
    .line 72
    invoke-virtual/range {v1 .. v1}, Lio/reactivex/internal/subscribers/BlockingSubscriber;->cancel()V
