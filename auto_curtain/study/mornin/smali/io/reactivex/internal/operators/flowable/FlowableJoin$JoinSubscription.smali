...
.method drain()V
    ...
    .line 183
    invoke-virtual/range {v2 .. v2}, Lio/reactivex/internal/queue/SpscLinkedArrayQueue;->clear()V
    ...
    invoke-virtual/range {v5 .. v5}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I
    ...
    .line 197
    :goto_1
    invoke-virtual/range {v2 .. v2}, Lio/reactivex/internal/queue/SpscLinkedArrayQueue;->poll()Ljava/lang/Object;
    ...
    invoke-interface/range {v8 .. v8}, Ljava/util/Map;->values()Ljava/util/Collection;

    move-result-object v8

    invoke-interface/range {v8 .. v8}, Ljava/util/Collection;->iterator()Ljava/util/Iterator;
...
.method public innerClose(ZLio/reactivex/internal/operators/flowable/FlowableGroupJoin$LeftRightEndSubscriber;)V
    ...
    .line 389
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->drain()V
