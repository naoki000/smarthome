...
.method public static checkTerminated(ZZLio/reactivex/Observer;ZLio/reactivex/internal/fuseable/SimpleQueue;Lio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/ObservableQueueDrain;)Z
    ...
    .line 162
    invoke-interface/range {p6 .. p6}, Lio/reactivex/internal/util/ObservableQueueDrain;->cancelled()Z
    ...
    .line 163
    invoke-interface/range {p4 .. p4}, Lio/reactivex/internal/fuseable/SimpleQueue;->clear()V

    .line 164
    invoke-interface/range {p5 .. p5}, Lio/reactivex/disposables/Disposable;->dispose()V
    ...
    .line 174
    :cond_1
    invoke-interface/range {p6 .. p6}, Lio/reactivex/internal/util/ObservableQueueDrain;->error()Ljava/lang/Throwable;
    ...
    .line 178
    :cond_2
    invoke-interface/range {p2 .. p2}, Lio/reactivex/Observer;->onComplete()V
...
.method public static checkTerminated(ZZLorg/reactivestreams/Subscriber;ZLio/reactivex/internal/fuseable/SimpleQueue;Lio/reactivex/internal/util/QueueDrain;)Z
    ...
    .line 95
    invoke-interface/range {p5 .. p5}, Lio/reactivex/internal/util/QueueDrain;->cancelled()Z
    ...
    .line 103
    invoke-interface/range {p5 .. p5}, Lio/reactivex/internal/util/QueueDrain;->error()Ljava/lang/Throwable;
    ...
    .line 107
    :cond_1
    invoke-interface/range {p2 .. p2}, Lorg/reactivestreams/Subscriber;->onComplete()V
...
.method public static drainLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lio/reactivex/Observer;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/ObservableQueueDrain;)V
    ...
    invoke-interface/range {p0 .. p0}, Lio/reactivex/internal/fuseable/SimplePlainQueue;->isEmpty()Z
    ...
    .line 139
    invoke-interface/range {p0 .. p0}, Lio/reactivex/internal/fuseable/SimplePlainQueue;->poll()Ljava/lang/Object;
...
.method public static drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lorg/reactivestreams/Subscriber;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
    ...
    :cond_0
    :goto_0
    invoke-interface/range {p4 .. p4}, Lio/reactivex/internal/util/QueueDrain;->done()Z
    ...
    .line 60
    invoke-interface/range {p3 .. p3}, Lio/reactivex/disposables/Disposable;->dispose()V
    ...
    .line 69
    :cond_4
    invoke-interface/range {p4 .. p4}, Lio/reactivex/internal/util/QueueDrain;->requested()J
    ...
    .line 77
    :cond_5
    invoke-interface/range {p0 .. p0}, Lio/reactivex/internal/fuseable/SimplePlainQueue;->clear()V
...
.method static isCancelled(Lio/reactivex/functions/BooleanSupplier;)Z
    ...
    .line 283
    :try_start_0
    invoke-interface/range {p0 .. p0}, Lio/reactivex/functions/BooleanSupplier;->getAsBoolean()Z
    ...
    .line 285
    invoke-static/range {p0 .. p0}, Lio/reactivex/exceptions/Exceptions;->throwIfFatal(Ljava/lang/Throwable;)V
...
.method static postCompleteDrain(JLorg/reactivestreams/Subscriber;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    ...
    .line 331
    invoke-static/range {p5 .. p5}, Lio/reactivex/internal/util/QueueDrainHelper;->isCancelled(Lio/reactivex/functions/BooleanSupplier;)Z
    ...
    .line 335
    :cond_1
    invoke-interface/range {p3 .. p3}, Ljava/util/Queue;->poll()Ljava/lang/Object;
    ...
    .line 350
    :cond_4
    invoke-interface/range {p3 .. p3}, Ljava/util/Queue;->isEmpty()Z
