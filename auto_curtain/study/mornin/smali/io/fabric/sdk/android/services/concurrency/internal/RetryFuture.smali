...
.method constructor <init>(Ljava/util/concurrent/Callable;Lio/fabric/sdk/android/services/concurrency/internal/RetryState;Lio/fabric/sdk/android/services/concurrency/internal/RetryThreadPoolExecutor;)V
    ...
    .line 30
    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/services/concurrency/internal/AbstractFuture;-><init>()V
...
.method private getBackoff()Lio/fabric/sdk/android/services/concurrency/internal/Backoff;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/concurrency/internal/RetryState;->getBackoff()Lio/fabric/sdk/android/services/concurrency/internal/Backoff;
...
.method private getRetryCount()I
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/concurrency/internal/RetryState;->getRetryCount()I
...
.method private getRetryPolicy()Lio/fabric/sdk/android/services/concurrency/internal/RetryPolicy;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/concurrency/internal/RetryState;->getRetryPolicy()Lio/fabric/sdk/android/services/concurrency/internal/RetryPolicy;
...
.method public run()V
    ...
    .line 39
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/services/concurrency/internal/RetryFuture;->isDone()Z
    ...
    .line 47
    :try_start_1
    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/services/concurrency/internal/RetryFuture;->getRetryPolicy()Lio/fabric/sdk/android/services/concurrency/internal/RetryPolicy;

    move-result-object v1

    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/services/concurrency/internal/RetryFuture;->getRetryCount()I
    ...
    .line 48
    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/services/concurrency/internal/RetryFuture;->getBackoff()Lio/fabric/sdk/android/services/concurrency/internal/Backoff;
    ...
    invoke-virtual/range {v3 .. v3}, Lio/fabric/sdk/android/services/concurrency/internal/RetryState;->nextRetryState()Lio/fabric/sdk/android/services/concurrency/internal/RetryState;
