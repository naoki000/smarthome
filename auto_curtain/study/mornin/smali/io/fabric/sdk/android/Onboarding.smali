...
.method public constructor <init>(Ljava/util/concurrent/Future;Ljava/util/Collection;)V
    ...
    invoke-direct/range {v0 .. v0}, Lio/fabric/sdk/android/services/network/DefaultHttpRequestFactory;-><init>()V
...
.method private buildAppRequest(Lio/fabric/sdk/android/services/settings/IconRequest;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/AppRequestData;
    ...
    invoke-direct/range {v2 .. v2}, Lio/fabric/sdk/android/services/common/ApiKey;-><init>()V
    ...
    .line 210
    invoke-static/range {v1 .. v1}, Lio/fabric/sdk/android/services/common/CommonUtils;->resolveBuildId(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static/range {v2 .. v2}, Lio/fabric/sdk/android/services/common/CommonUtils;->createInstanceIdFrom([Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v1}, Lio/fabric/sdk/android/services/common/IdManager;->getAppIdentifier()Ljava/lang/String;
...
.method private performAutoConfigure(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
    ...
    .line 157
    invoke-direct/range {p0 .. p3}, Lio/fabric/sdk/android/Onboarding;->performCreateApp(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
    ...
    invoke-virtual/range {p1 .. p1}, Lio/fabric/sdk/android/services/settings/Settings;->loadSettingsSkippingCache()Z
    ...
    .line 175
    invoke-direct/range {p0 .. p3}, Lio/fabric/sdk/android/Onboarding;->performUpdateApp(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
...
.method private performCreateApp(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/AppSettingsData;Ljava/util/Collection;)Z
    ...
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/Onboarding;->getOverridenSpiEndpoint()Ljava/lang/String;
...
.method private retrieveSettingsData()Lio/fabric/sdk/android/services/settings/SettingsData;
    ...
    .line 126
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/settings/Settings;->loadSettingsData()Z
    ...
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/services/settings/Settings;->awaitSettingsData()Lio/fabric/sdk/android/services/settings/SettingsData;
...
.method protected doInBackground()Ljava/lang/Boolean;
    ...
    invoke-static/range {v0 .. v0}, Lio/fabric/sdk/android/services/common/CommonUtils;->getAppIconHashOrNull(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    .line 99
    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/Onboarding;->retrieveSettingsData()Lio/fabric/sdk/android/services/settings/SettingsData;
    ...
    .line 113
    invoke-interface/range {v2 .. v2}, Ljava/util/Map;->values()Ljava/util/Collection;
...
.method protected bridge synthetic doInBackground()Ljava/lang/Object;
    ...
    .line 45
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/Onboarding;->doInBackground()Ljava/lang/Boolean;
...
.method mergeKits(Ljava/util/Map;Ljava/util/Collection;)Ljava/util/Map;
    ...
    .line 138
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/Kit;->getIdentifier()Ljava/lang/String;
    ...
    .line 140
    invoke-virtual/range {v0 .. v0}, Lio/fabric/sdk/android/Kit;->getVersion()Ljava/lang/String;
...
.method protected onPreExecute()Z
    ...
    invoke-virtual/range {v1 .. v1}, Lio/fabric/sdk/android/services/common/IdManager;->getInstallerPackageName()Ljava/lang/String;
    ...
    invoke-virtual/range {v2 .. v2}, Landroid/content/Context;->getApplicationInfo()Landroid/content/pm/ApplicationInfo;
    ...
    .line 84
    invoke-interface/range {v1 .. v1}, Ljava/lang/CharSequence;->toString()Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/content/Context;->getApplicationInfo()Landroid/content/pm/ApplicationInfo;
