...
.method private findImplicitKits()Ljava/util/Map;
    ...
    .line 70
    invoke-virtual/range {v1 .. v1}, Lio/fabric/sdk/android/KitInfo;->getIdentifier()Ljava/lang/String;
...
.method private findRegisteredKits()Ljava/util/Map;
    ...
    .line 83
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/FabricKitsFinder;->loadApkFile()Ljava/util/zip/ZipFile;

    move-result-object v1

    .line 84
    invoke-virtual/range {v1 .. v1}, Ljava/util/zip/ZipFile;->entries()Ljava/util/Enumeration;
    ...
    :cond_0
    :goto_0
    invoke-interface/range {v2 .. v2}, Ljava/util/Enumeration;->hasMoreElements()Z
    ...
    .line 86
    invoke-interface/range {v2 .. v2}, Ljava/util/Enumeration;->nextElement()Ljava/lang/Object;
    ...
    .line 88
    invoke-virtual/range {v3 .. v3}, Ljava/util/zip/ZipEntry;->getName()Ljava/lang/String;
    ...
    .line 92
    invoke-virtual/range {v3 .. v3}, Lio/fabric/sdk/android/KitInfo;->getIdentifier()Ljava/lang/String;
    ...
    .line 95
    invoke-virtual/range {v3 .. v3}, Lio/fabric/sdk/android/KitInfo;->getVersion()Ljava/lang/String;
    ...
    .line 103
    :try_start_0
    invoke-virtual/range {v1 .. v1}, Ljava/util/zip/ZipFile;->close()V
    :try_end_0
...
.method private loadKitInfo(Ljava/util/zip/ZipEntry;Ljava/util/zip/ZipFile;)Lio/fabric/sdk/android/KitInfo;
    ...
    invoke-direct/range {v1 .. v1}, Ljava/util/Properties;-><init>()V
    ...
    .line 128
    invoke-static/range {p2 .. p2}, Lio/fabric/sdk/android/services/common/CommonUtils;->closeQuietly(Ljava/io/Closeable;)V
...
.method public bridge synthetic call()Ljava/lang/Object;
    ...
    .line 35
    invoke-virtual/range {p0 .. p0}, Lio/fabric/sdk/android/FabricKitsFinder;->call()Ljava/util/Map;
...
.method public call()Ljava/util/Map;
    ...
    .line 52
    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/FabricKitsFinder;->findImplicitKits()Ljava/util/Map;
    ...
    .line 54
    invoke-direct/range {p0 .. p0}, Lio/fabric/sdk/android/FabricKitsFinder;->findRegisteredKits()Ljava/util/Map;
