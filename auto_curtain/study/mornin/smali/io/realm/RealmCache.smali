...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v0}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V
...
.method static synthetic access$900(Ljava/lang/String;Ljava/io/File;)V
    ...
    .line 56
    invoke-static/range {p0 .. p1}, Lio/realm/RealmCache;->copyFileIfNeeded(Ljava/lang/String;Ljava/io/File;)V
...
.method private static copyAssetFileIfNeeded(Lio/realm/RealmConfiguration;)V
    ...
    .line 498
    invoke-virtual/range {p0 .. p0}, Lio/realm/RealmConfiguration;->hasAssetFile()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lio/realm/RealmConfiguration;->getRealmDirectory()Ljava/io/File;

    move-result-object v1

    invoke-virtual/range {p0 .. p0}, Lio/realm/RealmConfiguration;->getRealmFileName()Ljava/lang/String;
    ...
    .line 501
    invoke-static/range {v1 .. v1}, Lio/realm/internal/ObjectServerFacade;->getFacade(Z)Lio/realm/internal/ObjectServerFacade;
    ...
    .line 503
    invoke-static/range {v1 .. v1}, Lio/realm/internal/Util;->isEmptyString(Ljava/lang/String;)Z
...
.method private static copyFileIfNeeded(Ljava/lang/String;Ljava/io/File;)V
    ...
    invoke-virtual/range {v1 .. v1}, Landroid/content/Context;->getAssets()Landroid/content/res/AssetManager;
    ...
    :goto_1
    :try_start_4
    invoke-virtual/range {v2 .. v2}, Ljava/io/FileOutputStream;->close()V
    :try_end_4
...
.method private declared-synchronized doCreateRealmOrGetFromCache(Lio/realm/RealmConfiguration;Ljava/lang/Class;)Lio/realm/BaseRealm;
    ...
    invoke-static/range {p2 .. p2}, Lio/realm/RealmCache$RealmCacheType;->valueOf(Ljava/lang/Class;)Lio/realm/RealmCache$RealmCacheType;
    ...
    .line 290
    invoke-direct/range {p0 .. p0}, Lio/realm/RealmCache;->getTotalGlobalRefCount()I
    ...
    .line 291
    invoke-static/range {p1 .. p1}, Lio/realm/RealmCache;->copyAssetFileIfNeeded(Lio/realm/RealmConfiguration;)V

    .line 292
    invoke-virtual/range {p1 .. p1}, Lio/realm/RealmConfiguration;->realmExists()Z
    ...
    .line 296
    :try_start_1
    invoke-virtual/range {p1 .. p1}, Lio/realm/RealmConfiguration;->isSyncConfiguration()Z
    ...
    .line 301
    invoke-static/range {p1 .. p1}, Lio/realm/internal/OsSharedRealm;->getInstance(Lio/realm/RealmConfiguration;)Lio/realm/internal/OsSharedRealm;
    ...
    .line 307
    :try_start_3
    invoke-virtual/range {v1 .. v1}, Lio/realm/internal/OsSharedRealm;->close()V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    .line 312
    :try_start_4
    invoke-static/range {p1 .. p1}, Lio/realm/BaseRealm;->deleteRealm(Lio/realm/RealmConfiguration;)Z
    ...
    .line 320
    :try_start_5
    invoke-static/range {v1 .. v1}, Lio/realm/internal/Table;->migratePrimaryKeyTableIfNeeded(Lio/realm/internal/OsSharedRealm;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0
    ...
    .line 325
    invoke-virtual/range {v2 .. v2}, Lio/realm/internal/OsSharedRealm;->close()V
    ...
    .line 333
    :cond_4
    invoke-direct/range {p0 .. p1}, Lio/realm/RealmCache;->validateConfiguration(Lio/realm/RealmConfiguration;)V

    .line 336
    :goto_2
    invoke-static/range {v0 .. v0}, Lio/realm/RealmCache$RefAndCount;->access$600(Lio/realm/RealmCache$RefAndCount;)Ljava/lang/ThreadLocal;
    ...
    .line 342
    invoke-static/range {p0 .. p0}, Lio/realm/Realm;->createInstance(Lio/realm/RealmCache;)Lio/realm/Realm;
    ...
    .line 344
    invoke-static/range {p0 .. p0}, Lio/realm/DynamicRealm;->createInstance(Lio/realm/RealmCache;)Lio/realm/DynamicRealm;
    ...
    .line 351
    invoke-static/range {v0 .. v0}, Lio/realm/RealmCache$RefAndCount;->access$700(Lio/realm/RealmCache$RefAndCount;)Ljava/lang/ThreadLocal;
    ...
    .line 354
    invoke-static/range {v0 .. v0}, Lio/realm/RealmCache$RefAndCount;->access$808(Lio/realm/RealmCache$RefAndCount;)I
...
.method private declared-synchronized doCreateRealmOrGetFromCacheAsync(Lio/realm/RealmConfiguration;Lio/realm/BaseRealm$InstanceCallback;Ljava/lang/Class;)Lio/realm/RealmAsyncTask;
    ...
    invoke-direct/range {v0 .. v0}, Lio/realm/internal/android/AndroidCapabilities;-><init>()V
...
.method private static getCache(Ljava/lang/String;Z)Lio/realm/RealmCache;
    ...
    invoke-virtual/range {v3 .. v3}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;
...
.method static getLocalThreadCount(Lio/realm/RealmConfiguration;)I
    ...
    invoke-virtual/range {p0 .. p0}, Ljava/util/EnumMap;->values()Ljava/util/Collection;
    ...
    .line 585
    invoke-static/range {v2 .. v2}, Lio/realm/RealmCache$RefAndCount;->access$700(Lio/realm/RealmCache$RefAndCount;)Ljava/lang/ThreadLocal;

    move-result-object v2

    invoke-virtual/range {v2 .. v2}, Ljava/lang/ThreadLocal;->get()Ljava/lang/Object;
...
.method private getTotalGlobalRefCount()I
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/util/EnumMap;->values()Ljava/util/Collection;
    ...
    .line 601
    invoke-static/range {v2 .. v2}, Lio/realm/RealmCache$RefAndCount;->access$800(Lio/realm/RealmCache$RefAndCount;)I
...
.method private validateConfiguration(Lio/realm/RealmConfiguration;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/RealmConfiguration;->getEncryptionKey()[B
    ...
    .line 436
    invoke-virtual/range {p1 .. p1}, Lio/realm/RealmConfiguration;->getMigration()Lio/realm/RealmMigration;
    ...
    invoke-virtual/range {v1 .. v1}, Lio/realm/RealmConfiguration;->getMigration()Lio/realm/RealmMigration;
...
.method declared-synchronized invokeWithLock(Lio/realm/RealmCache$Callback0;)V
    ...
    .line 485
    :try_start_0
    invoke-interface/range {p1 .. p1}, Lio/realm/RealmCache$Callback0;->onCall()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized release(Lio/realm/BaseRealm;)V
    ...
    .line 371
    :try_start_0
    invoke-virtual/range {p1 .. p1}, Lio/realm/BaseRealm;->getPath()Ljava/lang/String;
    ...
    invoke-static/range {v2 .. v2}, Lio/realm/RealmCache$RealmCacheType;->valueOf(Ljava/lang/Class;)Lio/realm/RealmCache$RealmCacheType;
    ...
    .line 373
    invoke-static/range {v1 .. v1}, Lio/realm/RealmCache$RefAndCount;->access$700(Lio/realm/RealmCache$RefAndCount;)Ljava/lang/ThreadLocal;
    ...
    .line 390
    invoke-static/range {v1 .. v1}, Lio/realm/RealmCache$RefAndCount;->access$600(Lio/realm/RealmCache$RefAndCount;)Ljava/lang/ThreadLocal;
    ...
    .line 393
    invoke-static/range {v1 .. v1}, Lio/realm/RealmCache$RefAndCount;->access$810(Lio/realm/RealmCache$RefAndCount;)I

    .line 394
    invoke-static/range {v1 .. v1}, Lio/realm/RealmCache$RefAndCount;->access$800(Lio/realm/RealmCache$RefAndCount;)I
    ...
    .line 401
    invoke-virtual/range {p1 .. p1}, Lio/realm/BaseRealm;->doClose()V
    ...
    .line 409
    invoke-virtual/range {p1 .. p1}, Lio/realm/BaseRealm;->getConfiguration()Lio/realm/RealmConfiguration;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Lio/realm/RealmConfiguration;->isSyncConfiguration()Z

    move-result v0

    invoke-static/range {v0 .. v0}, Lio/realm/internal/ObjectServerFacade;->getFacade(Z)Lio/realm/internal/ObjectServerFacade;
