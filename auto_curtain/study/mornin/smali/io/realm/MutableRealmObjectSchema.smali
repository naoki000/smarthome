...
.method private addModifiers(Ljava/lang/String;[Lio/realm/FieldAttribute;)V
    ...
    .line 315
    invoke-virtual/range {p0 .. p1}, Lio/realm/MutableRealmObjectSchema;->addIndex(Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    ...
    .line 321
    invoke-virtual/range {p0 .. p1}, Lio/realm/MutableRealmObjectSchema;->addPrimaryKey(Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    :try_end_0
    ...
    .line 329
    invoke-virtual/range {p0 .. p1}, Lio/realm/MutableRealmObjectSchema;->getColumnIndex(Ljava/lang/String;)J
...
.method private checkFieldNameIsAvailable(Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lio/realm/MutableRealmObjectSchema;->getClassName()Ljava/lang/String;
...
.method private checkNewFieldName(Ljava/lang/String;)V
    ...
    .line 351
    invoke-static/range {p1 .. p1}, Lio/realm/MutableRealmObjectSchema;->checkLegalName(Ljava/lang/String;)V

    .line 352
    invoke-direct/range {p0 .. p1}, Lio/realm/MutableRealmObjectSchema;->checkFieldNameIsAvailable(Ljava/lang/String;)V
...
.method public varargs addField(Ljava/lang/String;Ljava/lang/Class;[Lio/realm/FieldAttribute;)Lio/realm/RealmObjectSchema;
    ...
    .line 103
    invoke-direct/range {p0 .. p0}, Lio/realm/MutableRealmObjectSchema;->checkAddPrimaryKeyForSync()V

    .line 106
    :cond_3
    invoke-direct/range {p0 .. p1}, Lio/realm/MutableRealmObjectSchema;->checkNewFieldName(Ljava/lang/String;)V
...
.method public addIndex(Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    ...
    .line 192
    invoke-virtual/range {p0 .. p1}, Lio/realm/MutableRealmObjectSchema;->checkFieldExists(Ljava/lang/String;)V
...
.method public addRealmListField(Ljava/lang/String;Lio/realm/RealmObjectSchema;)Lio/realm/RealmObjectSchema;
    ...
    invoke-virtual/range {p2 .. p2}, Lio/realm/RealmObjectSchema;->getClassName()Ljava/lang/String;

    move-result-object p2

    invoke-static/range {p2 .. p2}, Lio/realm/internal/Table;->getTableNameForClass(Ljava/lang/String;)Ljava/lang/String;
...
.method varargs getColumnIndices(Ljava/lang/String;[Lio/realm/RealmFieldType;)Lio/realm/internal/fields/FieldDescriptor;
    ...
    .line 305
    invoke-virtual/range {p0 .. p0}, Lio/realm/MutableRealmObjectSchema;->getSchemaConnector()Lio/realm/SchemaConnector;

    move-result-object v0

    invoke-virtual/range {p0 .. p0}, Lio/realm/MutableRealmObjectSchema;->getTable()Lio/realm/internal/Table;
...
.method public removeField(Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/BaseRealm;->checkNotInSync()V

    .line 161
    invoke-static/range {p1 .. p1}, Lio/realm/MutableRealmObjectSchema;->checkLegalName(Ljava/lang/String;)V

    .line 162
    invoke-virtual/range {p0 .. p1}, Lio/realm/MutableRealmObjectSchema;->hasField(Ljava/lang/String;)Z
...
.method public renameField(Ljava/lang/String;Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    ...
    .line 179
    invoke-static/range {p2 .. p2}, Lio/realm/MutableRealmObjectSchema;->checkLegalName(Ljava/lang/String;)V
...
.method public setClassName(Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    ...
    .line 45
    invoke-direct/range {p0 .. p1}, Lio/realm/MutableRealmObjectSchema;->checkEmpty(Ljava/lang/String;)V
...
.method public setRequired(Ljava/lang/String;Z)Lio/realm/RealmObjectSchema;
    ...
    .line 252
    invoke-virtual/range {p0 .. p1}, Lio/realm/MutableRealmObjectSchema;->isRequired(Ljava/lang/String;)Z
...
.method public transform(Lio/realm/RealmObjectSchema$Function;)Lio/realm/RealmObjectSchema;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/Table;->size()J
