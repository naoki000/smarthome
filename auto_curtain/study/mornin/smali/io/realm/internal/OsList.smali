...
.method public constructor <init>(Lio/realm/internal/UncheckedRow;J)V
    ...
    invoke-direct/range {v0 .. v0}, Lio/realm/internal/ObserverPairList;-><init>()V

    iput-object v0, p0, Lio/realm/internal/OsList;->observerPairs:Lio/realm/internal/ObserverPairList;

    .line 23
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/UncheckedRow;->getTable()Lio/realm/internal/Table;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/Table;->getSharedRealm()Lio/realm/internal/OsSharedRealm;

    move-result-object v0

    .line 24
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/OsSharedRealm;->getNativePtr()J
...
.method public addDate(Ljava/util/Date;)V
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsList;->nativeAddNull(J)V
...
.method public deleteAll()V
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsList;->nativeDeleteAll(J)V
...
.method public getQuery()Lio/realm/internal/TableQuery;
    ...
    invoke-static/range {v3 .. v4}, Lio/realm/internal/OsList;->nativeGetQuery(J)J
...
.method public isEmpty()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsList;->nativeSize(J)J
...
.method public isValid()Z
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsList;->nativeIsValid(J)Z
...
.method public notifyChangeListeners(J)V
    ...
    .line 251
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/OsCollectionChangeSet;->isEmpty()Z
...
.method public removeAll()V
    ...
    invoke-static/range {v0 .. v1}, Lio/realm/internal/OsList;->nativeRemoveAll(J)V
