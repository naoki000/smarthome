...
.method public constructor <init>(Lio/realm/internal/OsCollectionChangeSet;)V
    ...
    .line 30
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsCollectionChangeSet;->isFirstAsyncCallback()Z

    move-result v0

    .line 31
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsCollectionChangeSet;->isRemoteDataLoaded()Z
    ...
    .line 33
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsCollectionChangeSet;->getError()Ljava/lang/Throwable;
...
.method public getChangeRanges()[Lio/realm/OrderedCollectionChangeSet$Range;
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/OrderedCollectionChangeSet;->getChangeRanges()[Lio/realm/OrderedCollectionChangeSet$Range;
...
.method public getChanges()[I
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/OrderedCollectionChangeSet;->getChanges()[I
...
.method public getDeletionRanges()[Lio/realm/OrderedCollectionChangeSet$Range;
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/OrderedCollectionChangeSet;->getDeletionRanges()[Lio/realm/OrderedCollectionChangeSet$Range;
...
.method public getDeletions()[I
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/OrderedCollectionChangeSet;->getDeletions()[I
...
.method public getInsertionRanges()[Lio/realm/OrderedCollectionChangeSet$Range;
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/OrderedCollectionChangeSet;->getInsertionRanges()[Lio/realm/OrderedCollectionChangeSet$Range;
...
.method public getInsertions()[I
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/OrderedCollectionChangeSet;->getInsertions()[I
