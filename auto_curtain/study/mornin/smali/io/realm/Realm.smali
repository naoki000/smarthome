...
.method private constructor <init>(Lio/realm/RealmCache;)V
    ...
    .line 164
    invoke-virtual/range {p1 .. p1}, Lio/realm/RealmCache;->getConfiguration()Lio/realm/RealmConfiguration;

    move-result-object v0

    invoke-virtual/range {v0 .. v0}, Lio/realm/RealmConfiguration;->getSchemaMediator()Lio/realm/internal/RealmProxyMediator;

    move-result-object v0

    invoke-static/range {v0 .. v0}, Lio/realm/Realm;->createExpectedSchemaInfo(Lio/realm/internal/RealmProxyMediator;)Lio/realm/internal/OsSchemaInfo;
    ...
    invoke-virtual/range {v2 .. v2}, Lio/realm/internal/OsSharedRealm;->getSchemaInfo()Lio/realm/internal/OsSchemaInfo;
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/RealmConfiguration;->getSchemaMediator()Lio/realm/internal/RealmProxyMediator;
    ...
    invoke-static/range {v1 .. v1}, Lio/realm/internal/Table;->getTableNameForClass(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsSharedRealm;->close()V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/RealmConfiguration;->getPath()Ljava/lang/String;
    ...
    .line 180
    invoke-static/range {v1 .. v1}, Lio/realm/internal/Table;->getClassNameForTable(Ljava/lang/String;)Ljava/lang/String;
...
.method private constructor <init>(Lio/realm/internal/OsSharedRealm;)V
    ...
    .line 187
    invoke-direct/range {p0 .. p1}, Lio/realm/BaseRealm;-><init>(Lio/realm/internal/OsSharedRealm;)V
    ...
    .line 189
    invoke-virtual/range {v2 .. v2}, Lio/realm/RealmConfiguration;->getSchemaMediator()Lio/realm/internal/RealmProxyMediator;

    move-result-object v2

    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsSharedRealm;->getSchemaInfo()Lio/realm/internal/OsSchemaInfo;
...
.method private static checkFilesDirAvailable(Landroid/content/Context;)V
    ...
    :cond_0
    :try_start_0
    invoke-virtual/range {v0 .. v0}, Ljava/io/File;->mkdirs()Z
    :try_end_0
    ...
    invoke-virtual/range {v6 .. v6}, Ljava/io/File;->exists()Z
    ...
    .line 308
    invoke-static/range {v6 .. v7}, Landroid/os/SystemClock;->sleep(J)V
...
.method private checkHasPrimaryKey(Ljava/lang/Class;)V
    ...
    invoke-virtual/range {v1 .. v1}, Lio/realm/internal/OsSharedRealm;->getSchemaInfo()Lio/realm/internal/OsSchemaInfo;
    ...
    .line 1627
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/OsObjectSchemaInfo;->getPrimaryKeyProperty()Lio/realm/internal/Property;
...
.method private checkValidObjectForDetach(Lio/realm/RealmModel;)V
    ...
    invoke-static/range {p1 .. p1}, Lio/realm/RealmObject;->isValid(Lio/realm/RealmModel;)Z
...
.method public static compactRealm(Lio/realm/RealmConfiguration;)Z
    ...
    .line 1709
    invoke-virtual/range {p0 .. p0}, Lio/realm/RealmConfiguration;->isSyncConfiguration()Z
    ...
    .line 1712
    invoke-static/range {p0 .. p0}, Lio/realm/BaseRealm;->compactRealm(Lio/realm/RealmConfiguration;)Z
...
.method private copyOrUpdate(Lio/realm/RealmModel;ZLjava/util/Map;)Lio/realm/RealmModel;
    ...
    .line 1607
    invoke-virtual/range {p0 .. p0}, Lio/realm/Realm;->checkIfValid()V
...
.method private static createExpectedSchemaInfo(Lio/realm/internal/RealmProxyMediator;)Lio/realm/internal/OsSchemaInfo;
    ...
    invoke-virtual/range {p0 .. p0}, Lio/realm/internal/RealmProxyMediator;->getExpectedObjectSchemaInfoMap()Ljava/util/Map;
...
.method public static deleteRealm(Lio/realm/RealmConfiguration;)Z
    ...
    .line 1691
    invoke-static/range {p0 .. p0}, Lio/realm/BaseRealm;->deleteRealm(Lio/realm/RealmConfiguration;)Z
...
.method public static getDefaultModule()Ljava/lang/Object;
    ...
    .line 1867
    invoke-virtual/range {v1 .. v1}, Ljava/lang/Class;->getDeclaredConstructors()[Ljava/lang/reflect/Constructor;
...
.method public static getLocalInstanceCount(Lio/realm/RealmConfiguration;)I
    ...
    .line 1907
    invoke-static/range {p0 .. p0}, Lio/realm/RealmCache;->getLocalThreadCount(Lio/realm/RealmConfiguration;)I
...
.method public static declared-synchronized init(Landroid/content/Context;)V
    ...
    .line 257
    invoke-static/range {p0 .. p0}, Lio/realm/Realm;->checkFilesDirAvailable(Landroid/content/Context;)V

    .line 258
    invoke-static/range {p0 .. p0}, Lio/realm/internal/RealmCore;->loadLibrary(Landroid/content/Context;)V
    ...
    invoke-static/range {v1 .. v1}, Lio/realm/internal/OsSharedRealm;->initialize(Ljava/io/File;)V
...
.method public static migrateRealm(Lio/realm/RealmConfiguration;Lio/realm/RealmMigration;)V
    ...
    .line 1672
    invoke-static/range {p0 .. p1}, Lio/realm/BaseRealm;->migrateRealm(Lio/realm/RealmConfiguration;Lio/realm/RealmMigration;)V
...
.method public addChangeListener(Lio/realm/RealmChangeListener;)V
    ...
    .line 1363
    invoke-virtual/range {p0 .. p1}, Lio/realm/Realm;->addListener(Lio/realm/RealmChangeListener;)V
...
.method public asFlowable()Lio/reactivex/Flowable;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/RealmConfiguration;->getRxFactory()Lio/realm/rx/RxObservableFactory;
...
.method public bridge synthetic beginTransaction()V
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->beginTransaction()V
...
.method public bridge synthetic cancelTransaction()V
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->cancelTransaction()V
...
.method public bridge synthetic commitTransaction()V
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->commitTransaction()V
...
.method public copyFromRealm(Lio/realm/RealmModel;I)Lio/realm/RealmModel;
    ...
    .line 1330
    invoke-direct/range {p0 .. p1}, Lio/realm/Realm;->checkValidObjectForDetach(Lio/realm/RealmModel;)V
...
.method public copyToRealm(Lio/realm/RealmModel;)Lio/realm/RealmModel;
    ...
    .line 1004
    invoke-direct/range {p0 .. p1}, Lio/realm/Realm;->checkNotNullObject(Lio/realm/RealmModel;)V
...
.method public createAllFromJson(Ljava/lang/Class;Ljava/io/InputStream;)V
    ...
    .line 604
    :try_start_0
    invoke-virtual/range {v0 .. v0}, Landroid/util/JsonReader;->beginArray()V

    .line 605
    :goto_0
    invoke-virtual/range {v0 .. v0}, Landroid/util/JsonReader;->hasNext()Z
    ...
    invoke-virtual/range {p2 .. p2}, Lio/realm/RealmConfiguration;->getSchemaMediator()Lio/realm/internal/RealmProxyMediator;
    ...
    .line 608
    :cond_1
    invoke-virtual/range {v0 .. v0}, Landroid/util/JsonReader;->endArray()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 610
    invoke-virtual/range {v0 .. v0}, Landroid/util/JsonReader;->close()V
...
.method public createObjectFromJson(Ljava/lang/Class;Ljava/io/InputStream;)Lio/realm/RealmModel;
    ...
    invoke-virtual/range {p2 .. p2}, Ljava/util/Scanner;->next()Ljava/lang/String;
    ...
    .line 835
    invoke-virtual/range {p2 .. p2}, Ljava/util/Scanner;->close()V
...
.method createObjectInternal(Ljava/lang/Class;ZLjava/util/List;)Lio/realm/RealmModel;
    ...
    .line 938
    invoke-static/range {v0 .. v0}, Lio/realm/internal/OsObject;->create(Lio/realm/internal/Table;)Lio/realm/internal/UncheckedRow;
    ...
    .line 935
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/Table;->getClassName()Ljava/lang/String;
...
.method public createOrUpdateAllFromJson(Ljava/lang/Class;Ljava/io/InputStream;)V
    ...
    .line 641
    invoke-direct/range {p0 .. p1}, Lio/realm/Realm;->checkHasPrimaryKey(Ljava/lang/Class;)V
...
.method public createOrUpdateObjectFromJson(Ljava/lang/Class;Ljava/io/InputStream;)Lio/realm/RealmModel;
    ...
    .line 890
    invoke-virtual/range {v0 .. v0}, Ljava/util/Scanner;->close()V
...
.method public bridge synthetic deleteAll()V
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->deleteAll()V
...
.method public executeTransaction(Lio/realm/Realm$Transaction;)V
    ...
    .line 1408
    invoke-virtual/range {p0 .. p0}, Lio/realm/Realm;->isInTransaction()Z
...
.method public executeTransactionAsync(Lio/realm/Realm$Transaction;Lio/realm/Realm$Transaction$OnSuccess;Lio/realm/Realm$Transaction$OnError;)Lio/realm/RealmAsyncTask;
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/internal/Capabilities;->canDeliverNotification()Z
...
.method public bridge synthetic getConfiguration()Lio/realm/RealmConfiguration;
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->getConfiguration()Lio/realm/RealmConfiguration;
...
.method public bridge synthetic getPath()Ljava/lang/String;
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->getPath()Ljava/lang/String;
...
.method public getPermissions()Lio/realm/sync/permissions/RealmPermissions;
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/RealmQuery;->findFirst()Ljava/lang/Object;
...
.method public bridge synthetic getPrivileges(Lio/realm/RealmModel;)Lio/realm/sync/permissions/ObjectPrivileges;
    ...
    .line 146
    invoke-super/range {p0 .. p1}, Lio/realm/BaseRealm;->getPrivileges(Lio/realm/RealmModel;)Lio/realm/sync/permissions/ObjectPrivileges;
...
.method public bridge synthetic getPrivileges()Lio/realm/sync/permissions/RealmPrivileges;
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->getPrivileges()Lio/realm/sync/permissions/RealmPrivileges;
...
.method public bridge synthetic getVersion()J
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->getVersion()J
...
.method public insert(Lio/realm/RealmModel;)V
    ...
    .line 1117
    invoke-virtual/range {p0 .. p0}, Lio/realm/Realm;->checkIfValidAndInTransaction()V
...
.method public bridge synthetic isAutoRefresh()Z
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->isAutoRefresh()Z
...
.method public bridge synthetic isClosed()Z
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->isClosed()Z
...
.method public bridge synthetic isEmpty()Z
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->isEmpty()Z
...
.method public bridge synthetic isInTransaction()Z
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->isInTransaction()Z
...
.method public bridge synthetic refresh()V
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->refresh()V
...
.method public removeAllChangeListeners()V
    ...
    .line 1385
    invoke-virtual/range {p0 .. p0}, Lio/realm/Realm;->removeAllListeners()V
...
.method public removeChangeListener(Lio/realm/RealmChangeListener;)V
    ...
    .line 1375
    invoke-virtual/range {p0 .. p1}, Lio/realm/Realm;->removeListener(Lio/realm/RealmChangeListener;)V
...
.method public bridge synthetic setAutoRefresh(Z)V
    ...
    .line 146
    invoke-super/range {p0 .. p1}, Lio/realm/BaseRealm;->setAutoRefresh(Z)V
...
.method public bridge synthetic stopWaitForChange()V
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->stopWaitForChange()V
...
.method public bridge synthetic waitForChange()Z
    ...
    .line 146
    invoke-super/range {p0 .. p0}, Lio/realm/BaseRealm;->waitForChange()Z
...
.method public where(Ljava/lang/Class;)Lio/realm/RealmQuery;
    ...
    .line 1343
    invoke-static/range {p0 .. p1}, Lio/realm/RealmQuery;->createQuery(Lio/realm/Realm;Ljava/lang/Class;)Lio/realm/RealmQuery;
...
.method public bridge synthetic writeCopyTo(Ljava/io/File;)V
    ...
    .line 146
    invoke-super/range {p0 .. p1}, Lio/realm/BaseRealm;->writeCopyTo(Ljava/io/File;)V
...
.method public bridge synthetic writeEncryptedCopyTo(Ljava/io/File;[B)V
    ...
    .line 146
    invoke-super/range {p0 .. p2}, Lio/realm/BaseRealm;->writeEncryptedCopyTo(Ljava/io/File;[B)V
