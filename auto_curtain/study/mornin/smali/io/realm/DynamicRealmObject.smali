...
.method constructor <init>(Lio/realm/BaseRealm;Lio/realm/internal/Row;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/ProxyState;->setConstructionFinished()V
...
.method public constructor <init>(Lio/realm/RealmModel;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/internal/UncheckedRow;->convertToChecked()Lio/realm/internal/CheckedRow;
...
.method private checkIsPrimaryKey(Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lio/realm/DynamicRealmObject;->getType()Ljava/lang/String;
    ...
    .line 1195
    invoke-virtual/range {v0 .. v0}, Lio/realm/RealmObjectSchema;->hasPrimaryKey()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual/range {v0 .. v0}, Lio/realm/RealmObjectSchema;->getPrimaryKey()Ljava/lang/String;
...
.method private getOperator(Lio/realm/BaseRealm;Lio/realm/internal/OsList;Lio/realm/RealmFieldType;Ljava/lang/Class;)Lio/realm/ManagedListOperator;
    ...
    invoke-virtual/range {p3 .. p3}, Lio/realm/RealmFieldType;->name()Ljava/lang/String;
...
.method private setModelList(Ljava/lang/String;Lio/realm/RealmList;)V
    ...
    .line 808
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsList;->getTargetTable()Lio/realm/internal/Table;
    ...
    invoke-virtual/range {v2 .. v2}, Lio/realm/BaseRealm;->getSchema()Lio/realm/RealmSchema;
    ...
    invoke-virtual/range {v2 .. v2}, Lio/realm/internal/Table;->getClassName()Ljava/lang/String;
    ...
    .line 834
    invoke-interface/range {v9 .. v9}, Lio/realm/internal/RealmObjectProxy;->realmGet$proxyState()Lio/realm/ProxyState;

    move-result-object v10

    invoke-virtual/range {v10 .. v10}, Lio/realm/ProxyState;->getRealm$realm()Lio/realm/BaseRealm;

    move-result-object v10

    iget-object v11, p0, Lio/realm/DynamicRealmObject;->proxyState:Lio/realm/ProxyState;

    invoke-virtual/range {v11 .. v11}, Lio/realm/ProxyState;->getRealm$realm()Lio/realm/BaseRealm;
    ...
    invoke-virtual/range {v10 .. v10}, Lio/realm/ProxyState;->getRow$realm()Lio/realm/internal/Row;

    move-result-object v10

    invoke-interface/range {v10 .. v10}, Lio/realm/internal/Row;->getTable()Lio/realm/internal/Table;
    ...
    invoke-virtual/range {v9 .. v9}, Lio/realm/ProxyState;->getRow$realm()Lio/realm/internal/Row;

    move-result-object v9

    invoke-interface/range {v9 .. v9}, Lio/realm/internal/Row;->getIndex()J
    ...
    .line 848
    :cond_5
    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsList;->removeAll()V
...
.method private setValueList(Ljava/lang/String;Lio/realm/RealmList;Lio/realm/RealmFieldType;)V
    ...
    invoke-virtual/range {p3 .. p3}, Lio/realm/RealmFieldType;->ordinal()I
    ...
    .line 873
    invoke-virtual/range {p2 .. p2}, Lio/realm/RealmList;->isManaged()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual/range {p1 .. p1}, Lio/realm/internal/OsList;->size()J
    ...
    .line 877
    invoke-virtual/range {p2 .. p2}, Lio/realm/RealmList;->iterator()Ljava/util/Iterator;
...
.method public get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual/range {v2 .. v2}, Lio/realm/RealmFieldType;->ordinal()I
...
.method public getByte(Ljava/lang/String;)B
    ...
    .line 210
    invoke-virtual/range {p0 .. p1}, Lio/realm/DynamicRealmObject;->getLong(Ljava/lang/String;)J
...
.method public getDynamicRealm()Lio/realm/DynamicRealm;
    ...
    .line 1174
    invoke-virtual/range {p0 .. p0}, Lio/realm/DynamicRealmObject;->realmGet$proxyState()Lio/realm/ProxyState;
    ...
    .line 1176
    invoke-virtual/range {p0 .. p0}, Lio/realm/DynamicRealmObject;->isValid()Z
...
.method public getFieldNames()[Ljava/lang/String;
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/internal/Row;->getColumnCount()J
...
.method public getList(Ljava/lang/String;)Lio/realm/RealmList;
    ...
    .line 355
    invoke-virtual/range {v2 .. v2}, Lio/realm/internal/OsList;->getTargetTable()Lio/realm/internal/Table;

    move-result-object v3

    invoke-virtual/range {v3 .. v3}, Lio/realm/internal/Table;->getClassName()Ljava/lang/String;
...
.method public getObject(Ljava/lang/String;)Lio/realm/DynamicRealmObject;
    ...
    invoke-interface/range {p1 .. p1}, Lio/realm/internal/Row;->getTable()Lio/realm/internal/Table;
...
.method public isNull(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {p1 .. p1}, Lio/realm/RealmFieldType;->ordinal()I
...
.method public linkingObjects(Ljava/lang/String;Ljava/lang/String;)Lio/realm/RealmResults;
    ...
    .line 1136
    invoke-virtual/range {v0 .. v0}, Lio/realm/DynamicRealm;->checkIfValid()V
    ...
    invoke-interface/range {v1 .. v1}, Lio/realm/internal/Row;->checkIfAttached()V

    .line 1139
    invoke-virtual/range {v0 .. v0}, Lio/realm/DynamicRealm;->getSchema()Lio/realm/RealmSchema;
    ...
    .line 1157
    invoke-virtual/range {p1 .. p1}, Lio/realm/RealmFieldType;->name()Ljava/lang/String;
    ...
    .line 1159
    invoke-virtual/range {v2 .. v2}, Lio/realm/RealmFieldType;->name()Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v1}, Lio/realm/RealmObjectSchema;->getTable()Lio/realm/internal/Table;
...
.method public set(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 517
    :pswitch_0
    invoke-static/range {v1 .. v1}, Ljava/lang/Double;->parseDouble(Ljava/lang/String;)D
    ...
    .line 514
    :pswitch_1
    invoke-static/range {v1 .. v1}, Ljava/lang/Float;->parseFloat(Ljava/lang/String;)F
    ...
    .line 511
    :pswitch_2
    invoke-static/range {v1 .. v1}, Ljava/lang/Long;->parseLong(Ljava/lang/String;)J
    ...
    .line 508
    :pswitch_3
    invoke-static/range {v1 .. v1}, Ljava/lang/Boolean;->parseBoolean(Ljava/lang/String;)Z
    ...
    .line 520
    :cond_1
    invoke-static/range {v1 .. v1}, Lio/realm/internal/android/JsonUtils;->stringToDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    .line 531
    invoke-virtual/range {p0 .. p1}, Lio/realm/DynamicRealmObject;->setNull(Ljava/lang/String;)V
...
.method public setByte(Ljava/lang/String;B)V
    ...
    .line 643
    invoke-direct/range {p0 .. p1}, Lio/realm/DynamicRealmObject;->checkIsPrimaryKey(Ljava/lang/String;)V
...
.method public setList(Ljava/lang/String;Lio/realm/RealmList;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lio/realm/RealmFieldType;->ordinal()I
    ...
    .line 782
    :pswitch_2
    invoke-virtual/range {p2 .. p2}, Lio/realm/RealmList;->isEmpty()Z
    ...
    .line 783
    invoke-virtual/range {p2 .. p2}, Lio/realm/RealmList;->first()Ljava/lang/Object;
    ...
    :cond_1
    :goto_0
    invoke-direct/range {p0 .. p2}, Lio/realm/DynamicRealmObject;->setModelList(Ljava/lang/String;Lio/realm/RealmList;)V
...
.method public setObject(Ljava/lang/String;Lio/realm/DynamicRealmObject;)V
    ...
    invoke-virtual/range {p2 .. p2}, Lio/realm/ProxyState;->getRow$realm()Lio/realm/internal/Row;

    move-result-object p2

    invoke-interface/range {p2 .. p2}, Lio/realm/internal/Row;->getIndex()J
...
.method public toString()Ljava/lang/String;
    ...
    invoke-interface/range {v0 .. v0}, Lio/realm/internal/Row;->isAttached()Z
    ...
    invoke-virtual/range {v7 .. v7}, Lio/realm/ProxyState;->getRow$realm()Lio/realm/internal/Row;
    ...
    invoke-virtual/range {v9 .. v9}, Lio/realm/RealmFieldType;->ordinal()I
    ...
    invoke-virtual/range {v11 .. v11}, Lio/realm/ProxyState;->getRow$realm()Lio/realm/internal/Row;
    ...
    invoke-virtual/range {v7 .. v7}, Lio/realm/internal/OsList;->size()J
    ...
    invoke-virtual/range {v6 .. v6}, Lio/realm/ProxyState;->getRow$realm()Lio/realm/internal/Row;

    move-result-object v6

    invoke-interface/range {v6 .. v6}, Lio/realm/internal/Row;->getTable()Lio/realm/internal/Table;
    ...
    invoke-virtual/range {v6 .. v6}, Lio/realm/internal/Table;->getClassName()Ljava/lang/String;
    ...
    invoke-virtual/range {v6 .. v6}, Lio/realm/internal/OsList;->size()J
    ...
    invoke-virtual/range {v5 .. v5}, Lio/realm/ProxyState;->getRow$realm()Lio/realm/internal/Row;
    ...
    invoke-interface/range {v5 .. v5}, Lio/realm/internal/Row;->getTable()Lio/realm/internal/Table;
    ...
    invoke-virtual/range {v5 .. v5}, Lio/realm/internal/Table;->getClassName()Ljava/lang/String;
    ...
    invoke-static/range {v5 .. v5}, Ljava/util/Arrays;->toString([B)Ljava/lang/String;
    ...
    .line 1114
    :cond_7
    invoke-virtual/range {v1 .. v1}, Ljava/lang/StringBuilder;->length()I
